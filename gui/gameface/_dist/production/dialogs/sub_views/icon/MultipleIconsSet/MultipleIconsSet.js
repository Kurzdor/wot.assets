    ...
    var __webpack_modules__ = {
                ...
                const w = E.instance,
                    p = {
                        ...
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            d(n.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
                        sendShowPopOverEvent: (u, e, A, F, E = R.invalid('resId'), t) => {
                            const D = i.O.view.getViewGlobalPosition(),
                                ...
                                s = {
                                    ...
                                    y: i.O.view.pxToRem(C) + D.y,
                                    width: i.O.view.pxToRem(o),
                                    height: i.O.view.pxToRem(a),
                                };
                            d(n.POP_OVER, {
                                isMouseEvent: !0,
                                contentID: u,
            ...
            6838: (u, e, A) => {
                ...
                const o = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    s = (u, e, A = B.left) => u.split(e).reduce(A === B.left ? a : i, []),
                    c = (() => {
                        const u = new RegExp(
                ...
                const v = (u = 1) => {
                    ...
                    f = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const F = w(`${u}.${A}`, window);
                                return g(F) ? e(u, A, F) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    T = (u) => {
                        const e = ((u) => {
                                const e = v(),
                        ...
                        if (F.length > 0) {
                            ...
                            return (
                                F.reduce((e, F) => {
                                    const E = w(b(A, `${e}.${F}`), window);
                                    return g(E) ? (u.push(E.id), `${e}.${F}.value`) : (u.push(F), `${e}.${F}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        p(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    F = T(u);
                                a.current = x.addCallback(F, A, n, e === O.Deep);
                            }
                        }),
                        (0, F.useEffect)(() => {
                            if (e !== O.None)
                ...
                const M = 'FormatText_base_d0',
                    P = ({ binding: u, text: e = '', classMix: A, alignment: t = B.left, formatWithBrackets: D }) => {
                    ...
                    W = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    I = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    U = (0, F.memo)(({ text: u, binding: e, classMix: A }) => {
                                ...
                                (r = r.replace(A, `%(${n})`)),
                                    (D[n] = L[u]
                                        ? E().createElement(
                                              'span',
                                              { className: L[u] },
                                              E().createElement(P, { text: o, binding: e }),
                                          )
                                        : E().createElement(
                                              'span',
                                              { style: t(u) },
                        ...
                        return E().createElement(P, { text: r, classMix: A, binding: D });
                    }),
                    V = () => {
                    ...
                    $ = 'Icon_base_67',
                    z = (0, F.memo)(({ src: u, classMix: e, style: A }) => {
                        const t = (0, F.useState)(0),
                            ...
                            a = V(),
                            i = (0, F.useMemo)(
                                () => Object.assign({ width: `${B}rem`, height: `${D}rem` }, A),
                                [D, B, A],
                            ),
                            s = S()($, e);
                        return E().createElement(
                            'div',
                            { className: s, style: i },
                            E().createElement('img', { alt: 'icon', src: u, style: a, onLoad: o }),
                        );
                    }),
                    q = 'SimpleTextApp_base_bd',
                    K = 'SimpleTextApp_formatText_fa',
                    j = (u) => u,
                    G = ({ path: u, modelAdapter: e = j }) => {
                        const A = e(y(u)) || {},
                            t = A.text,
                            D = A.imageSubstitutions,
                            n = (0, F.useMemo)(
                                () =>
                                    D.map(({ value: u }) => ({
                            ...
                            r = (0, F.useMemo)(
                                () =>
                                    D.reduce(
                                        (u, { value: e }, A) => (
                                            e.path &&
                                                (u[e.placeholder] = E().createElement(z, { src: e.path, style: n[A] })),
                                            u
                                        ),
                                        {},
                                    ),
                        ...
                        return E().createElement(
                            'div',
                            { className: q },
                            E().createElement(U, { classMix: K, text: t, binding: r }),
                        );
                    },
                    ...
                    eu = () => {
                        const u = y(),
                            ...
                            c = (0, F.useCallback)((u) => {
                                C(u.currentTarget.height), i(u.currentTarget.width);
                            }, []),
                            l = V();
                        return E().createElement(
                            'div',
                                ...
                                e.map(
                                    ({ value: u }) =>
                                        ...
                                        E().createElement(
                                            ...
                                            E().createElement('img', { alt: 'bg icon', src: u.path, style: l }),
                                        ),
                                ),
                                E().createElement(
                                    'div',
                                        ...
                                        ({ value: u }, e) =>
                                            ...
                                            E().createElement(
                                                ...
                                                E().createElement('img', {
                                                    alt: '',
                                                    src: u.path,
                                                    style: { width: `${a}rem`, height: `${B}rem` },
                                                    onLoad: c,
                                                }),
                                                u.iconLabel &&
                                                    E().createElement(
                                ...
                                A.map(
                                    ({ value: u }) =>
                                        ...
                                        E().createElement(
                                            'div',
                                            { key: u.path, className: J },
                                            E().createElement('img', { alt: 'overlay icon', src: u.path, style: l }),
                                        ),
                                ),
                            ),
                        );
