    ...
    var __webpack_modules__ = {
            ...
            6838: (u, e, A) => {
                ...
                const a = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    s = (u, e, A = B.left) => u.split(e).reduce(A === B.left ? C : i, []),
                    c = (() => {
                        const u = new RegExp(
                ...
                const v = (u = 1) => {
                    ...
                    f = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const E = w(`${u}.${A}`, window);
                                return g(E) ? e(u, A, E) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    T = (u) => {
                        const e = ((u) => {
                                const e = v(),
                                ...
                                return { modelPrefix: F, modelPath: b(F, u || ''), resId: E };
                            })(),
                            A = e.modelPrefix,
                            E = u.split('.');
                        if (E.length > 0) {
                        ...
                        p(() => {
                            if (
                                ...
                                const A = (u) => {
                                    ...
                                    E = T(u);
                                C.current = y.addCallback(E, A, n, e === x.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== x.None)
                ...
                const P = 'FormatText_base_d0',
                    M = ({ binding: u, text: e = '', classMix: A, alignment: t = B.left, formatWithBrackets: D }) => {
                    ...
                    W = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    I = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    U = (0, E.memo)(({ text: u, binding: e, classMix: A }) => {
                                ...
                                (r = r.replace(A, `%(${n})`)),
                                    (D[n] = L[u]
                                        ? F().createElement(
                                              'span',
                                              { className: L[u] },
                                              F().createElement(M, { text: a, binding: e }),
                                          )
                                        : F().createElement(
                                              'span',
                                              { style: t(u) },
                        ...
                        return F().createElement(M, { text: r, classMix: A, binding: D });
                    }),
                    $ = () => {
                        const u = (0, E.useState)(h.O.view.getScale()),
                            e = u[0],
                            A = u[1];
                        return (
                            (0, E.useEffect)(() => {
                    ...
                    V = 'Icon_base_67',
                    z = (0, E.memo)(({ src: u, classMix: e, style: A }) => {
                    ...
                    j = ({ path: u, modelAdapter: e = K }) => {
                            ...
                            r = (0, E.useMemo)(
                                () =>
                                    D.reduce(
                                        (u, { value: e }, A) => (
                                            e.path &&
                                                (u[e.placeholder] = F().createElement(z, { src: e.path, style: n[A] })),
                                            u
                                        ),
                                        {},
                                    ),
                        ...
                        return F().createElement(
                            'div',
                            { className: q },
                            F().createElement(U, { classMix: G, text: t, binding: r }),
                        );
                    },
