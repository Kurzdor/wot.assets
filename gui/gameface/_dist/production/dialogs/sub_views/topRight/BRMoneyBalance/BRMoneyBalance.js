(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => a, off: () => o, on: () => r, onResize: () => F, onScaleUpdated: () => A });
                var n = t(2472),
                    E = t(1176);
            ...
            9916: (u, e, t) => {
                t.d(e, { Sw: () => F.Z, B3: () => o, Z5: () => A.Z5, B0: () => r, ry: () => d });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            4540: (u, e, t) => {
                        ...
                        if (n.length > 0) {
                            ...
                            return (
                                n.reduce((e, n) => {
                                    ...
                                    return l(E) ? (u.push(E.id), `${e}.${n}.value`) : (u.push(n), `${e}.${n}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            T = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (f(t, C, { isMouseEvent: !0, on: !0, arguments: g(E) }, y),
                                    m && m(),
                    ...
                    W = ({ value: u, currencyType: e, isWGMAvailable: t, tooltip: n }) => {
                        ...
                        return E().createElement(
                            ...
                            E().createElement(
                                ...
                                t ? E().createElement(b, { value: u, format: F }) : E().createElement(S, null),
                            ),
                        );
                    },
                ...
                const j = (0, n.memo)(({ value: u, currencyType: e, isWGMAvailable: t, tooltip: F }) => {
                        const A = (0, n.useMemo)(() => N(F.type, { currency: e }), [F.type, e]);
                        return e !== q.brcoin
                ...
                engine.whenReady.then(() => {
                    A().render(E().createElement(z, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (o = 0; o < deferred.length; o++) {
                    for (var [e, t, n] = deferred[o], F = !0, A = 0; A < e.length; A++)
                        (!1 & n || E >= n) &&
