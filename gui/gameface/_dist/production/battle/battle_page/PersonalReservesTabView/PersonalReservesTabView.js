    ...
    var __webpack_modules__ = {
            ...
            7090: (u, e, t) => {
                ...
                const G = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    j = (u, e, t = H.left) => u.split(e).reduce(t === H.left ? U : $, []),
                    V = (() => {
                        const u = new RegExp(
                    ...
                    q = (u, e = H.left) => {
                        ...
                        return ((u, e = H.left) => {
                            ...
                            const r =
                                ...
                                n = G(u);
                            return j(n, /( )/, e).forEach((u) => (t = t.concat(j(u, r, H.left)))), t;
                        })(u, e);
                    },
                        ...
                        return [
                            function ({ mode: a = 'real', options: s, children: o, mocks: E }) {
                                const l = (0, r.useRef)([]),
                                    ...
                                    D = F[0],
                                    _ = F[1],
                                    d = (0, r.useState)(() => c(a, s, E)),
                                    C = d[0],
                                    B = d[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        A.current ? B(c(D, s, E)) : (A.current = !0);
                                    }, [E, D, s]),
                                    (0, r.useEffect)(() => {
                                        _(a);
                                    }, [a]),
                ...
                const ju = Uu,
                    ...
                    Ku = (u, e) => {
                        switch (e) {
                            ...
                            case Pu.Extended:
                                return `${W(R.strings.common.duration.days(), { days: u.days })} | ${Xu(u.hours)}:${Xu(u.minutes)}:${Xu(u.seconds)}`;
                        }
                    },
                ...
                (0, r.memo)(
                    ({
                        ...
                        const E = t !== Pu.Description ? 1 : void 0,
                            l = ju(u, E),
                            c = (() => {
                        ...
                        return n().createElement(
                            ...
                            e !== Ou.None &&
                                n().createElement('div', {
                                    className: g()(zu, o.icon),
                                    style: { backgroundImage: `url('${Zu(e, c)}')` },
                                }),
                ...
                const oe = (0, r.memo)(
                        ({
                            ...
                            showPlus: s,
                            isEnough: o = !0,
                            stockBackgroundName: E = se.Red,
                            className: l,
                            classNames: c,
                        }) =>
                            n().createElement(
                                'span',
                                { className: g()(ne.base, ne[`base__${t}`], l) },
                                n().createElement(
                                    'span',
                                    {
                                        className: g()(
                    ...
                    Ee = 'Quantity_base_e7',
                    le = 'Quantity_base__highlighted_3d',
                    ce = 'Quantity_icon_e5',
                ...
                const ge = (u) => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                !O && !I && y && n().createElement('div', { className: de.expiringLight }),
                                n().createElement(
                                    'div',
                ...
                const xe = R.views.common.tooltip_window.simple_tooltip_content,
                    ...
                    Te = 'ReserveGroup_base_86',
                    Re = 'ReserveGroup_header_58',
                ...
                const Me = ({
                        ...
                        const E = (0, r.useReducer)((u) => !u, !1)[1],
                            l = i.some((u) => (null == u ? void 0 : u.inactivationTime) > 0),
                            c = 1 === i.length,
                            A = e === Y.Clan,
                            F = fu[e],
                                        ...
                                        n().createElement(
                                            ...
                                            d.map((t, r) => {
                                                ...
                                                e === Y.Clan
                                                    ? (F = A <= 0 && l)
                                                    : u === Pe.BATTLE
                                                      ? t.state !== bu.Active && (F = 0 === t.inDepot || l)
                                                      : t.isPremium ||
                                                        t.state === bu.Active ||
                                                        (F = 0 === t.inDepot || (l && t.inactivationTime <= 0));
                                                const D =
                                                    u !== Pe.BATTLE &&
                                                    t.isPremium &&
                                                    t.state !== bu.Active &&
                    ...
                    Ie = (0, Z.Pi)(() => {
                        const u = Eu().model.computes.getReserveCategoryNames();
                        return n().createElement(
                            'div',
                            { className: lu },
                            n().createElement(
                ...
                engine.whenReady.then(() => {
                    I().render(
                        n().createElement(ou, null, n().createElement(M, null, n().createElement(Ie, null))),
