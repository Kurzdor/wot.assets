    ...
    var __webpack_modules__ = {
            ...
            5936: (u, e, t) => {
                ...
                const Au = { [ou.NBSP]: iu.NoBreakSymbol, [ou.ZWNBSP]: iu.NoBreakSymbol, [ou.NEW_LINE]: iu.LineBreak },
                    ...
                    _u = (u, e = '') => {
                        ...
                        return (
                            Cu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: iu.Word, colorTag: e, childList: mu(u) });
                                },
                                (u) => {
                                    const r = u[0],
                                        n = Au[r.charAt(0)];
                    ...
                    bu = (u, e) => !u || u.offsetTop + u.offsetHeight > e,
                                                ...
                                                const A = a.children,
                                                    s = ((u, e) => {
                                                        ...
                                                        for (; r - t >= 0; ) {
                                                            ...
                                                            bu(u[n], e) ? (r = n - 1) : (t = n + 1);
                                                        }
                                                        return t - 1;
                                                    })(A, i);
                                                if (s < 0) return [n, !1];
                                                const F = fu(A, n, s, E, r.length, r),
                                                    l = F[0],
                                                    D = F[1];
                ...
                function ku(u = Lu.n.NONE, e = yu, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Lu.n.NONE)
                            return (
                ...
                const Ru = (0, r.memo)(({ className: u, children: e, onClick: t, enabled: a = !0 }) => {
                        ...
                        return n().createElement(
                            'div',
                            {
                                className: _()(Mu.base, Mu[`base__${E}`], !a && Mu.base__disabled, u),
                                onMouseEnter: () => {
                                    a && (Ou('highlight'), o(Nu.Hovered));
                                },
                                onMouseLeave: () => {
                                    a && o(Nu.Normal);
                                },
                                ...
                                onMouseDown: () => {
                                    a && (Ou('play'), o(Nu.Pressed));
                                },
                                onClick: () => {
                                    a && t && t();
                                },
                            },
                            n().createElement('div', { className: _()(Mu.bg, Mu.bg__base) }),
                            n().createElement('div', { className: _()(Mu.bg, Mu.bg__hovered) }),
                            n().createElement('div', { className: _()(Mu.bg, Mu.bg__pressed) }),
                            n().createElement('div', { className: Mu.label }, e),
                        );
                    }),
                    ...
                    Hu = 'Lore_glow_68',
                    Iu = (0, r.memo)(({ className: u, folder: e, text: t }) => {
                        const a = ((u) => {
                                const e = v().mediaSize;
                                return u
                                    ? e >= p.ExtraLarge
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement('div', { className: _()(Hu, 'Lore_glow__top_b7') }),
                                n().createElement('div', { className: _()(Hu, 'Lore_glow__bottom_f7') }),
                ...
                const Uu = (u) => (0 === u ? window : window.subViews.get(u)),
                    ...
                    Ku = R.strings.sm_battle.prebattle.mission,
                    Yu = 'attackIcon',
                    Zu = { [Yu]: [1, 2], flagIcon: [3, 4, 5, 1e3, 1001] },
                    Xu = (u) => {
                        for (var e = 0, t = Object.entries(Zu); e < t.length; e++) {
                            const r = t[e],
                                n = r[0];
                    ...
                    Qu = (0, Tu.Pi)(() => {
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement(Iu, { className: qu.lore, folder: o, text: Ku.text.$num(i) }),
                                n().createElement('div', { className: qu.vignette }),
                                n().createElement(
                                    'div',
                                    { className: qu.header },
                                    n().createElement('div', { className: qu.stage }, Ku.stage.$num(i)),
                                    n().createElement('div', { className: qu.title }, Ku.title.$num(i)),
                                    n().createElement(
                                        'div',
                                        { className: qu.task },
                                        n().createElement('div', { className: qu[Xu(i)] }),
                                        n().createElement(xu, { text: Ku.task.$num(i) }),
                                    ),
                                ),
                                E
                                    ? n().createElement(Pu, { className: qu.loading })
                                    : n().createElement(
                                          Ru,
                                          { className: qu.battleButton, onClick: t.gotoBattle },
                ...
                engine.whenReady.then(() => {
                    N().render(
                        n().createElement(zu, null, n().createElement(O, null, n().createElement(Qu, null))),
