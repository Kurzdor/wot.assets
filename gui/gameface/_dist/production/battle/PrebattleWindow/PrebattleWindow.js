    ...
    var __webpack_modules__ = {
            ...
            936: (u, e, t) => {
                ...
                const E = i.O.client.getSize('rem'),
                    c = E.width,
                    A = E.height,
                    d = Object.assign({ width: c, height: A }, s(c, A, o)),
                    ...
                    B = (u) => {
                        ...
                        const n = (0, r.useContext)(F),
                            ...
                            w = { extraLarge: _, large: h, medium: C, small: g, extraSmall: p };
                ...
                const x = {
                    ...
                    k = (u) => {
                        ...
                        const i = (() => {
                            ...
                            l = i.mediaHeight,
                            s = i.mediaSize;
                        return n().createElement('div', f({ className: h()(t, x[o], L[l], y[s]) }, a), e);
                    },
                    T = ['children'],
                    S = (u) => {
                        let e = u.children,
                        ...
                        return n().createElement(m, null, n().createElement(k, t, e));
                    };
                var O = t(493),
                    M = t.n(O),
                    N = t(364);
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (W(t, F, { isMouseEvent: !0, on: !0, arguments: H(n) }, w),
                                    h && h(),
                            ...
                            z(
                                {
                                    contentId:
                                        ...
                                        c ? $.SimpleTooltipHtmlContent('resId') : $.SimpleTooltipContent('resId')),
                ...
                const Y = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    if (e.header || e.body) return n().createElement(q, e, r);
                    const a = e.contentId;
                    return a ? n().createElement(I, K({}, e, { contentId: a }), r) : n().createElement(U, e, r);
                };
                var X = t(45);
                let Z;
                t(281),
                    ...
                    iu = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return r
                            ? ru[r]
                                ? n().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: h()(nu, ru[r]) },
                                      u,
                                  )
                                : n().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: nu, style: au(r) },
                                      u,
                                  )
                            : n().createElement('span', { key: t, 'data-block-type': e.blockType, className: nu }, u);
                    },
                    ou = {
                        [Q.Word]: iu,
                        [Q.NoBreakSymbol]: iu,
                    ...
                    _u = (u, e, t, r, a, i) => {
                        ...
                        for (let s = t; s >= 0; s--) {
                            ...
                            if (!(t.childElementCount > 1)) {
                                ...
                                const d = c.slice(0, c.length - A) + i,
                                    F = e[s];
                                (l = n().cloneElement(F, F.props, d)), (o = s);
                                break;
                            }
                            {
                                const u = t.children,
                ...
                function pu(u = Cu.n.NONE, e = gu, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== Cu.n.NONE)
                            return (
                ...
                const Lu = (0, r.memo)(({ className: u, children: e, onClick: t, enabled: a = !0 }) => {
                        const i = (0, r.useState)(xu.Normal),
                            o = i[0],
                            l = i[1],
                            s = h()(fu.base, fu[`base__${o}`], !a && fu.base__disabled, u),
                            E = h()(fu.label, !a && fu.label__disabled);
                        return n().createElement(
                            'div',
                            {
                                className: s,
                                onMouseEnter: () => {
                                    a && (bu('highlight'), l(xu.Hovered));
                                },
                                onMouseLeave: () => {
                                    a && l(xu.Normal);
                                },
                            ...
                            n().createElement('div', { className: fu.preloadDown }),
                            n().createElement('div', { className: fu.preloadHovered }),
                        );
                    }),
                    yu = (0, r.memo)(({ className: u }) => {
                    ...
                    ku = 'Lore_glow_68',
                    Tu = (0, r.memo)(({ className: u, folder: e, text: t }) => {
                        const a = ((u) => {
                                const e = (0, r.useContext)(F);
                                return u
                            ...
                            o = h()('Lore_base_eb', u),
                            l = h()(ku, 'Lore_glow__top_b7'),
                            s = h()(ku, 'Lore_glow__bottom_f7');
                        return n().createElement(
                            'div',
                            { className: o },
                            n().createElement(
                ...
                const Ru = (u) => (0 === u ? window : window.subViews.get(u)),
                    Nu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: a, children: o, mocks: l }) {
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        c.current ? m(E(d, a, l)) : (c.current = !0);
                                    }, [l, d, a]),
                                    (0, r.useEffect)(() => {
                                        F(u);
                                    }, [u]),
                    ...
                    Iu = R.strings.sm_battle.prebattle.mission,
                    ju = (0, wu.Pi)(() => {
                        const u = Hu(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement(Tu, { className: Wu.lore, folder: l, text: Iu.text.$num(i) }),
                                n().createElement('div', { className: Wu.vignette }),
                                n().createElement(
                                    'div',
                                    { className: Wu.header },
                                    n().createElement('div', { className: Wu.stage }, Iu.stage.$num(i)),
                                    n().createElement('div', { className: Wu.title }, Iu.title.$num(i)),
                                    n().createElement(
                                        'div',
                                        { className: Wu.task },
                                        n().createElement('div', { className: Wu.icon }),
                                        n().createElement(hu, { text: Iu.task.$num(i) }),
                                    ),
                                ),
                                o
                                    ? n().createElement(yu, { className: Wu.loading })
                                    : n().createElement(
                                          Lu,
                                          { className: Wu.battleButton, onClick: t.gotoBattle },
                ...
                engine.whenReady.then(() => {
                    M().render(
                        n().createElement(Pu, null, n().createElement(S, null, n().createElement(ju, null))),
