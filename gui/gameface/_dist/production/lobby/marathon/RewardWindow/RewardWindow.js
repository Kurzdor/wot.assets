    ...
    var __webpack_modules__ = {
            ...
            961: (u, e, t) => {
                ...
                const S = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    L = (u, e, t = k.left) => u.split(e).reduce(t === k.left ? M : N, []),
                    I = (() => {
                        const u = new RegExp(
                    ...
                    W = ({ binding: u, text: e = '', classMix: t, alignment: a = k.left, formatWithBrackets: i }) => {
                ...
                function j(u = z.n.NONE, e = Y, t = !1, r = !1) {
                    (0, n.useEffect)(() => {
                        if (u !== z.n.NONE)
                            return (
                ...
                const _u = (0, n.memo)(
                    ({
                        ...
                        const l = q(['leftBlock', 'rightBlock'], Du),
                            F = (0, n.useState)(A),
                            D = F[0],
                            c = F[1];
                        (0, n.useEffect)(() => c(!A), [A]);
                        ...
                        const h = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, n.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Ou(t, c, { isMouseEvent: !0, on: !0, arguments: ku(r) }, w),
                                    m && m(),
                ...
                const Wu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const a = e.contentId;
                        return a ? r().createElement(Pu, Hu({}, e, { contentId: a }), n) : r().createElement(Nu, e, n);
                    },
                    zu = {
                        base: 'Reward_base_ea',
                ...
                const Ku = r().memo(
                    ...
                    Zu = ({ size: u, count: e }) => {
                        const t = P(R.strings.marathon.reward.rest(), { count: e });
                        return r().createElement(
                            Pu,
                    ...
                    re = () => {
                        ...
                        const p = q(['base'], ee),
                            ...
                            T = (0, n.useMemo)(
                                () => ({
                                    name: c,
                                    type: r().createElement(su, { type: B, classMix: ee.nameType }),
                                    level: iu(_),
                                }),
                                [c, B, _],
                            ),
                            y = P(R.strings.marathon.reward.stage(), { stage: iu(s), text: t }),
                            k = h()(ee.button, ee[`button__lang_${ne}`]),
                            O = E ? R.strings.marathon.reward.confirm() : R.strings.marathon.reward.confirmStyle();
                        return r().createElement(
                            _u,
                            {
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: ee.header },
                                    r().createElement('div', { className: ee.supTitle }, y),
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(W, { classMix: ee.name, text: a, binding: T }),
                                        r().createElement(
                                            'div',
