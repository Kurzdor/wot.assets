(() => {
    ...
    var __webpack_modules__ = {
            3457: (e, u, t) => {
                ...
                const c = ({
                    ...
                    const h = (0, i.useRef)(null),
                        ...
                        k = S[1],
                        T = (0, i.useCallback)(() => {
                            c || (h.current && (h.current.focus(), C(!0)));
                        }, [c]),
                        x = (0, i.useCallback)(
                            (e) => {
                                b && null !== h.current && !h.current.contains(e.target) && C(!1);
                            },
                            [b],
                        ),
                        P = (0, i.useCallback)(
                        ...
                        N = (0, i.useCallback)(
                            (e) => {
                                c || (null !== m && (0, a.G)(m), F && F(e), t && T(), w(!0));
                            },
                            [c, m, F, T, t],
                        ),
                        I = (0, i.useCallback)(
                        ...
                        G = r()(o.Z.state, o.Z.state__default);
                    return (
                        (0, i.useEffect)(
                            () => (
                ...
                const i = ['children'],
                    s = (e) => {
                        ...
                        const s = (0, n.useContext)(a.Y),
                            ...
                            C = { extraLarge: B, large: D, medium: h, small: p, extraSmall: b };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.extraLargeWidth && m) return (0, r.H)(u, t, C);
            ...
            5067: (e, u, t) => {
                ...
                const $ = Object.keys(h).reduce((e, u) => ((e[u] = () => viewEnv.getShowingStatus() === h[u]), e), {}),
                    j = {
                        set: (e, u) => {
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(
                                        ...
                                        b.isTruncateFinished && _ ? b.elementList : f,
                                    ),
                                ),
                            )
                        );
            ...
            4389: (e, u, t) => {
                    ...
                    k = (0, n.memo)(
                        ({
                            ...
                            const v = (0, n.useMemo)(() => Object.assign({ width: '100%' }, y(e), w(E)), [E, e]),
                                k = (0, n.useMemo)(() => Object.assign({ width: '0%' }, y(e), w(E)), [E, e]),
                                T = (0, n.useMemo)(() => Object.assign({ width: '0%' }, S(E, a), y(e)), [a, E, e]),
                                R = (0, n.useMemo)(
                ...
                const O = (0, n.memo)((e) => {
                        ...
                        switch (a.animationSettings.type) {
                            ...
                            case _.Growing:
                                return r().createElement(T, P({}, a, { onEndAnimation: l, isComplete: s }));
                            default:
                                return null;
                        }
                    }),
                ...
                const N = (0, n.memo)((e) => {
                    ...
                    return (
                        (a.current.from = s),
                        r().createElement(O, M({}, t, { onEndAnimation: i, key: `${s}-${t.to}`, from: s }))
                    );
                });
                function I() {
                    return (
                ...
                const be = (0, n.memo)(({ isDateFormat: e, pendingDate: u, countdownSeconds: t }) =>
                        e
                    ...
                    fe = {
                        [s.c.Announce]: Ce.announce,
                        [s.c.Active]: Ce.active,
                        [s.c.Frozen]: Ce.active,
                        [s.c.Finished]: Ce.finished,
                    },
                    ve = (0, n.memo)(({ pendingDate: e, countdownSeconds: u, frontlineState: t }) => {
                        const a = (0, n.useMemo)(() => {
                            if (t === s.c.Finished) return { text: Ce.finished() };
                            {
                                const n = u > Be.IZ,
                                    a = fe[t];
                                return {
                ...
                (0, o.Pi)(() => {
                    ...
                    return r().createElement(
                        ...
                        r().createElement(
                            ...
                            r().createElement(_e, { level: g ? u : 0, isGlowVisible: t }),
                            r().createElement(re, {
                                frontlineState: o,
                                isMaxLevel: t,
                                level: u,
