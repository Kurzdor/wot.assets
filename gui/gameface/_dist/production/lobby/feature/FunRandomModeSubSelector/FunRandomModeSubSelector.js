(() => {
    var __webpack_modules__ = {
            ...
            5067: (e, u, t) => {
                ...
                var a = {};
                t.r(a),
                    t.d(a, { mouse: () => A, off: () => d, on: () => E, onResize: () => l, onScaleUpdated: () => c });
                var n = {};
                t.r(n),
                    t.d(n, {
                        events: () => a,
            ...
            9916: (e, u, t) => {
                'use strict';
                t.d(u, { Sw: () => r.Z, B3: () => l, Z5: () => i.Z5, B0: () => s, ry: () => B, Sy: () => g });
                class a {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            9112: (e, u, t) => {
                ...
                const x = {
                    ...
                    y = (e) => {
                        ...
                        const r = v(),
                            ...
                            s = r.mediaHeight,
                            o = r.mediaSize;
                        return n().createElement('div', S({ className: C()(t, x[i], T[s], P[o]) }, a), u);
                    },
                    k = ['children'],
                    O = (e) => {
                        let u = e.children,
                                        ...
                                        const r = (function ({
                                            ...
                                            E = (({ observableModel: e, readByPath: u }) => {
                                                const t = {
                                                    ...
                                                    a = (0, pe.Om)(() => ge(t.cardList.get(), _e), { equals: Fe });
                ...
                const Te = ({ size: e = Se.Default }) => {
                        const u = C()(we.background, we[`background__${e}`]);
                        return n().createElement('div', { className: u });
                    },
                    Pe = { base: 'ProgressBarBlink_base_24', base__small: 'ProgressBarBlink_base__small_0f' },
                    ye = ({ size: e }) => {
                        const u = C()(Pe.base, Pe[`base__${e}`]);
                        return n().createElement('div', { className: u });
                    },
                    Re = {
                    ...
                    Oe = ({ size: e, value: u, lineRef: t, disabled: r, onComplete: i }) => {
                        ...
                        return (
                            ...
                            n().createElement(ke, { size: e, disabled: r, baseStyles: s, isComplete: o, lineRef: t })
                        );
                    };
                let Ne, Ie;
                !(function (e) {
                    ...
                    Ge = (0, a.memo)(
                        ({
                            ...
                            const h = (0, a.useMemo)(() => Object.assign({ width: '100%' }, $e(e), Ue(E)), [E, e]),
                                ...
                                f = (0, a.useMemo)(() => Object.assign({ width: '0%' }, We(E, r), $e(e)), [r, E, e]),
                                v = (0, a.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(s - r)}%` }, We(E, r), $e(e)),
                                    [r, E, s, e],
                                );
                            if (_) return null;
                            const w = C()(
                ...
                const qe = (0, a.memo)((e) => {
                        ...
                        switch (r.animationSettings.type) {
                            case xe.Simple:
                                return n().createElement(Me, je({}, r, { onEndAnimation: l, isComplete: s }));
                            case xe.Growing:
                                return n().createElement(He, je({}, r, { onEndAnimation: l, isComplete: s }));
                            default:
                                return null;
                        }
                    }),
                ...
                const Xe = (0, a.memo)((e) => {
                    ...
                    return (
                        (r.current.from = s),
                        n().createElement(qe, Ye({}, t, { onEndAnimation: i, key: `${s}-${t.to}`, from: s }))
                    );
                });
                function Ke() {
                    return (
                ...
                const Qe = (0, a.memo)(
                    ...
                    au = (0, a.memo)(
                        ({
                            ...
                            return n().createElement(
                                'div',
                                { className: C()(we.base, we[`base__${t}`]), style: Ze(u) },
                                !s && n().createElement(Te, { size: t }),
                                n().createElement(Qe, {
                                    size: t,
                                    lineRef: c,
                                    disabled: i,
                ...
                const su = (e) => e.replace(/&nbsp;/g, ' '),
                    ...
                    cu = (e, u, t = ru.left) => e.split(u).reduce(t === ru.left ? ou : lu, []),
                    Eu = (() => {
                        const e = new RegExp(
                        ...
                        const h = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, a.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (_u(t, A, { isMouseEvent: !0, on: !0, arguments: Au(n) }, b),
                                    C && C(),
                ...
                const vu = ({ children: e, tooltipArgs: u, className: t }) => {
                        ...
                        const r = u.contentId;
                        return r ? n().createElement(Fu, fu({}, u, { contentId: r }), a) : n().createElement(Cu, u, a);
                    },
                    wu = {
                        base: 'Reward_base_ea',
                    ...
                    Su = ({
                        ...
                        return n().createElement(
                            'div',
                            { className: C()(wu.base, wu[`base__${a}`], l), style: o },
                            n().createElement(
                                vu,
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: C()(wu.image, null == c ? void 0 : c.image) },
                                        m &&
                                            n().createElement('div', {
                                                className: C()(wu.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        u &&
                                            n().createElement('div', {
                                                className: C()(wu.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${u})` },
                                            }),
                                        A &&
                                            n().createElement('div', {
                                                className: C()(wu.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                            ...
                            t &&
                                n().createElement(
                                    ...
                                    { tooltipArgs: d },
                                    n().createElement('div', {
                                        className: C()(wu.timer, null == c ? void 0 : c.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const Tu = n().memo(
                        ({
                            ...
                            var d, m;
                            const A = C()('Rewards_base_26', t && 'Rewards_base__vertical_9f', i),
                                _ = C()('Rewards_reward_7b', t && 'Rewards_reward__vertical_c6', s);
                            return n().createElement(
                                'div',
                                { className: A },
                                c
                    ...
                    Pu = ({ binding: e, text: u = '', classMix: t, alignment: r = ru.left, formatWithBrackets: i }) => {
                        if (null === u) return console.error("FormatText was supplied with 'null'"), null;
                        const s = i && e ? iu(u, e) : u;
                        return n().createElement(
                            a.Fragment,
                            null,
                            s.split('\n').map((u, i) =>
                ...
                const $u = (e) => e === ve.ACTIVE_RESETTABLE || e === ve.ACTIVE_FINAL,
                    ...
                    at = (0, Y.Pi)(({ onStatusUpdate: e }) => {
                                    ...
                                    (0, Lu.C)(
                                        {
                                            ...
                                            states: {
                                                ...
                                                [Uu.UpdateState]: {
                                                    always: [
                                                        { target: Uu.Active, cond: Gu },
                                                        { target: Uu.NonActive, cond: Hu },
                                                    ],
                                                },
                                                [Uu.Active]: {
                                                    on: {
                        ...
                        (0, a.useEffect)(() => {
                            g({ type: Wu.CheckDataUpdate, status: o, stage: l, currentPoints: r, maximumPoints: i });
                        }, [o, r, i, l, g]);
                ...
                const ct = (e, u = !0) =>
                        e.days > 7 && u
                            ? iu(R.strings.common.duration.days(), { days: e.days })
                            : e.days >= 1
                              ? 0 === e.hours
                                  ? iu(R.strings.common.duration.days(), { days: e.days })
                                  : `${iu(R.strings.common.duration.days(), { days: e.days })} ${iu(R.strings.common.duration.hours(), { hours: e.hours })}`
                              : e.hours >= 1
                                ? 0 === e.minutes
                                    ? iu(R.strings.common.duration.hours(), { hours: e.hours })
                                    : `${iu(R.strings.common.duration.hours(), { hours: e.hours })} ${iu(R.strings.common.duration.minutes(), { minutes: e.minutes })}`
                                : iu(R.strings.common.duration.minutes(), { minutes: e.minutes || 1 }),
                    Et = () => {};
                let dt;
                j.Sw.instance,
                    (function (e) {
                ...
                const mt = (e = 0, u, t = 0, n = Et) => {
                    ...
                    Dt = (0, a.memo)(
                        ({
                            ...
                            const l = t !== it.Description ? 1 : void 0,
                                c = mt(e, l),
                                E = (() => {
                            ...
                            const d = ((e, u) => {
                                switch (u) {
                                    ...
                                    case it.Extended:
                                        return `${iu(R.strings.common.duration.days(), { days: e.days })} | ${At(e.hours)}:${At(e.minutes)}:${At(e.seconds)}`;
                                }
                            })(lt(c), t);
                            return n().createElement(
                                'div',
                                ...
                                u !== rt.None &&
                                    n().createElement('div', {
                                        ...
                                        style: { backgroundImage: `url('${Ft(u, E)}')` },
                                    }),
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(Dt, { duration: u, style: it.Description }),
                                ),
                                n().createElement(
                                    'div',
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(at, { onStatusUpdate: (e) => i(e) }),
                                ),
                                n().createElement(
                                    'div',
                ...
                const Tt = () => {
                    ...
                    yt = ({
                        ...
                        const g = Tt(),
                            p = (0, a.useCallback)(() => {
                                d({ index: e, size: u, cardMediaSize: g }), M.playClick();
                            }, [d, e, u, g]),
                            h = (0, a.useCallback)(
                                (u) => {
                    ...
                    Rt = ({ index: e, text: u, isSmall: t = !1, classMix: a, tooltipId: r, modeName: i = '' }) =>
                        n().createElement(
                            Cu,
                ...
                const It = (e, u) => {
                    ...
                    Mt = ({ timeToStart: e, state: u, classMix: t }) => {
                        const a = u === kt.NOT_STARTED && e < ot,
                            r = ct(lt(e)),
                            i = ((e, u) => {
                                switch (e) {
                                    case kt.NOT_STARTED:
                    ...
                    zt = (e) => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement(Mt, { timeToStart: s, state: t, classMix: Ut.startTime }),
                            ),
                        );
                    },
                ...
                engine.whenReady.then(() => {
                    I().render(
                        n().createElement(be, null, n().createElement(O, null, n().createElement(Xt, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(9112));
