(() => {
    var __webpack_modules__ = {
            ...
            176: (e, u, t) => {
                ...
                var r = {};
                t.r(r), t.d(r, { Area: () => Jn, Bar: () => Yn, Default: () => Qn, useVerticalScrollApi: () => Pn });
                var a = t(179),
                    i = t.n(a);
                const s = (e, u, t) =>
                        ...
                        const u = Math.floor((e.getTime() - Date.now()) / 1e3),
                            t = ((e) => {
                                const u = `${lu(e.hours)}:${lu(e.minutes)}:${lu(e.seconds)}`,
                                    t = `${Ie(R.strings.common.duration.days(), { days: e.days })}`;
                                return e.days ? `${t} ${u}` : u;
                            })(
                                (function (e = 0) {
                                    let u = e;
                ...
                const xu = yu,
                    ...
                    ku = 'Footer_button_2d',
                    Pu = R.strings.personal_exchange_rates.common,
                    Iu = ({ onExchange: e, onClose: u, disabled: t, currenciesAfterExchange: n }) =>
                        i().createElement(
                            'div',
                            { className: wu },
                            i().createElement('div', { className: Su }),
                            i().createElement('div', { className: Nu }, Pu.afterExchange()),
                            i().createElement(
                                'div',
                                { className: Mu },
                                n.map((e) =>
                ...
                const Bt = 2147483647,
                    ...
                    Tt = ({ binding: e, text: u = '', classMix: t, alignment: n = Pe.left, formatWithBrackets: r }) => {
                ...
                const It = (e, u = V.B3.INTEGRAL) => V.Z5.getNumberFormat(e, u);
                t(368);
                let Rt;
                !(function (e) {
                    (e[(e.ZERO = 48)] = 'ZERO'),
                ...
                const Dn = {
                    ...
                    Ln = (0, a.memo)(
                        ({
                            ...
                            const s = (0, a.useRef)(null),
                                ...
                                h = () => {
                                    ...
                                    const a = e.animationScroll.scrollPosition.get(),
                                        i = Math.min(1, n / r),
                                        s = on(0, 1, a / (r - n)),
                                        o = (u.offsetWidth - Mn(u, i)) * s;
                                    (t.style.transform = `translateX(${0 | o}px)`),
                                        ((e) => {
                                            if (c.current && l.current && d.current && m.current) {
                                                if (0 === e)
                                                    return (
                                                        c.current.classList.add(xn), void l.current.classList.remove(xn)
                                                    );
                                                if (
                                                    ((u = d.current),
                                                    (t = m.current),
                                                    ...
                                                    return (
                                                        c.current.classList.remove(xn), void l.current.classList.add(xn)
                                                    );
                                                var u, t;
                                                c.current.classList.remove(xn), l.current.classList.remove(xn);
                                            }
                                        })(o);
                                },
                                g = ln(() => {
                            ...
                            return i().createElement(
                                'div',
                                { className: B()(pn, u.base), ref: s, onWheel: e.handleMouseWheel },
                                i().createElement('div', {
                                ...
                                i().createElement(
                                    ...
                                    i().createElement('div', { ref: m, className: B()(bn, u.thumb) }),
                ...
                const Pn = hn({
                    ...
                    Yn = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = jn, onDrag: n = Gn }) => {
                        ...
                        return i().createElement(
                            'div',
                            { className: B()(In, u.base), ref: r, onWheel: e.handleMouseWheel },
                            i().createElement('div', {
                ...
                const er = { Vertical: r, Horizontal: n },
                    ...
                    Pr = 'VehicleItem_modernizationBadge_97',
                    Ir = 'VehicleItem_combatXp_3e',
                            ...
                            i().createElement(
                                ...
                                i().createElement(
                                    ...
                                    i().createElement(
                                        ...
                                        a.isFieldModernizationComplited && i().createElement('div', { className: Pr }),
                                    ),
                                ),
                                i().createElement('div', { className: Ir }, It(a.amountOfCombatXp)),
                            ),
                        );
                        var o;
                    }),
                ...
                engine.whenReady.then(() => {
                    H().render(
                        i().createElement(P, null, i().createElement(bt, null, i().createElement(qr, null))),
