(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => v, getTextureUrl: () => l });
                var n = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            75: (u, e, t) => {
                ...
                const O = (u = 'model', e = g.Deep) => {
                            ...
                            w(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        F = f(u);
                                    B.current = b.addCallback(F, t, r, e === g.Deep);
                                }
                            }),
                            (0, F.useEffect)(() => {
                                if (e !== g.None)
                    ...
                    I = () => {
                        const u = O('model'),
                            ...
                            a = (0, F.useMemo)(() => ({ backgroundImage: `url(${E})` }), [E]);
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                t && A().createElement('div', { className: k }, t),
                                E &&
                                    A().createElement(
                                        'div',
                                        { className: P, style: a },
                                ...
                                r && A().createElement('div', { className: S }, r),
                                o &&
                                    A().createElement(
                                        'div',
                                        { className: L },
                ...
                engine.whenReady.then(() => {
                    n().render(A().createElement(I, null), document.getElementById('root'));
                });
            },
        },
