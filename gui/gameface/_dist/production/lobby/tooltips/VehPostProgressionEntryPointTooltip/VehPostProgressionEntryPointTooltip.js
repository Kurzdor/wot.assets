(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, A) => {
                ...
                var F = {};
                A.r(F),
                    A.d(F, { mouse: () => s, off: () => i, on: () => o, onResize: () => r, onScaleUpdated: () => C });
                var E = {};
                A.r(E),
                    A.d(E, {
                        events: () => F,
                ...
                var D = {};
                A.r(D), A.d(D, { getBgUrl: () => v, getTextureUrl: () => d });
                var t = {};
                function n(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const H = Object.keys(w).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === w[e]), u), {}),
                    $ = {
                        set: (u, e) => {
            ...
            640: (u, e, A) => {
                ...
                const T = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    P = (u, e, A = O.left) => u.split(e).reduce(A === O.left ? x : k, []),
                    M = (() => {
                        const u = new RegExp(
                    ...
                    L = (u, e = O.left) => {
                        ...
                        return ((u, e = O.left) => {
                            ...
                            const F =
                                ...
                                E = T(u);
                            return P(E, /( )/, e).forEach((u) => (A = A.concat(P(u, F, O.left)))), A;
                        })(u, e);
                    },
                    N = 'FormatText_base_d0',
                    V = ({ binding: u, text: e = '', classMix: A, alignment: D = O.left, formatWithBrackets: t }) => {
                    ...
                    j = 'Footer_separatorContainer_57',
                    q = 'Footer_separator_a0',
                    W = 'Footer_container_fa',
                    K = 'Footer_lock_46',
                    G = ({ modulesExplored: u, modulesTotal: e, hasVehiclesToUnlock: A }) => {
                        const D = (0, F.useMemo)(
                                () => ({
                                    explored: E().createElement('span', { className: z }, u),
                                    total: E().createElement('span', { className: U }, e),
                                }),
                                [u, e],
                            ),
                            t = (0, F.useMemo)(
                        ...
                        return E().createElement(
                            'div',
                            { className: I },
                            E().createElement('div', { className: j }, E().createElement('div', { className: q })),
                            E().createElement(
                                'div',
                                { className: W },
                                E().createElement('div', { className: K }),
                                E().createElement(V, { text: t, binding: D, classMix: U }),
                            ),
                        );
                    },
                    ...
                    J = () => {
                        ...
                        return E().createElement(
                            'div',
                            { className: $ },
                            E().createElement('div', { className: Y }, e),
                            E().createElement(
                                'div',
                                { className: Z },
                                E().createElement(H, { text: A, className: X }),
                                F &&
                                    E().createElement(
                                        E().Fragment,
                                        null,
                                        ' ',
                                        E().createElement(H, { text: F, className: Q }),
                                    ),
                            ),
                            model.modulesExplored < model.modulesTotal && E().createElement(G, model),
                        );
                    },
                    uu = () => E().createElement(s, null, E().createElement(J, null));
                engine.whenReady.then(() => {
                    t().render(E().createElement(uu, null), document.getElementById('root'));
                });
            },
        },
