(() => {
    ...
    var __webpack_modules__ = {
            ...
            494: (u, e, t) => {
                                ...
                                const n = Date.now(),
                                    A = setInterval(
                                        () => {
                                            ...
                                            null !== t && e <= t ? (E(t), r && r(), clearInterval(A)) : E(e);
                                        },
                                        1e3 * (e || (u > 120 ? 60 : 1)),
                                    );
                                return () => {
                ...
                const g = (u) => (0 === u ? window : window.subViews.get(u)),
                                ...
                                const o = (0, n.useRef)([]),
                                    a = (u, t, n) => {
                                        ...
                                        const A = (function ({
                                            ...
                                            E = (e) =>
                                                'mocks' === u ? (null == n ? void 0 : n.getter(e)) : F.readByPath(e),
                                            ...
                                            D = { mode: u, model: s, externalModel: F, cleanup: a };
                                        return {
                                            model: s,
                                    ...
                                    B = D[0],
                                    c = D[1],
                                    C = (0, n.useState)(() => a(u, A, E)),
                                    l = C[0],
                                    d = C[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        s.current ? d(a(B, A, E)) : (s.current = !0);
                                    }, [E, B, A]),
                                    (0, n.useEffect)(() => {
                                        c(u);
                                    }, [u]),
                                    ...
                                    r().createElement(t.Provider, { value: l }, F)
                                );
                            },
                            () => (0, n.useContext)(t),
                        ];
                    ...
                    O = y[0],
                    T = y[1],
                    P = R.strings.tech_tree_trade_in.tooltip.entryPoint,
                    k = (0, w.Pi)(() => {
                        const u = T().model.root.get().dateEnd,
                            e = ((u, e = !0) =>
                                u.days > 7 && e
                                    ? C(R.strings.common.duration.days(), { days: u.days })
                                    : u.days >= 1
                                      ? 0 === u.hours
                                          ? C(R.strings.common.duration.days(), { days: u.days })
                                          : `${C(R.strings.common.duration.days(), { days: u.days })} ${C(R.strings.common.duration.hours(), { hours: u.hours })}`
                                      : u.hours >= 1
                                        ? 0 === u.minutes
                                            ? C(R.strings.common.duration.hours(), { hours: u.hours })
                                            : `${C(R.strings.common.duration.hours(), { hours: u.hours })} ${C(R.strings.common.duration.minutes(), { minutes: u.minutes })}`
                                        : C(R.strings.common.duration.minutes(), { minutes: u.minutes || 1 }))(
                                (function (u = 0) {
                                    let e = u;
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: 'App_base_36' },
                                r().createElement('div', { className: 'App_title_f3' }, P.title()),
                                r().createElement('div', { className: 'App_icon_7d' }),
                                r().createElement('div', { className: 'App_description_90' }, P.description()),
                                r().createElement(
                                    'div',
                                    { className: 'App_timer_2d' },
                                    r().createElement('div', { className: 'App_timerLight_52' }),
                                    r().createElement('div', { className: 'App_timerText_87' }, P.timerText()),
                                    r().createElement(
                                        'div',
                                        { className: 'App_iconWrapper_e7' },
                                        r().createElement('div', { className: 'App_timerIcon_d9' }),
                                    ),
                                    r().createElement('div', { className: 'App_timerDate_5a' }, e),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    F().render(r().createElement(O, null, r().createElement(k, null)), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(494));
