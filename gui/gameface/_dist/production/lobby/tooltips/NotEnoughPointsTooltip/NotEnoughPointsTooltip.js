    ...
    var __webpack_modules__ = {
            ...
            5664: (u, e, t) => {
                ...
                const y = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const o = e.contentId;
                    return o ? r().createElement(_, g({}, e, { contentId: o }), n) : r().createElement(v, e, n);
                };
                var k = t(8045);
                let T;
                t(1281),
                ...
                const P = { [L.NBSP]: O.NoBreakSymbol, [L.ZWNBSP]: O.NoBreakSymbol, [L.NEW_LINE]: O.LineBreak },
                    ...
                    j = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? M[n]
                                ? r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: a()(N, M[n]) },
                                      u,
                                  )
                                : r().createElement(
                                      'span',
                            ...
                            : r().createElement('span', { key: t, 'data-block-type': e.blockType, className: N }, u);
                    },
                    V = {
                        [O.Word]: j,
                        [O.NoBreakSymbol]: j,
                    ...
                    Q = r().memo(
                        ({
                            ...
                            const l = (0, n.useRef)(null),
                                ...
                                v = (0, n.useMemo)(() => ({ justifyContent: F, alignContent: A }), [A, F]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                const a = (0, n.useRef)([]),
                                    F = (u, t, n) => {
                                        ...
                                        const o = (function ({
                                            ...
                                            c = { mode: u, model: A, externalModel: i, cleanup: F };
                                        return {
                                            model: A,
                                    ...
                                    l = c[0],
                                    D = c[1],
                                    d = (0, n.useState)(() => F(u, o, s)),
                                    B = d[0],
                                    C = d[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        A.current ? C(F(l, o, s)) : (A.current = !0);
                                    }, [s, l, o]),
                                    (0, n.useEffect)(() => {
                                        D(u);
                                    }, [u]),
                ...
                engine.whenReady.then(() => {
                    i().render(
                        r().createElement(ru, null, r().createElement(iu, null)),
