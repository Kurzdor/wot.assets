    ...
    var __webpack_modules__ = {
            ...
            647: (u, e, t) => {
                ...
                const i = (u, e, t) => {
                    ...
                    D = (u, e, t = F.left) => u.split(e).reduce(t === F.left ? i : a, []),
                    B = (() => {
                        const u = new RegExp(
                    ...
                    c = ['zh_cn', 'zh_sg', 'zh_tw'],
                    l = ({ binding: u, text: e = '', classMix: t, alignment: E = F.left }) =>
                        null === e
                                              ...
                                              onMouseEnter:
                                                  ...
                                                  (u) => {
                                                      (u.clientX === window.innerWidth &&
                                                          ...
                                                          ((g.current.timeoutId = window.setTimeout(T, i ? 100 : 400)),
                                                          E && E(u),
                                                          S && S(u));
                                                  }),
                                              onMouseLeave: ((u) => (e) => {
                ...
                const U = [
                    ...
                    H = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: s()(z.base, z[`base__${n}`], i), style: F },
                            r().createElement(
                                L,
                                ...
                                const s = (0, n.useRef)([]),
                                    F = (u, t, n) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            i = (({ observableModel: u }) => ({ rewards: u.array('rewards') }))({
                                                mode: u,
                                                readByPath: o,
                                                externalModel: A,
                                                observableModel: {
                                            ...
                                            a = { mode: u, model: i, externalModel: A, cleanup: F };
                                        return {
                                            model: i,
                                    ...
                                    D = a[0],
                                    B = a[1],
                                    c = (0, n.useState)(() => F(u, E, o)),
                                    l = c[0],
                                    C = c[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        i.current ? C(F(D, E, o)) : (i.current = !0);
                                    }, [o, D, E]),
                                    (0, n.useEffect)(() => {
                                        B(u);
                                    }, [u]),
