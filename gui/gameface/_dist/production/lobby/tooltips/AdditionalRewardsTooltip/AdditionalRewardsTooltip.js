(() => {
    ...
    var __webpack_modules__ = {
            ...
            596: (u, e, t) => {
                t.d(e, { Sw: () => E.Z, B3: () => i, Z5: () => s, B0: () => a, ry: () => m });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            562: (u, e, t) => {
                ...
                const w = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            g({}, i, {
                                className: a()(p.base, p[`base__theme-${o}`], E),
                                ref: function (u) {
                ...
                const au = R.views.common.tooltip_window.simple_tooltip_content,
                    iu = (u) => {
                        ...
                        const A = (0, n.useMemo)(() => {
                            const u = Object.assign({}, a, { body: t, header: E, note: s, alert: o });
                ...
                const Fu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        return E || o
                            ? r().createElement(tu, Au({}, e, { contentId: E || o }), n)
                    ...
                    lu = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: a()(Du.base, Du[`base__${n}`], A), style: i },
                            r().createElement(
                                Fu,
                ...
                const Ru = ({ rewards: u, rewardLimit: e }) => {
                    ...
                    Mu = () => {
                        const u = I(),
                            ...
                            s = e && t ? { count: r().createElement('span', { className: Nu }, t) } : void 0,
                            o = E ? { count: E } : void 0;
                        return r().createElement(
                            r().Fragment,
                            null,
                            ...
                            n &&
                                r().createElement(
                                    'div',
                                    { className: ku },
                                    r().createElement(_, { text: n, binding: o }),
                                ),
                        );
                    },
                    Iu = () => {
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { ref: t },
                                            r().createElement(Ru, { rewardLimit: s, rewards: u }),
                                        ),
                                        i &&
                                            r().createElement(
                                                'div',
                ...
                engine.whenReady.then(() => {
                    s().render(r().createElement(Iu, null), document.getElementById('root'));
                });
            },
        },
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (a = 0; a < deferred.length; a++) {
                    for (var [e, t, n] = deferred[a], E = !0, s = 0; s < e.length; s++)
                        (!1 & n || r >= n) &&
