(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var n = {};
                t.r(n),
                    t.d(n, { mouse: () => B, off: () => D, on: () => F, onResize: () => o, onScaleUpdated: () => A });
                var r = {};
                t.r(r),
                    t.d(r, {
                        events: () => n,
                ...
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => m, getTextureUrl: () => _ });
                var a = {};
                function i(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const X = Object.keys(p).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === p[e]), u), {}),
                    H = {
                        set: (u, e) => {
            ...
            976: (u, e, t) => {
                t.d(e, { Sw: () => E.Z, B3: () => s, Z5: () => a.Z5, B0: () => i, ry: () => _ });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            623: (u, e, t) => {
                ...
                const f = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            h({}, o, {
                                className: s()(w.base, w[`base__theme-${i}`], E),
                                ref: function (u) {
                ...
                const Du = R.views.common.tooltip_window.simple_tooltip_content,
                    lu = (u) => {
                        ...
                        const A = (0, n.useMemo)(() => {
                            const u = Object.assign({}, s, { body: t, header: E, note: a, alert: i });
                ...
                const cu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const E = e.contentId;
                        return E ? r().createElement(au, Bu({}, e, { contentId: E }), n) : r().createElement(ou, e, n);
                    },
                    Cu = {
                        base: 'Reward_base_ea',
                    ...
                    du = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: s()(Cu.base, Cu[`base__${n}`], A), style: o },
                            r().createElement(
                                cu,
                    ...
                    wu = ({ icon: u, label: e }) => {
                        ...
                        return 'string' != typeof t
                            ? (console.error(
                              ...
                              null)
                            : r().createElement(gu, { label: t, value: e });
                    },
                    bu = {
                        ...
                        switch (u.name) {
                            ...
                            case q.Crystal:
                                return r().createElement(gu, {
                                    label: fu.$dyn(u.name),
                                    value: u.value,
                                    bindingStyle: s()(bu.value, bu[`value__${u.name}`]),
                                });
                            case q.Xp:
                            case q.FreeXp:
                            case q.TankmenXP:
                                return r().createElement(gu, { label: fu.$dyn(u.name), value: u.value });
                            case q.Premium:
                            case q.PremiumPlus:
                                return r().createElement(gu, {
                                    label: fu.$dyn(u.name),
                            ...
                            case q.BlueprintsFinal:
                                return r().createElement(vu, hu({}, u, { valueStyle: bu.value }));
                            case q.Customizations:
                                return r().createElement(wu, u);
                            case q.BattleAchievement:
                            case q.BattleBadge:
                                return r().createElement(gu, { label: fu.$dyn(u.name), value: u.label });
                            default:
                ...
                const Ou = (u) => {
                    ...
                    return r().createElement(
                        'div',
                        { className: s()(_u, e && mu) },
                        r().createElement(du, Pu({}, t, { size: Y.Small })),
                        r().createElement('div', { className: pu }, r().createElement(Tu, t)),
                    );
                };
                function yu() {
                    return (
                ...
                const Su = ({ rewards: u, rewardLimit: e }) => {
                    ...
                    ku = 'App_base_06',
                    Nu = 'App_background_79',
                    xu = 'App_remaining_f8',
                    Iu = 'RewardsTooltipHeader_header_f4',
                    Mu = 'RewardsTooltipHeader_description_fe',
                    Lu = 'RewardsTooltipHeader_count_d1',
                    Uu = () => {
                        const u = U(),
                            e = u.headerText,
                            t = u.headerCount,
                            ...
                            a = e && t ? { count: r().createElement('span', { className: Lu }, t) } : void 0,
                            i = E ? { count: E } : void 0;
                        return r().createElement(
                            r().Fragment,
                            null,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { ref: t },
                                            r().createElement(Su, { rewardLimit: a, rewards: u }),
                                        ),
                                        o &&
                                            r().createElement(
                                                'div',
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [807], () => __webpack_require__(623));
