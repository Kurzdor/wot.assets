(() => {
    ...
    var __webpack_modules__ = {
            ...
            596: (u, e, t) => {
                t.d(e, { Sw: () => E.Z, B3: () => s, Z5: () => o, B0: () => a, ry: () => m });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            544: (u, e, t) => {
                ...
                const i = (u, e, t) => {
                    ...
                    D = (u, e, t = s.left) => u.split(e).reduce(t === s.left ? i : F, []),
                    l = (() => {
                        const u = new RegExp(
                                  ...
                                  e.split('\n').map((e, o) =>
                                      r().createElement(
                                          ...
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : c(u, e))))(e, E, u).map((u, e) =>
                ...
                const w = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            g({}, s, {
                                className: a()(p.base, p[`base__theme-${A}`], E),
                                ref: function (u) {
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (eu(t, B, { isMouseEvent: !0, on: !0, arguments: uu(r) }, w),
                                    m && m(),
                ...
                const au = R.views.common.tooltip_window.simple_tooltip_content,
                    su = (u) => {
                        ...
                        const i = (0, n.useMemo)(() => {
                            const u = Object.assign({}, a, { body: t, header: E, note: o, alert: A });
                ...
                const Fu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    lu = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: a()(Du.base, Du[`base__${n}`], i), style: s },
                            r().createElement(
                                Fu,
                    ...
                    du = ({ label: u, value: e, bindingKey: t = 'value', bindingStyle: E }) => {
                        const o = (0, n.useMemo)(
                            () => ({ [t]: E ? r().createElement('span', { className: E }, e) : c(String(e)) }),
                            [e, t, E],
                        );
