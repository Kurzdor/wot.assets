(() => {
    ...
    var __webpack_modules__ = {
            ...
            2031: (u, e, t) => {
                ...
                const T = Object.keys(n).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === n[e]), u), {}),
                    k = {
                        set: (u, e) => {
            ...
            4455: (u, e, t) => {
                ...
                const b = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: E, children: A, mocks: D }) {
                                ...
                                return (
                                    (0, n.useEffect)(() => {
                                        o.current ? p(a(s, E, D)) : (o.current = !0);
                                    }, [D, s, E]),
                                    (0, n.useEffect)(() => {
                                        C(u);
                                    }, [u]),
                ...
                engine.whenReady.then(() => {
                    s().render(
                        r().createElement(p, null, r().createElement(o, null, r().createElement(Q, null))),
