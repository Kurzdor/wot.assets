    ...
    var u,
        e = {
            8160: (u, e, A) => {
                ...
                const Au = Object.keys(w).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === w[e]), u), {}),
                    Fu = {
                        set: (u, e) => {
                ...
                const Cu = nu().forwardRef(function (u, e) {
                    let A = u.children,
                        F = u.className,
                        E = u.theme,
                ...
                const mu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    fu = (u, e, A = lu.left) => u.split(e).reduce(A === lu.left ? pu : gu, []),
                    vu = (() => {
                        const u = new RegExp(
                    ...
                    _u = (u, e = lu.left) => {
                        ...
                        return ((u, e = lu.left) => {
                            ...
                            const F =
                                ...
                                E = mu(u);
                            return fu(E, /( )/, e).forEach((u) => (A = A.concat(fu(u, F, lu.left)))), A;
                        })(u, e);
                    },
                    hu = 'FormatText_base_d0',
                    Pu = ({ binding: u, text: e = '', classMix: A, alignment: F = lu.left, formatWithBrackets: E }) => {
                        ...
                        return nu().createElement(
                            ...
                            D.split('\n').map((e, E) =>
                                nu().createElement(
                                    'div',
                                    { className: B()(hu, A), key: `${e}-${E}` },
                                    ((u, e, A) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (A && u in A ? A[u] : _u(u, e))))(
                                        e,
                                        F,
                                        u,
                                    ).map((u, e) => nu().createElement(tu.Fragment, { key: `${e}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                let Ru, wu, yu, xu, Su, Tu, Ou, ku;
                !(function (u) {
                    (u.Items = 'items'),
                        ...
                        switch (E) {
                            case 'vehicles':
                                return B
                                    ...
                                    : D
                                      ? `R.images.gui.maps.shop.vehicles.${Mu(e)}.${D}`
                            ...
                            case 'dossier_badge':
                                return `R.images.gui.maps.icons.quests.bonuses.badges.${Mu(e)}.${D}`;
                            case 'dossier_achievement':
                                return `R.images.gui.maps.icons.achievement.${Mu(e)}.${D}`;
                            case 'xp':
                            case 'xpFactor':
                            ...
                            case 'battlePassSelectToken': {
                                const u = Uu(R.images, `gui.maps.icons.quests.bonuses.${e}.${D}_${t}`);
                                return u || `R.images.gui.maps.icons.quests.bonuses.${e}.${D}`;
                            }
                            case 'premiumTank':
                            ...
                            case 'lootBox': {
                                const u = Uu(R.images, `gui.maps.icons.quests.bonuses.${e}.lootBox_${D}`);
                                return u || `R.images.gui.maps.icons.quests.bonuses.${e}.lootBox_default`;
                            }
                            case 'collectionItem':
                                return `R.images.gui.maps.icons.collectionItems.${Mu(e)}.${D}`;
                        }
                    };
                function Nu() {}
                function $u() {
                ...
                const ju = ((u, e) => {
                        ...
                        return [
                            function ({ mode: F = 'real', options: E, children: D, mocks: t }) {
                                ...
                                return (
                                    ...
                                    nu().createElement(A.Provider, { value: a }, D)
                                );
                            },
                            () => (0, tu.useContext)(A),
                        ];
                    ...
                    Hu = 'App_icon_2f',
                    Zu = 'App_title_f8',
                    Wu = 'App_highlighted_6b',
                    Ju = 'App_description_f5',
                    Ku = (0, Iu.Pi)(() => {
                        ...
                        return nu().createElement(
                            ...
                            nu().createElement('div', {
                                className: Hu,
                                style: { backgroundImage: `url(${Gu(u, yu.S600x450)})` },
                            }),
                            nu().createElement(
                                'div',
                                { className: Zu },
                                Uu(R.strings, `tooltips.awardItem.${u.name}.header`),
                            ),
                            nu().createElement(Pu, {
                                classMix: Ju,
                                text: Uu(R.strings, `tooltips.awardItem.${u.name}.body`),
                                binding: {
                                    highlighted: nu().createElement(Pu, {
                                        classMix: Wu,
                                        text: Uu(R.strings, 'tooltips.awardItem.highlighted'),
                                        binding: { xp: u.value },
                                    }),
                                },
                            }),
                ...
                engine.whenReady.then(() => {
                    au().render(
                        nu().createElement(Yu, null, nu().createElement(Cu, null, nu().createElement(Ku, null))),
