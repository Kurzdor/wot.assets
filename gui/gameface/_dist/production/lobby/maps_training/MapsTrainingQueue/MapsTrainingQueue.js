(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var E = {};
                t.r(E),
                    t.d(E, { mouse: () => o, off: () => s, on: () => B, onResize: () => i, onScaleUpdated: () => D });
                var A = {};
                t.r(A),
                    t.d(A, {
                        events: () => E,
                ...
                var F = {};
                t.r(F), t.d(F, { getBgUrl: () => m, getTextureUrl: () => _ });
                var n = {};
                function a(u) {
                    return (e) => (
                        engine.on(u, e),
            ...
            916: (u, e, t) => {
                ...
                function l(u, e, t, E, A, F, n) {
                    ...
                    a.done ? e(r) : Promise.resolve(r).then(E, A);
                }
            ...
            188: (u, e, t) => {
                ...
                const s = r.O.client.getSize('rem'),
                    C = s.width,
                    o = s.height,
                    l = Object.assign({ width: C, height: o }, B(C, o, i)),
                ...
                const _ = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.smallWidth && o) return a(e, t, v);
                        if (t.extraSmallWidth && l) return a(e, t, v);
                        if (
                    ...
                    h = ({ children: u }) => {
                        const e = (0, E.useContext)(c),
                            ...
                            a = (0, E.useCallback)((u, e) => {
                                ...
                                n(Object.assign({ width: t, height: E }, B(t, E, i)));
                            }, []),
                            D = (0, E.useCallback)(() => {
                        ...
                        m(() => {
                            r.O.client.events.on('clientResized', a), r.O.client.events.on('self.onScaleUpdated', D);
                        }),
                            (0, E.useEffect)(
                                () => () => {
                ...
                const p = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    x = (u, e, t = w.left) => u.split(e).reduce(t === w.left ? f : b, []),
                    y = (() => {
                        const u = new RegExp(
                    ...
                    T = (u, e = w.left) => {
                        ...
                        return ((u, e = w.left) => {
                            ...
                            const E =
                                ...
                                A = p(u);
                            return x(A, /( )/, e).forEach((u) => (t = t.concat(x(u, E, w.left)))), t;
                        })(u, e);
                    };
                var k = t(916),
                    S = t(613);
                        ...
                        m(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = W(u);
                                s.current = U.addCallback(E, t, a, e === z.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== z.None)
                                return () => {
                                    U.removeCallback(s.current, a);
                                };
                        }, [a, e]),
                        D
                    );
                ...
                const G = 'FormatText_base_d0',
                    j = ({ binding: u, text: e = '', classMix: t, alignment: F = w.left, formatWithBrackets: n }) => {
                    ...
                    const c = (0, E.useRef)(null),
                        ...
                        M = q()(
                            ...
                            $[`base__${F}`],
                            {
                                ...
                                [$[`base__${e}`]]: e,
                                [$.base__focus]: _,
                                [$.base__highlightActive]: g,
                                [$.base__firstHover]: p,
                            },
                            a,
                        ),
                        P = q()($.state, $.state__default);
                    return (
                        (0, E.useEffect)(
                            () => (
                ...
                const Eu = 'SceneWrapper_base_85',
                            ...
                            B = (0, E.useCallback)(
                                (u) => {
                                    ...
                                    const t = u.clientX,
                                        ...
                                        n = E !== r.current ? E - r.current : 0;
                                    (0 === A && 0 === n) ||
                                        ((a.current = t), (r.current = E), e({ dx: A, dy: n, dz: 0 }));
                                },
                                [D, F, a, r, e],
                            ),
                            s = (0, E.useCallback)(
                        ...
                        const o = (0, E.useCallback)(
                                (u) => {
                                    u.preventDefault(),
                                        0 === u.button &&
                                            D(u) &&
                                            (n(!0), (a.current = u.clientX), (r.current = u.clientY));
                                },
                                [D, n],
                            ),
                    ...
                    Cu = (0, E.memo)(({ descr: u, onShowPrevTip: e, onShowNextTip: t }) => {
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                { className: iu },
                                u,
                                A().createElement('div', { className: a, onClick: F, onMouseOver: Y.playHighlight }),
                                A().createElement('div', { className: r, onClick: n, onMouseOver: Y.playHighlight }),
                            ),
                        );
                    }),
                    ou = 'MapsTrainingQueueApp_base_bf',
                    lu = 'MapsTrainingQueueApp_sceneWrapper_7e',
                    cu = 'MapsTrainingQueueApp_box_8e',
                    du = 'MapsTrainingQueueApp_time_bb',
                    _u = 'MapsTrainingQueueApp_timeValue_21',
                    mu = 'MapsTrainingQueueApp_button_9f',
                    hu = 'MapsTrainingQueueApp_title_5c',
                    gu = () => {
                        const u = I(),
                            e = u.time,
                            t = u.descrTip,
                            ...
                            D = u.onShowPrevTip,
                            B = u.onShowNextTip,
                            s = (0, E.useMemo)(() => ({ time: A().createElement('div', { className: _u }, e) }), [e]),
                            C = (0, E.useMemo)(
                                () =>
                                    'long' === n
                            ...
                            o = (0, E.useCallback)(() => r(), [r]),
                            l = (0, E.useCallback)(() => i(), [i]);
                        return (
                            tu(uu.n.ESCAPE, l),
                            A().createElement(
                                'div',
                                { className: ou },
                                A().createElement('div', { className: lu }, A().createElement(nu, { onMoveSpace: a })),
                                A().createElement(
                                    'div',
                                    { className: cu },
                                    A().createElement(j, {
                                    ...
                                    A().createElement(
                                        J,
                                        { mixClass: mu, type: Z.secondary, size: Q.small, onClick: o },
                                        R.strings.maps_training.queue.quitButton(),
                                    ),
                                    C && A().createElement('div', { className: hu }, C),
                                ),
                                A().createElement(Cu, { descr: t, onShowPrevTip: D, onShowNextTip: B, isDelay: F }),
                            )
                        );
                    };
                engine.whenReady.then(() => {
                    n().render(
                        A().createElement(h, null, A().createElement(gu, null)),
