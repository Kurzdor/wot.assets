    ...
    var __webpack_modules__ = {
            ...
            9264: (u, e, t) => {
                    ...
                    return (
                        E(() => {
                            if (
                                ...
                                C.current = d.addCallback(r, t, o, e === c.Deep);
                            }
                        }),
                        (0, r.useEffect)(() => {
                            if (e !== c.None)
                ...
                const G = ({ children: u }) => {
                    ...
                    return a().createElement(W.Provider, { value: o }, u);
                };
                let U, V, $;
                !(function (u) {
                                            ...
                                            t &&
                                                setTimeout(
                                                    X(function* () {
                                                        T(!0);
                                                        const u = c.concat();
                                                        u.unshift(u.pop()), _(u), x(b), yield (0, o.Eu)(), T(!1), k(!1);
                                                    }),
                                                    600,
                                                ),
                                            m('play'),
                                            ...
                                            t &&
                                                setTimeout(
                                                    X(function* () {
                                                        T(!0);
                                                        const u = c.concat();
                                                        u.push(u.shift()), _(u), x(b), yield (0, o.Eu)(), T(!1), k(!1);
                                                    }),
                                                    600,
                                                ),
                                            m('play'),
                ...
                const ou = {
                    ...
                    du = (u) => {
                        ...
                        const i = j(),
                            ...
                            s = i.mediaHeight,
                            l = i.mediaSize;
                        return a().createElement('div', Eu({ className: B()(t, ou[n], Au[s], Fu[l]) }, r), e);
                    },
                    cu = ['children'],
                    _u = (u) => {
                        let e = u.children,
