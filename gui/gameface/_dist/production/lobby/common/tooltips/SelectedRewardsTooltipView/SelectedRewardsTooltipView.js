(() => {
    ...
    var __webpack_modules__ = {
            768: (u, e, t) => {
                ...
                var F = {};
                t.r(F), t.d(F, { getBgUrl: () => h, getTextureUrl: () => v });
                var n = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const Q = Object.keys(T).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === T[e]), u), {}),
                    J = {
                        set: (u, e) => {
                ...
                const L = A().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            A().createElement(
                                'div',
                                N({}, D, {
                                    className: S()(k.base, k[`base__theme-${r}`], F),
                                    ref: function (u) {
                    ...
                    I = ({ binding: u, text: e = '', classMix: t, alignment: F = D.left, formatWithBrackets: n }) => {
                    ...
                    z = (0, E.memo)(({ text: u, binding: e, classMix: t }) => {
                        ...
                        return A().createElement(I, { text: D, classMix: t, binding: n });
                    });
                let Y, $, j, K, X, H, Z;
                !(function (u) {
                    (u.Items = 'items'),
                    ...
                    nu = ({ type: u, rewards: e }) => {
                                    ...
                                    t = e
                                        .map(({ value: e }, t) => {
                                            const E = ((u) => {
                                                ...
                                                return (
                                                    E ||
                                                    (A ? a(A) : void console.error('title for reward is not provided'))
                                                );
                                            })(e.type);
                                            ...
                                            var r, D;
                                            return (
                                                (u[F] = A().createElement(I, { text: n, classMix: Au })), `${E}%(${F})s`
                                            );
                                        })
                                        .join(Fu.separator());
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                A().createElement('div', { className: Eu }, A().createElement(I, F)),
                            ),
                        );
                    },
                    ru = 'App_base_ba',
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                A().createElement(
                                    'div',
                                    { className: Du },
                                    A().createElement(z, { text: Bu.title(), binding: F }),
                                ),
                                A().createElement('div', { className: ou }, Bu.description()),
                                A().createElement('div', { className: au }),
                                t.map(({ value: u }, e) =>
                                    A().createElement('div', { key: e, className: iu }, A().createElement(nu, u)),
                                ),
                            ),
                        );
                    };
