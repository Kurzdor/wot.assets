(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var E = {};
                t.r(E),
                    t.d(E, { mouse: () => C, off: () => B, on: () => i, onResize: () => o, onScaleUpdated: () => a });
                var F = {};
                t.r(F),
                    t.d(F, {
                        events: () => E,
            ...
            896: (u, e, t) => {
                ...
                const p = (u = 1) => {
                    ...
                    b = (u) => {
                        ...
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const F = w(h(t, `${e}.${E}`), window);
                                    return g(F) ? (u.push(F.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        v(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = b(u);
                                B.current = f.addCallback(E, t, r, e === P.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== P.None)
                                return () => {
                                    f.removeCallback(B.current, r);
                                };
                        }, [r, e]),
                        a
                    );
                ...
                const L = F().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            F().createElement(
                                'div',
                                N({}, D, {
                                    className: x()(k.base, k[`base__theme-${r}`], A),
                                    ref: function (u) {
                ...
                const Q = (u, e = j.Small) => `R.images.gui.maps.icons.quests.bonuses.${e}.${u}_gift`,
                    J = 'Category_base_e5',
                    uu = 'Category_image_e5',
                    eu = 'Category_content_4f',
                    tu = 'Category_title_0e',
                    Eu = 'Category_rewards_10',
                    Fu = 'Category_counter_79',
                    ...
                    nu = ({ type: u, rewards: e }) => {
                                    ...
                                    t = e
                                        .map(({ value: e }, t) => {
                                            const E = ((u) => {
                                                ...
                                                return (
                                                    E ||
                                                    (F ? a(F) : void console.error('title for reward is not provided'))
                                                );
                                            })(e.type);
                                            ...
                                            var r, D;
                                            return (
                                                (u[A] = F().createElement(I, { text: n, classMix: Fu })), `${E}%(${A})s`
                                            );
                                        })
                                        .join(Au.separator());
                        ...
                        return F().createElement(
                            'div',
                            { className: J },
                            F().createElement('div', { className: uu, style: t }),
                            F().createElement(
                                'div',
                                { className: eu },
                                F().createElement(
                                ...
                                F().createElement('div', { className: Eu }, F().createElement(I, A)),
                            ),
                        );
                    },
                    ru = 'App_base_ba',
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement(
                                    'div',
                                    { className: Du },
                                    F().createElement(z, { text: Bu.title(), binding: A }),
                                ),
                                F().createElement('div', { className: ou }, Bu.description()),
                                F().createElement('div', { className: au }),
                                t.map(({ value: u }, e) =>
                                    F().createElement('div', { key: e, className: iu }, F().createElement(nu, u)),
                                ),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    n().render(F().createElement(su, null), document.getElementById('root'));
                });
            },
        },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [127], () => __webpack_require__(896));
