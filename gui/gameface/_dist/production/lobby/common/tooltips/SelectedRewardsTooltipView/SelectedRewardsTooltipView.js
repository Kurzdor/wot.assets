(() => {
    ...
    var __webpack_modules__ = {
            645: (u, e, t) => {
                ...
                var E = {};
                t.r(E),
                    t.d(E, { mouse: () => i, off: () => o, on: () => D, onResize: () => n, onScaleUpdated: () => r });
                var F = t(472);
                function A(u) {
                    viewEnv.setTrackMouseOnStage(u);
                }
                const n = (0, F.E)('clientResized'),
            ...
            153: (u, e, t) => {
                t.d(e, { O: () => G });
                var E = {};
                t.r(E), t.d(E, { getBgUrl: () => D, getTextureUrl: () => r });
                var F = {};
                t.r(F),
                    t.d(F, {
                        addModelObserver: () => w,
            ...
            485: (u, e, t) => {
                ...
                const a = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    s = (u, e, t = D.left) => u.split(e).reduce(t === D.left ? i : B, []),
                    C = (() => {
                        const u = new RegExp(
                ...
                const J = (u, e) => !['$dyn', '$num', '$plural'].includes(u) && u in e,
                    uu = (u, e = j.Small) => {
                        const t = eu(u + '_gift', e, R.images.gui.maps.icons.quests.bonuses);
                        if (t) return t;
                        console.error('Category image unavailable.');
                    },
                    eu = (u, e, t) => {
                        if (!J(e, t)) return void console.error(`Invalid gfFolder. gfFolder[${e}] does not exist.`);
                        const E = t[e];
                        if ('object' == typeof E)
                            if (J(u, E)) {
                                if ('function' == typeof E[u]) return E[u]();
                                console.error(`Invalid type. gfFolder[${e}][${u}] is not callable`);
                            } else console.error(`Invalid type. gfFolder[${e}][${u}] does not exist.`);
                        else console.error(`Invalid gfFolder. gfFolder[${e}] is not a GFFolder.`);
                    },
                    tu = 'Category_base_e5',
                    Eu = 'Category_image_e5',
                    Fu = 'Category_content_4f',
                    Au = 'Category_title_0e',
                    ...
                    ou = ({ type: u, rewards: e }) => {
                            ...
                            A = (0, E.useMemo)(() => {
                                const u = {},
                                    t = e
                                        .map(({ value: e }, t) => {
                                            const E = ((u) => {
                                                const e = u.includes('_') ? u.split('_')[1] : null;
                                                if (e && J(e, R.strings.blueprints.nations))
                                                    return R.strings.blueprints.nations[e]();
                                                if (J(u, R.strings.artefacts) && 'empty' !== u) {
                                                    const e = R.strings.artefacts[u];
                                                    if ('name' in e) return a(e.name());
                                                }
                                                if (J(u, R.strings.event.rewardSelection))
                                                    return R.strings.event.rewardSelection[u]();
                                            ...
                                            var r, D;
                                            return (
                                                (u[A] = F().createElement(I, { text: n, classMix: ru })), `${E}%(${A})s`
                                            );
                                        })
                                        .join(Du.separator());
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement('div', { className: nu }, F().createElement(I, A)),
                            ),
                        );
                    },
                    au = 'App_base_ba',
                    iu = 'App_title_43',
                    Bu = 'App_description_43',
                    su = 'App_divider_36',
                    Cu = 'App_category_c3',
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement(
                                    'div',
                                    { className: iu },
                                    F().createElement(z, { text: lu.title(), binding: A }),
                                ),
                                F().createElement('div', { className: Bu }, lu.description()),
                                F().createElement('div', { className: su }),
                                t.map(({ value: u }, e) =>
                                    F().createElement('div', { key: e, className: Cu }, F().createElement(ou, u)),
                                ),
                            ),
                        );
                    };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [127], () => __webpack_require__(485));
