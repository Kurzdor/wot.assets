(() => {
    var __webpack_modules__ = {
            280: (u, e, t) => {
                ...
                var a = t(6179),
                    ...
                    E = t(3649),
                    s = t(5287);
                const l = ({ binding: u, text: e = '', classMix: t, alignment: r = E.v2.left }) =>
                    null === e
            ...
            3649: (u, e, t) => {
                ...
                const r = (u, e, t) => {
                    ...
                    A = (u, e, t) => u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (t && u in t ? t[u] : o(u, e)));
            },
            1358: (u, e, t) => {
                'use strict';
                t.d(e, { Z: () => r });
            ...
            3306: (u, e, t) => {
                ...
                const o = i.O.client.getSize('rem'),
                    A = o.width,
                    F = o.height,
                    c = Object.assign({ width: A, height: F }, l(A, F, E)),
                    ...
                    C = (0, a.memo)(({ children: u }) => {
                        const e = (0, a.useContext)(D),
                            ...
                            o = (0, a.useCallback)((u, e) => {
                                ...
                                s(Object.assign({ width: t, height: a }, l(t, a, E)));
                            }, []);
                        d(() => {
                ...
                const T = {
                    ...
                    S = (u) => {
                        ...
                        const r = f(),
                            ...
                            E = r.mediaHeight,
                            s = r.mediaSize;
                        return n().createElement('div', L({ className: h()(t, T[i], M[E], y[s]) }, a), e);
                    },
                    k = ['children'];
                const O = (u) => {
                    let e = u.children,
                    ...
                    return n().createElement(C, null, n().createElement(S, t, e));
                };
                var P = t(493),
                    I = t.n(P);
                function N(u) {
                ...
                const nu = ({ onClick: u, direction: e, isLocked: t, tooltipArgs: r, className: i }) => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                'div',
                                { className: o },
                                n().createElement('div', { className: E, onClick: s, onMouseEnter: l }),
                            ),
                        );
                    },
                    ru = 'Pagination_base_50',
                    iu = 'Pagination_content_0e',
                    Eu = 'Pagination_list_9e',
                    su = ({ className: u, hasArrow: e, arrowOffset: t, selectedIndex: r, children: i }) => {
                        t = t || 0;
                        const E = (0, a.useMemo)(
                                () =>
                                    i.map((u) => ({
                            ...
                            s = i.length - 1,
                            l = (0, a.useMemo)(() => {
                                const u = E.findIndex((u) => void 0 === u.isInaccessible && void 0 === u.isCompleted);
                                return -1 === u ? 0 : u;
                            }, [E]),
                            o = (0, a.useState)(r || l),
                            A = o[0],
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                ...
                                n().createElement('div', { style: d }, i[A].render()),
                                e &&
                                    n().createElement(nu, {
                                        onClick: _,
                            ...
                            n().createElement(eu, { className: Eu, selectedStep: A, data: E, onChange: c }),
                        );
                    },
                    lu = {
                ...
                class Fu extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = h()(lu.base, lu[`base__${i}`], lu[`base__${r}`], null == E ? void 0 : E.base),
                            D = h()(lu.icon, lu[`icon__${i}`], lu[`icon__${r}`], null == E ? void 0 : E.icon),
                            _ = h()(lu.glow, null == E ? void 0 : E.glow),
                            B = h()(lu.caption, lu[`caption__${i}`], null == E ? void 0 : E.caption),
                            d = h()(lu.goto, null == E ? void 0 : E.goto);
                        return n().createElement(
                            'div',
                            Au(
                                {
                ...
                function _u(u = cu.n.NONE, e = Du, t = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== cu.n.NONE)
                            return (
                ...
                const wu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: E, children: s, mocks: l }) {
                                const o = (0, a.useRef)([]),
                                    A = (t, a, n) => {
                                        var r;
                                        const E = (function ({
                                    ...
                                    D = c[0],
                                    _ = c[1],
                                    B = (0, a.useState)(() => A(r, E, l)),
                                    d = B[0],
                                    C = B[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        F.current ? C(A(D, E, l)) : (F.current = !0);
                                    }, [l, D, E]),
                                    (0, a.useEffect)(() => {
                                        _(r);
                                    }, [r]),
                        ...
                        ({ observableModel: u }) => {
                            const e = { root: u.object(), gameModes: u.array('gameModes') },
                                t = (0, pu.Om)(() => du.UI(e.gameModes.get(), (u) => u)),
                                a = (0, pu.Om)((u) => (t() ? du.U2(t(), u) : void 0), { equals: mu }),
                                n = (0, pu.Om)(
                                    (u, e) => {
                                        const t = a(e);
                                        return t ? du.U2(null == t ? void 0 : t.cards, u) : void 0;
                                    },
                                    { equals: mu },
                                );
                ...
                const Ou = 'Table_base_61',
                    Pu = 'Table_row_d4',
                    Ru = 'Table_row__head_19',
                    Iu = 'Table_row__content_6b',
                    Nu = 'Table_cell_8e',
                    Hu = 'Table_cell__text_8c',
                    Uu = 'Table_cell__wide_52',
                    Wu = 'Table_cell__wideHead_0b',
                    ...
                    ju = ({ tableRows: u, arenaBonusType: e }) => {
                        ...
                        return n().createElement(
                            ...
                            { className: Ou },
                            du.UI(u, (u, t) => {
                                const r = h()(Pu, 0 === t && Ru, 0 !== t && Iu),
                                    i = a && 0 !== t && e === ku.COMP7;
                                return n().createElement(
                                    'div',
                                    { key: t, className: r },
                                    du.UI(u.cell, ({ text: u, points: r }, E) => {
                                        const s = h()(
                                            Nu,
                                            a && a[E].value.text && Hu,
                                            i && a && a[E].value.text && Uu,
                                            0 === t && Gu,
                                            0 === t && 0 === E && e === ku.COMP7 && Wu,
                                        );
                                        return n().createElement(
                                            'div',
                                            { className: s, lang: R.strings.settings.LANGUAGE_CODE(), key: E },
                ...
                const re = R.strings.battle_pass.howToEarnPoints.card,
                    ...
                    se = (0, Cu.Pi)(({ cardIndex: u, slideIndex: e, isSmall: t = !1 }) => {
                        const a = xu(),
                            r = a.model,
                            i = a.controls,
                            E = f().mediaSize,
                            s = r.computes.getCard(u, e),
                            l = s.cardType,
                            o = s.viewId,
                            A = s.vehiclesList,
                            F = E >= b.Medium,
                        ...
                        return n().createElement(
                            'div',
                            { className: h()(Zu, t && Qu) },
                            n().createElement('div', { className: ae }, Ee[l].title),
                            _ &&
                                n().createElement(
                                    'div',
                            ...
                            d &&
                                ...
                                n().createElement(
                                    Yu,
                                    { onClick: () => o && i.openLink(o), size: 'small', type: 'ghost' },
                                    d,
                                ),
                        );
                    }),
                    ...
                    Fe = {
                        [ku.REGULAR]: { small: oe.random(), large: Ae.random() },
                        [ku.RANKED]: { small: oe.ranked(), large: Ae.ranked() },
                        [ku.BATTLE_ROYALE_SOLO]: { small: oe.steelhunt(), large: Ae.battle_royale() },
                        [ku.EPIC_BATTLE]: { small: oe.frontline(), large: Ae.epicbattle() },
                        [ku.COMP7]: { small: oe.comp7(), large: Ae.comp7() },
                    },
                    ce = {
                        [ku.REGULAR]: { levelRange: [6, 10] },
                        [ku.RANKED]: { levelRange: [0] },
                        [ku.BATTLE_ROYALE_SOLO]: { levelRange: [0] },
                        [ku.EPIC_BATTLE]: { levelRange: [0] },
                        [ku.COMP7]: { levelRange: [0] },
                    },
                    De = 'Slide_base_b8',
                    _e = 'Slide_container_2d',
                    ...
                    we = (0, Cu.Pi)(({ index: u }) => {
                        ...
                        const t = xu().model.computes.getSlide(u),
                            ...
                            E = t.cards,
                            s = t.arenaBonusType,
                            l = f().mediaSize >= b.Medium,
                            o = (null == (e = ce[s]) ? void 0 : e.levelRange) || [],
                            A = (0, Su.uF)(
                                r,
                                2 === o.length ? { startLevel: yu(o[0]), endLevel: yu(o[1]) } : { level: yu(o[0]) },
                            );
                        return n().createElement(
                            'div',
                            { className: De },
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: de },
                                    n().createElement('div', { className: me, style: pe(l, s) }),
                                    n().createElement(
                                        'div',
                                        { className: Ce },
                                    ...
                                    n().createElement(ju, { tableRows: i, arenaBonusType: s }),
                                ),
                                n().createElement(
                                    'div',
                                    { className: ve },
                    ...
                    Te = 'App_dimBg_f6',
                    Me = 'App_close_6f',
                    ye = 'App_titleContainer_46',
                    Se = 'App_title_d4',
                    ke = 'App_description_af',
                    Oe = 'App_pagination_1a',
                    Pe = 'App_animationBg_04',
                    Re = R.strings.battle_pass.howToEarnPoints,
                    Ie = (0, Cu.Pi)(() => {
                        const u = xu().model;
                        return (
                            Bu(),
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: ye },
                                        n().createElement('div', { className: Se }, Re.title()),
                                        n().createElement('div', { className: ke }, Re.description()),
                                    ),
                                    u.computes.getItems().length > 0 &&
                                        n().createElement(
                                            su,
                                            { hasArrow: !0, selectedIndex: 0, className: Oe },
                                            du.UI(u.gameModes.get(), (u, e) => ({
                ...
                engine.whenReady.then(() => {
                    I().render(
                        n().createElement(fu, null, n().createElement(O, null, n().createElement(Ie, null))),
            ...
            6583: (u, e, t) => {
                ...
                const E = {
                    ...
                    s = R.images.gui.maps.icons.vehicleTypes,
                    l = ({ isSpecial: u, vehicleLevel: e, vehicleName: t, vehicleType: a, isElite: r }) => {
                        const l = ((u, e) => {
                            ...
                            o = i()(E.base, E[`base__level${e}`]),
                            A = i()(E.vehicleType, r && E.vehicleType__elite);
                        return n().createElement(
                            'div',
                            { className: o },
                            n().createElement('div', { className: A, style: l }),
                            n().createElement('div', { className: u ? E.vehicleName : '' }, t),
                        );
                    };
            },
            9243: (u, e, t) => {
                ...
                const l = 'VehicleList_base_b7',
                    ...
                    c = ({ vehiclesList: u }) => {
                        ...
                        return E().createElement(
                            ...
                            { className: l },
                            n.UI(u, (u, t) =>
                                E().createElement(a.z, { classMix: o, text: u.textResource, key: t, binding: e(u) }),
                            ),
                        );
                    };
            },
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (__webpack_require__.j = 853),
        (() => {
            var u = { 853: 0, 243: 0, 914: 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [519], () => __webpack_require__(3306));
