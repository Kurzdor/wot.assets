(() => {
    var __webpack_modules__ = {
            ...
            3355: (u, e, t) => {
                ...
                const E = n.O.client.getSize('rem'),
                    A = E.width,
                    F = E.height,
                    d = Object.assign({ width: A, height: F }, l(A, F, s)),
                ...
                const S = {
                    ...
                    O = (u) => {
                        ...
                        const i = p(),
                            ...
                            s = i.mediaHeight,
                            o = i.mediaSize;
                        return a().createElement('div', x({ className: h()(t, S[n], y[s], M[o]) }, r), e);
                    },
                    k = ['children'];
                const T = (u) => {
                    let e = u.children,
                ...
                const nu = (0, r.createContext)({}),
                    su = (0, r.memo)(
                        ({
                            ...
                            const l = (0, r.useRef)(null),
                                ...
                                T = w === O && !t,
                                R = 1 !== O,
                                H = (0, r.useMemo)(() => ({ isAnimationDisabled: L }), [L]),
                                P = (function () {
                                    var u = iu(function* () {
                                        if (l && l.current) {
                                            x(!0), yield (0, q.Eu)();
                            ...
                            const N = (0, r.useCallback)(
                                            ...
                                            t &&
                                                setTimeout(
                                                    iu(function* () {
                                                        x(!0);
                                                        const u = d.concat();
                                                        u.unshift(u.pop()), _(u), f(w), yield (0, q.Eu)(), x(!1), M(!1);
                                                    }),
                                                    600,
                                                ),
                                            W('play'),
                                            ...
                                            t &&
                                                setTimeout(
                                                    iu(function* () {
                                                        x(!0);
                                                        const u = d.concat();
                                                        u.push(u.shift()), _(u), f(w), yield (0, q.Eu)(), x(!1), M(!1);
                                                    }),
                                                    600,
                                                ),
                                            W('play'),
                                ...
                                U = () => W('highlight');
                            Y(z.n.ARROW_LEFT, N), Y(z.n.ARROW_RIGHT, I);
                            const G = (0, r.useMemo)(() => (t ? { width: 'auto' } : { width: `${B}rem` }), [B, t]),
                                V = (0, r.useMemo)(
                                    () =>
                                        t
                            ...
                            return a().createElement(
                                'div',
                                { className: $ },
                                R && a().createElement('div', { className: K, onClick: N, onMouseEnter: U, style: j }),
                                R && a().createElement('div', { className: X, onClick: I, onMouseEnter: U, style: j }),
                                n &&
                                    a().createElement(
                                        'div',
                                        { className: Z },
                                    ...
                                    a().createElement(
                                        ...
                                        d.map((u, e) => {
                                            ...
                                            return (
                                                ...
                                                a().createElement(
                                                    'div',
                                                    { className: s, key: `slide-${e}`, style: G, onClick: n },
                    ...
                    wu = ({
                        ...
                        const A = (0, r.useState)(!1),
                            ...
                            g = B.mediaHeight,
                            v = bu[m],
                            b = g >= f.Medium && C <= w.Small,
                            L = g <= f.Small ? V.small : V.medium,
                            x = h()(ou, b && Bu, F && Eu);
                        (0, r.useEffect)(
                            () =>
                                ((u) => {
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: x, style: { backgroundImage: `url(${l})` } },
                                a().createElement('div', { className: Au, style: { backgroundImage: `url(${l})` } }),
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        su,
                                        { arrowsTopPosition: v, withCounter: !0 },
                                        i.map(
                                            ({ value: u }, e) =>
                                                u &&
                                                a().createElement(tu, {
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: Cu },
                                        a().createElement($, { type: G.primary, size: L, mixClass: hu, onClick: S }, t),
                                    ),
                                ),
                            )
                        );
                ...
                const Mu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: i = 'real', options: s, children: o, mocks: l }) {
                                    ...
                                    A = (t, r, a) => {
                                        ...
                                        const s = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Lu(a.keys()); !(u = t()).done; ) i(u.value, e);
                                                    },
                                                    unsubscribe: i,
                                                };
                                            })(r),
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        F.current ? m(A(c, s, l)) : (F.current = !0);
                                    }, [l, c, s]),
                                    (0, r.useEffect)(() => {
                                        _(i);
                                    }, [i]),
                    ...
                    Tu = (0, N.Pi)(() => {
                        ...
                        return a().createElement(wu, {
                            ...
                            backgroundLink: 'R.images.gui.maps.icons.battlePass.backgrounds.common',
                            isVideoExist: o,
                        });
                    });
                engine.whenReady.then(() => {
                    P().render(
                        a().createElement(Ou, null, a().createElement(T, null, a().createElement(Tu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [519], () => __webpack_require__(3355));
