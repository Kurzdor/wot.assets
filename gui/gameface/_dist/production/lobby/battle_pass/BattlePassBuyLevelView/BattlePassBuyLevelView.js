(() => {
    var __webpack_modules__ = {
            3457: (e, u, t) => {
                ...
                const c = ({
                    ...
                    const C = (0, s.useRef)(null),
                        ...
                        U = r()(o.Z.state, o.Z.state__default);
                    return (
                        (0, s.useEffect)(
                            () => (
            ...
            3638: (e, u, t) => {
                ...
                function G(e = U.n.NONE, u = $, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (e !== U.n.NONE)
                            return (
                    ...
                    Le = (0, r.memo)(
                        ({
                            ...
                            const h = (0, r.useMemo)(() => Object.assign({ width: '100%' }, xe(e), Re(d)), [d, e]),
                                ...
                                v = (0, r.useMemo)(() => Object.assign({ width: '0%' }, Pe(d, n), xe(e)), [n, d, e]),
                                b = (0, r.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - n)}%` }, Pe(d, n), xe(e)),
                                    [n, d, o, e],
                                );
                            if (F) return null;
                            const w = i()(we, E, d && 0 === o && ye);
                            return a().createElement(
                                'div',
                                { style: D ? v : b, className: w },
                                a().createElement(
                                    'div',
                                    { style: B ? f : h, className: Se },
                                    a().createElement(Fe, { size: s }),
                                ),
                            );
                        },
                ...
                const Me = (0, r.memo)((e) => {
                        ...
                        switch (n.animationSettings.type) {
                            ...
                            case _e.Growing:
                                return a().createElement(Te, Ne({}, n, { onEndAnimation: l, isComplete: i }));
                            default:
                                return null;
                        }
                    }),
                ...
                const He = (0, r.memo)((e) => {
                    ...
                    return (
                        (n.current.from = i),
                        a().createElement(Me, Ie({}, t, { onEndAnimation: s, key: `${i}-${t.to}`, from: i }))
                    );
                });
                function Ue() {
                    return (
                ...
                const $e = (0, r.memo)(
                        ({
                            ...
                            return s.withStack
                                ...
                                : a().createElement(Me, Ue({ key: `${r}-${u}` }, c));
                        },
                    ),
                    Ge = (e) => ({
                    ...
                    Ve = (0, r.memo)(
                        ({
                            ...
                            return a().createElement(
                                'div',
                                { className: i()(Ee.base, Ee[`base__${t}`]), style: Ge(u) },
                    ...
                    au = ({
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement(Qe, { value: f, maximum: h, allowSlide: o, slideValue: v }),
                            ),
                            o &&
                                a().createElement('div', {
                                    className: i()(uu, E && tu),
                ...
                const Eu = 'RewardsList_base_9f',
                    ...
                    Fu = (0, h.Pi)(({ rewards: e, isDisappearing: u }) => {
                    ...
                    hu = R.strings.battle_pass.battlePassBuyView.confirmAnyNumber,
                    fu = 10,
                    vu = 12,
                    bu = 20,
                    wu = 24,
                    ...
                    Su = (0, h.Pi)(() => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(Fu, { rewards: h, isDisappearing: !_ }),
                            a().createElement(
                                'div',
                                { className: gu },
                                a().createElement(
                                    ...
                                    F > 0 && a().createElement(ne.z, { text: hu.moreRewards(), binding: { count: F } }),
                                ),
                            ),
                        );
                    });
                ...
                const ku = (0, r.memo)(
                    ...
                    Gu = (0, h.Pi)(() => {
                        ...
                        ((e) => {
                            ...
                            G(U.n.SPACE, t.back),
                            W(t.back);
                        const _ = z.hJ.includes(c.get())
                            ? {
                                  backgroundImage: `url(${(0, z.wD)(R.images.gui.maps.icons.battlePass.backgrounds.purchase_confirmation, c.get())})`,
                              }
                            : (0, z.W4)(c.get());
                        return a().createElement(
                            'div',
                ...
                const Zu = 'Content_base_80',
                    ...
                    ot = R.strings.battle_pass.battlePassBuyView.reward,
                    lt = (e) => R.strings.battle_pass.chapter.fullNameUppercased.$dyn(`c_${e}`),
                    ct = (0, h.Pi)(({ back: e }) => {
                        const u = ju().model,
                            t = u.rewardsInfo,
                            n = t.chapterID,
                            ...
                            s = t.fromLevel;
                        W(e);
                        const i = z.hJ.includes(n.get())
                            ? {
                                  backgroundImage: `url(${(0, z.wD)(R.images.gui.maps.icons.battlePass.backgrounds.purchase_confirmation, n.get())})`,
                              }
                            : null;
                        return a().createElement(
                            'div',
                            ...
                            a().createElement(
                                te.u5,
                                { type: te.L$.secondary, size: te.qE.medium, mixClass: rt, onClick: e },
                                ot.backBtn(),
                            ),
                        );
                    }),
                    ...
                    dt = (0, h.Pi)(() => {
                        ...
                        return 'rewardsState' === u.main.state.get()
                            ? a().createElement(zu, { options: Et }, a().createElement(ct, { back: t.showConfirmAny }))
                ...
                const a = (e) => R.strings.battle_pass.chapter.fullNameUppercased.$dyn(`c_${e}`),
                    s = (e, u = n.h2.Big) => {
                        ...
                        return {
                            ...
                            value: s,
                            valueType: (0, r.p3)(a),
                            tooltipArgs: (0, r.pI)({ tooltipId: o }, Number(l), { ignoreShowDelay: !0 }),
                            size: u,
                        };
                    };
            },
            ...
            3862: (e, u, t) => {
                ...
                const c = ({ text: e, type: u, steps: t, className: n }) =>
                    i().createElement(
                        ...
                        i().createElement('div', { className: r()(o.divider, o.divider__left) }),
                        i().createElement(
                            'div',
                            { className: o.inner },
                        ...
                        i().createElement('div', { className: r()(o.divider, o.divider__right) }),
                    );
            },
            9144: (e, u, t) => {
                'use strict';
                ...
                const C = {
                    ...
                    p = ({
                        ...
                        return (l = {}) => {
                            ...
                            return (0, o.useMemo)(
                                ...
                                [f.scrollPosition, w, y, B.off, B.on, P, S, v, _.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    h = p({
                    ...
                    N = (0, o.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = L, onDrag: n = T }) => {
                        ...
                        return l().createElement(
                            ...
                            l().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(P) || 0 !== e.button || ((0, m.G)('play'), H(B.Next));
                                },
                                onMouseUp: U,
                                ref: a,
                                onMouseEnter: $,
                            ...
                            l().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(P) || 0 !== e.button || ((0, m.G)('play'), H(B.Prev));
                                },
                                onMouseUp: U,
                                ref: A,
                                onMouseEnter: $,
