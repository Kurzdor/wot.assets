(() => {
    ...
    var __webpack_modules__ = {
            ...
            6484: (u, e, t) => {
                ...
                const C = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    b = (u, e, t = B.left) => u.split(e).reduce(t === B.left ? p : g, []),
                    v = (() => {
                        const u = new RegExp(
                    ...
                    P = ({ binding: u, text: e = '', classMix: t, alignment: a = B.left, formatWithBrackets: s }) => {
                ...
                const S = (0, n.memo)(({ columnWidth: u, header: e, labels: t, headerClassMix: n, labelClassMix: a }) =>
                    r().createElement(
                        'div',
                        { style: { width: `${u}rem` } },
                        r().createElement('div', { className: i()(O.Z.tableHeader, n) }, e),
                        t.map((u, e) =>
                            r().createElement('div', { className: i()(O.Z.label, O.Z.label__table, a), key: e }, u),
                        ),
                    ),
                );
                var k = t(4890);
                const N = (0, n.memo)(({ header: u, points: e, columnClassMix: t }) =>
                        r().createElement(
                            'div',
                            { className: i()(O.Z.pointsColumn, t) },
                            r().createElement('div', { className: O.Z.tableHeader }, u),
                            e.map((u, e) =>
                                r().createElement(
                                    'div',
                                    { className: O.Z.label, key: e },
                                    r().createElement(k.E, { value: u }),
                                ),
                            ),
                        ),
                    ),
                    I = 'BattleRoyaleTable_pointsColumn_f0',
                    x = 'BattleRoyaleTable_header_7e',
                    M = 'BattleRoyaleTable_label_e2',
                    L = R.strings.battle_pass.tooltips.pointsTable,
                    U = ({ rewardPoints: u }) => {
                        const e = (0, n.useMemo)(
                                () =>
                                    u.soloMode.map(({ value: u }, e) =>
                                        m(e > 0 ? L.places() : L.place(), { place: u.place }),
                                    ),
                                [u],
                            ),
                        ...
                        return r().createElement(
                            ...
                            r().createElement(N, { points: t, columnClassMix: I }),
                            r().createElement(S, {
                                columnWidth: 140,
                                header: L.squad(),
                                headerClassMix: x,
                            ...
                            r().createElement(N, { points: s }),
                        );
                    },
                    G = R.strings.battle_pass.tooltips,
                    $ = ({ win: u, points: e, hasDraw: t = !0, battleType: n = '' }) => {
                        const a = 'comp7' === n ? G.prestigePoints : G.pointsTable,
                            s = ((u, e, t) => (u ? t.win() : e ? t.lose() : t.loseWithoutDraw()))(u, t, a);
                        return r().createElement(
                            'div',
                            { className: O.Z.pointsColumn },
                            r().createElement('div', { className: O.Z.tableHeader }, s),
                            e.items.map(({ value: e }, t) =>
                                r().createElement(
                                    'div',
                                    { className: O.Z.label, key: t },
                                    r().createElement(k.E, {
                    ...
                    z = ({
                        ...
                        const s = u.items.map(({ value: u }) => m(e, { place: u.topCount }));
                        return r().createElement(
                            r().Fragment,
                            null,
                            r().createElement(S, { columnWidth: n, labels: s }),
                            r().createElement($, { points: u, win: !0, battleType: a }),
                            r().createElement($, { points: u, win: !1, hasDraw: t, battleType: a }),
                        );
                    };
                var q = t(9351);
                function Y() {}
                        ...
                        return [
                            function ({ mode: a = 'real', options: s, children: o, mocks: i }) {
                                const l = (0, n.useRef)([]),
                                    ...
                                    D = F[0],
                                    d = F[1],
                                    B = (0, n.useState)(() => A(a, s, i)),
                                    m = B[0],
                                    _ = B[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        c.current ? _(A(D, s, i)) : (c.current = !0);
                                    }, [i, D, s]),
                                    (0, n.useEffect)(() => {
                                        d(a);
                                    }, [a]),
                ...
                const du = 'ExpireTime_base_55',
                    Bu = 'ExpireTime_light_64',
                    mu = 'ExpireTime_icon_56',
                    _u = 'ExpireTime_value_1c',
                    Cu = (0, y.Pi)(() => {
                        const u = ((u, e = !0) =>
                            u.days > 7 && e
                        ...
                        return r().createElement(
                            ...
                            r().createElement('div', { className: _u }, u),
                        );
                    }),
                    pu = 'Level_level_18',
                ...
                const Ru = ({ size: u = hu.Default }) => {
                        const e = i()(wu.background, wu[`background__${u}`]);
                    ...
                    Su = ({ size: u, value: e, lineRef: t, disabled: a, onComplete: s }) => {
                ...
                const xu = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    Wu = (0, n.memo)(
                        ({
                            ...
                            const b = (0, n.useMemo)(() => Object.assign({ width: '100%' }, ju(u), qu(c)), [c, u]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, ju(u), qu(c)), [c, u]),
                                w = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Yu(c, a), ju(u)), [a, c, u]),
                                h = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - a)}%` }, Yu(c, a), ju(u)),
                                    [a, c, o, u],
                                );
                            if (B) return null;
                ...
                const Ju = (0, n.memo)((u) => {
                    ...
                    return (
                        (a.current.from = o),
                        r().createElement(Zu, Qu({}, t, { onEndAnimation: s, key: `${o}-${t.to}`, from: o }))
                    );
                });
                function ue() {
                    return (
                ...
                const ee = (0, n.memo)(
                        ({
                            ...
                            return s.withStack
                                ...
                                : r().createElement(Zu, ue({ key: `${a}-${e}` }, l));
                        },
                    ),
                    te = (u) => ({
                    ...
                    Ce = (0, y.Pi)(() => {
                        const u = Q().model,
                            ...
                            t = e.chapter,
                            n = e.expireTime,
                            a = m(R.strings.battle_pass.tooltips.inProgress.chapter(), {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: me },
                                r().createElement('div', { className: _e }, a),
                                s && r().createElement(Cu, null),
                            ),
                        ...
                        const b = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (Le(t, D, { isMouseEvent: !0, on: !0, arguments: Me(r) }, v),
                                    C && C(),
                            ...
                            Ye(
                                {
                                    contentId:
                                        ...
                                        A ? je.SimpleTooltipHtmlContent('resId') : je.SimpleTooltipContent('resId')),
                ...
                const He = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const a = e.contentId;
                        return a ? r().createElement(Ue, Ve({}, e, { contentId: a }), n) : r().createElement(ze, e, n);
                    },
                    Xe = {
                        base: 'Reward_base_ea',
                    ...
                    Ze = ({
                        ...
                        const D = ((u, e) => {
                                if (void 0 === e || !Ie.includes(u)) return null;
                                switch (e) {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: i()(Xe.image, null == A ? void 0 : A.image) },
                                        D &&
                                            r().createElement('div', {
                                                className: i()(Xe.highlight, null == A ? void 0 : A.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: i()(Xe.icon, null == A ? void 0 : A.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        d &&
                                            r().createElement('div', {
                                                className: i()(Xe.overlay, null == A ? void 0 : A.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: F },
                                    r().createElement('div', {
                                        className: i()(Xe.timer, null == A ? void 0 : A.periodicIcon),
                                    }),
                                ),
                        );
                    },
                ...
                const ct = R.strings.battle_pass.tooltips,
                    Ft = { randoms: 'c_1', ranked: 'ranked', mapbox: 'c_1', comp7: 'c_24' },
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: J.rewards },
                                    r().createElement(lt, { label: ct.inProgress.baseReward(), rewards: o }),
                                    r().createElement(lt, {
                                ...
                                d || B
                                    ? r().createElement(
                                          ...
                                          r().createElement('div', {
                                              className: i()(J.modeIcon, J[`modeIcon__${_(a)}`]),
                                          }),
                                          r().createElement(P, { text: ct.inProgress.getPointsFrom(), binding: D }),
                                      )
                                    : r().createElement(T.l, {
                            ...
                            d
                                ? r().createElement(
                                      ...
                                      r().createElement(U, { rewardPoints: A }),
                                  )
                                : r().createElement(
                                      q.c,
                                      { mixClass: J.perBattlePointsTable, separatorRows: l.items },
                                      r().createElement(z, {
                                          rewardPoints: l,
                                          hasDraw: !B,
                                          topPlace: (a === At.COMP7 ? dt : Dt).topPlace(),
                                          battleType: a,
                                      }),
                                  ),
                            F &&
                            ...
                            c && r().createElement(Eu, null),
                        );
                    }),
                    mt = () => r().createElement(D, null, r().createElement(Bt, null));
                engine.whenReady.then(() => {
                    s().render(
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [1519], () => __webpack_require__(6484));
