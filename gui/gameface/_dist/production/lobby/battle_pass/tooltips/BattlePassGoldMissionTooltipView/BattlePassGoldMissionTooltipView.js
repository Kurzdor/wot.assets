    ...
    var u,
        A = {
            3963: (u, A, F) => {
                var E = {};
                F.r(E),
                    F.d(E, { mouse: () => m, off: () => v, on: () => d, onResize: () => c, onScaleUpdated: () => l });
                var e = {};
                F.r(e),
                    F.d(e, {
                        events: () => E,
                ...
                const Du = Object.keys(O).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === O[A]), u), {}),
                    Bu = {
                        set: (u, A) => {
                ...
                const au = t().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        t().createElement(
                            ...
                            t().createElement('div', { className: ru.decorator }, F),
                        )
                    );
                });
                function su() {}
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            t = tu.view.addModelObserver(C, A, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = du(e.keys()); !(u = F()).done; ) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(E),
                ...
                const yu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Pu = (u, A, F = hu.left) => u.split(A).reduce(F === hu.left ? xu : _u, []),
                    Su = (() => {
                        const u = new RegExp(
                    ...
                    Ou = (u, A = hu.left) => {
                        ...
                        return ((u, A = hu.left) => {
                            ...
                            const E =
                                ...
                                e = yu(u);
                            return Pu(e, /( )/, A).forEach((u) => (F = F.concat(Pu(u, E, hu.left)))), F;
                        })(u, A);
                    },
                    Tu = 'FormatText_base_d0',
                    zu = ({ binding: u, text: A = '', classMix: F, alignment: E = hu.left, formatWithBrackets: e }) => {
                ...
                var ju = F(3403);
                const Mu = 'Content_base_17',
                    ku = 'Content_separator_9c',
                    Lu = 'Content_title_01',
                    Vu = 'Content_text_bc',
                    Gu = 'Content_currency_1a',
                    Nu = 'Content_icon_eb',
                    $u = 'Content_duration_9f',
                    Iu = 'Content_description_b6',
                    Hu = 'Content_highlight_bd',
                    Uu = R.strings.battle_pass.tooltips.goldMission,
                    qu = (0, ju.Pi)(() => {
                        const u = pu().model;
                        return t().createElement(
                            'div',
                            { className: Mu },
                            t().createElement('div', { className: Lu }, Uu.title()),
                            t().createElement(zu, {
                                classMix: Vu,
                                text: Uu.text(),
                                binding: {
                                    count: t().createElement('span', { className: Gu }, u.count.get()),
                                    icon: t().createElement('span', { className: Nu }),
                                    duration: t().createElement(zu, {
                                        classMix: $u,
                                        text: Uu.textDuration(),
                                        binding: { days: u.days.get() },
                                    }),
                                },
                            }),
                            t().createElement('div', { className: ku }),
                            t().createElement(zu, {
                                classMix: Iu,
                                text: Uu.description(),
                                binding: {
                                    highlight: t().createElement(
                                        'span',
                                        { className: Hu },
                                        Uu.highlightedDescription(),
                                    ),
                                },
                            }),
                        );
                    }),
                    Wu = () => t().createElement(au, null, t().createElement(gu, null, t().createElement(qu, null)));
                engine.whenReady.then(() => {
                    r().render(t().createElement(Wu, null), document.getElementById('root'));
                });
            },
        },
        F = {};
