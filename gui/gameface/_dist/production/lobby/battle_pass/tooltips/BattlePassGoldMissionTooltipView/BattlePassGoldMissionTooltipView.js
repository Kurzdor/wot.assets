            ...
            5154: (u, A, F) => {
                ...
                function iu(u, A) {
                    ...
                    if (
                        ...
                        (F = (function (u, A) {
                            if (!u) return;
                            if ('string' == typeof u) return au(u, A);
                                    ...
                                    r = (F, E, e) => {
                                        ...
                                        const B = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = iu(e.keys()); !(u = F()).done; ) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(E),
                ...
                const gu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    wu = (u, A, F = fu.left) => u.split(A).reduce(F === fu.left ? pu : bu, []),
                    hu = (() => {
                        const u = new RegExp(
                ...
                var Ou = F(3403);
                const Su = 'Content_base_17',
                    Ru = 'Content_separator_9c',
                    Tu = 'Content_title_01',
                    zu = 'Content_text_bc',
                    Mu = 'Content_currency_1a',
                    ju = 'Content_icon_eb',
                    ku = 'Content_duration_9f',
                    Lu = 'Content_description_b6',
                    Vu = 'Content_highlight_bd',
                    Nu = R.strings.battle_pass.tooltips.goldMission,
                    Gu = (0, Ou.Pi)(() => {
                        const u = du().model;
                        return t().createElement(
                            'div',
                            { className: Su },
                            t().createElement('div', { className: Tu }, Nu.title()),
                            t().createElement(Pu, {
                                classMix: zu,
                                text: Nu.text(),
                                binding: {
                                    count: t().createElement('span', { className: Mu }, u.count.get()),
                                    icon: t().createElement('span', { className: ju }),
                                    duration: t().createElement(Pu, {
                                        classMix: ku,
                                        text: Nu.textDuration(),
                                        binding: { days: u.days.get() },
                                    }),
                                },
                            }),
                            t().createElement('div', { className: Ru }),
                            t().createElement(Pu, {
                                classMix: Lu,
                                text: Nu.description(),
                                binding: {
                                    highlight: t().createElement(
                                        'span',
                                        { className: Vu },
                                        Nu.highlightedDescription(),
                                    ),
                                },
                            }),
                        );
                    }),
                    Iu = () => t().createElement(tu, null, t().createElement(lu, null, t().createElement(Gu, null)));
                engine.whenReady.then(() => {
                    r().render(t().createElement(Iu, null), document.getElementById('root'));
                });
            },
        },
        F = {};
