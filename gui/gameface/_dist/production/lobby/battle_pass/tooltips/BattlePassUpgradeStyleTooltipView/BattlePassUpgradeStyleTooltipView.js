    ...
    var u,
        A = {
            1240: (u, A, F) => {
                ...
                const Du = Object.keys(S).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === S[A]), u), {}),
                    Bu = {
                        set: (u, A) => {
                ...
                const au = C().forwardRef(function (u, A) {
                    let F = u.children,
                        e = u.className,
                        E = u.theme,
                    ...
                    return (
                        ...
                        C().createElement(
                            'div',
                            iu({}, B, {
                                className: i()(ru.base, ru[`base__theme-${D}`], e),
                                ref: function (u) {
                ...
                const du = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    fu = (u, A, F = lu.left) => u.split(A).reduce(F === lu.left ? vu : mu, []),
                    gu = (() => {
                        const u = new RegExp(
                    ...
                    wu = ({ binding: u, text: A = '', classMix: F, alignment: e = lu.left, formatWithBrackets: E }) => {
                        if (null === A) return console.error("FormatText was supplied with 'null'"), null;
                        const D = E && u ? cu(A, u) : A;
                ...
                function _u(u) {
                    let A = '';
                    for (let F = xu.length - 1; F >= 0; F--) for (; u >= xu[F]; ) (A += yu[F]), (u -= xu[F]);
                    return A;
                }
                ...
                const Mu = ((u, A) => {
                    ...
                    ku = Mu[1],
                    Lu = 'Content_base_d2',
                    Vu = 'Content_separator_b4',
                    $u = 'Content_base__bottom_ab',
                    Iu = 'Content_image_90',
                    Gu = 'Content_section_83',
                    Uu = 'Content_sectionBottom_01',
                    Hu = 'Content_title_c5',
                    Wu = 'Content_warning_d0',
                    qu = 'Content_text_bf',
                    Qu = 'Content_highlightedText_e0',
                    Xu = 'Content_subtitle_55',
                    Zu = 'Content_paragraphs_c3',
                    Ju = 'Content_paragraphTop_18',
                    Ku = R.strings.battle_pass.tooltips.styleUpgrade,
                    Yu = (0, Pu.Pi)(() => {
                        const u = ku().model.root.get(),
                            ...
                            E = u.vehicles,
                            D = {
                                level: C().createElement('div', { className: Qu }, _u(A)),
                                levelWord: C().createElement('div', { className: Qu }, Ku.chosen.levelWord()),
                            };
                        return C().createElement(
                            'div',
                            { className: i()(Lu, F && $u) },
                            ...
                            C().createElement(
                                'div',
                                { className: Gu },
                                C().createElement('div', { className: Vu }),
                                C().createElement(
                                    'div',
                                    { className: Hu },
                                    F ? cu(Ku.chosen.title(), { styleName: e }) : Ku.notChosen.title(),
                                ),
                                !F && C().createElement('div', { className: Wu }, Ku.notChosen.warning()),
                                C().createElement(
                                    'div',
                                    { className: qu },
                                    F
                                        ? C().createElement(wu, { text: Ku.chosen.text(), binding: D })
                                        : Ku.notChosen.text(),
                                ),
                                C().createElement('div', { className: Vu }),
                            ),
                            C().createElement(
                                'div',
                                { className: Zu },
                                C().createElement('div', { className: Ju }, Ku.paragraphTop()),
                                Ku.paragraphBottom(),
                            ),
                            F &&
                                C().createElement(
                                    ...
                                    { className: Uu },
                                    C().createElement('div', { className: Vu }),
                                    C().createElement('div', { className: Xu }, Ku.chosen.subtitle()),
                                    C().createElement('div', { className: qu }, E),
                                ),
                        );
                    }),
                    uA = () => C().createElement(au, null, C().createElement(Yu, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(Nu, null, C().createElement(uA, null)),
