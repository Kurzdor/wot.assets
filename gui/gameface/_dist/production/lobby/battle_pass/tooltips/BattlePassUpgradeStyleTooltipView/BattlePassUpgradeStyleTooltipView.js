    ...
    var u,
        A = {
            8484: (u, A, F) => {
                ...
                const uu = Object.keys(y).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === y[A]), u), {}),
                    Au = {
                        set: (u, A) => {
                ...
                const iu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    lu = (u, A, F = ru.left) => u.split(A).reduce(F === ru.left ? au : su, []),
                    cu = (() => {
                        const u = new RegExp(
                    ...
                    vu = (u, A = ru.left) => {
                        ...
                        return ((u, A = ru.left) => {
                            ...
                            const E =
                                ...
                                e = iu(u);
                            return lu(e, /( )/, A).forEach((u) => (F = F.concat(lu(u, E, ru.left)))), F;
                        })(u, A);
                    },
                    mu = 'FormatText_base_d0',
                    fu = ({ binding: u, text: A = '', classMix: F, alignment: E = ru.left, formatWithBrackets: e }) => {
                        if (null === A) return console.error("FormatText was supplied with 'null'"), null;
                        const D = e && u ? ou(A, u) : A;
                        return C().createElement(
                            ...
                            D.split('\n').map((A, e) =>
                                C().createElement(
                                    ...
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : vu(u, A))))(
                                        A,
                                        E,
                                        u,
                ...
                function bu(u) {
                    let A = '';
                    for (let F = pu.length - 1; F >= 0; F--) for (; u >= pu[F]; ) (A += gu[F]), (u -= pu[F]);
                    return A;
                }
                ...
                const Ru = ((u, A) => {
                                    ...
                                    r = (F, E, e) => {
                                        ...
                                        const B = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = _u(e.keys()); !(u = F()).done; ) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(E),
                    ...
                    Su = Ru[1],
                    zu = 'Content_base_d2',
                    ju = 'Content_separator_b4',
                    Mu = 'Content_base__bottom_ab',
                    Nu = 'Content_image_90',
                    ku = 'Content_section_83',
                    Lu = 'Content_sectionBottom_01',
                    Vu = 'Content_title_c5',
                    Iu = 'Content_warning_d0',
                    Gu = 'Content_text_bf',
                    $u = 'Content_highlightedText_e0',
                    Uu = 'Content_subtitle_55',
                    Hu = 'Content_paragraphs_c3',
                    Wu = 'Content_paragraphTop_18',
                    qu = R.strings.battle_pass.tooltips.styleUpgrade,
                    Qu = (0, hu.Pi)(() => {
                        const u = Su().model.root.get(),
                            ...
                            e = u.vehicles,
                            D = {
                                level: C().createElement('div', { className: $u }, bu(A)),
                                levelWord: C().createElement('div', { className: $u }, qu.chosen.levelWord()),
                            };
                        return C().createElement(
                            'div',
                            { className: i()(zu, F && Mu) },
                            ...
                            C().createElement(
                                ...
                                C().createElement(
                                    'div',
                                    { className: Vu },
                                    F ? ou(qu.chosen.title(), { styleName: E }) : qu.notChosen.title(),
                                ),
                                !F && C().createElement('div', { className: Iu }, qu.notChosen.warning()),
                                C().createElement(
                                    'div',
                                    { className: Gu },
                                    F
                                        ? C().createElement(fu, { text: qu.chosen.text(), binding: D })
                                        : qu.notChosen.text(),
                                ),
                                C().createElement('div', { className: ju }),
                            ),
                            C().createElement(
                                'div',
                                { className: Hu },
                                C().createElement('div', { className: Wu }, qu.paragraphTop()),
                                qu.paragraphBottom(),
                            ),
                            F &&
                                C().createElement(
                                    ...
                                    { className: Lu },
                                    C().createElement('div', { className: ju }),
                                    C().createElement('div', { className: Uu }, qu.chosen.subtitle()),
                                    C().createElement('div', { className: Gu }, e),
                                ),
                        );
                    }),
                    Xu = () => C().createElement(Cu, null, C().createElement(Qu, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(Tu, null, C().createElement(Xu, null)),
