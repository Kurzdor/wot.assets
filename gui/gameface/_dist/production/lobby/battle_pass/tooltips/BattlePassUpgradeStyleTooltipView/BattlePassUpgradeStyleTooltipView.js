    ...
    var u,
        A = {
            1240: (u, A, F) => {
                ...
                function Pu(u) {
                    let A = '';
                    for (let F = _u.length - 1; F >= 0; F--) for (; u >= _u[F]; ) (A += xu[F]), (u -= _u[F]);
                    return A;
                }
                ...
                const Nu = ((u, A) => {
                    ...
                    Lu = Nu[1],
                    Vu = 'Content_base_d2',
                    $u = 'Content_separator_b4',
                    Iu = 'Content_base__bottom_ab',
                    Gu = 'Content_image_90',
                    Uu = 'Content_section_83',
                    Hu = 'Content_sectionBottom_01',
                    Wu = 'Content_title_c5',
                    qu = 'Content_warning_d0',
                    Qu = 'Content_text_bf',
                    Xu = 'Content_highlightedText_e0',
                    Zu = 'Content_subtitle_55',
                    Ju = 'Content_paragraphs_c3',
                    Ku = 'Content_paragraphTop_18',
                    Yu = R.strings.battle_pass.tooltips.styleUpgrade,
                    uA = (0, Ru.Pi)(() => {
                        const u = Lu().model.root.get(),
                            ...
                            E = u.vehicles,
                            D = {
                                level: C().createElement('div', { className: Xu }, Pu(A)),
                                levelWord: C().createElement('div', { className: Xu }, Yu.chosen.levelWord()),
                            };
                        return C().createElement(
                            'div',
                            { className: i()(Vu, F && Iu) },
                            ...
                            C().createElement(
                                ...
                                C().createElement(
                                    'div',
                                    { className: Wu },
                                    F ? du(Yu.chosen.title(), { styleName: e }) : Yu.notChosen.title(),
                                ),
                                !F && C().createElement('div', { className: qu }, Yu.notChosen.warning()),
                                C().createElement(
                                    'div',
                                    { className: Qu },
                                    F
                                        ? C().createElement(yu, { text: Yu.chosen.text(), binding: D })
                                        : Yu.notChosen.text(),
                                ),
                                C().createElement('div', { className: $u }),
                            ),
                            C().createElement(
                                'div',
                                { className: Ju },
                                C().createElement('div', { className: Ku }, Yu.paragraphTop()),
                                Yu.paragraphBottom(),
                            ),
                            F &&
                                C().createElement(
                                    ...
                                    { className: Hu },
                                    C().createElement('div', { className: $u }),
                                    C().createElement('div', { className: Zu }, Yu.chosen.subtitle()),
                                    C().createElement('div', { className: Qu }, E),
                                ),
                        );
                    }),
                    AA = () => C().createElement(su, null, C().createElement(uA, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(ku, null, C().createElement(AA, null)),
