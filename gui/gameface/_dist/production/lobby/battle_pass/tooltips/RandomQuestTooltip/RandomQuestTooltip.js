        ...
        e = {
            2184: (u, e, F) => {
                ...
                const su = n().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            iu({}, t, {
                                className: a()(ou.base, ou[`base__theme-${D}`], A),
                                ref: function (u) {
                                    ...
                                    r = (F, A, E) => {
                                        ...
                                        const t = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = du(E.keys()); !(u = F()).done; ) D(u.value, e);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(A),
                ...
                const bu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Tu = (u, e, F = xu.left) => u.split(e).reduce(F === xu.left ? _u : yu, []),
                    Su = (() => {
                        const u = new RegExp(
                    ...
                    Ru = (u, e = xu.left) => {
                        ...
                        return ((u, e = xu.left) => {
                            ...
                            const A =
                                ...
                                E = bu(u);
                            return Tu(E, /( )/, e).forEach((u) => (F = F.concat(Tu(u, A, xu.left)))), F;
                        })(u, e);
                    },
                    Ou = 'FormatText_base_d0',
                    Mu = ({ binding: u, text: e = '', classMix: F, alignment: A = xu.left, formatWithBrackets: E }) => {
                ...
                const ku = {
                    ...
                    Lu = (0, B.memo)(({ text: u, binding: e, classMix: F }) => {
                                ...
                                (t = t.replace(F, `%(${D})`)),
                                    (E[D] = ku[u]
                                        ? n().createElement(
                                              'span',
                                              { className: ku[u] },
                                              n().createElement(Mu, { text: o, binding: e }),
                                          )
                                        : n().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return n().createElement(Mu, { text: t, classMix: F, binding: E });
                    }),
                    Vu = 'List_base_65',
                    $u = 'List_item_f9',
                    Gu = 'List_circle_65',
                    Iu = ({ children: u, className: e }) => {
                    ...
                    qu = 'Content_image_d9',
                    Uu = 'Content_title_33',
                    Qu = 'Content_subTitle_97',
                    Zu = 'Content_divider_52',
                    Ju = 'Content_rewardBase_31',
                    Ku = 'Content_reward_b0',
                    Xu = 'Content_expireTime_7c',
                    Yu = R.strings.battle_pass.tooltips.RandomQuestTooltip,
                    ue = (0, zu.Pi)(() => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(Mu, { text: Yu.title(), binding: { vehicleName: e }, classMix: Uu }),
                            A &&
                                n().createElement(Mu, {
                                    text: Yu.condition(),
                                    binding: { condition: A },
                            ...
                            n().createElement('div', { className: Qu }, Yu.rewardsTitle()),
                            n().createElement('div', { className: Zu }),
                            n().createElement(
                                Iu,
                                { className: Ju },
                                n().createElement(Lu, { text: Yu.rewards.consumables(), classMix: Ku }),
                                n().createElement(Lu, { text: Yu.rewards.directives(), classMix: Ku }),
                                n().createElement(Lu, { text: Yu.rewards.personal_reserves(), classMix: Ku }),
                                n().createElement(Lu, { text: Yu.rewards.premium(), classMix: Ku }),
                                n().createElement(Lu, { text: Yu.rewards.money(), classMix: Ku }),
                                n().createElement(Lu, { text: Yu.rewards.standardEquipment(), classMix: Ku }),
                            ),
                            n().createElement('div', { className: Zu }),
                            n().createElement(Lu, {
                                text: Yu.expireTime(),
                    ...
                    ee = () => n().createElement(fu, null, n().createElement(su, null, n().createElement(ue, null)));
                engine.whenReady.then(() => {
                    r().render(n().createElement(ee, null), document.getElementById('root'));
                });
            },
        },
        F = {};
