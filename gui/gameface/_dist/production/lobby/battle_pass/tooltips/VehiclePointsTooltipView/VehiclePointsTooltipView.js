(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => A, off: () => o, on: () => i, onResize: () => a, onScaleUpdated: () => E });
                var n = t(2472),
                    r = t(1176);
                ...
                const i = {
                    ...
                    F = ({ isSpecial: u, vehicleLevel: e, vehicleName: t, vehicleType: n, isElite: a }) => {
                        const F = ((u, e) => {
                            ...
                            A = E()(i.base, i[`base__level${e}`]),
                            s = E()(i.vehicleType, a && i.vehicleType__elite);
            ...
            6482: (u, e, t) => {
                ...
                const D = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            c({}, D, {
                                className: o()(s.base, s[`base__theme-${i}`], a),
                                ref: function (u) {
                                ...
                                const A = (0, n.useRef)([]),
                                    s = (t, n, r) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            c = { mode: t, model: l, externalModel: i, cleanup: s };
                                        return {
                                            model: l,
                                    ...
                                    D = c[0],
                                    B = c[1],
                                    _ = (0, n.useState)(() => s(a, E, o)),
                                    m = _[0],
                                    b = _[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        l.current ? b(s(D, E, o)) : (l.current = !0);
                                    }, [o, D, E]),
                                    (0, n.useEffect)(() => {
                                        B(a);
                                    }, [a]),
                ...
                const I = (0, n.memo)(({ columnWidth: u, header: e, labels: t, headerClassMix: n, labelClassMix: a }) =>
                    r().createElement(
                        'div',
                        { style: { width: `${u}rem` } },
                        r().createElement('div', { className: o()(M.Z.tableHeader, n) }, e),
                        t.map((u, e) =>
                            r().createElement('div', { className: o()(M.Z.label, M.Z.label__table, a), key: e }, u),
                        ),
                    ),
                );
                var V = t(4890);
                const U = R.strings.battle_pass.tooltips,
                    W = ({ win: u, points: e, hasDraw: t = !0, battleType: n = '' }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement('div', { className: M.Z.tableHeader }, E),
                    ...
                    j = ({
                        ...
                        const E = u.items.map(({ value: u }) => L(e, { place: u.topCount }));
                        return r().createElement(
                            r().Fragment,
                            null,
                            r().createElement(I, { columnWidth: n, labels: E }),
                ...
                const z = 'Footer_rewards_98',
                    ...
                    Y = (0, f.Pi)(() => {
                        ...
                        return r().createElement(
                            r().Fragment,
                            null,
                            r().createElement('div', { className: K }, n ? Z.special.descr() : Z.$dyn(a) || Z.descr()),
                            r().createElement(
                                q.c,
                ...
                (window.onload = () => document.body.appendChild(tu)), E().render(r().createElement(eu, null), tu);
            },
            351: (u, e, t) => {
                t.d(e, { E: () => A });
                var n = t(6179),
                ...
                const a = 'BlockCompleted_separator_c8',
                    ...
                    o = 'BlockCompleted_whiteBgIcon_17',
            ...
            4890: (u, e, t) => {
                ...
                const s = ({ value: u, isSpecial: e = !1 }) =>
                    r().createElement(
                        'div',
                        { className: a },
                        r().createElement('div', { className: A()(E, e && i) }, u),
                        r().createElement('div', { className: o }),
                    );
            },
            401: (u, e, t) => {
