(() => {
    ...
    var __webpack_modules__ = {
            ...
            6583: (u, e, t) => {
                ...
                const F = {
                    ...
                    i = ({ isSpecial: u, vehicleLevel: e, vehicleName: t, vehicleType: n, isElite: a }) => {
                        const i = ((u, e) => {
                                const t = e.replace('-', '_'),
                                    n = u ? A.elite : A;
                            ...
                            o = E()(F.base, F[`base__level${e}`]),
                            s = E()(F.vehicleType, a && F.vehicleType__elite);
                        return r().createElement(
                            'div',
                            { className: o },
                            r().createElement('div', { className: s, style: i }),
                            r().createElement('div', { className: u ? F.vehicleName : '' }, t),
                        );
                    };
            },
            6482: (u, e, t) => {
                ...
                const D = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            c({}, D, {
                                className: A()(s.base, s[`base__theme-${F}`], a),
                                ref: function (u) {
                                ...
                                const o = (0, n.useRef)([]),
                                    s = (t, n, r) => {
                                        ...
                                        const E = (function ({
                                            ...
                                            c = { mode: t, model: l, externalModel: F, cleanup: s };
                                        return {
                                            model: l,
                                    ...
                                    D = c[0],
                                    B = c[1],
                                    _ = (0, n.useState)(() => s(a, E, A)),
                                    m = _[0],
                                    b = _[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        l.current ? b(s(D, E, A)) : (l.current = !0);
                                    }, [A, D, E]),
                                    (0, n.useEffect)(() => {
                                        B(a);
                                    }, [a]),
                                    ...
                                    r().createElement(t.Provider, { value: m }, F)
                                );
                            },
                            () => (0, n.useContext)(t),
                        ];
                ...
                const O = 'Content_base_06',
                    ...
                    N = 'Content_base__small_39',
                    k = 'Content_title_07',
                    M = 'Content_titleLabel_ba';
                let S;
                !(function (u) {
                ...
                var L = t(401);
                const x = (0, n.memo)(({ columnWidth: u, header: e, labels: t, headerClassMix: n, labelClassMix: a }) =>
                    r().createElement(
                        'div',
                        { style: { width: `${u}rem` } },
                        r().createElement('div', { className: A()(L.Z.tableHeader, n) }, e),
                        t.map((u, e) =>
                            r().createElement('div', { className: A()(L.Z.label, L.Z.label__table, a), key: e }, u),
                        ),
                    ),
                );
                var I = t(4890);
                const U = R.strings.battle_pass.tooltips,
                    V = ({ win: u, points: e, hasDraw: t = !0, battleType: n = '' }) => {
                        const a = 'comp7' === n ? U.prestigePoints : U.pointsTable,
                            E = ((u, e, t) => (u ? t.win() : e ? t.lose() : t.loseWithoutDraw()))(u, t, a);
                        return r().createElement(
                            'div',
                            { className: L.Z.pointsColumn },
                            r().createElement('div', { className: L.Z.tableHeader }, E),
                            e.items.map(({ value: e }, t) =>
                                r().createElement(
                                    'div',
                                    { className: L.Z.label, key: t },
                                    r().createElement(I.E, {
                    ...
                    W = ({
                        ...
                        const E = u.items.map(({ value: u }) => {
                            return (
                                (t = e),
                                (n = { place: u.topCount }),
                                t.replace(/\{\w+\}/g, (u) => String(n[u.slice(1, -1)]))
                            );
                            var t, n;
                        });
                        return r().createElement(
                            r().Fragment,
                            null,
                            r().createElement(x, { columnWidth: n, labels: E }),
                            r().createElement(V, { points: u, win: !0, battleType: a }),
                            r().createElement(V, { points: u, win: !1, hasDraw: t, battleType: a }),
                        );
                    };
                var j = t(9351);
                const q = 'Footer_rewards_98',
                    H = 'Footer_description_dc',
                    K = 'Footer_awardImage_9e',
                    z = 'Footer_awardPoints_6a',
                    G = R.strings.battle_pass.tooltips.vehiclePoints,
                    Z = (0, f.Pi)(() => {
                        const u = w().model,
                            e = u.root.get(),
                            t = e.pointsReward,
                        ...
                        return r().createElement(
                            r().Fragment,
                            null,
                            r().createElement('div', { className: H }, n ? G.special.descr() : G.$dyn(a) || G.descr()),
                            r().createElement(
                                j.c,
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: K },
                                    r().createElement('div', { className: z }, t),
                                ),
                            ),
                        );
                    }),
                    Y = 'Points_points_ce',
                    $ = 'Points_pointsSplitter_fb',
                    X = 'Points_pointsCurrentLabel_9d',
                    Q = (0, f.Pi)(({ isCompleted: u = !1 }) => {
                        ...
                        return r().createElement(
                            'div',
                            { className: Y },
                            r().createElement('div', { className: u ? '' : X }, B.Z5.getNumberFormat(t, B.B3.INTEGRAL)),
                    ...
                    J = (0, f.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(Q, { isCompleted: o }),
                                o
                                    ? r().createElement(y.E, {
                    ...
                    uu = () => (
                        ...
                        r().createElement(h, null, r().createElement(D, null, r().createElement(J, null)))
                    ),
                    eu = document.createElement('div');
                (window.onload = () => document.body.appendChild(eu)), E().render(r().createElement(uu, null), eu);
            },
            351: (u, e, t) => {
                t.d(e, { E: () => o });
                var n = t(6179),
                ...
                const a = 'BlockCompleted_separator_c8',
                    E = 'BlockCompleted_whiteBg_52',
                    F = 'BlockCompleted_whiteBgLine_94',
                    A = 'BlockCompleted_whiteBgIcon_17',
                    i = 'BlockCompleted_description_a4',
                    o = ({ label: u, description: e }) =>
                        r().createElement(
                            r().Fragment,
                            null,
            ...
            9351: (u, e, t) => {
                ...
                const A = ({
                    ...
                    E().createElement(
                        'div',
                        { className: r()(a, F.Z.base), style: n ? { width: '100%', backgroundSize: '100% 100%' } : {} },
                        t &&
                            E().createElement(
                                'div',
            ...
            4890: (u, e, t) => {
                ...
                const s = ({ value: u, isSpecial: e = !1 }) =>
                    r().createElement(
                        'div',
                        { className: a },
                        r().createElement('div', { className: o()(E, e && F) }, u),
                        r().createElement('div', { className: A }),
                    );
            },
            401: (u, e, t) => {
    ...
    (__webpack_require__.m = __webpack_modules__),
        ...
        (() => {
            var u = { 194: 0, 243: 0, 262: 0, 773: 0, 235: 0 };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [519], () => __webpack_require__(6482));
