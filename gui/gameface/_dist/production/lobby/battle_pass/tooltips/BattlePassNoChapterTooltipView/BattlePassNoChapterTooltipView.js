    ...
    var u,
        A = {
            6978: (u, A, F) => {
                ...
                var D = {};
                F.r(D), F.d(D, { getBgUrl: () => h, getTextureUrl: () => w });
                var B = {};
                F.r(B),
                    F.d(B, {
                        addModelObserver: () => L,
                ...
                const uu = Object.keys(x).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === x[A]), u), {}),
                    Au = {
                        set: (u, A) => {
                ...
                function au(u, A) {
                    ...
                    if (
                        ...
                        (F = (function (u, A) {
                            if (!u) return;
                            if ('string' == typeof u) return su(u, A);
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const t = 'string' == typeof D ? `${e}.${D}` : e,
                                                            C = eu.view.addModelObserver(t, A, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = au(E.keys()); !(u = F()).done; ) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(e),
                ...
                const pu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    hu = (u, A, F = fu.left) => u.split(A).reduce(F === fu.left ? bu : wu, []),
                    xu = (() => {
                        const u = new RegExp(
                    ...
                    _u = (u, A = fu.left) => {
                        ...
                        return ((u, A = fu.left) => {
                            ...
                            const e =
                                ...
                                E = pu(u);
                            return hu(E, /( )/, A).forEach((u) => (F = F.concat(hu(u, e, fu.left)))), F;
                        })(u, A);
                    },
                    Su = 'FormatText_base_d0',
                    Pu = ({ binding: u, text: A = '', classMix: F, alignment: e = fu.left, formatWithBrackets: E }) => {
                    ...
                    Ou = 'Message_base_24',
                    Ru = 'Message_separator_51',
                    Tu = 'Message_content_ea',
                    zu = 'Message_text_f3',
                    Mu = 'Message_lightWrapper_d3',
                    ju = 'Message_lightWrapper__x2_8f',
                    Nu = 'Message_light_a9',
                    ku = 'Message_points_53',
                    Lu = 'Message_check_01',
                    Vu = R.strings.battle_pass.tooltips.notChosen,
                    Gu = ({ points: u }) => {
                        const A = (() => {
                            const u = (0, t.useState)(eu.view.getScale()),
                                A = u[0],
                                F = u[1];
                            return (
                                (0, t.useEffect)(() => {
                                    ...
                                    C().createElement(Pu, {
                                        ...
                                        binding: {
                                            points: C().createElement(
                                                ...
                                                C().createElement(
                                                    'div',
                                                    { className: i()(Mu, 2 === A && ju) },
                                                    C().createElement('div', { className: Nu }),
                                                ),
                                                C().createElement('div', { className: Lu }, u),
                                            ),
                                        },
                                    }),
                                ),
                    ...
                    Iu = 'Content_base_d5',
                    $u = 'Content_separator_b7',
                    Wu = 'Content_title_59',
                    Hu = 'Content_subtitle_b4',
                    Uu = 'Content_messageWrapper_5e',
                    qu = 'Content_description_cb',
                    Qu = 'Content_separatorWrapper_0e',
                    Zu = R.strings.battle_pass.tooltips.notChosen,
                    Ju = (0, nu.Pi)(() => {
                        const u = vu().model.root.get().points;
                        return C().createElement(
                            'div',
                            { className: Iu },
                            C().createElement('div', { className: Wu }, Zu.title()),
                            C().createElement('div', { className: Hu }, Zu.subTitle()),
                            u > 0
                                ? C().createElement('div', { className: Uu }, C().createElement(Gu, { points: u }))
                                : C().createElement(
                                      'div',
                                      { className: Qu },
                                      C().createElement('div', { className: $u }),
                                  ),
                            C().createElement('div', { className: qu }, Zu.description()),
                        );
                    }),
                    Ku = () => C().createElement(Cu, null, C().createElement(Ju, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(du, null, C().createElement(Ku, null)),
