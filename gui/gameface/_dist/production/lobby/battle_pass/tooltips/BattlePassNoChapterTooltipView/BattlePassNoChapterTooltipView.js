    ...
    var u,
        A = {
            1722: (u, A, F) => {
                ...
                const Du = Object.keys(T).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === T[A]), u), {}),
                    Bu = {
                        set: (u, A) => {
                ...
                const xu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Su = (u, A, F = hu.left) => u.split(A).reduce(F === hu.left ? _u : Pu, []),
                    Ru = (() => {
                        const u = new RegExp(
                    ...
                    ju = 'Message_base_24',
                    ku = 'Message_separator_51',
                    Nu = 'Message_content_ea',
                    Lu = 'Message_text_f3',
                    Vu = 'Message_lightWrapper_d3',
                    Gu = 'Message_lightWrapper__x2_8f',
                    $u = 'Message_light_a9',
                    Iu = 'Message_points_53',
                    Wu = 'Message_check_01',
                    Hu = R.strings.battle_pass.tooltips.notChosen,
                    Uu = ({ points: u }) => {
                        const A = (() => {
                            const u = (0, t.useState)(Cu.view.getScale()),
                                A = u[0],
                                F = u[1];
                            return (
                                (0, t.useEffect)(() => {
                        ...
                        return C().createElement(
                            'div',
                            { className: ju },
                            C().createElement('div', { className: ku }),
                            C().createElement(
                                'div',
                                { className: Nu },
                                C().createElement(
                                    ...
                                    C().createElement(Mu, {
                                        ...
                                        binding: {
                                            points: C().createElement(
                                                ...
                                                C().createElement(
                                                    'div',
                                                    { className: i()(Vu, 2 === A && Gu) },
                                                    C().createElement('div', { className: $u }),
                                                ),
                                                C().createElement('div', { className: Wu }, u),
                                            ),
                                        },
                                    }),
                                ),
                    ...
                    qu = 'Content_base_d5',
                    Qu = 'Content_separator_b7',
                    Zu = 'Content_title_59',
                    Ju = 'Content_subtitle_b4',
                    Ku = 'Content_messageWrapper_5e',
                    Xu = 'Content_description_cb',
                    Yu = 'Content_separatorWrapper_0e',
                    uA = R.strings.battle_pass.tooltips.notChosen,
                    AA = (0, su.Pi)(() => {
                        const u = bu().model.root.get().points;
                        return C().createElement(
                            'div',
                            { className: qu },
                            C().createElement('div', { className: Zu }, uA.title()),
                            C().createElement('div', { className: Ju }, uA.subTitle()),
                            u > 0
                                ? C().createElement('div', { className: Ku }, C().createElement(Uu, { points: u }))
                                : C().createElement(
                                      'div',
                                      { className: Yu },
                                      C().createElement('div', { className: Qu }),
                                  ),
                            C().createElement('div', { className: Xu }, uA.description()),
                        );
                    }),
                    FA = () => C().createElement(au, null, C().createElement(AA, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(pu, null, C().createElement(FA, null)),
