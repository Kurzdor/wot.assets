        ...
        A = {
            1722: (u, A, F) => {
                ...
                const _u = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Lu = 'Message_content_ea',
                    Vu = 'Message_text_f3',
                    Gu = 'Message_lightWrapper_d3',
                    $u = 'Message_lightWrapper__x2_8f',
                    Iu = 'Message_light_a9',
                    Wu = 'Message_points_53',
                    Hu = 'Message_check_01',
                    Uu = R.strings.battle_pass.tooltips.notChosen,
                    qu = ({ points: u }) => {
                        const A = (() => {
                            const u = (0, t.useState)(nu.view.getScale()),
                                A = u[0],
                                F = u[1];
                            return (
                                (0, t.useEffect)(() => {
                                    ...
                                    C().createElement(ju, {
                                        ...
                                        binding: {
                                            points: C().createElement(
                                                ...
                                                C().createElement(
                                                    'div',
                                                    { className: i()(Gu, 2 === A && $u) },
                                                    C().createElement('div', { className: Iu }),
                                                ),
                                                C().createElement('div', { className: Hu }, u),
                                            ),
                                        },
                                    }),
                                ),
                    ...
                    Qu = 'Content_base_d5',
                    Zu = 'Content_separator_b7',
                    Ju = 'Content_title_59',
                    Ku = 'Content_subtitle_b4',
                    Xu = 'Content_messageWrapper_5e',
                    Yu = 'Content_description_cb',
                    uA = 'Content_separatorWrapper_0e',
                    AA = R.strings.battle_pass.tooltips.notChosen,
                    FA = (0, lu.Pi)(() => {
                        const u = wu().model.root.get().points;
                        return C().createElement(
                            'div',
                            { className: Qu },
                            C().createElement('div', { className: Ju }, AA.title()),
                            C().createElement('div', { className: Ku }, AA.subTitle()),
                            u > 0
                                ? C().createElement('div', { className: Xu }, C().createElement(qu, { points: u }))
                                : C().createElement(
                                      'div',
                                      { className: uA },
                                      C().createElement('div', { className: Zu }),
                                  ),
                            C().createElement('div', { className: Yu }, AA.description()),
                        );
                    }),
                    eA = () => C().createElement(su, null, C().createElement(FA, null));
                engine.whenReady.then(() => {
                    r().render(
                        C().createElement(bu, null, C().createElement(eA, null)),
