        ...
        e = {
            ...
            1676: (u, e, t) => {
                ...
                const eu = J.client.getSize('rem'),
                    tu = eu.width,
                    Au = eu.height,
                    ru = Object.assign({ width: tu, height: Au }, uu(tu, Au, K)),
                    Fu = (0, a.createContext)(ru),
                    Eu = ['children'];
                const au = (u) => {
                    let e = u.children,
                        t = (function (u, e) {
                    ...
                    const A = (0, a.useContext)(Fu),
                        ...
                        x = { extraLarge: d, large: m, medium: c, small: g, extraSmall: h };
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && l) return i(e, t, x);
                        if (t.largeWidth && B) return i(e, t, x);
                        if (t.mediumWidth && o) return i(e, t, x);
                        if (t.smallWidth && C) return i(e, t, x);
                        if (t.extraSmallWidth && s) return i(e, t, x);
                        if (
                        ...
                        const e = (0, a.useContext)(Fu),
                            ...
                            F = (0, a.useCallback)((u, e) => {
                                const t = J.view.pxToRem(u),
                                    A = J.view.pxToRem(e);
                                r(Object.assign({ width: t, height: A }, uu(t, A, K)));
                            }, []);
                        nu(() => {
                            engine.on('clientResized', F);
                        }),
                            (0, a.useEffect)(() => () => engine.off('clientResized', F), [F]);
                        const E = (0, a.useMemo)(() => Object.assign({}, A), [A]);
                        return n().createElement(Fu.Provider, { value: E }, u);
                    });
                var Du = t(6483),
                    lu = t.n(Du),
                    Bu = t(926),
                ...
                const hu = {
                    ...
                    vu = (u) => {
                        ...
                        const r = mu(),
                            ...
                            E = r.mediaHeight,
                            a = r.mediaSize;
                        return n().createElement('div', gu({ className: lu()(t, hu[F], xu[E], fu[a]) }, A), e);
                    },
                    wu = ['children'];
                const Lu = (u) => {
                    let e = u.children,
                    ...
                    return n().createElement(iu, null, n().createElement(vu, t, e));
                };
                var Su = t(493),
                    bu = t.n(Su);
                let pu;
                                                ...
                                                return {
                                                    subscribe: (t, F) => {
                                                        const a = 'string' == typeof F ? `${A}.${F}` : A,
                                                            n = J.view.addModelObserver(a, e, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = Ru(r.keys()); !(u = t()).done; ) F(u.value, e);
                                                    },
                                                    unsubscribe: F,
                                                };
                                            })(A),
                ...
                const Nu = (u, e, t = '') => {
                    ...
                    Uu = (u) => ({
                        backgroundImage: `url(${Nu(R.images.gui.maps.icons.battlePass.chapter_choice.commander, u)})`,
                    }),
                    Vu = (u) => ({
                        backgroundImage: `url(${Nu(R.images.gui.maps.icons.battlePass.chapter_choice.tank, u)})`,
                    }),
                    Xu = 'Illustration_base_e1',
                    qu = 'Illustration_chapter_6b',
                    Qu = 'Illustration_tank_f9',
                    Zu = ({ chapterID: u }) =>
                        n().createElement(
                            'div',
                            { className: Xu },
                            n().createElement(
                                'div',
                                { className: qu, style: Uu(u) },
                                n().createElement('div', { className: Qu, style: Vu(u) }),
                            ),
                        ),
                    Ju = 'App_base_92',
                    Ku = 'App_title_95',
                    Yu = 'App_subTitle_5f',
                    ue = R.strings.battle_pass.chapterChoice.confirmation;
                let ee;
                !(function (u) {
                    (u.Switch = 'switch'), (u.Select = 'select');
                })(ee || (ee = {}));
                const te = (u) => R.strings.battle_pass.chapter.fullName.quoted.$num(u),
                    Ae = (0, yu.Pi)(() => {
                        const u = Pu().model.root.get(),
                            e = u.prevChapter,
                            t = u.nextChapter,
                            A = 0 !== e ? ee.Switch : ee.Select;
                        return n().createElement(
                            'div',
                            { className: Ju },
                            n().createElement(Zu, { chapterID: t }),
                            n().createElement(
                                'div',
                                { className: Ku },
                                ((u, e) => {
                                    const t = e ? te(e) : '';
                                    return Hu(ue.title.$dyn(u), { chName: t });
                                })(A, t),
                            ),
                            n().createElement(
                                'div',
                                ...
                                ((u, e) => {
                                    const t = e ? te(e) : '';
                                    return Hu(ue.description.$dyn(u), { chName: t });
                                })(A, e),
                            ),
                        );
                    });
