(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => s, off: () => A, on: () => i, onResize: () => n, onScaleUpdated: () => E });
                var a = t(2472),
                    r = t(1176);
            ...
            2076: (u, e, t) => {
                ...
                const L = {
                    ...
                    M = (u) => {
                        ...
                        const n = w(),
                            ...
                            i = n.mediaHeight,
                            A = n.mediaSize;
                        return r().createElement('div', y({ className: h()(t, L[E], S[i], T[A]) }, a), e);
                    },
                    k = ['children'];
                const O = (u) => {
                    let e = u.children,
                    ...
                    return r().createElement(_, null, r().createElement(M, t, e));
                };
                var H = t(493),
                    N = t.n(H);
                function P(u) {
                    ...
                    eu = (u, e = z.left) => {
                        ...
                        return ((u, e = z.left) => {
                            ...
                            const a =
                                ...
                                r = Y(u);
                            return Q(r, /( )/, e).forEach((u) => (t = t.concat(Q(u, a, z.left)))), t;
                        })(u, e);
                    },
                    tu = 'FormatText_base_d0',
                    au = ({ binding: u, text: e = '', classMix: t, alignment: n = z.left, formatWithBrackets: E }) => {
                ...
                class iu extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()(ru.base, ru[`base__${E}`], ru[`base__${n}`], null == i ? void 0 : i.base),
                            B = h()(ru.icon, ru[`icon__${E}`], ru[`icon__${n}`], null == i ? void 0 : i.icon),
                            c = h()(ru.glow, null == i ? void 0 : i.glow),
                            C = h()(ru.caption, ru[`caption__${E}`], null == i ? void 0 : i.caption),
                            d = h()(ru.goto, null == i ? void 0 : i.goto);
                        return r().createElement(
                            'div',
                            Eu(
                                {
                            ...
                            'info' !== E && r().createElement('div', { className: ru.shine }),
                ...
                function su(u = Au.n.NONE, e = Fu, t = !1, r = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== Au.n.NONE)
                            return (
                ...
                const hu = ({
                    ...
                    return r().createElement(
                        'div',
                        { className: h()(du.base, du[`base__size${K(i)}`], du[`base__type${K(A)}`], F) },
                        r().createElement('div', { className: h()(du.level, null == s ? void 0 : s.level) }, cu(n)),
                        r().createElement('div', {
                            className: h()(
                                du.type,
                                u && du[`type__elite${K(i)}`],
                                du[`type__${i}`],
                                null == s ? void 0 : s.typeIcon,
                            ),
                            style: { backgroundImage: `url(${B})` },
                        }),
                        Cu(E, 'premiumIGR') && r().createElement('div', { className: du.premiumIGR }),
                        r().createElement('div', { className: h()(du.name, null == s ? void 0 : s.name) }, o ? t : e),
                    );
                };
                function gu() {
                    return !1;
                ...
                const wu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: i, children: A, mocks: F }) {
                                const s = (0, a.useRef)([]),
                                    o = (t, a, r) => {
                                        ...
                                        const i = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = pu(r.keys()); !(u = t()).done; ) n(u.value, e);
                                                    },
                                                    unsubscribe: n,
                                                };
                                            })(a),
                                    ...
                                    B = l[0],
                                    c = l[1],
                                    C = (0, a.useState)(() => o(n, i, F)),
                                    d = C[0],
                                    _ = C[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        D.current ? _(o(B, i, F)) : (D.current = !0);
                                    }, [F, B, i]),
                                    (0, a.useEffect)(() => {
                                        c(n);
                                    }, [n]),
                    ...
                    $u = ({ title: u, name: e, description: t }) =>
                        r().createElement(
                            'div',
                            { className: Wu },
                            r().createElement('div', { className: Iu }, u),
                ...
                const zu = R.strings.battle_pass.extraIntroView,
                    Vu = (0, ou.Pi)(() => {
                        ...
                        const C = { vehicleName: r().createElement(hu, ju({}, E, { type: mu.white })) },
                            d = q(zu.premium3dStyleVechicle(), { styleName: n }),
                            _ = q(zu.premiumProgressionDescription(), { vehicleName: E.vehicleName, styleName: n });
                        return r().createElement(
                            'div',
                            { className: h()(Lu, A && Su) },
                            r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(Pu, {
                                    title: zu.title(),
                                    description: r().createElement(au, { text: zu.titleDescription(), binding: C }),
                                }),
                            ),
                            r().createElement(
                                'div',
                                ...
                                r().createElement($u, { title: zu.premiumProgression(), name: d, description: _ }),
                            ),
                            r().createElement(
                                $,
                                {
                ...
                engine.whenReady.then(() => {
                    N().render(
                        r().createElement(xu, null, r().createElement(O, null, r().createElement(Vu, null))),
