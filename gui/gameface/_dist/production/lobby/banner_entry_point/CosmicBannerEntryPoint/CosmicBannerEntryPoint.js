(() => {
            ...
            529: (u, e, t) => {
                ...
                const U = (0, n.memo)(function (u) {
                        ...
                        return (
                            ...
                            r().createElement('canvas', N({}, g, { width: e, height: t, ref: w }))
                        );
                    }),
                    G = (u, e) => {
                        let t = u;
                    ...
                    return (
                        B(() => {
                            if (
                                ...
                                F.current = Q.addCallback(n, t, o, e === J.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== J.None)
                ...
                const tu = {
                    ...
                    nu = {
                        ...
                        base__single: 'App_base__single_c4',
                        ...
                        base__endSoon: 'App_base__endSoon_31',
                        seasonDateText: 'App_seasonDateText_b3',
                        performanceIcon: 'App_performanceIcon_7c',
                        banner__mediumRisk: 'App_banner__mediumRisk_a0',
                        banner__highRisk: 'App_banner__highRisk_34',
                        new: 'App_new_a3',
                    };
                let ru, au;
                function iu(u, e) {
                        ...
                        if (u === j.Active)
                            return ((u, e) => {
                                const t = ((u) => {
                                    ...
                                    n = t.day,
                                    r = t.month;
                                return iu(u, { day: n, month: R.strings.menu.dateTime.months.$num(r + 1) });
                            })(R.strings.cosmicEvent.banner.eventLasts(), t);
                        if (u === j.EndSoon) {
                            ...
                            return iu(u, { day: i, hour: r, min: a });
                        }
                        return '';
                    },
                    su = [
                ...
                const lu = (u, e, t = {}, n = 0) => {
                    ...
                    Au = (u) => {
                        ...
                        const w = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            v = (0, n.useMemo)(() => _ || q().resId, [_]),
                            p = (0, n.useCallback)(() => {
                                (w.current.isVisible && w.current.timeoutId) ||
                                    (lu(t, d, { isMouseEvent: !0, on: !0, arguments: Eu(r) }, v),
                                    C && C(),
                ...
                const Du = (u) => {
                    ...
                    return r().createElement(
                        'div',
                        du({ className: c }, E),
                        r().createElement('div', { className: Fu.bg }),
                        r().createElement('div', { className: Fu.pattern }),
                        r().createElement(
                            'div',
                            { className: h()(Fu.value, A && Fu.value__text) },
                            F ? o : l,
                            F && r().createElement('span', { className: Fu.plus }, '+'),
                        ),
                    );
                };
                function mu() {
                ...
                const Bu = {
                        [j.Disabled]: nu.base__disabled,
                        [j.Active]: nu.base__active,
                        [j.EndSoon]: nu.base__endSoon,
                    },
                    _u = {
                        width: 280,
                        height: 170,
                        ...
                        const u = uu(),
                            ...
                            l = (function (u = {}, e = []) {
                                ...
                                const o = (0, n.useState)(null != (t = u.state) ? t : P),
                                    s = o[0],
                                    E = o[1],
                                    l = (0, n.useState)(null != (r = u.initialFrameIndex) ? r : 0),
                                    A = l[0],
                                    F = l[1],
                                    c = (0, n.useState)(null != (a = u.frameTime) ? a : 33),
                                    d = c[0],
                                    D = c[1],
                                    m = (0, n.useState)(null == (i = u.loop) || i),
                                    B = m[0],
                                    _ = m[1],
                                    C = (0, n.useRef)(A),
                                    h = (0, n.useCallback)((u) => {
                            ...
                            A = b().mediaSize,
                            F = !t && A <= v.Medium ? au.Small : au.Big;
                        return r().createElement(
                            Au,
                            { contentId: R.views.cosmic_event.lobby.tooltips.EventBannerTooltip('resId') },
                            r().createElement(
                                'div',
                                null,
                                r().createElement(
                                    'div',
                                    {
                                        className: h()(nu.base, Bu[i], t && nu.base__single, nu[`banner__${a}`]),
                                        onClick: () => {
                                            eu(R.sounds.yes()), E();
                                        },
                                        onMouseEnter: () => {
                                            tu.playHighlight(), l.play();
                                        },
                                        onMouseLeave: () => {
                                            l.stop();
                                        },
                                    ...
                                    i === j.Disabled && r().createElement('div', { className: nu.overlay }),
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { className: nu.title },
                                            R.strings.cosmicEvent.banner.title(),
                                        ),
                                        j.Disabled === i &&
                                            r().createElement(
                                                'div',
                                                ...
                                                ((u, e) =>
                                                    u === j.Disabled
                                                        ...
                                                        : (console.error(
                                                              `Unreachable code for state '${u}' in Cosmic Banner.`,
                                                          ),
                                                          ''))(i, F),
                                            ),
                                        r().createElement(
                                            ...
                                            r().createElement('div', { className: nu.seasonDateText }, ou(i, o, s)),
                                        ),
                                    ),
                                    r().createElement(
                                        'div',
                                        ...
                                        e &&
                                            r().createElement(Du, {
                                                size: 'small',
                                                value: R.strings.cosmicEvent.banner.new(),
                                            }),
                                    ),
                                    a !== z.LowRisk &&
                                        !e &&
                                        r().createElement('div', { className: nu.performanceIcon }),
                                ),
                            ),
                        );
                    };
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [503], () => __webpack_require__(529));
