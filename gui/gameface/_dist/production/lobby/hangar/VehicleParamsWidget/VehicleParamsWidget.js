    ...
    var __webpack_modules__ = {
            ...
            911: (e, u, t) => {
                ...
                const g = {
                    ...
                    I = (0, s.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = L, onDrag: n = P }) => {
                                ...
                                (t.style.transform = `translateX(${0 | l}px)`),
                                    ((e) => {
                                        if (o.current && d.current && D.current && _.current) {
                                            if (0 === e)
                                                return o.current.classList.add(N), void d.current.classList.remove(N);
                                            if (
                                                ((u = D.current),
                                                (t = _.current),
                                                e - (u.offsetWidth - t.offsetWidth) >= -0.5)
                                            )
                                                return o.current.classList.remove(N), void d.current.classList.add(N);
                                            var u, t;
                                            o.current.classList.remove(N), d.current.classList.remove(N);
                                        }
                                    })(l);
                            },
                            R = A(() => {
                        ...
                        const V = (e) => {
                            e.target.classList.contains(N) || B('highlight');
                        };
                        return l().createElement(
                            ...
                            l().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(N) || 0 !== e.button || (B('play'), z(p.Next));
                                },
                                onMouseUp: W,
                                ref: o,
                                onMouseEnter: V,
                            ...
                            l().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(N) || 0 !== e.button || (B('play'), z(p.Prev));
                                },
                                onMouseUp: W,
                                ref: d,
                                onMouseEnter: V,
                ...
                const Pe = { [Le.NBSP]: Ne.NoBreakSymbol, [Le.ZWNBSP]: Ne.NoBreakSymbol, [Le.NEW_LINE]: Ne.LineBreak },
                    ...
                    Ge = {
                        ...
                        [Ne.LineBreak]: ({ key: e }) =>
                            l().createElement('span', { key: e, 'data-block-type': Ne.LineBreak, className: ze }),
                        [Ne.NewLine]: ({ elementList: e, key: u }) =>
                            l().createElement('span', { key: u, 'data-block-type': Ne.NewLine, className: We }, e),
                        [Ne.NoBreakWrapper]: ({ elementList: e, key: u }) =>
                            l().createElement(
                                'span',
                                { key: u, 'data-block-type': Ne.NoBreakWrapper, className: Ie },
                                e,
                            ),
                    },
                    Ue = (e, u, t) => {
                    ...
                    $e = (e, u = '') => {
                        ...
                        return (
                            Ke(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (e) => {
                                    t.push({ blockType: Ne.Word, colorTag: u, childList: Ye(e) });
                                },
                                (e) => {
                                    const n = e[0],
                                        r = Pe[n.charAt(0)];
                            ...
                            Ke(
                                ...
                                (e) => {
                                    ...
                                    'string' == typeof o || 'number' == typeof o
                                        ? n.push(...$e(String(o), t))
                                        : n.push({ blockType: Ne.Binding, colorTag: t, childList: [o] });
                                },
                            ),
                            n
                        );
                ...
                const iu = {
                    ...
                    su = l().memo(function ({ buffIconType: e, className: u }) {
                        return e === au.none
                            ? null
                            : l().createElement('div', { className: a()(iu.base, iu[`base__${au[e]}`], u) });
                    }),
                    lu = 'Delta_base_3e',
                    cu = 'Delta_base__positive_82',
                    Eu = 'Delta_base__negative_86',
                    du = l().memo(function ({ isPositive: e, width: u, isUseAnim: t }) {
                        ...
                        return l().createElement(
                            l().Fragment,
                            null,
                            l().createElement(f.animated.div, { className: a()(lu, Eu), style: n }),
                            l().createElement(f.animated.div, { className: a()(lu, cu), style: r }),
                        );
                    }),
                    Au = 'Indicator_base_b9',
                    Fu = 'Indicator_progress_ce',
                    Bu = 'Indicator_progressMarker_b4',
                    Du = 'Indicator_indicator_bc',
                    _u = 'Indicator_indicator__start_80',
                    mu = 'Indicator_indicator__end_3b',
                    Cu = 'Indicator_marker_f7',
                    fu = 'Indicator_valueLine_1d',
                    pu = 300,
                    gu = l().memo(function ({
                        minValue: e,
                        maxValue: u,
                        ...
                        const i = n === e ? 2 : (n / u) * 254,
                            ...
                            c = (r / u) * 254,
                            E = r > 0,
                            d = { config: { duration: pu }, immediate: !o },
                            A = (0, f.useSpring)(Object.assign({ from: { left: 2 }, to: { left: i }, delay: pu }, d)),
                            F = (0, f.useSpring)(Object.assign({ from: { width: e }, to: { width: s }, delay: pu }, d));
                        return l().createElement(
                            'div',
                            { className: Au },
                            l().createElement(
                                'div',
                                { className: Fu },
                                l().createElement('div', { className: a()(Du, _u) }),
                                l().createElement(f.animated.div, { className: fu, style: F }),
                                l().createElement(
                                    'div',
                                    { className: Bu },
                                    l().createElement(
                                        f.animated.div,
                                        { className: Cu, style: A },
                                        l().createElement(du, { isPositive: E, width: c, isUseAnim: o }),
                                    ),
                                ),
                                l().createElement('div', { className: a()(Du, mu) }),
                            ),
                        );
                    });
                let hu;
                ...
                const vu = {
                    ...
                    bu = l().memo(function ({
                        ...
                        return l().createElement(
                            ...
                            l().createElement(
                                'div',
                                { className: vu.base },
                                l().createElement(ru, { justifyContent: xe.FlexEnd, classMix: vu.value, text: u }),
                                l().createElement('div', {
                                    className: vu.icon,
                    ...
                    yu = 'Group_group_07',
                    ku = 'Group_hoverBg_97',
                    Tu = 'Group_hoverBg__scrollable_2a',
                    Ou = 'Group_groupHeader_f5',
                    Su = 'Group_name_21',
                    Nu = 'Group_arrow_96',
                    xu = 'Group_arrow__opened_47',
                    Lu = 'Group_params_88',
                    Pu = 'Group_params__opened_9a',
                    Mu = 'Group_separator_b5',
                    Ru = 'Group_right_13',
                    Iu = 'Group_buff_fa',
                    zu = 'Group_value_00',
                            ...
                            return l().createElement(
                                ...
                                l().createElement(
                                    ...
                                    l().createElement(
                                        ...
                                        l().createElement('div', { className: a()(ku, d && Tu) }),
                                        l().createElement(
                                            'div',
                                            { className: Ou },
                                            l().createElement('div', { className: a()(Nu, u && xu) }),
                                            l().createElement(
                                                'div',
                                                { className: Su },
                                            ...
                                            l().createElement(
                                                'div',
                                                { className: Ru },
                                                l().createElement(su, { buffIconType: c, className: Iu }),
                                                s && l().createElement(ru, { classMix: a()(zu, Wu), text: s }),
                                                l().createElement(ru, { classMix: zu, text: i }),
                                            ),
                                        ),
                                        l().createElement(gu, o),
                                    ),
                                ),
                                l().createElement(
                                    'div',
                                    { className: a()(Lu, u && Pu) },
                                    ie(t, (e) => l().createElement(bu, Vu({ key: e.id }, e))),
                                    F && l().createElement('div', { className: Mu }),
                                    ie(n, (e) => l().createElement(bu, Vu({ key: e.id }, e))),
                                ),
                            );
                        },
                    ),
                ...
                const Uu = {
                    ...
                    qu = (0, se.Pi)(({ showBackground: e = !0, className: u }) => {
                        const t = (0, ou.tT)().model,
                            n = (0, s.useState)(!1),
                            r = n[0],
                            o = n[1],
                            i = t.groups.get(),
                        ...
                        return (
                            ...
                            l().createElement(
                                'div',
                                { className: a()(Hu.base, e && Hu.base__bg, u) },
                                l().createElement(
                                    ae.Vertical.Area.Default,
                                    {
                                        api: c,
                                        barClassNames: { base: Hu.barBase },
                                        scrollClassName: Hu.scroll,
                                        scrollClassNames: { content: Hu.content },
                                    },
                                    l().createElement(
                                        'div',
                                        { className: Hu.groups },
                                        ie(i, (e) => l().createElement(ju, Gu({ key: e.id }, e, { isScrollable: r }))),
                                    ),
                                ),
                            )
                        );
