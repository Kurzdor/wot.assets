    ...
    var __webpack_modules__ = {
            768: (e, u, t) => {
                ...
                const f = {
                    ...
                    C = Object.keys(p).reduce((e, u) => ((e[u] = () => _(p[u])), e), {}),
                    g = { play: Object.assign({}, C, { sound: _ }), setRTPC: B };
                function h(e, u, t = 1) {
            ...
            322: (e, u, t) => {
                ...
                const g = {
                    ...
                    I = (0, s.memo)(
                        ({ api: e, classNames: u = {}, getStepByRailClick: t = N, onDrag: n = L, onClick: r = L }) => {
                            const o = (0, s.useRef)(null),
                                ...
                                R = () => {
                                    ...
                                    const o = e.animationScroll.scrollPosition.get(),
                                        a = Math.min(1, n / r),
                                        i = c(0, 1, o / (r - n)),
                                        s = (u.offsetWidth - M(u, a)) * i;
                                    (t.style.transform = `translateX(${0 | s}px)`),
                                        ((e) => {
                                            if (d.current && B.current && D.current && m.current) {
                                                if (0 === e)
                                                    return (
                                                        d.current.classList.add(O), void B.current.classList.remove(O)
                                                    );
                                                if (
                                                    ((u = D.current),
                                                    (t = m.current),
                                                    ...
                                                    return (
                                                        d.current.classList.remove(O), void B.current.classList.add(O)
                                                    );
                                                var u, t;
                                                d.current.classList.remove(O), B.current.classList.remove(O);
                                            }
                                        })(s);
                                },
                                I = A(() => {
                                    (() => {
                                        ...
                                        (u.style.width = `${M(t, a)}px`),
                                            ...
                                            o.current &&
                                                (1 === a ? o.current.classList.add(w) : o.current.classList.remove(w));
                                    })(),
                                        R();
                                });
                            (0, s.useEffect)(() => i(I)),
                            ...
                            return l().createElement(
                                'div',
                                { className: a()(b, u.base), ref: o, onWheel: e.handleMouseWheel },
                                l().createElement('div', {
                                ...
                                l().createElement(
                                    ...
                                    l().createElement('div', { ref: m, className: a()(x, u.thumb) }),
                    ...
                    te = (0, s.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = J, onDrag: n = X }) => {
                        ...
                        return l().createElement(
                            ...
                            l().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Z) || 0 !== e.button || (_('play'), k(C.Next));
                                },
                                ref: o,
                                onMouseEnter: x,
                            }),
                            ...
                            l().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Z) || 0 !== e.button || (_('play'), k(C.Prev));
                                },
                                onMouseUp: T,
                                ref: d,
                                onMouseEnter: x,
