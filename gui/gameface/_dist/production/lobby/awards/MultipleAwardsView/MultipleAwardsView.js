                ...
                const Y = {
                    ...
                    q = () => {
                        const e = W('model'),
                            ...
                            a = e.mainItemsCount,
                            r = M(['base'], Y),
                            i = p()(r.base, a && Y.base__additional),
                            s = p()(Y.light, u && Y.light__gold),
                            o = p()(Y.ribbon, u && Y.ribbon__gold);
                        return n().createElement(
                            'div',
                            { className: i },
                            t &&
                ...
                const uu = ({ showAdditionalInfo: e, reward: u, size: t }) => {
                    ...
                    su = ({ reward: e, size: u, onImageError: t }) => {
                        const r = e.name,
                            ...
                            b = (0, a.useMemo)(() => {
                                if (B && s && !F) {
                                    return (g ? nu.shop.vehicles.c_180x135 : nu.shop.vehicles.c_600x450).$dyn(s);
                                }
                                if ('battleToken' === r) {
                        ...
                        const T = { isRentVehicle: h, isMinSize: F, isPremiumPlus: C, isVehicle: B };
                        return n().createElement(
                            'div',
