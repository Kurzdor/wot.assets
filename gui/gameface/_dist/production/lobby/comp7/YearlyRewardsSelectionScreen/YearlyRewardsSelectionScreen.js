(() => {
    var __webpack_modules__ = {
            ...
            8749: (e, u, t) => {
                ...
                var n = {};
                t.r(n), t.d(n, { Area: () => vu, Bar: () => pu, Default: () => fu, useVerticalScrollApi: () => su });
                var a = t(6179),
                    o = t.n(a);
                const s = (e, u, t) =>
                ...
                const D = (e) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.smallWidth && m) return s(u, t, f);
                ...
                const L = {
                    ...
                    P = (e) => {
                        ...
                        const n = y(),
                            ...
                            s = n.mediaHeight,
                            i = n.mediaSize;
                        return o().createElement('div', T({ className: h()(t, L[a], M[s], k[i]) }, r), u);
                    },
                    O = ['children'];
                const N = (e) => {
                    let u = e.children,
                ...
                const K = ((e, u) => {
                        ...
                        return [
                            function ({ mode: r = 'real', options: n, children: s, mocks: l }) {
                                ...
                                return (
                                    (0, a.useEffect)(() => {
                                        E.current ? D(d(m, n, l)) : (E.current = !0);
                                    }, [l, m, n]),
                                    (0, a.useEffect)(() => {
                                        A(r);
                                    }, [r]),
                ...
                class re extends o().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            _ = h()(ee.base, ee[`base__${a}`], ee[`base__${n}`], null == s ? void 0 : s.base),
                            m = h()(ee.icon, ee[`icon__${a}`], ee[`icon__${n}`], null == s ? void 0 : s.icon),
                            A = h()(ee.glow, null == s ? void 0 : s.glow),
                            F = h()(ee.caption, ee[`caption__${a}`], null == s ? void 0 : s.caption),
                            g = h()(ee.goto, null == s ? void 0 : s.goto);
                ...
                function se(e = ne.n.NONE, u = oe, t = !1, r = !1) {
                    (0, a.useEffect)(() => {
                        if (e !== ne.n.NONE)
                            return (
                        ...
                        const h = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, a.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Be(t, m, { isMouseEvent: !0, on: !0, arguments: De(r) }, f),
                                    B && B(),
                ...
                const we = (e) => e.replace(/&nbsp;/g, ' '),
                    ...
                    Te = R.strings.selectable_reward.tabs,
                    Re = (0, ie.Pi)(({ index: e }) => {
                        const u = y().mediaSize,
                            t = Q(),
                            r = t.model,
                        ...
                        return o().createElement(
                            'div',
                            {
                                className: h()(
                                    xe.base,
                                    i && xe.base__completed,
                                    l ? xe.base__selected : s.count && xe[`base__${a}`],
                                ),
                                onClick: () => {
                                    J('bp_click'), n.openTab(s.type);
                                },
                                onMouseEnter: () => J('bp_highlight'),
                            },
                            o().createElement('div', { className: h()(xe.glow, l && xe.glow__show) }),
                            o().createElement(
                                'div',
                                { className: xe.title },
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    o().createElement('div', {
                                        className: xe.image,
                                        style: { backgroundImage: `url(${Se(s.type, c)})` },
                                    }),
                                    o().createElement('div', { className: xe.check }),
                                ),
                            ),
                            o().createElement(
                                'div',
                                { className: xe.counter },
                                be(Te.counter(), { count: s.count, limit: s.limit }),
                            ),
                        );
                        var d;
                    }),
                ...
                const Ge = {
                            ...
                            const c = l.settings,
                                ...
                                m = (() => {
                                    const e = (0, a.useMemo)(() => ({}), []),
                                        ...
                                        n = (e, ...t) => {
                                            for (var r, n = Ne(u(e).values()); !(r = n()).done; ) (0, r.value)(...t);
                                        };
                    ...
                    ru = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = eu, onDrag: r = uu }) => {
                        ...
                        const f = (e) => {
                            e.target.classList.contains(Qe) || J('highlight');
                        };
                        return o().createElement(
                            'div',
                            { className: h()(je, u.base), ref: n, onWheel: e.handleMouseWheel },
                            o().createElement('div', {
                                className: h()(qe, u.leftButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Qe) || 0 !== e.button || (J('play'), C(Ue.Next));
                                },
                                onMouseUp: p,
                                ref: s,
                                onMouseEnter: f,
                                    ...
                                    onMouseDown: (u) => {
                                        ...
                                        if (r && 0 === u.button)
                                            if ((J('play'), u.target === r))
                                                ...
                                                })(u.screenX > r.getBoundingClientRect().x ? Ue.Prev : Ue.Next);
                                            }
                                    },
                                    ref: c,
                                    onMouseEnter: f,
                                },
                                o().createElement('div', { ref: d, className: h()(Ke, u.thumb) }),
                                o().createElement('div', { className: h()(Ze, u.rail) }),
                            ),
                            o().createElement('div', {
                                className: h()(Ye, u.rightButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Qe) || 0 !== e.button || (J('play'), C(Ue.Prev));
                                },
                                onMouseUp: p,
                                ref: l,
                                onMouseEnter: f,
                    ...
                    au = ({
                        ...
                        const d = (0, a.useMemo)(() => {
                                const e = r || {};
                                return Object.assign({}, e, { base: h()(nu.base, e.base) });
                            }, [r]),
                            E = (0, a.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
                        return o().createElement(
                            'div',
                            { className: h()(nu.defaultScroll, t), onWheel: u.handleMouseWheel },
                            o().createElement(
                                'div',
                                { className: h()(nu.defaultScrollArea, n) },
                                o().createElement(ou, { className: i, api: E, classNames: s }, e),
                            ),
                            o().createElement(ru, { getStepByRailClick: l, api: u, onDrag: c, classNames: d }),
                        );
                    },
                    ou = ({ api: e, className: u, classNames: t, children: r }) => (
                        (0, a.useEffect)(() => Le(e.recalculateContent)),
                        o().createElement(
                            'div',
                            { className: h()(nu.base, u) },
                            o().createElement(
                                'div',
                                {
                                    className: h()(nu.wrapper, null == t ? void 0 : t.wrapper),
                                    onWheel: e.handleMouseWheel,
                                    ref: e.wrapperRef,
                                },
                                o().createElement(
                                    'div',
                                    { className: h()(nu.content, null == t ? void 0 : t.content), ref: e.contentRef },
                                    r,
                                ),
                            ),
                        )
                    );
                (ou.Bar = ru), (ou.Default = au);
                const su = ze({
                    ...
                    pu = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Du, onDrag: r = Fu }) => {
                        const n = (0, a.useRef)(null),
                            s = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                            c = (0, a.useRef)(null),
                            ...
                            D = Pe(() => {
                                ...
                                const a = e.animationScroll.scrollPosition.get(),
                                    o = Math.min(1, r / n),
                                    i = Me(0, 1, a / (n - r)),
                                    E = (u.offsetHeight - Cu(u, o)) * i;
                                (t.style.transform = `translateY(${0 | E}px)`),
                                    ((e) => {
                                        if (s.current && l.current && c.current && d.current) {
                                            if (0 === Math.round(e))
                                                return s.current.classList.add(Au), void l.current.classList.remove(Au);
                                            if (
                                                ((u = c.current),
                                                (t = d.current),
                                                e - (u.offsetHeight - t.offsetHeight) >= -0.5)
                                            )
                                                return s.current.classList.remove(Au), void l.current.classList.add(Au);
                                            var u, t;
                                            s.current.classList.remove(Au), l.current.classList.remove(Au);
                                        }
                                    })(E);
                            }),
                            B = Pe(() => {
                        ...
                        const C = Oe((u) => e.applyStepTo(u), E, [e]),
                            p = C[0],
                            f = C[1];
                        (0, a.useEffect)(
                            () => (
                        ...
                        const v = (e) => {
                            e.target.classList.contains(Au) || J('highlight');
                        };
                        return o().createElement(
                            'div',
                            { className: h()(iu, u.base), ref: n, onWheel: e.handleMouseWheel },
                            o().createElement('div', {
                                className: h()(cu, u.topButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Au) || 0 !== e.button || (J('play'), p(Ue.Next));
                                },
                                ref: s,
                                onMouseEnter: v,
                            }),
                                    ...
                                    onMouseDown: (u) => {
                                        ...
                                        if (r && 0 === u.button)
                                            if ((J('play'), u.target === r))
                                                ...
                                                })(u.screenY > r.getBoundingClientRect().y ? Ue.Prev : Ue.Next);
                                            }
                                    },
                                    ref: c,
                                    onMouseEnter: v,
                                },
                                o().createElement('div', { ref: d, className: h()(_u, u.thumb) }),
                                o().createElement('div', { className: h()(mu, u.rail) }),
                            ),
                            o().createElement('div', {
                                className: h()(du, u.bottomButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Au) || 0 !== e.button || (J('play'), p(Ue.Prev));
                                },
                                onMouseUp: f,
                                ref: l,
                                onMouseEnter: v,
                    ...
                    fu = ({
                        ...
                        const d = (0, a.useMemo)(() => {
                                const e = r || {};
                                return Object.assign({}, e, { base: h()(hu.base, e.base) });
                            }, [r]),
                            E = (0, a.useMemo)(() => Object.assign({}, u, { handleMouseWheel: () => {} }), [u]);
                        return o().createElement(
                            'div',
                            { className: h()(hu.defaultScroll, t), onWheel: u.handleMouseWheel },
                            o().createElement(
                                'div',
                                { className: h()(hu.area, n) },
                                o().createElement(vu, { className: s, classNames: i, api: E }, e),
                            ),
                            o().createElement(pu, { getStepByRailClick: l, api: u, onDrag: c, classNames: d }),
                        );
                    },
                    vu = ({ className: e, classNames: u, children: t, api: r }) => (
                        (0, a.useEffect)(() => Le(r.recalculateContent)),
                        o().createElement(
                            'div',
                            { className: h()(hu.base, e), ref: r.wrapperRef, onWheel: r.handleMouseWheel },
                            o().createElement(
                                'div',
                                { className: h()(hu.content, null == u ? void 0 : u.content), ref: r.contentRef },
                                t,
                            ),
                        )
                    );
                ...
                const Pu = ({ type: e = ku.Plus, isEnabled: u = !0, onClick: t }) =>
                    o().createElement('div', {
                ...
                const Nu = R.strings.selectable_reward.reward;
                const Iu = (0, ie.Pi)(({ index: e }) => {
                        const u = Q(),
                            t = u.model,
                            r = u.controls,
                            ...
                            E = r.addReward,
                            _ = r.reduceReward,
                            m = i > 0 && 'state_received' !== l,
                            A = n === X.Accepting && m,
                            F = (function (e) {
                                return e.startsWith(Ou.Trophy)
                                    ? Ou.Trophy
                                    : e.startsWith(Ou.Deluxe)
                                      ? Ou.Deluxe
                                      : e.startsWith(Ou.Modernized)
                                        ? Ou.Modernized
                                        : e.toLowerCase().endsWith(Ou.BattleBooster.toLowerCase())
                                          ? Ou.BattleBooster
                                          : Ou.None;
                            })(s);
                        return o().createElement(
                            'div',
                            {
                                className: h()(
                                    Lu.base,
                                    m && Lu.base__selected,
                                    A && Lu.base__accepting,
                                    Lu[`base__${((g = l), g.replace(/_\w/g, (e) => e[1].toUpperCase()))}`],
                                ),
                                onClick: () => {
                                    l === Tu
                                        ? (J(R.sounds.bp_click()), E(s))
                                        : l === Ru && J(R.sounds.bp_click_limit());
                                },
                                onMouseEnter: () => J(R.sounds.bp_highlight()),
                            },
                            o().createElement(
                                'div',
                                { className: h()(Lu.storage, c <= 0 && Lu.storage__hidden) },
                                o().createElement('div', { className: Lu.storageIcon }),
                                c,
                            ),
                            o().createElement(
                                fe,
                                ...
                                o().createElement(
                                    ...
                                    o().createElement('div', {
                                        className: Lu.image,
                                        style: { backgroundImage: `url(${ye(s)})` },
                                    }),
                                    F !== Ou.None &&
                                        o().createElement('div', {
                                            className: Lu.optDeviceType,
                                            style: {
                                    ...
                                    !m &&
                                        l !== Tu &&
                                        o().createElement('div', {
                                            className: Lu.disabled,
                                            style: { maskImage: `url(${ye(s)})` },
                                        }),
                                    d > 1 &&
                                        o().createElement(
                                            'div',
                                            { className: Lu.packSize },
                                            be(Nu.packSizeCount(), { packSize: d }),
                                        ),
                                ),
                            ),
                            o().createElement(
                                ...
                                ((e) => {
                                    ...
                                    return r || (n ? we(n) : void console.error('title for reward is not provided'));
                                })(s),
                            ),
                            m || l === Tu
                                ? o().createElement(
                                      o().Fragment,
                                      null,
                                      o().createElement('span', { className: Lu.countText }, i),
                                      o().createElement(
                                          'div',
                                          { className: Lu.select },
                                          o().createElement(Pu, {
                                          ...
                                          o().createElement(Pu, {
                                              ...
                                              isEnabled: l === Tu,
                                              onClick: () => {
                                                  l === Tu && (J(R.sounds.bp_click_plus()), E(s));
                                              },
                                          }),
                                      ),
                                  )
                                : o().createElement(
                                      ...
                                      l === Ru && 0 === i
                                          ? {
                                                header: Nu.tooltip.state_limited.header(),
                                                body: Nu.tooltip.state_limited.body(),
                                            }
                                          : { isEnabled: !1 },
                                      o().createElement(
                                          'div',
                                          { className: Lu.state },
                                          o().createElement('div', { className: Lu.stateText }, Nu.$dyn(l)),
                                          o().createElement('div', { className: Lu.stateIcon }),
                                      ),
                                  ),
                            o().createElement('div', { className: Lu.glow }),
                        );
                        var g;
                    }),
                    Hu = 'ContentGrid_base_59',
                    Wu = 'ContentGrid_scrollArea_e0',
                    Uu = 'ContentGrid_scrollAreaInner_ba',
                    Gu = 'ContentGrid_reward_68',
                    zu = {
                        base: 'Lip_base_57',
                ...
                const ju = ({ position: e, visible: u }) =>
                        o().createElement('div', { className: h()(zu.base, zu[`base__${e}`], u && zu.base__show) }),
                    $u = (0, ie.Pi)(({ className: e }) => {
                        const u = Q().model,
                            ...
                            o().createElement(
                                ...
                                'hidden' !== i &&
                                    o().createElement(
                                        o().Fragment,
                                        null,
                                        o().createElement(ju, { position: Vu.Top, visible: 'start' !== i }),
                                        o().createElement(ju, { position: Vu.Bottom, visible: 'end' !== i }),
                                    ),
                            )
                        );
                    }),
                ...
                const Ku = ({
                    ...
                    const F = (0, a.useRef)(null),
                        ...
                        N = h()(qu.state, qu.state__default);
                    return (
                        (0, a.useEffect)(
                            () => (
                ...
                const Ju = 'Footer_base_78',
                    et = 'Footer_description_7a',
                    ut = 'Footer_selectRewards_b0',
                    tt = 'Footer_rewardsSelected_06',
                    rt = 'Footer_rewardsSelectedCount_af',
                    nt = 'Footer_rewardsSelectedIcon_83',
                    at = 'Footer_buttons_10',
                    ot = 'Footer_cButton_fe',
                    st = (0, ie.Pi)(({ buttonsSize: e, classNames: u }) => {
                        const t = Q(),
                            r = t.model,
                            n = t.controls,
                            ...
                            s = a > 0,
                            i = y().mediaSize,
                            l = null != e ? e : ((e) => (e > b.Small ? Xu.medium : Xu.small))(i),
                            c = h()(ot, null == u ? void 0 : u.button),
                            d = Qu(),
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    Zu,
                                    { size: l, type: Yu.secondary, mixClass: c, onClick: n.close },
                    ...
                    lt = (0, ie.Pi)(({ title: e, subTitle: u, classNames: t, buttonsSize: r }) => {
                        ...
                        return (
                            ...
                            o().createElement(
                                'div',
                                { className: h()(it.base, it[`base__${d}`]) },
                                o().createElement(
                                    'div',
                                    { className: h()(it.heading, null == t ? void 0 : t.heading) },
                                    o().createElement(
                                        'div',
                                        { className: h()(it.title, null == t ? void 0 : t.title) },
                                        e,
                                    ),
                                    o().createElement(
                                        'div',
                                        { className: h()(it.subTitle, null == t ? void 0 : t.subTitle) },
                                        u,
                                    ),
                                ),
                                o().createElement(
                                    'div',
                                    { className: h()(it.wrapper, s && it.wrapper__shown) },
                                    o().createElement(
                                        'div',
                                        { className: it.categories },
                                        le(c.length, (e) => o().createElement(Re, { key: e, index: e })),
                                    ),
                                    o().createElement($u, { className: null == t ? void 0 : t.contentGrid }),
                                ),
                                o().createElement(
                                    'div',
                                    { className: h()(it.footer, null == t ? void 0 : t.footer) },
                                    o().createElement(st, {
                                        buttonsSize: r,
                    ...
                    gt = (0, ie.Pi)(() => {
                        ...
                        return o().createElement(
                            ...
                            o().createElement('div', { className: Et }, Ft.title()),
                            o().createElement('div', { className: _t }, Ft.description()),
                            o().createElement(
                                'div',
                                { className: mt },
                                o().createElement(
                                    Zu,
                                    { mixClass: At, type: Yu.primary, size: Xu.medium, onClick: e.close },
                                    Ft.button(),
                                ),
                            ),
                        );
                    ...
                    Bt = (0, ie.Pi)(({ title: e, subTitle: u, classNames: t, buttonsSize: r }) => {
                        const n = Q().model.tabs.get();
                        return o().createElement(
                            N,
                            { className: Dt },
                            n.length > 0
                                ? o().createElement(lt, { title: e, subTitle: u, classNames: t, buttonsSize: r })
                    ...
                    ft = 'App_title_06',
                    vt = 'App_subTitle_0e',
                    bt = 'App_contentGridClassName_06',
                    wt = 'App_footer_6c',
                    St = 'App_button_2b',
                    yt = 'App_background_60',
                    xt = 'App_backgroundImage_2e',
                    Tt = 'App_shadow_db',
                    Rt = 'App_close_12',
                    Lt = R.strings.comp7.yearlyRewardsSelectionScreen,
                    Mt = {
                        title: ft,
                        subTitle: vt,
                        contentGrid: bt,
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(Bt, {
                                        ...
                                        subTitle: Lt.title(u.computes.rewardsToClaimTotal()),
                                        classNames: Mt,
                                        buttonsSize: Xu.medium,
                                    }),
                                ),
                            )
                        );
                    }),
                    Pt = { context: 'model.selectableRewardModel' };
                engine.whenReady.then(() => {
                    H().render(
                        o().createElement(N, null, o().createElement(Z, { options: Pt }, o().createElement(kt, null))),
