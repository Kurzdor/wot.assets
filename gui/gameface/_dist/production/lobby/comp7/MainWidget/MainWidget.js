    ...
    var __webpack_modules__ = {
            ...
            5916: (u, e, t) => {
                        ...
                        const p = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, n.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    ($(t, c, { isMouseEvent: !0, on: !0, arguments: N(r) }, f),
                                    g && g(),
                ...
                const tu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    lu = { [Q.A]: 'A', [Q.B]: 'B', [Q.C]: 'C', [Q.D]: 'D', [Q.E]: 'E' },
                    Au = (u) => Eu.$dyn(lu[u]);
                let Fu;
                !(function (u) {
                    (u[(u.First = 6)] = 'First'),
                    ...
                    Wu = (0, n.memo)(
                        ({ size: u, lineRef: e, disabled: t, baseStyles: n, isComplete: a, withoutBounce: i }) => {
                            ...
                            return r().createElement(
                                ...
                                r().createElement('div', { className: Pu.pattern }),
                                r().createElement('div', { className: Pu.gradient }),
                                s && r().createElement(Iu, { size: u }),
                            );
                        },
                    ),
                ...
                const Gu = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    Ju = (0, n.memo)(
                        ({
                            ...
                            const p = (0, n.useMemo)(() => Object.assign({ width: '100%' }, Zu(u), Xu(A)), [A, u]),
                                f = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Zu(u), Xu(A)), [A, u]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Qu(A, a), Zu(u)), [a, A, u]),
                                b = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(o - a)}%` }, Qu(A, a), Zu(u)),
                                    [a, A, o, u],
                                );
                            if (d) return null;
                            const w = _()(qu, l, A && 0 === o && Ku);
                            return r().createElement(
                                'div',
                                { style: B ? v : b, className: w },
                                r().createElement(
                                    'div',
                                    { style: m ? f : p, className: Yu },
                                    r().createElement(Iu, { size: i }),
                                ),
                            );
                        },
                ...
                const se = (0, n.memo)(
                    ...
                    de = 'Progress_base_2e',
                    Be = 'Progress_progress_32',
                    Ce = 'Progress_status_95',
                    me = 'Progress_statusPoints_73',
                    ge = 'Progress_points_a7',
                    _e = 'Progress_dash_32',
                    he = 'Progress_dash__right_fb',
                    pe = 'Progress_score_c0',
                    fe = ({ rank: u, currentScore: e, prevScore: t, divisionInfo: n, className: a }) =>
                        Bu(u)
                            ? r().createElement(
                                  'div',
                                  { className: _()(de, a) },
                    ...
                    Ie = R.strings.comp7.qualification,
                    Pe = { hasHtmlContent: !0 },
                    We = ({ maxBattlesCount: u, children: e }) => {
                        return r().createElement(
                            V,
                            {
                                header: Ie.conditionTooltip.header(),
                                body:
                                    ((t = Ie.conditionTooltip.body(u)),
                                    (n = { maxBattlesCount: u }),
                                    t.replace(/(\{|%\()\w+(\}|\)s)/g, (u) => {
                    ...
                    je = (0, Y.Pi)(({ seasonName: u, classNames: e }) => {
                        const t = yu(),
                            n = t.model,
                            a = t.controls,
                    ...
                    at = { content: Ze, emblemContainer: Je, emblem: et },
                    it = (0, Y.Pi)(() => {
                        const u = yu(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return (
                            ...
                            r().createElement(
                                X.animated.div,
                                { className: _()(Qe, !E && ut), ref: d, style: C },
                                e.qualification.isActive.get()
                                    ? r().createElement(je, { seasonName: D, classNames: at })
                                    : r().createElement(
                                          r().Fragment,
                                          null,
                                          r().createElement(
