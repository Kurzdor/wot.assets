(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => A, off: () => s, on: () => o, onResize: () => a, onScaleUpdated: () => i });
                var n = t(2472),
                    r = t(1176);
            ...
            4537: (u, e, t) => {
                ...
                const B = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.mediumWidth && D) return i(e, t, w);
                ...
                const y = {
                    ...
                    M = (u) => {
                        ...
                        const r = b(),
                            ...
                            o = r.mediaHeight,
                            s = r.mediaSize;
                        return a().createElement('div', S({ className: h()(t, y[i], T[o], L[s]) }, n), e);
                    },
                    O = ['children'];
                const k = (u) => {
                    let e = u.children,
                        ...
                        return [
                            function ({ mode: i = 'real', options: o, children: s, mocks: E }) {
                                const A = (0, r.useRef)([]),
                                    l = (t, r, a) => {
                                        ...
                                        const o = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = W(a.keys()); !(u = t()).done; ) i(u.value, e);
                                                    },
                                                    unsubscribe: i,
                                                };
                                            })(r),
                                    ...
                                    c = D[0],
                                    d = D[1],
                                    B = (0, r.useState)(() => l(i, o, E)),
                                    C = B[0],
                                    m = B[1];
                                return (
                                    (0, r.useEffect)(() => {
                                        F.current ? m(l(c, o, E)) : (F.current = !0);
                                    }, [E, c, o]),
                                    (0, r.useEffect)(() => {
                                        d(i);
                                    }, [i]),
                ...
                class ru extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = h()(eu.base, eu[`base__${i}`], eu[`base__${r}`], null == o ? void 0 : o.base),
                            c = h()(eu.icon, eu[`icon__${i}`], eu[`icon__${r}`], null == o ? void 0 : o.icon),
                ...
                const Eu = 'page_heading_05',
                    ...
                    Fu = 'Heading_base_74',
                    Du = ({ children: u, className: e }) => a().createElement('div', { className: h()(Fu, e) }, u),
                    cu = $()(
                        ...
                        const v = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            p = (0, r.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (hu(t, c, { isMouseEvent: !0, on: !0, arguments: _u(n) }, w),
                                    _ && _(),
                ...
                const yu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Mu = (u, e, t = xu.left) => u.split(e).reduce(t === xu.left ? Tu : Lu, []),
                    Ou = (() => {
                        const u = new RegExp(
                    ...
                    Ru = (u, e = xu.left) => {
                        ...
                        return ((u, e = xu.left) => {
                            ...
                            const n =
                                ...
                                r = yu(u);
                            return Mu(r, /( )/, e).forEach((u) => (t = t.concat(Mu(u, n, xu.left)))), t;
                        })(u, e);
                    };
                var Hu = t(8613);
                const Nu = 60,
                    Pu = 3600,
                    Iu = 86400,
                    Wu = (Date.now(), Hu.Ew.getRegionalDateTime),
                    Gu = Hu.Ew.getFormattedDateTime;
                const Uu = (0, r.memo)(({ datetime: u, format: e = fu.ShortDate, isConvertedToLocal: t = !0 }) =>
                        Object.values(fu).includes(e) ? Wu(u, e, t) : Gu(u, e, t),
                    ),
                    $u = 'FormatText_base_d0',
                    ju = ({ binding: u, text: e = '', classMix: t, alignment: n = xu.left, formatWithBrackets: i }) => {
                    ...
                    zu = R.strings.comp7.season,
                    qu = (u, e) => ({
                        startDate: a().createElement(Uu, { datetime: u, format: fu.ShortDate }),
                        endDate: a().createElement(Uu, { datetime: e, format: fu.ShortDate }),
                    }),
                    Ku = (u, e, t) => {
                        const n = e - t,
                            r = ((u, e) => Vu(u - e))(e, t);
                        return n >= 604800
                            ? a().createElement(ju, { text: zu.range(), binding: qu(u, e) })
                            : n >= Iu
                              ? a().createElement(ju, { text: zu.daysLeft(), binding: r })
                              : n >= Pu
                                ? a().createElement(ju, { text: zu.hoursLeft(), binding: r })
                                : n >= Nu
                                  ? a().createElement(ju, { text: zu.minutesLeft(), binding: r })
                                  : n >= 1
                                    ? a().createElement(ju, { text: zu.secondsLeft(), binding: r })
                                    : void 0;
                    },
                    Yu = 'ActiveSeasonState_base_55',
                    Zu = 'ActiveSeasonState_calendarIcon_df',
                    Xu = ({ startTimestamp: u, endTimestamp: e, currentTimestamp: t, tooltipId: n = '' }) =>
                        a().createElement(
                            pu,
                    ...
                    Qu = 'ScheduleSubheading_base_f7',
                    Ju = (0, uu.Pi)(({ className: u, classNames: e }) => {
                        const t = z(),
                            n = t.model,
                            r = t.controls,
                            i = n.season.startTimestamp.get(),
                            o = n.season.endTimestamp.get(),
                            s = n.season.serverTimestamp.get();
                        return (
                            Cu(s, o, r.pollServerTime),
                            s >= o
                                ? null
                                : a().createElement(
                                      'div',
                ...
                iu.Sw.instance;
                const ae = ne,
                    ie = 'Countdown_base_fe',
                    oe = 'Countdown_icon_8b',
                    se = 'Countdown_description_8d',
                    ...
                    Ae = (u, e) => {
                        switch (e) {
                            case ee.Description:
                                return ((u, e = !0) =>
                                    u.days > 7 && e
                                        ? Su(R.strings.common.duration.days(), { days: u.days })
                                        : u.days >= 1
                                          ? 0 === u.hours
                                              ? Su(R.strings.common.duration.days(), { days: u.days })
                                              : `${Su(R.strings.common.duration.days(), { days: u.days })} ${Su(R.strings.common.duration.hours(), { hours: u.hours })}`
                                          : u.hours >= 1
                                            ? 0 === u.minutes
                                                ? Su(R.strings.common.duration.hours(), { hours: u.hours })
                                                : `${Su(R.strings.common.duration.hours(), { hours: u.hours })} ${Su(R.strings.common.duration.minutes(), { minutes: u.minutes })}`
                                            : Su(R.strings.common.duration.minutes(), { minutes: u.minutes || 1 }))(u);
                            case ee.Short:
                                return `${Ee(u.minutes)}:${Ee(u.seconds)}`;
                            case ee.Long:
                                return `${Ee(u.hours)}:${Ee(u.minutes)}:${Ee(u.seconds)}`;
                            case ee.Extended:
                                return `${Su(R.strings.common.duration.days(), { days: u.days })} | ${Ee(u.hours)}:${Ee(u.minutes)}:${Ee(u.seconds)}`;
                        }
                    },
                    le = R.images.gui.maps.icons.components.countdown,
                    Fe = (u, e) => {
                        const t = 2 === e ? le.big : le;
                        switch (u) {
                            case ue.Timer:
                                return t.clock();
                            case ue.Countdown:
                    ...
                    De = (0, r.memo)(
                        ({
                            ...
                            const E = t !== ee.Description ? 1 : void 0,
                                A = ae(u, E),
                                l = (() => {
                            ...
                            const F = Ae(
                                (function (u = 0) {
                                    ...
                                    return (e -= r * Nu), { days: t, hours: n, minutes: r, seconds: e };
                                })(A),
                                t,
                            );
                            return a().createElement(
                                ...
                                e !== ue.None &&
                                    a().createElement('div', {
                                        className: h()(oe, s.icon),
                                        style: { backgroundImage: `url('${Fe(e, l)}')` },
                                    }),
                                a().createElement('div', { className: h()(se, s.text) }, F),
                            );
                        },
                    ),
                    ce = 'CountDownSubheading_base_f7',
                    de = 'CountDownSubheading_highlight_7d',
                    Be = 'CountDownSubheading_timeLeftText_2b',
                    Ce = 'CountDownSubheading_countDownContainer_93',
                    me = 'CountDownSubheading_countDownText_87',
                    _e = 'CountDownSubheading_timer_49',
                    he = ({ timeLeft: u, className: e }) =>
                        a().createElement(
                            'div',
                            { className: h()(ce, e) },
                            a().createElement(ju, {
                                ...
                                binding: {
                                    timeLeft: a().createElement(
                                        ...
                                        a().createElement(De, { duration: u, icon: ue.None, classNames: { text: me } }),
                                    ),
                                },
                                classMix: Be,
                            }),
                        ),
                    ge = { countDown: 'IntroSubheading_countDown_1e' },
                    ve = (0, uu.Pi)(() => {
                        const u = z(),
                            e = u.model,
                            t = u.controls,
                        ...
                        return (
                            Cu(i, r, t.pollServerTime),
                            a().createElement(
                                'div',
                                { className: ge.base },
                                i < n
                                    ? a().createElement(he, { timeLeft: n - i, className: ge.countDown })
                    ...
                    pe = 'Slide_title_85',
                    fe = 'Slide_icon_70',
                    be = 'Slide_description_89',
                    xe = R.strings.comp7.intro,
                    Se = R.images.gui.maps.icons.comp7.metaIntro,
                    ye = (0, uu.Pi)(({ id: u }) => {
                        const e = Bu().model,
                            t = z().model,
                        ...
                        return a().createElement(
                            'div',
                            { className: we },
                            a().createElement(ju, { text: String(xe.title.$dyn(u)), classMix: pe }),
                            a().createElement('div', { className: fe, style: { backgroundImage: r } }),
                            a().createElement(ju, {
                                text: `${xe.description.$plural(u, n)}`,
                                binding: { count: n },
                                classMix: be,
                            }),
                        );
                    ...
                    Te = 'Slider_base_e2',
                    Le = 'Slider_trackWrapper_77',
                    Me = 'Slider_track_1c',
                    Oe = 'Slider_track__withoutTransition_1f',
                    ke = 'Slider_slide_3c',
                    Re = 'Slider_slide__active_b7',
                    He = 'Slider_prev_c8',
                    Ne = 'Slider_next_79',
                    Pe = 'Slider_prev__disabled_2b',
                    Ie = 'Slider_next__disabled_fc',
                    We = 'Slider_counter_ff',
                    Ge = 'Slider_counterDivider_90',
                    Ue = ['vehiclesOnMap', 'pointsOfInterest', 'roleSkills', 'onslaughtModifiers', 'noRankedSystem'],
                    $e = Ue.length,
                    je = (u, e) => () => {
                    ...
                    Ve = () => {
                        ...
                        const l = je(s, () => t(e - 1)),
                            F = je(E, () => t(e + 1));
                        return (
                            su(au.n.ARROW_LEFT, l),
                            su(au.n.ARROW_RIGHT, F),
                            a().createElement(
                                'div',
                                { className: Te, style: { '--currentSlideIndex': e, '--transitionDuration': '500ms' } },
                                a().createElement('div', {
                                    className: h()(He, s && Pe),
                                    onClick: l,
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        ...
                                        Ue.map((u, t) =>
                                            a().createElement(
                                                'div',
                                                { className: h()(ke, t === e && Re), key: `slide-${t}` },
                                                a().createElement(ye, { id: u }),
                                            ),
                                        ),
                                    ),
                                ),
                    ...
                    Ze = (0, uu.Pi)(() => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement('div', { className: qe }, a().createElement(Ve, null)),
                            a().createElement(
                                'div',
                                { className: Ke },
                                a().createElement(
                                    J,
                                    { type: Z.primary, size: X.medium, mixClass: Ye, onClick: u.close },
                                    R.strings.comp7.intro.confirmButton(),
                                ),
                            ),
                            a().createElement(lu, { onClose: u.close }),
                        );
                    });
                n.O.view.addPreloadTexture('gui/maps/icons/comp7/backgrounds/comp7_bg.png');
                const Xe = { context: 'model.scheduleInfo' };
                engine.whenReady.then(() => {
                    N().render(
                        a().createElement(
                            k,
                            ...
                            a().createElement(
                                du,
                                null,
                                a().createElement(V, { options: Xe }, a().createElement(Ze, null)),
                            ),
                        ),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [926], () => __webpack_require__(4537));
