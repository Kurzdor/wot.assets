    ...
    var __webpack_modules__ = {
            ...
            1694: (u, e, t) => {
                ...
                const p = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    v = (u, e, t = _.left) => u.split(e).reduce(t === _.left ? f : h, []),
                    b = (() => {
                        const u = new RegExp(
                    ...
                    y = (u, e = _.left) => {
                        ...
                        return ((u, e = _.left) => {
                            ...
                            const n =
                                ...
                                r = p(u);
                            return v(r, /( )/, e).forEach((u) => (t = t.concat(v(u, n, _.left)))), t;
                        })(u, e);
                    },
                ...
                const S = {
                    ...
                    P = (u) => S[u],
                    N = [O.First, O.Second, O.Third, O.Fourth],
                    M = (u) => N.includes(u);
                let L;
                !(function (u) {
                    (u[(u.x22 = 22)] = 'x22'),
                ...
                const Fu = ({ format: u, value: e }) => {
                    ...
                    hu = R.strings.comp7.mainWidgetTooltip,
                    vu = ({ rank: u, currentScore: e, topPercentage: t }) =>
                        r().createElement(
                            'div',
                            { className: _u },
                            r().createElement('div', { className: gu }, r().createElement(Fu, { value: e })),
                            r().createElement('div', { className: pu }, hu.ratingScore()),
                            r().createElement('div', { className: mu }),
                            r().createElement(du, { text: $(hu.info, u), binding: { topPercentage: t }, classMix: fu }),
                        ),
                    bu = {
                    ...
                    Ku = (0, n.memo)(
                        ({
                            ...
                            const f = (0, n.useMemo)(() => Object.assign({ width: '100%' }, Uu(u), qu(D)), [D, u]),
                                h = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Uu(u), qu(D)), [D, u]),
                                v = (0, n.useMemo)(() => Object.assign({ width: '0%' }, Vu(D, a), Uu(u)), [a, D, u]),
                                b = (0, n.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(i - a)}%` }, Vu(D, a), Uu(u)),
                                    [a, D, i, u],
                                );
                            if (c) return null;
                            const w = E()($u, s, D && 0 === i && ju);
                            return r().createElement(
                                'div',
                                { style: d ? v : b, className: w },
                                r().createElement(
                                    'div',
                                    { style: _ ? h : f, className: Gu },
                                    r().createElement(ku, { size: o }),
                                ),
                            );
                        },
                ...
                const te = (0, n.memo)(
                    ...
                    he = 'QualificationContent_dash_65',
                    ve = 'QualificationContent_dash__right_b2',
                    ...
                    ke = R.strings.comp7.mainWidgetTooltip,
                    Oe = (0, C.Pi)(({ classNames: u }) => {
                        const e = J().model,
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement('div', { className: E()(he, ve) }),
                            ),
                            r().createElement(
                                'div',
                                ...
                                r().createElement(Du, {
                                    text: ke.qualification.condition(n),
                    ...
                    Pe = (0, C.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement('div', { className: tu }, ((l = o), q(G.seasonName, l))),
                                u.qualification.isActive.get()
                                    ? r().createElement(Oe, { classNames: Re })
                                    : r().createElement(
                                          r().Fragment,
                                          null,
                                          r().createElement('div', { className: nu }, j(t)),
                                          r().createElement(
                                              'div',
                                              { className: ru },
