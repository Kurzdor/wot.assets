    ...
    var u,
        A = {
            7137: (u, A, F) => {
                ...
                var e = {};
                F.r(e), F.d(e, { getBgUrl: () => L, getTextureUrl: () => k });
                var B = {};
                F.r(B),
                    F.d(B, {
                        addModelObserver: () => K,
                    ...
                    p = (u, A = s.left) => {
                        ...
                        return ((u, A = s.left) => {
                            ...
                            const E =
                                ...
                                D = l(u);
                            return f(D, /( )/, A).forEach((u) => (F = F.concat(f(u, E, s.left)))), F;
                        })(u, A);
                    },
                    b = 'FormatText_base_d0',
                    w = ({ binding: u, text: A = '', classMix: F, alignment: E = s.left, formatWithBrackets: D }) => {
                ...
                const iu = Object.keys(V).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === V[A]), u), {}),
                    au = {
                        set: (u, A) => {
                ...
                const mu = t().forwardRef(function (u, A) {
                    ...
                    return (
                        ...
                        t().createElement(
                            'div',
                            fu({}, B, {
                                className: i()(du.base, du[`base__theme-${e}`], E),
                                ref: function (u) {
                ...
                var gu = F(3403);
                const pu = 'tooltips_base_6b',
                    bu = 'tooltips_heading_ac',
                    wu = 'tooltips_description_85',
                    hu = 'tooltips_description__topIndent_ba',
                    yu = 'tooltips_highlight_87';
                function xu() {}
                function _u() {
                    return !1;
                }
                ...
                const Tu = ((u, A) => {
                                                ...
                                                return {
                                                    subscribe: (F, e) => {
                                                        const C = 'string' == typeof e ? `${E}.${e}` : E,
                                                            t = cu.view.addModelObserver(C, A, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = Su(D.keys()); !(u = F()).done; ) e(u.value, A);
                                                    },
                                                    unsubscribe: e,
                                                };
                                            })(E),
                    ...
                    zu = Tu[0],
                    ju = Tu[1],
                    Mu = R.strings.comp7.rankInactivityTooltip,
                    ku = (0, gu.Pi)(() => {
                        const u = ju().model.root.get().rankInactivityCount;
                        return t().createElement(
                            mu,
                            null,
                            t().createElement(
                                'div',
                                { className: pu },
                                t().createElement('div', { className: bu }, Mu.heading()),
                                t().createElement('div', { className: i()(wu, hu) }, Mu.description()),
                                t().createElement(
                                    'div',
                                    { className: i()(wu, hu) },
                                    t().createElement(w, {
                                        text: Mu.timeLeft(),
                                        binding: { count: t().createElement('span', { className: yu }, u) },
                                    }),
                                ),
                            ),
                        );
