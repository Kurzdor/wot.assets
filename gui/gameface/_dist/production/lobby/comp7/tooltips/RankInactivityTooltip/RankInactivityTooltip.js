    ...
    var u,
        A = {
            7062: (u, A, F) => {
                ...
                var D = {};
                F.r(D), F.d(D, { getBgUrl: () => N, getTextureUrl: () => $ });
                var B = {};
                F.r(B),
                    F.d(B, {
                        addModelObserver: () => Fu,
                ...
                const wu = t().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                ...
                var yu = F(3403);
                const xu = 'tooltips_base_6b',
                    Pu = 'tooltips_heading_ac',
                    _u = 'tooltips_description_85',
                    Su = 'tooltips_description__topIndent_ba',
                ...
                const Lu = ((u, A) => {
                    ...
                    Vu = Lu[0],
                    Iu = Lu[1],
                    Gu = R.strings.comp7.rankInactivityTooltip,
                    $u = (0, yu.Pi)(() => {
                        const u = Iu().model.root.get().rankInactivityCount;
                        return t().createElement(
                            wu,
                            null,
                            t().createElement(
                                'div',
                                { className: xu },
                                t().createElement('div', { className: Pu }, Gu.heading()),
                                t().createElement('div', { className: i()(_u, Su) }, Gu.description()),
                                t().createElement(
                                    'div',
                                    { className: i()(_u, Su) },
                                    t().createElement(h, {
                                        text: Gu.timeLeft(),
                                        binding: { count: t().createElement('span', { className: Ru }, u) },
                                    }),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement(Vu, null, t().createElement($u, null)),
