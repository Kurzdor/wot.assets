    ...
    var __webpack_modules__ = {
            ...
            8005: (u, e, A) => {
                ...
                const a = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    l = (u, e, A = C.left) => u.split(e).reduce(A === C.left ? s : c, []),
                    d = (() => {
                        const u = new RegExp(
                    ...
                    v = (u, e = C.left) => {
                        ...
                        return ((u, e = C.left) => {
                            ...
                            const E =
                                ...
                                F = a(u);
                            return l(F, /( )/, e).forEach((u) => (A = A.concat(l(u, E, C.left)))), A;
                        })(u, e);
                    };
                A(9916);
                var m = A(8613);
                ...
                const p = (0, E.memo)(({ datetime: u, format: e = B.ShortDate, isConvertedToLocal: A = !0 }) =>
                    ...
                    f = ({ binding: u, text: e = '', classMix: A, alignment: t = C.left, formatWithBrackets: D }) => {
                ...
                const k = F().forwardRef(function (u, e) {
                    let A = u.children,
                        t = u.className,
                        D = u.theme,
                ...
                function q(u, e) {
                    ...
                    if (
                        ...
                        (A = (function (u, e) {
                            ...
                            if ('Arguments' === A || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(A)) return W(u, e);
                        })(u)) ||
                ...
                const K = ((u, e) => {
                        ...
                        return [
                            function ({ mode: t = 'real', options: D, children: n, mocks: r }) {
                                const B = (0, E.useRef)([]),
                                    o = (A, E, F) => {
                                        ...
                                        const D = (function ({
                                            ...
                                            i = { mode: A, model: C, externalModel: n, cleanup: o };
                                        return {
                                            model: C,
                                ...
                                return (
                                    (0, E.useEffect)(() => {
                                        C.current ? d(o(a, D, r)) : (C.current = !0);
                                    }, [r, a, D]),
                                    (0, E.useEffect)(() => {
                                        s(t);
                                    }, [t]),
                    ...
                    Z = (0, P.Pi)(() => {
                        ...
                        return F().createElement(
                            ...
                            F().createElement(
                                ...
                                F().createElement('div', { className: N }, F().createElement(f, { text: A })),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    D().render(F().createElement(G, null, F().createElement(Z, null)), document.getElementById('root'));
                });
            },
        },
