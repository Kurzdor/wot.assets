    ...
    var u,
        A = {
            8340: (u, A, F) => {
                ...
                const Au = Object.keys(x).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === x[A]), u), {}),
                    Fu = {
                        set: (u, A) => {
                ...
                const ou = Bu().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        Bu().createElement(
                            'div',
                            ru({}, B, {
                                className: t()(tu.base, tu[`base__theme-${D}`], E),
                                ref: function (u) {
                ...
                const du = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    fu = (u, A, F = cu.left) => u.split(A).reduce(F === cu.left ? vu : mu, []),
                    gu = (() => {
                        const u = new RegExp(
                    ...
                    bu = (u, A = cu.left) => {
                        ...
                        return ((u, A = cu.left) => {
                            ...
                            const E =
                                ...
                                e = du(u);
                            return fu(e, /( )/, A).forEach((u) => (F = F.concat(fu(u, E, cu.left)))), F;
                        })(u, A);
                    },
                    hu = 'FormatText_base_d0',
                    wu = ({ binding: u, text: A = '', classMix: F, alignment: E = cu.left, formatWithBrackets: e }) => {
                        if (null === A) return console.error("FormatText was supplied with 'null'"), null;
                        const D = e && u ? lu(A, u) : A;
                        return Bu().createElement(
                            ...
                            D.split('\n').map((A, e) =>
                                Bu().createElement(
                                    'div',
                                    { className: t()(hu, F), key: `${A}-${e}` },
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : bu(u, A))))(
                                        A,
                                        E,
                                        u,
                                    ).map((u, A) => Bu().createElement(Du.Fragment, { key: `${A}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                var yu = F(3403);
                const xu = 'tooltips_divider_26';
                function _u() {}
                function Pu() {
                    return !1;
                }
                ...
                const zu = ((u, A) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: e, children: D, mocks: B }) {
                                const C = (0, Du.useRef)([]),
                                    ...
                                    o = r[0],
                                    i = r[1],
                                    a = (0, Du.useState)(() => t(E, e, B)),
                                    s = a[0],
                                    c = a[1];
                                return (
                                    (0, Du.useEffect)(() => {
                                        n.current ? c(t(o, e, B)) : (n.current = !0);
                                    }, [B, o, e]),
                                    (0, Du.useEffect)(() => {
                                        i(E);
                                    }, [E]),
                    ...
                    Nu = 'App_image_a5',
                    $u = 'App_section_73',
                    Lu = 'App_section__bg_09',
                    Vu = 'App_section__bottom_45',
                    Gu = 'App_divider_15',
                    Iu = 'App_divider__top_36',
                    Hu = 'App_title_e8',
                    Uu = 'App_text_94',
                    qu = 'App_subtitle_ba',
                    Wu = 'App_howToReceive_05',
                    Qu = 'App_paragraph_f4',
                    Zu = R.strings.comp7.style3dTooltip,
                    Ju = R.images.gui.maps.icons.comp7.rewards,
                    Ku = (0, yu.Pi)(() => {
                        ...
                        return Bu().createElement(
                            ...
                            Bu().createElement(
                                'div',
                                { className: $u },
                                Bu().createElement(wu, { text: String(Zu.$num(A)), classMix: Hu }),
                            ),
                            Bu().createElement('div', {
                                className: Nu,
                                style: { backgroundImage: `url(${Ju.$dyn(`style3d_${A}`)})` },
                            }),
                            Bu().createElement(
                                'div',
                                { className: $u },
                                Bu().createElement('div', { className: Qu }, Zu.description()),
                                Bu().createElement('div', { className: t()(qu, Wu) }, Zu.howToReceive()),
                                Bu().createElement('div', { className: Qu }, Zu.secondaryDescription.$num(A)),
                            ),
                            Bu().createElement(
                                'div',
                                { className: t()($u, Lu, Vu) },
                                Bu().createElement('div', { className: t()(xu, Gu, Iu) }),
                                Bu().createElement('div', { className: qu }, Zu.suitableVehicles()),
                                Bu().createElement('div', { className: Uu }, F),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    au().render(
                        Bu().createElement(ju, null, Bu().createElement(ou, null, Bu().createElement(Ku, null))),
