    ...
    var u,
        A = {
            8340: (u, A, F) => {
                ...
                const iu = Cu().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        Cu().createElement(
                            'div',
                            ou({}, B, {
                                className: t()(nu.base, nu[`base__theme-${D}`], E),
                                ref: function (u) {
                                    (n.current = u), 'function' == typeof A ? A(u) : A && (A.current = u);
                                },
                            }),
                            Cu().createElement('div', { className: nu.decorator }, F),
                        )
                    );
                });
                var au = F(493),
                ...
                const vu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    gu = (u, A, F = cu.left) => u.split(A).reduce(F === cu.left ? mu : fu, []),
                    pu = (() => {
                        const u = new RegExp(
                    ...
                    wu = (u, A = cu.left) => {
                        ...
                        return ((u, A = cu.left) => {
                            ...
                            const E =
                                ...
                                e = vu(u);
                            return gu(e, /( )/, A).forEach((u) => (F = F.concat(gu(u, E, cu.left)))), F;
                        })(u, A);
                    },
                    hu = 'FormatText_base_d0',
                    yu = ({ binding: u, text: A = '', classMix: F, alignment: E = cu.left, formatWithBrackets: e }) => {
                            ...
                            D.split('\n').map((A, e) =>
                                Cu().createElement(
                                    ...
                                    ((u, A, F) =>
                                        ...
                                        E,
                                        u,
                                    ).map((u, A) => Cu().createElement(Bu.Fragment, { key: `${A}-${u}` }, u)),
                                ),
                            ),
                        );
                    };
                var xu = F(3403);
                const _u = 'tooltips_divider_26';
                function Pu() {}
                function Ru() {
                    return !1;
                }
                ...
                const ju = ((u, A) => {
                    ...
                    $u = 'App_image_a5',
                    Lu = 'App_section_73',
                    Vu = 'App_section__bg_09',
                    Gu = 'App_section__bottom_45',
                    Iu = 'App_divider_15',
                    Hu = 'App_divider__top_36',
                    Uu = 'App_title_e8',
                    qu = 'App_text_94',
                    Wu = 'App_subtitle_ba',
                    Qu = 'App_howToReceive_05',
                    Zu = 'App_paragraph_f4',
                    Ju = R.strings.comp7.style3dTooltip,
                    Ku = R.images.gui.maps.icons.comp7.rewards,
                    Xu = (0, xu.Pi)(() => {
                        ...
                        return Cu().createElement(
                            ...
                            Cu().createElement(
                                'div',
                                { className: Lu },
                                Cu().createElement(yu, { text: String(Ju.$num(A)), classMix: Uu }),
                            ),
                            Cu().createElement('div', {
                                className: $u,
                                style: { backgroundImage: `url(${Ku.$dyn(`style3d_${A}`)})` },
                            }),
                            Cu().createElement(
                                'div',
                                { className: Lu },
                                Cu().createElement('div', { className: Zu }, Ju.description()),
                                Cu().createElement('div', { className: t()(Wu, Qu) }, Ju.howToReceive()),
                                Cu().createElement('div', { className: Zu }, Ju.secondaryDescription.$num(A)),
                            ),
                            Cu().createElement(
                                'div',
                                { className: t()(Lu, Vu, Gu) },
                                Cu().createElement('div', { className: t()(_u, Iu, Hu) }),
                                Cu().createElement('div', { className: Wu }, Ju.suitableVehicles()),
                                Cu().createElement('div', { className: qu }, F),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    su().render(
                        Cu().createElement(Mu, null, Cu().createElement(iu, null, Cu().createElement(Xu, null))),
