(() => {
    var __webpack_modules__ = {
            ...
            4179: (u, e, t) => {
                'use strict';
                t.d(e, { kH: () => A, Z5: () => i, lf: () => E, cy: () => s, B0: () => o, ry: () => B });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            8163: (u, e, t) => {
                ...
                var r = {};
                t.r(r), t.d(r, { Area: () => ie, Bar: () => ne, Default: () => ae, useVerticalScrollApi: () => zu });
                var a = t(6179),
                    i = t.n(a);
                const s = (u, e, t) =>
                ...
                const B = (u) => {
                    ...
                    if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                        ...
                        if (t.extraLargeWidth && E) return s(e, t, f);
                        if (t.largeWidth && A) return s(e, t, f);
                        if (t.mediumWidth && F) return s(e, t, f);
                        if (t.smallWidth && D) return s(e, t, f);
                        if (t.extraSmallWidth && d) return s(e, t, f);
                        if (
                ...
                const C = (u) => {
                    ...
                    g = (0, a.memo)(({ children: u }) => {
                        ...
                        return i().createElement(m.Provider, { value: c }, u);
                    });
                var h = t(6483),
                    v = t.n(h),
                    f = t(926),
                ...
                const S = {
                    ...
                    O = (u) => {
                        ...
                        const r = M(),
                            ...
                            s = r.mediaHeight,
                            o = r.mediaSize;
                        return i().createElement('div', T({ className: v()(t, S[a], L[s], N[o]) }, n), e);
                    },
                    k = ['children'];
                const H = (u) => {
                    let e = u.children,
                    ...
                    return i().createElement(g, null, i().createElement(O, t, e));
                };
                var P = t(493),
                    I = t.n(P),
                    W = t(3403);
                ...
                class G extends i().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            F = v()(V.base, V[`base__${a}`], V[`base__${r}`], null == s ? void 0 : s.base),
                            D = v()(V.icon, V[`icon__${a}`], V[`icon__${r}`], null == s ? void 0 : s.icon),
                            d = v()(V.glow, null == s ? void 0 : s.glow),
                            m = v()(V.caption, V[`caption__${a}`], null == s ? void 0 : s.caption),
                            _ = v()(V.goto, null == s ? void 0 : s.goto);
                ...
                const X = 'page_close_a4',
                    Z = ({ onClose: u, className: e }) => {
                        var t;
                        return (
                            (t = u),
                            K(j.n.ESCAPE, t),
                ...
                const nu = () => (u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: r, children: s, mocks: l }) {
                                const c = (0, a.useRef)([]),
                                    ...
                                    D = F[0],
                                    d = F[1],
                                    m = (0, a.useState)(() => E(n, r, l)),
                                    _ = m[0],
                                    B = m[1];
                                return (
                                    (0, a.useEffect)(() => {
                                        A.current ? B(E(D, r, l)) : (A.current = !0);
                                    }, [l, D, r]),
                                    (0, a.useEffect)(() => {
                                        d(n);
                                    }, [n]),
                    ...
                    ru = nu()(
                        ({ observableModel: u }) =>
                            Object.assign({}, u.primitives(['maxBattlesCount']), { vehicles: u.array('vehicles') }),
                        ({ externalModel: u }) => ({
                    ...
                    const m = (0, a.useRef)(null),
                        ...
                        k = v()(
                            ...
                            lu[`base__${n}`],
                            {
                                ...
                                [lu[`base__${e}`]]: e,
                                [lu.base__focus]: B,
                                [lu.base__highlightActive]: h,
                                [lu.base__firstHover]: b,
                            },
                            s,
                        ),
                        H = v()(lu.state, lu.state__default);
                    return (
                        (0, a.useEffect)(
                            () => (
                        ...
                        i().createElement(
                            ...
                            n !== cu.ghost &&
                                i().createElement(
                                    i().Fragment,
                                    null,
                                    i().createElement('div', { className: lu.back }),
                                    i().createElement('span', { className: lu.texture }),
                                ),
                            i().createElement(
                                'span',
                                { className: H },
                                i().createElement('span', { className: lu.stateDisabled }),
                                i().createElement('span', { className: lu.stateHighlightHover }),
                                i().createElement('span', { className: lu.stateHighlightActive }),
                            ),
                            i().createElement(
                                'span',
                ...
                Au.defaultProps = { type: cu.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Fu = (0, a.memo)(Au),
                    Du = (u) => {
                        let e,
                            t = null;
                        return (
                ...
                const pu = {
                            ...
                            const c = l.settings,
                                ...
                                D = (() => {
                                    const u = (0, a.useMemo)(() => ({}), []),
                                        ...
                                        r = (u, ...t) => {
                                            for (var n, r = Cu(e(u).values()); !(n = r()).done; ) (0, n.value)(...t);
                                        };
                    ...
                    wu = bu({
                        ...
                        getDirection: (u) => (u.deltaY > 1 ? fu.Next : fu.Prev),
                        triggerMouseMoveOnUpdate: !0,
                    }),
                    xu = 'HorizontalBar_base_49',
                    ...
                    Iu = (0, a.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = ku, onDrag: n = Hu }) => {
                        const r = (0, a.useRef)(null),
                            ...
                            m = () => {
                                ...
                                const a = u.animationScroll.scrollPosition.get(),
                                    i = Math.min(1, n / r),
                                    E = du(0, 1, a / (r - n)),
                                    A = (e.offsetWidth - Pu(e, i)) * E;
                                (t.style.transform = `translateX(${0 | A}px)`),
                                    ((u) => {
                                        if (s.current && o.current && l.current && c.current) {
                                            if (0 === u)
                                                return s.current.classList.add(Ru), void o.current.classList.remove(Ru);
                                            if (
                                                ((e = l.current),
                                                (t = c.current),
                                                u - (e.offsetWidth - t.offsetWidth) >= -0.5)
                                            )
                                                return s.current.classList.remove(Ru), void o.current.classList.add(Ru);
                                            var e, t;
                                            s.current.classList.remove(Ru), o.current.classList.remove(Ru);
                                        }
                                    })(A);
                            },
                            _ = _u(() => {
                            ...
                            (0, a.useEffect)(() => {
                                ...
                                const e = (e) => {
                                        ...
                                        u.scrollPosition.start({
                                            scrollPosition: u.clampPosition(r, o),
                                            reset: !0,
                                            immediate: !0,
                                    ...
                                    t = () => {
                                        window.removeEventListener('mousemove', e), d(Ou);
                                    };
                                return (
                        ...
                        const h = (u) => {
                            u.target.classList.contains(Ru) || U('highlight');
                        };
                        return i().createElement(
                            'div',
                            { className: v()(xu, e.base), ref: r, onWheel: u.handleMouseWheel },
                            i().createElement('div', {
                                className: v()(yu, e.leftButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(Ru) || 0 !== u.button || (U('play'), C(fu.Next));
                                },
                                onMouseUp: g,
                                ref: s,
                                onMouseEnter: h,
                            ...
                            i().createElement(
                                'div',
                                {
                                    className: v()(Su, e.track),
                                    onMouseDown: (e) => {
                                        const n = c.current;
                                        if (n && 0 === e.button)
                                            if ((U('play'), e.target === n))
                                                ...
                                                })(e.screenX > n.getBoundingClientRect().x ? fu.Prev : fu.Next);
                                            }
                                    },
                                    ref: l,
                                    onMouseEnter: h,
                                },
                                i().createElement('div', { ref: c, className: v()(Lu, e.thumb) }),
                                i().createElement('div', { className: v()(Nu, e.rail) }),
                            ),
                            i().createElement('div', {
                                className: v()(Tu, e.rightButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(Ru) || 0 !== u.button || (U('play'), C(fu.Prev));
                                },
                                onMouseUp: g,
                                ref: o,
                                onMouseEnter: h,
                    ...
                    Uu = ({
                        ...
                        const E = (0, a.useMemo)(() => {
                                const u = n || {};
                                return Object.assign({}, u, { base: v()(Wu.base, u.base) });
                            }, [n]),
                            A = (0, a.useMemo)(() => Object.assign({}, e, { handleMouseWheel: () => {} }), [e]);
                        return i().createElement(
                            'div',
                            { className: v()(Wu.defaultScroll, t), onWheel: e.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: v()(Wu.defaultScrollArea, r) },
                                i().createElement(Vu, { className: o, api: A, classNames: s }, u),
                            ),
                    ...
                    Vu = ({ api: u, className: e, classNames: t, children: n }) => (
                        ...
                        i().createElement(
                            'div',
                            { className: v()(Wu.base, e) },
                            i().createElement(
                                'div',
                                {
                                    className: v()(Wu.wrapper, null == t ? void 0 : t.wrapper),
                                    onWheel: u.handleMouseWheel,
                                    ref: u.wrapperRef,
                                },
                                i().createElement(
                                    'div',
                                    { className: v()(Wu.content, null == t ? void 0 : t.content), ref: u.contentRef },
                                    n,
                                ),
                            ),
                        )
                ...
                (Vu.Bar = Iu),
                    (Vu.Default = Uu),
                    (Vu.SeniorityAwards = ({ api: u, className: e, classNames: t, children: n }) => (
                        (0, a.useEffect)(() => Du(u.recalculateContent)),
                        i().createElement(
                            'div',
                            { className: v()(Wu.base, e) },
                            i().createElement(
                                'div',
                                { className: v()(Wu.wrapper, null == t ? void 0 : t.wrapper), ref: u.wrapperRef },
                                i().createElement(
                                    'div',
                                    { className: v()(Wu.content, null == t ? void 0 : t.content), ref: u.contentRef },
                                    n,
                ...
                const zu = bu({
                    ...
                    te = (u, e) => Math.max(20, u.offsetHeight * e),
                    ne = (0, a.memo)(({ api: u, classNames: e = {}, getStepByRailClick: t = ue, onDrag: n = Qu }) => {
                        const r = (0, a.useRef)(null),
                            s = (0, a.useRef)(null),
                            o = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                            ...
                            m = _u(() => {
                                ...
                                const i = Math.min(1, n / a);
                                return (
                                    (e.style.height = `${te(t, i)}px`),
                                    e.classList.add(Ku),
                                    r.current &&
                                        (1 === i ? r.current.classList.add(Gu) : r.current.classList.remove(Gu)),
                                    i
                                );
                            }),
                            _ = _u(() => {
                                ...
                                const a = u.animationScroll.scrollPosition.get(),
                                    i = Math.min(1, n / r),
                                    E = du(0, 1, a / (r - n)),
                                    A = (e.offsetHeight - te(e, i)) * E;
                                (t.style.transform = `translateY(${0 | A}px)`),
                                    ((u) => {
                                        if (s.current && o.current && l.current && c.current) {
                                            if (0 === u)
                                                return s.current.classList.add(Zu), void o.current.classList.remove(Zu);
                                            if (
                                                ((e = l.current),
                                                (t = c.current),
                                                u - (e.offsetHeight - t.offsetHeight) >= -0.5)
                                            )
                                                return s.current.classList.remove(Zu), void o.current.classList.add(Zu);
                                            var e, t;
                                            s.current.classList.remove(Zu), o.current.classList.remove(Zu);
                                        }
                                    })(A);
                            }),
                            B = _u(() => {
                        ...
                        (0, a.useEffect)(() => Du(B)),
                            ...
                            (0, a.useEffect)(() => {
                                ...
                                const e = (e) => {
                                    ...
                                    t = () => {
                                        window.removeEventListener('mousemove', e), d(Ju);
                                    };
                                return (
                                    window.addEventListener('mousemove', e),
                                    window.addEventListener('mouseup', t),
                        ...
                        const f = (u) => {
                            u.target.classList.contains(Zu) || U('highlight');
                        };
                        return i().createElement(
                            'div',
                            { className: v()($u, e.base), ref: r, onWheel: u.handleMouseWheel },
                            i().createElement('div', {
                                className: v()(ju, e.topButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(Zu) || 0 !== u.button || (U('play'), g(fu.Next));
                                },
                                ref: s,
                                onMouseEnter: f,
                            }),
                            i().createElement(
                                    ...
                                    onMouseDown: (e) => {
                                        ...
                                        if (n && 0 === e.button)
                                            if ((U('play'), e.target === n))
                                                ...
                                                })(e.screenY > n.getBoundingClientRect().y ? fu.Prev : fu.Next);
                                            }
                                    },
                                    ref: l,
                                    onMouseEnter: f,
                                ...
                                i().createElement('div', { className: v()(Xu, e.rail) }),
                            ),
                            i().createElement('div', {
                                className: v()(Yu, e.bottomButton),
                                onMouseDown: (u) => {
                                    u.target.classList.contains(Zu) || 0 !== u.button || (U('play'), g(fu.Prev));
                                },
                                onMouseUp: h,
                                ref: o,
                                onMouseEnter: f,
                    ...
                    ae = ({
                        ...
                        const E = (0, a.useMemo)(() => {
                                const u = n || {};
                                return Object.assign({}, u, { base: v()(re.base, u.base) });
                            }, [n]),
                            A = (0, a.useMemo)(() => Object.assign({}, e, { handleMouseWheel: () => {} }), [e]);
                        return i().createElement(
                            'div',
                            { className: v()(re.defaultScroll, t), onWheel: e.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: v()(re.area, r) },
                                i().createElement(ie, { className: s, classNames: o, api: A }, u),
                            ),
                            i().createElement(ne, { getStepByRailClick: l, api: e, onDrag: c, classNames: E }),
                        );
                    },
                    ie = ({ className: u, classNames: e, children: t, api: n }) => (
                        (0, a.useEffect)(() => Du(n.recalculateContent)),
                        i().createElement(
                            'div',
                            { className: v()(re.base, u), ref: n.wrapperRef, onWheel: n.handleMouseWheel },
                            i().createElement(
                                'div',
                                { className: v()(re.content, null == e ? void 0 : e.content), ref: n.contentRef },
                                t,
                            ),
                        )
                    );
                ...
                const Be = (u, e, t) => {
                    ...
                    ge = (u, e, t = me.left) => u.split(e).reduce(t === me.left ? Be : Ce, []),
                    he = (() => {
                        const u = new RegExp(
                        ...
                        return ve.includes(t)
                            ...
                            : ((u, e = me.left) => {
                                  ...
                                  const n =
                                      ...
                                      r = u.replace(/&nbsp;/g, ' ');
                                  return ge(r, /( )/, e).forEach((u) => (t = t.concat(ge(u, n, me.left)))), t;
                              })(u, e);
                    };
                let pe;
                !(function (u) {
                ...
                const be = 60,
                    ...
                    xe = 86400;
                Date.now();
                const Me = (0, a.memo)(({ datetime: u, format: e = pe.SHORT_DATE, localize: t = !0 }) =>
                        ((u, e, t) => {
                            switch (e) {
                                case pe.SHORT_DATE:
                                    return t
                                        ? Y.Z5.getDateFormat(u, Y.kH.SHORT_FORMAT)
                                        : Y.cy.getTimeFormat('%d.%m.%y', u, !0);
                                case pe.SHORT_TIME:
                                    return t
                                        ? Y.Z5.getTimeFormat(u, Y.lf.SHORT_FORMAT)
                                        : Y.cy.getTimeFormat('%I:%M %p', u, !0);
                                case pe.SHORT_DATE_TIME:
                                    return t
                                        ? `${Y.Z5.getDateFormat(u, Y.kH.SHORT_FORMAT)}, ${Y.Z5.getTimeFormat(u, Y.lf.SHORT_FORMAT)}`
                                        : Y.cy.getTimeFormat('%d.%m.%y, %I:%M %p', u, !0);
                                case pe.FULL_DATE:
                                    return t
                                        ? Y.Z5.getDateFormat(u, Y.kH.LONG_FORMAT)
                                        : Y.cy.getTimeFormat('%B %d, %Y', u, !0);
                                case pe.FULL_DATE_TIME:
                                    return t
                                        ? `${Y.Z5.getDateFormat(u, Y.kH.LONG_FORMAT)}, ${Y.Z5.getTimeFormat(u, Y.lf.SHORT_FORMAT)}`
                                        : Y.cy.getTimeFormat('%B %d, %Y, %I:%M %p', u, !0);
                                case pe.MONTH:
                                ...
                                case pe.WEEK_DAY_TIME:
                                    return t
                                        ? `${Y.cy.getTimeFormat('%A', u, !0)} ${Y.Z5.getTimeFormat(u, Y.lf.SHORT_FORMAT)}`
                                        : Y.cy.getTimeFormat('%A, %I:%M %p', u, !0);
                                case pe.YEAR:
                    ...
                    Te = ({ binding: u, text: e = '', classMix: t, alignment: n = me.left }) =>
                        null === e
                            ...
                            : i().createElement(
                                  ...
                                  e.split('\n').map((e, r) =>
                                      i().createElement(
                                          'div',
                                          { className: v()(ye, t), key: `${e}-${r}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : fe(u, e))))(e, n, u).map((u, e) =>
                        ...
                        const v = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            p = (0, a.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (Ne(t, D, { isMouseEvent: !0, on: !0, arguments: Le(n) }, f),
                                    C && C(),
                ...
                const He = (u) => {
                    ...
                    Ie = 'ActiveSeasonState_base_55',
                    We = 'ActiveSeasonState_calendarIcon_df',
                    Ue = 'ActiveSeasonState_divider_5b',
                    Ve = R.strings.comp7.season,
                    ze = (u, e) => ({
                        startDate: i().createElement(Me, { datetime: u, format: pe.SHORT_DATE }),
                        endDate: i().createElement(Me, { datetime: e, format: pe.SHORT_DATE }),
                    }),
                    $e = (u, e, t) => {
                        const n = e - t,
                            r = ((u, e) => Pe(u - e))(e, t);
                        return n >= 604800
                            ? i().createElement(Te, { text: Ve.range(), binding: ze(u, e) })
                            : n >= xe
                              ? i().createElement(Te, { text: Ve.daysLeft(), binding: r })
                              : n >= we
                                ? i().createElement(Te, { text: Ve.hoursLeft(), binding: r })
                                : n >= be
                                  ? i().createElement(Te, { text: Ve.minutesLeft(), binding: r })
                                  : n >= 1
                                    ? i().createElement(Te, { text: Ve.secondsLeft(), binding: r })
                                    : void 0;
                    },
                    Ge = ({
                        startTimestamp: u,
                    ...
                    je = 'ScheduleSubheading_base_f7',
                    Ye = (0, W.Pi)(({ className: u, hasSeasonName: e = !0 }) => {
                        const t = de(),
                            n = t.model,
                            r = t.controls,
                            a = n.season.startTimestamp.get(),
                            s = n.season.endTimestamp.get(),
                            o = n.season.serverTimestamp.get();
                        return (
                            Ae(o, s, r.pollServerTime),
                            i().createElement(
                                'div',
                                { className: v()(je, u) },
                                o < s
                    ...
                    Ke = 'typography_h2_18',
                    Xe = 'typography_h3_79',
                    Ze = 'typography_paragraphText_f5',
                    Qe = 'Banner_base_a0',
                    Je = 'Banner_h3_80',
                    ut = 'Banner_date_db',
                    et = R.strings.comp7.whatsNewView.banner,
                    tt = { context: 'model.scheduleInfo' },
                    nt = () =>
                        i().createElement(
                            'div',
                            { className: Qe },
                            i().createElement('div', { className: v()(Xe, Je) }, et.title.small()),
                            i().createElement('div', { className: qe }, et.title.large()),
                            i().createElement(
                                'div',
                                { className: ut },
                                i().createElement(De, { options: tt }, i().createElement(Ye, { hasSeasonName: !1 })),
                            ),
                        ),
                    rt = {
                        base: 'Tag_base_b1',
                        ...
                        base__seasonUpdated: 'Tag_base__seasonUpdated_35',
                    },
                    at = ({ type: u, className: e }) =>
                        i().createElement(
                            'div',
                            { className: v()(rt.base, rt[`base__${u}`], e) },
                            R.strings.comp7.whatsNewView.tag.$dyn(u),
                        ),
                    it = 'Introduction_row_38',
                    st = 'Introduction_h2_a8',
                    ot = 'Introduction_tag_b9',
                    lt = 'Introduction_seasonText_ff',
                    ct = 'Introduction_bannerContainer_30',
                    Et = 'Introduction_bannerBackground_69',
                    At = 'Introduction_bannerDescription_08',
                    Ft = 'Introduction_header_e0',
                    Dt = 'Introduction_img_64',
                    dt = 'Introduction_img__qualification_41',
                    mt = 'Introduction_img__rankingSystem_86',
                    _t = R.strings.comp7.whatsNewView,
                    Bt = (0, W.Pi)(() =>
                        i().createElement(
                            'div',
                            null,
                                ...
                                i().createElement(
                                    ...
                                    i().createElement(
                                        ...
                                        i().createElement(
                                            ...
                                            i().createElement(Te, {
                                                classMix: v()(Ke, st),
                                                text: _t.yearOfThePegasus.heading(),
                                            }),
                                            i().createElement(at, { type: 'seasonUpdated', className: ot }),
                                        ),
                                        i().createElement(Te, {
                                            classMix: v()(Ze, lt),
                                            text: _t.yearOfThePegasus.description(),
                                        }),
                                    ),
                                ),
                            ),
                            i().createElement(
                                ...
                                i().createElement(
                                    'div',
                                    { className: Ee },
                                    i().createElement('div', { className: v()(Dt, dt) }),
                                    i().createElement(
                                        'div',
                                        { className: v()(le, Ft) },
                                        i().createElement(Te, { classMix: Xe, text: _t.qualification.heading() }),
                                        i().createElement(at, { type: 'new' }),
                                    ),
                                    i().createElement(Te, { classMix: Ze, text: _t.qualification.description() }),
                                ),
                                i().createElement(
                                    'div',
                                    { className: Ee },
                                    i().createElement('div', { className: v()(Dt, mt) }),
                                    i().createElement(
                                        'div',
                                        { className: v()(le, Ft) },
                                        i().createElement(Te, { classMix: Xe, text: _t.rankingSystem.heading() }),
                                        i().createElement(at, { type: 'changed' }),
                                    ),
                                    i().createElement(Te, { classMix: Ze, text: _t.rankingSystem.description() }),
                                ),
                            ),
                        ),
                    ),
                    Ct = 'Main_base_e5',
                    gt = 'Main_areaBaseWrapper_81',
                    ht = 'Main_content_e4',
                    vt = 'Main_scrollBar_0a',
                    ft = 'Main_banner_44',
                    pt = 'Main_section_87',
                    bt = 'Main_button_8b',
                    wt = 'Main_container__1_64',
                    xt = 'Main_container__2_bb',
                    Mt = 'Main_container__3_31',
                    yt = 'Main_container__5_d0',
                    Tt = 'Map_base_71',
                    St = 'Map_gradient_81',
                    Lt = 'Map_name_70',
                    Nt = 'Map_tag_56',
                    Rt = ({ name: u, isRemoved: e }) => {
                        const t = R.images.gui.maps.icons.comp7.whatsNewView.arenas.$dyn(`c_${u}`),
                            n = R.strings.arenas.$dyn(`c_${u}`);
                        return i().createElement(
                            'div',
                            { className: Tt, style: { backgroundImage: `url(${t})` } },
                            i().createElement('div', { className: St }),
                            e &&
                                i().createElement(
                                    'div',
                                    { className: Nt },
                                    R.strings.comp7.whatsNewView.tag.mapRemoved(),
                                ),
                            i().createElement('div', { className: Lt }, n.$dyn('name')),
                        );
                    },
                    Ot = { header: 'MapChanges_header_5c', legend: 'MapChanges_legend_43' },
                    kt = R.strings.comp7.whatsNewView.mapChanges,
                    Ht = () =>
                        i().createElement(
                            'div',
                            { className: Ot.base },
                            i().createElement(
                                'div',
                                { className: v()(le, Ot.header) },
                                i().createElement('div', { className: Ke }, kt.heading()),
                                i().createElement(at, { type: 'seasonUpdate' }),
                            ),
                            i().createElement(
                                'div',
                                { className: v()(ce, Ot.legend) },
                                i().createElement('div', { className: v()(Ee, Ze) }, kt.addedMaps()),
                                i().createElement('div', { className: Ee }),
                                i().createElement('div', { className: Ee }),
                                i().createElement('div', { className: v()(Ee, Ze) }, kt.removedMaps()),
                            ),
                            i().createElement(
                                'div',
                                { className: ce },
                                i().createElement(
                                    'div',
                                    { className: Ee },
                                    i().createElement(Rt, { name: '01_karelia' }),
                                ),
                                i().createElement(
                                    'div',
                                    { className: Ee },
                                    i().createElement(Rt, { name: '08_ruinberg' }),
                                ),
                                i().createElement(
                                    'div',
                                    { className: Ee },
                                    i().createElement(Rt, { name: '11_murovanka' }),
                                ),
                                i().createElement(
                                    'div',
                                    { className: Ee },
                                    i().createElement(Rt, { name: '28_desert', isRemoved: !0 }),
                                ),
                            ),
                        );
                ...
                const $t = R.images.gui.maps.icons.vehicleTypes,
                    ...
                    jt = (0, a.memo)(
                        ({
                            ...
                            type: t,
                            size: n = zt.x24Metal,
                            typeIconFolderPath: r = Gt(n),
                            isPremium: a = !1,
                            nation: s,
                            className: o,
                            classNames: l,
                        }) => {
                            const c = `${_e(t)}${a ? '_elite' : ''}`;
                            return i().createElement(
                                'div',
                                { className: v()(Vt.base, Vt[`base__${n}`], o) },
                                s,
                                i().createElement('div', { className: null == l ? void 0 : l.level }, Ut(e)),
                                i().createElement(
                                    'div',
                                    {
                                        className: v()(
                                    ...
                                    i().createElement('div', {
                                        className: v()(Vt.vehicleType, null == l ? void 0 : l.type),
                                        style: { backgroundImage: `url(${null == r ? void 0 : r.$dyn(c)})` },
                                    }),
                                ),
                                i().createElement(
                                    'div',
                                    { className: v()(Vt.shortName, null == l ? void 0 : l.shortName) },
                                    u,
                                ),
                            );
                        },
                ...
                const Kt = R.images.gui.maps.icons.roleExp.roles,
                    ...
                    Zt = (0, a.memo)(
                        ({
                            role: u,
                            size: e = qt.x22,
                            roleIconFolderPath: t = Kt.$dyn(`c_${e}`),
                            className: n,
                            classNames: r,
                        }) => {
                            const a = _e(u);
                            return i().createElement(
                                'div',
                                { className: v()(Yt.base, Yt[`base__${e}`], n) },
                                i().createElement(
                                    'div',
                                    { className: v()(Yt.iconContainer, null == r ? void 0 : r.iconContainer) },
                                    i().createElement('div', {
                                        className: v()(Yt.icon, null == r ? void 0 : r.icon),
                                        style: { backgroundImage: `url(${null == t ? void 0 : t.$dyn(a)})` },
                                    }),
                                ),
                                i().createElement(
                                    'div',
                                    { className: v()(Yt.label, null == r ? void 0 : r.label) },
                                    i().createElement(Te, {
                                        text: `${Xt.roleName.$dyn(a)}`,
                                        binding: { groupName: Xt.roleGroupName.$dyn(a) },
                                    }),
                                ),
                            );
                        },
                    ...
                    Qt = 'Vehicle_base_ae',
                    Jt = 'Vehicle_details_7d',
                    un = 'Vehicle_shortName_02',
                    en = 'Vehicle_level_e9',
                    tn = 'Vehicle_vehicleName_7c',
                    nn = 'Vehicle_typeIcon_20',
                    rn = 'Vehicle_type_01',
                    an = { type: v()(nn, rn), vehicleTypeContainer: v()(nn, rn), shortName: un, level: en },
                    sn = ({ tier: u, type: e, techName: t, roleKey: n, name: r, isPremium: a }) =>
                        i().createElement(
                            'div',
                            {
                                className: Qt,
                                style: {
                                    backgroundImage: `url(${R.images.gui.maps.icons.comp7.whatsNewView.vehiclesForRent.$dyn(t)})`,
                                },
                            },
                            i().createElement(
                                'div',
                                ...
                                i().createElement(Zt, { role: n }),
                            ),
                        ),
                    on = { header: 'VehiclesForRent_header_2e' },
                    ln = (0, W.Pi)(() => {
                        const u = iu().model.vehicles.get();
                        return i().createElement(
                            'div',
                            { className: on.container },
                            i().createElement(
                                'div',
                                { className: v()(le, on.header) },
                                i().createElement(
                                    'div',
                                    { className: Ke },
                            ...
                            i().createElement(
                                ...
                                (t = (u) =>
                                    i().createElement(
                                        'div',
                                        { className: Ee, key: u.vehicleCD },
                                        i().createElement(sn, u),
                                    )),
                                Array.isArray(e)
                                    ? e.map(t)
                    ...
                    En = (0, W.Pi)(() => {
                        ...
                        return i().createElement(
                            se.Vertical.Default,
                            { className: Ct, barClassNames: cn, scrollClassName: gt, api: e },
                            i().createElement(
                                'div',
                                { className: ht },
                                i().createElement('div', { className: v()(oe, ft, wt) }, i().createElement(nt, null)),
                                i().createElement('div', { className: v()(oe, pt, xt) }, i().createElement(Bt, null)),
                                i().createElement('div', { className: v()(oe, pt, Mt) }, i().createElement(Ht, null)),
                                i().createElement('div', { className: v()(oe, yt) }, i().createElement(ln, null)),
                                i().createElement(
                                    Fu,
                                    { mixClass: bt, onClick: u.close },
                    ...
                    An = (0, W.Pi)(() => {
                        ...
                        return i().createElement(
                            'div',
                            { className: su },
                            i().createElement(Z, { className: ou, onClose: u.close }),
                            i().createElement(En, null),
                        );
                    });
                engine.whenReady.then(() => {
                    I().render(
                        i().createElement(au, null, i().createElement(H, null, i().createElement(An, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [926], () => __webpack_require__(8163));
