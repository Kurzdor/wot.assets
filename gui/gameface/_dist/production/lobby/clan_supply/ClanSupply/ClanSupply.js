(() => {
    var __webpack_modules__ = {
            ...
            67: (e, u, t) => {
                ...
                var a = {};
                t.r(a),
                    t.d(a, { mouse: () => d, off: () => C, on: () => E, onResize: () => l, onScaleUpdated: () => c });
                var r = {};
                t.r(r),
                    t.d(r, {
                        events: () => a,
                ...
                const j = Object.keys(p).reduce((e, u) => ((e[u] = () => viewEnv.getShowingStatus() === p[u]), e), {}),
                    Z = {
                        set: (e, u) => {
            ...
            223: (e, u, t) => {
                ...
                const c = s.O.client.getSize('rem'),
                    E = c.width,
                    C = c.height,
                    m = Object.assign({ width: E, height: C }, l(E, C, o)),
                ...
                const y = {
                    ...
                    T = (e) => {
                        ...
                        const n = S(),
                            ...
                            o = n.mediaHeight,
                            i = n.mediaSize;
                        return r().createElement('div', M({ className: p()(t, y[s], P[o], L[i]) }, a), u);
                    },
                    x = ['children'];
                const N = (e) => {
                    let u = e.children,
                ...
                class j extends r().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            m = p()(W.base, W[`base__${s}`], W[`base__${n}`], null == o ? void 0 : o.base),
                            d = p()(W.icon, W[`icon__${s}`], W[`icon__${n}`], null == o ? void 0 : o.icon),
                        ...
                        const h = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, a.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (Q(t, d, { isMouseEvent: !0, on: !0, arguments: Y(r) }, b),
                                    D && D(),
                ...
                const ie = () => (e, u) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: o, children: i, mocks: l }) {
                                const c = (0, a.useRef)([]),
                                    E = (t, a, r) => {
                                        ...
                                        const o = (function ({
                                            ...
                                            m = { mode: t, model: C, externalModel: i, cleanup: E };
                                        return {
                                            model: C,
                                ...
                                return (
                                    (0, a.useEffect)(() => {
                                        C.current ? F(E(d, o, l)) : (C.current = !0);
                                    }, [l, d, o]),
                                    (0, a.useEffect)(() => {
                                        _(n);
                                    }, [n]),
                ...
                const xe = (0, a.forwardRef)(function (e, u) {
                        let t = e.src,
                            n = e.className,
                            s = e.autoplay,
                            o = void 0 !== s && s,
                        ...
                        return (
                            ...
                            (0, a.useEffect)(() => {
                                if (_ && A.current) {
                                    ...
                                    const t = (u) => (
                                        ...
                                        s = (e) => {
                                            A.current && (A.current.currentTime = ye(0, A.current.duration, e));
                                        },
                                        o = () => {
                                            var e;
                            ...
                            r().createElement(
                                'video',
                                Te({ src: t, className: n, style: i, loop: c, ref: A, onClick: m }, d),
                            )
                        );
                    }),
                    Ne = (0, a.memo)(xe),
                    Oe = 'VideoBack_base_e2',
                    ...
                    He = () => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(Ne, {
                                className: ke,
                                src: Ie(R.videos.clan_supply, `clouds_${e}`),
                                loop: !0,
                                autoplay: !0,
                            }),
                        );
                    },
                    Ve = 'Background_base_f5',
                    Ue = 'Background_base__2x_1b',
                    Ge = 'Background_base__shaded_0f',
                    $e = 'Background_shadow_ba',
                    We = 'Background_videoBack_d9',
                    qe = ({ isShaded: e = !1, withVideo: u = !1 }) => {
                        const t = 2 === s.O.view.getScale();
                        return r().createElement(
                            'div',
                            { className: p()(Ve, t && Ue, e && Ge) },
                            e && r().createElement('div', { className: $e }),
                            u && r().createElement('div', { className: We }, r().createElement(He, null)),
                        );
                    };
                var ze = t(281);
                let je;
                ...
                const Ye = (e) => e.replace(/&nbsp;/g, ' '),
                    ...
                    Ke = (e, u, t = je.left) => e.split(u).reduce(t === je.left ? Qe : Xe, []),
                    Je = (() => {
                        const e = new RegExp(
                    ...
                    uu = (e, u = je.left) => {
                        ...
                        return ((e, u = je.left) => {
                            ...
                            const a =
                                ...
                                r = Ye(e);
                            return Ke(r, /( )/, u).forEach((e) => (t = t.concat(Ke(e, a, je.left)))), t;
                        })(e, u);
                    },
                    tu = 'FormatText_base_d0',
                    au = ({ binding: e, text: u = '', classMix: t, alignment: n = je.left, formatWithBrackets: s }) => {
                        if (null === u) return console.error("FormatText was supplied with 'null'"), null;
                        const o = s && e ? Ze(u, e) : u;
                        return r().createElement(
                            a.Fragment,
                            null,
                            o.split('\n').map((u, s) =>
                ...
                const su = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    iu = 'VehicleInfo_base_5e',
                    lu = 'VehicleInfo_type_7b',
                    cu = (0, I.Pi)(({ isFullName: e = !1, classNames: u }) => {
                        ...
                        return r().createElement(
                            ...
                            ou(a),
                            r().createElement('div', {
                                className: p()(lu, null == u ? void 0 : u.type),
                                style: {
                    ...
                    du = 'Header_vehicleType_40',
                    _u = R.strings.clan_supply.progressionPage.header,
                    Au = (0, I.Pi)(() => {
                        const e = Me().model.isCompleted.get();
                        return r().createElement(
                            'div',
                            { className: Eu },
                            r().createElement('div', { className: Cu }, e ? _u.headingCompleted() : _u.heading()),
                            r().createElement(
                                'div',
                                { className: mu },
                                e
                                    ? r().createElement(au, {
                                          text: _u.subheadingCompleted(),
                                          binding: {
                                              vehicle: r().createElement(cu, {
                                                  isFullName: !0,
                                                  classNames: { type: du },
                                              }),
                                          },
                ...
                const pu = ({
                    ...
                    const A = (0, a.useRef)(null),
                        ...
                        S = f[1],
                        w = (0, a.useCallback)(() => {
                            s || (A.current && (A.current.focus(), D(!0)));
                        }, [s]),
                        M = (0, a.useCallback)(
                            (e) => {
                        ...
                        k = p()(gu.state, gu.state__default);
                    return (
                        (0, a.useEffect)(
                            () => (
                ...
                pu.defaultProps = { type: Fu.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Bu = (0, a.memo)(pu),
                    ...
                    wu = 'Error_button_84',
                    Mu = ({ heading: e, description: u, reloadButtonText: t, onReloadClick: a }) =>
                        r().createElement(
                            'div',
                            { className: hu },
                            r().createElement(
                            ...
                            r().createElement(Bu, { mixClass: wu, type: 'secondary', onClick: a }, t),
                        ),
                    Ru = R.strings.clan_supply.progressionPage.errorScreen,
                    yu = (0, I.Pi)(() => {
                        const e = Me().controls;
                        return r().createElement(Mu, {
                            heading: Ru.heading(),
                            description: Ru.description(),
                            reloadButtonText: Ru.button.refresh(),
                    ...
                    Tu = 'Spinner_gear_c4',
                    xu = 'Spinner_logo_bf',
                    Nu = ({ message: e, className: u, classNames: t }) =>
                        r().createElement(
                            'div',
                            { className: p()(Pu, u) },
                            e && r().createElement('div', { className: p()(Lu, null == t ? void 0 : t.caption) }, e),
                            r().createElement('div', { className: p()(Tu, null == t ? void 0 : t.gear) }),
                            r().createElement('div', { className: p()(xu, null == t ? void 0 : t.logo) }),
                        ),
                    Ou = 'LoadingScreen_caption_88',
                    ku = () => {
                    ...
                    qu = ({ isPremium: e, svgNumberPath: u, isOnMap: t, status: a, isSelected: n, scale: s }) => {
                        const o = t ? 64 : 45,
                            i = a === Fe.Available;
                        return r().createElement(
                            'svg',
                            {
                                ...
                                className: p()(
                                    Wu.base,
                                    Wu[`base__${a || 0 === a ? pe[a] : Fe.Disabled}Status`],
                                    n && Wu.base__selected,
                                    t && Wu.base__onMap,
                                ),
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement('stop', { className: Wu.bodyStopColor1, offset: '0%' }),
                                    r().createElement('stop', { className: Wu.bodyStopColor2, offset: '100%' }),
                                ),
                                r().createElement(
                                    'linearGradient',
                                    { id: 'gradient-joint', x1: '0%', y1: '0%', x2: '0%', y2: '100%' },
                                    r().createElement('stop', {
                                        className: Wu.jointStopColor,
                                        stopOpacity: '0',
                                        offset: '0%',
                                    }),
                                    r().createElement('stop', {
                                ...
                                r().createElement(
                                    ...
                                    r().createElement('stop', { className: Wu.backStopColor1, offset: '0%' }),
                                    r().createElement('stop', { className: Wu.backStopColor2, offset: '100%' }),
                                ),
                                r().createElement(
                                    'radialGradient',
                                    {
                    ...
                    ju = R.videos.clan_supply,
                    Zu = (0, I.Pi)(({ isSelected: e = !1, id: u, status: t, isPremium: n, scale: s }) => {
                        const o = Me(),
                            i = o.model,
                            l = o.controls,
                            c = Hu[u].svgPath,
                        ...
                        return (
                            ...
                            r().createElement(
                                ...
                                r().createElement('div', { className: zu.highlightPoint }),
                                m &&
                                    r().createElement(
                                        'div',
                                        { className: zu.highlightPremium },
                                        r().createElement(Ne, {
                                            className: zu.highlightPremiumVideo,
                                            src: e ? ju.spark_yellow() : ju.spark_white(),
                                            ref: E,
                                            loop: !0,
                                            autoplay: !0,
                                        }),
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement('path', {
                                    ...
                                    clipRule: 'evenodd',
                                    d: e,
                                    className: p()(Yu.routePath, Yu[`routePath__${s}Status`]),
                                }),
                            ),
                        ),
                    Xu = 'Progression_base_b9',
                    Ku = 'Progression_mapContainer_dd',
                    Ju = 'Progression_stage_63',
                    et = 'Progression_route_fc',
                    ut = (0, I.Pi)(() => {
                        const e = Me().model,
                            ...
                            n = S().mediaWidth,
                            o = ((e) => ({ width: Iu[e].width, height: Iu[e].height }))(n),
                                ...
                                Vu.map((e, u) => {
                                    const t = e.svgPath,
                                        ...
                                        E =
                                            ((C = a[c].status),
                                            (m = a[s].status),
                                            C === Fe.Available && m === Fe.Opened
                                                ? Uu
                                                : C === Fe.Opened && m === Fe.Opened
                                                  ? $u
                                                  : Gu);
                                    var C, m;
                            ...
                            r().createElement(
                                ...
                                _e(t, (e, t) => {
                                    const a = e.id,
                                        s = e.status,
                                        o = e.isPremium,
                                        i = Hu[a].coordinates[n],
                                        l = i.top,
                                        E = i.left;
                                    return r().createElement(
                                        'div',
                                        { key: t, className: Ju, style: { transform: `translate(${E}rem, ${l}rem)` } },
                                        r().createElement(Zu, {
                                            id: a,
                                            status: s,
                                            isPremium: o,
                ...
                const ot = (e) => {
                        ...
                        return r().createElement(
                            ...
                            st(
                                {
                                    ...
                                    className: p()(
                                        rt.base,
                                        i && rt.base__disabled,
                                        c && rt.base__visibleLabel,
                                        !i && w && rt.base__mouseDown,
                                        !i && P && rt.base__hovered,
                                        n,
                                    ),
                                    onClick: O,
                                    onMouseEnter: H,
                            ...
                            t &&
                                r().createElement(
                                    'div',
                                    { className: p()(rt.label, rt[`label__${A}`], null == s ? void 0 : s.label) },
                                    t,
                                ),
                        );
                    },
                    it = 'VehicleReward_base_1f',
                    lt = 'VehicleReward_base__available_7c',
                    ct = 'VehicleReward_content_5e',
                    Et = 'VehicleReward_shadow_e3',
                    ...
                    dt = (0, I.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(cu, { classNames: { base: mt } }),
                            ),
                        );
                    });
                let _t, At, gt, Ft, Dt, pt, Bt, ht, bt;
                !(function (e) {
                    (e[(e.PENDING = 0)] = 'PENDING'), (e[(e.ERROR = 1)] = 'ERROR'), (e[(e.LOADED = 2)] = 'LOADED');
                })(_t || (_t = {})),
                    (function (e) {
                ...
                const vt = [
                        ...
                        gt.NaturalCover,
                        gt.BpCoin,
                        gt.BattlePassSelectToken,
                        gt.BattlaPassFinalAchievement,
                        gt.BattleBadge,
                        gt.BonusX5,
                        gt.CrewBonusX3,
                        gt.NewYearInvoice,
                        gt.EpicSelectToken,
                        gt.Comp7TokenWeeklyReward,
                        gt.DeluxeGift,
                        gt.BattleBoosterGift,
                        gt.OptionalDevice,
                    ],
                    St = [gt.Gold, gt.Credits, gt.Crystal, gt.FreeXp],
                    wt = [gt.BattlePassPoints, gt.EquipCoin],
                    Mt = [gt.PremiumPlus, gt.Premium],
                    Rt = ['engravings', 'backgrounds'],
                ...
                const kt = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    Ht = ({
                        ...
                        const m = ((e, u) => {
                            ...
                            d = ((e) => {
                                ...
                                switch (e) {
                                    ...
                                    case Bt.PROGRESSION_STYLE_UPGRADED_5:
                                        return bt.PROGRESSION_STYLE_UPGRADED_5;
                                    case Bt.PROGRESSION_STYLE_UPGRADED_6:
                            ...
                            _ = ((e, u) => {
                                ...
                                switch (u) {
                                    ...
                                    case pt.CURRENCY:
                                    case pt.NUMBER:
                                        return r().createElement(ft, { format: 'integral', value: Number(e) });
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                kt,
                                { tooltipArgs: E, className: It.tooltipWrapper },
                                r().createElement(
                                    r().Fragment,
                                    null,
                                    r().createElement(
                ...
                const Gt = R.strings.clan_supply.progressionPage.stageInfo,
                    $t = (0, I.Pi)(({ isReceived: e }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: Vt.label },
                                e ? Gt.rewardsReceivedLabel() : Gt.rewardsLabel(),
                            ),
                            _e(u, (e, u) => {
                                const t = e.tooltipId,
                                    a = Pt(e, Dt.Small),
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            ...
                                            {
                                                type: Fu.primary,
                                                size: o < b.Medium ? Du.small : Du.medium,
                                                onClick: () => t(),
                                                disabled: s,
                                                soundClick: 'yes',
                                            },
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: jt.icon },
                                    r().createElement(qu, { isPremium: s, svgNumberPath: d, scale: m }),
                                ),
                                    ...
                                    switch (!0) {
                                        ...
                                        default:
                                            return r().createElement(ta, {
                                                ...
                                                deficiencyAmount: c,
                                                buttonClick: A,
                                                isButtonDisabled: !l || o === At.UNAVAILABLE || E,
                                                isEnoughMoney: l,
                                                isStageUnavailable: o === At.UNAVAILABLE,
                                            });
                                    }
                                })(),
                            ),
                    ...
                    Da = {
                        ...
                        [Re.LOADED]: () =>
                            r().createElement(
                                r().Fragment,
                                null,
                                r().createElement('div', { className: p()(_a, Aa) }, r().createElement(ut, null)),
                                r().createElement('div', { className: ga }, r().createElement(dt, null)),
                    ...
                    Ba = (0, I.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: ma },
                                r().createElement('div', { className: da }, r().createElement(Au, null)),
                ...
                const wa = ie()(
                    ...
                    Pa = 'ErrorScreen_header_68',
                    La = 'ErrorScreen_icon_86',
                    Ta = 'ErrorScreen_heading_0b',
                    ...
                    ka = (0, I.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement('div', { className: Ta }, Oa.heading()),
                            ),
                    ...
                    Ua = 'ClaimTheReward_buttonWrapper_d3',
                    Ga = 'ClaimTheReward_glow_07',
                    ...
                    Ka = 'NonClanMemberWarning_button_75',
                    Ja = R.strings.clan_supply.questsPage.footer,
                    er = (0, I.Pi)(() => {
                        const e = Ra().controls;
                        return r().createElement(
                            'div',
                            ...
                            r().createElement('div', { className: Xa }, Ja.message.nonClanMember()),
                            r().createElement(
                                Bu,
                                { mixClass: Ka, type: 'primary', onClick: e.goToClans },
                                Ja.button.nonClanMember(),
                            ),
                        );
                    }),
                    ur = (0, I.Pi)(() => {
                        const e = Ra().model.root.get().status;
                        return r().createElement(
                            'div',
                            { className: Za },
                            (() => {
                    ...
                    tr = 'Header_base_11',
                    ar = 'Header_heading_9f',
                    rr = 'Header_subheading_43',
                    nr = R.strings.clan_supply.questsPage.header,
                    sr = (0, I.Pi)(() => {
                        const e = Ra().model.root.get().cycleDuration;
                        return r().createElement(
                            'div',
                            { className: tr },
                            r().createElement('div', { className: ar }, nr.heading()),
                            r().createElement(au, { classMix: rr, text: nr.subheading(), binding: { hours: e } }),
                        );
                    }),
                    or = {
                    ...
                    lr = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    cr = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    Er = (0, a.memo)(({ text: e, binding: u, classMix: t }) => {
                                ...
                                (i = i.replace(t, `%(${o})`)),
                                    (s[o] = or[e]
                                        ? r().createElement(
                                              'span',
                                              { className: or[e] },
                                              r().createElement(au, { text: E, binding: u }),
                                          )
                                        : r().createElement(
                                              'span',
                                              { style: n(e) },
                        ...
                        return r().createElement(au, { text: i, classMix: t, binding: s });
                    }),
                    ...
                    dr = ({
                        ...
                        return r().createElement(Er, { classMix: Cr, text: s, binding: JSON.parse(n) });
                    },
                    _r = 'Icon_base_77',
                    Ar = ({ level: e }) => {
                        const u = S().mediaSize;
                ...
                const pr = ({ size: e = Fr.Default }) => {
                        const u = p()(gr.background, gr[`background__${e}`]);
                        return r().createElement('div', { className: u });
                    },
                    Br = { base: 'ProgressBarBlink_base_24', base__small: 'ProgressBarBlink_base__small_0f' },
                    hr = ({ size: e }) => {
                    ...
                    fr = (0, a.memo)(
                        ({ size: e, lineRef: u, disabled: t, baseStyles: a, isComplete: n, withoutBounce: s }) => {
                            const o = p()(
                                    ...
                                    t && br.base__disabled,
                                    n && br.base__finished,
                                    s && br.base__withoutBounce,
                                ),
                                i = !t && !n;
                            return r().createElement(
                                'div',
                                { className: o, style: a, ref: u },
                                r().createElement('div', { className: br.pattern }),
                                r().createElement('div', { className: br.gradient }),
                                i && r().createElement(hr, { size: e }),
                            );
                        },
                    ),
                    vr = ({ size: e, value: u, lineRef: t, disabled: n, onComplete: s }) => {
                        ...
                        return (
                            ...
                            r().createElement(fr, { size: e, disabled: n, baseStyles: o, isComplete: i, lineRef: t })
                        );
                    },
                    Sr = (e, u) => {
                        let t;
                ...
                const Rr = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    Pr = (0, a.memo)(
                        ({
                            ...
                            return _
                                ...
                                : r().createElement(
                                      'div',
                                      { className: Rr, style: p },
                                      r().createElement(
                                          'div',
                                          { style: A ? F : D, className: yr },
                                          r().createElement(hr, { size: s }),
                                      ),
                                  );
                        },
                    ),
                    ...
                    Tr = 'ProgressBarDeltaGrow_base_7e',
                ...
                const $r = (0, a.memo)((e) => {
                        ...
                        switch (n.animationSettings.type) {
                            case Dr.Simple:
                                return r().createElement(Lr, Gr({}, n, { onEndAnimation: l, isComplete: o }));
                            case Dr.Growing:
                ...
                const zr = (0, a.memo)((e) => {
                    ...
                    return (
                        (n.current.from = o),
                        r().createElement($r, qr({}, t, { onEndAnimation: s, key: `${o}-${t.to}`, from: o }))
                    );
                });
                function jr() {
                    return (
                ...
                const Zr = (0, a.memo)(
                        ({
                            ...
                            return s.withStack
                                ? r().createElement(zr, c)
                                : r().createElement($r, jr({ key: `${n}-${u}` }, c));
                        },
                    ),
                    Yr = (e) => ({
                        ...
                        ({
                            ...
                            const d = ((e, u, t) =>
                                (0, a.useMemo)(() => {
                                    ...
                                    return { value: a, deltaFrom: Qr(a, u, t) };
                                }, [t, u, e]))(i, e, l);
                            return r().createElement(
                                'div',
                                { className: p()(gr.base, gr[`base__${t}`]), style: Yr(u) },
                                !o && r().createElement(pr, { size: t }),
                                r().createElement(Zr, {
                                    size: t,
                                    lineRef: c,
                                    disabled: s,
                    ...
                    un = ({ currentProgress: e, requiredProgress: u, status: t, isNonClanPlayer: a }) => {
                        const n = t === fa.COMPLETE || t === fa.REWARD_AVAILABLE || t === fa.REWARD_PENDING;
                        return r().createElement(
                            'div',
                            { className: p()(en.base, t === fa.IN_PROGRESS && en.base__inProgress) },
                            r().createElement(
                                'div',
                                { className: en.counter },
                                n
                                    ? r().createElement('div', { className: en.check })
                                    : r().createElement(
                                          r().Fragment,
                                          null,
                                          r().createElement(
                                              'span',
                                              { className: p()(en.current, e > 0 && en.current__started) },
                                              e,
                                          ),
                                          r().createElement('span', { className: en.slash }, '/'),
                                          r().createElement('span', { className: en.requested }, u),
                                      ),
                            ),
                            r().createElement(Jr, {
                                value: e,
                    ...
                    tn = 'QuestCard_base_d0',
                    an = 'QuestCard_icon_e1',
                    rn = 'QuestCard_base__disabled_59',
                    nn = 'QuestCard_condition_1c',
                    sn = 'QuestCard_progress_94',
                    on = 'QuestCard_footer_62',
                    ln = 'QuestCard_rewards_68',
                    cn = 'QuestCard_reward_cb',
                    En = 'QuestCard_rewardStatus_8e',
                    Cn = {
                        base: 'Reward_base_fa',
                        icon: 'Reward_icon_f2',
                    ...
                    An = R.strings.clan_supply.questsPage.questCard.tooltip.status.disabled,
                    gn = (0, I.Pi)(({ status: e }) => {
                        const u = Ra().model.root.get().status;
                        return e === fa.IN_PROGRESS
                            ? null
                            : r().createElement(
                                  'div',
                                  { className: p()(dn.base, dn[`base__${_n[e]}`]) },
                                  e === fa.DISABLED &&
                                      r().createElement(
                                          ue,
                                          {
                                              ...
                                              body:
                                                  u === ba.PREVIOUS_REWARDS
                                                      ? An.body.previousCycleRewardNotClaimed()
                                                      : An.body.previousQuestRewardNotClaimed(),
                                          },
                                          r().createElement('div', { className: dn.icon }),
                                      ),
                                  R.strings.clan_supply.questsPage.questCard.status.$dyn(_n[e]),
                              );
                    }),
                    Fn = ({
                        level: e,
                        ...
                        r().createElement(
                            'div',
                            { className: p()(tn, E && rn) },
                            r().createElement('div', { className: an }, r().createElement(Ar, { level: e })),
                            r().createElement(
                                'div',
                                { className: nn },
                                r().createElement(dr, {
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    _e(c, (e) =>
                                        r().createElement(
                                            'div',
                                            { key: e.name, className: cn },
                                            r().createElement(mn, e),
                                        ),
                                    ),
                                ),
                                r().createElement('div', { className: En }, r().createElement(gn, { status: l })),
                            ),
                        ),
                    Dn = 'Quests_base_1a',
                    pn = 'Quests_separator_a4',
                    Bn = 'Quests_separator__nextQuestAvailable_c1',
                    hn = 'Quests_activeSeparator_fd';
                function bn() {
                    return (
                        (bn =
                            Object.assign ||
                                ...
                                return r().createElement(
                                    ...
                                    a !== n.length - 1 &&
                                        r().createElement(
                                            'div',
                                            { className: p()(pn, s && Bn) },
                                            s && r().createElement('div', { className: hn }),
                                        ),
                                );
                            }),
                        );
                ...
                V.Sw.instance;
                const xn = Ln,
                    Nn = 'Countdown_base_0c',
                    On = 'Countdown_iconContainer_eb',
                    kn = 'Countdown_icon_80',
                    In = 'Countdown_countdown_63',
                    Hn = 'Countdown_base__expired_92',
                    Vn = (0, I.Pi)(() => {
                        const e = Ra().model.root.get().updateTime,
                            ...
                            s = a
                                ...
                                : ((e, u) => {
                                      switch (u) {
                                          case 'short':
                                              return `${yn(e.minutes)} : ${yn(e.seconds)}`;
                                          case 'long':
                                              return `${yn(e.hours)} : ${yn(e.minutes)} : ${yn(e.seconds)}`;
                                      }
                                  })(
                                      (function (e = 0) {
                                          let u = e;
                                          const t = Math.trunc(u / Rn);
                                          u -= t * Rn;
                                          const a = Math.trunc(u / Mn);
                                          u -= a * Mn;
                                          const r = Math.trunc(u / wn);
                                          return (u -= r * wn), { days: t, hours: a, minutes: r, seconds: u };
                                      })(t),
                                      n,
                                  );
                        return r().createElement(
                            'div',
                            { className: p()(Nn, a && Hn) },
                            r().createElement('div', { className: On }, r().createElement('div', { className: kn })),
                            r().createElement('div', { className: In }, s),
                        );
                    }),
                    Un = {
                    ...
                    $n = (0, I.Pi)(() => {
                        ...
                        return r().createElement(
                            'div',
                            { className: Un.base },
                            r().createElement('div', { className: Un.heading }, Gn.heading()),
                            r().createElement(
                                'div',
                                { className: Un.countdownWrapper },
                                r().createElement('div', { className: p()(Un.line, Un.line__left) }),
                                u && r().createElement('div', { className: Un.glow }),
                                r().createElement('div', { className: Un.countdown }, r().createElement(Vn, null)),
                                r().createElement('div', { className: p()(Un.line, Un.line__right) }),
                            ),
                        );
                    }),
                    Wn = (0, I.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement('div', { className: vn.header }, r().createElement(sr, null)),
                            (() => {
                                switch (e) {
                                    case ba.PENDING:
                                        return r().createElement(
                                            'div',
                                            { className: vn.spinner },
                                            r().createElement(Nu, {
                                                message: R.strings.clan_supply.questsPage.loading(),
                                            }),
                                        );
                                    case ba.ERROR:
                                        return r().createElement(
                                            'div',
                                            { className: vn.errorScreenWrapper },
                                            r().createElement(
                                                'div',
                                                { className: vn.errorScreen },
                                        ...
                                        return r().createElement(
                                            ...
                                            r().createElement(
                                                'div',
                                                {
                                                    className: p()(
                                                        vn.footer,
                                                        e === ba.PLAYER_NOT_IN_CLAN && vn.footer__notInClan,
                                                        e === ba.PREVIOUS_REWARDS && vn.footer__previousRewards,
                                                    ),
                                                },
                    ...
                    qn = { context: 'model.questsModel' },
                    zn = {
                        [ge.Progression]: () => r().createElement(we, { options: ha }, r().createElement(Ba, null)),
                        [ge.Quests]: () => r().createElement(Ma, { options: qn }, r().createElement(Wn, null)),
                    },
                    jn = ({ pageView: e }) => {
                        const u = zn[e];
                        return u ? r().createElement(u, null) : (console.error('Unreachable code: ViewResolver'), null);
                ...
                const Yn = {
                    ...
                    Qn = r().forwardRef(function ({ classNames: e, arrowRef: u, size: t = 'medium', className: a }, n) {
                        return r().createElement(
                            'div',
                            { className: p()(Yn.base, Yn[`base__${t}`], a), ref: n },
                            r().createElement('div', {
                                className: p()(
                                    Yn.border,
                                    Yn.border__top,
                            ...
                            r().createElement('div', {
                                className: p()(Yn.arrow, null == e ? void 0 : e.arrow),
                                ref: u,
                            }),
                        );
                    }),
                    ...
                    Kn = { mouseEnter: 'highlight', click: 'play' },
                            ...
                            A = r().createElement(
                                'div',
                                {
                                    className: p()(
                                        Xn.base,
                                        Xn[`base__${i}`],
                                        u && p()(Xn.base__active, null == a ? void 0 : a.activeTab),
                                        t,
                                    ),
                                    onClick: ((e) => () => {
                                ...
                                r().createElement('div', {
                                    className: p()(Xn.highlight, null == a ? void 0 : a.highlight),
                                }),
                                'function' == typeof o && i
                                    ? o(i)
                                    : r().createElement('div', {
                                          className: p()(Xn.icon, Xn[`icon__${i}`], null == a ? void 0 : a.icon),
                                ...
                                s &&
                                    r().createElement(
                                        'div',
                                        {
                                            className: p()(
                                                Xn.notification,
                                                Xn[`notification__${s.type}`],
                                                s.size ? Xn[`notification__${s.size}`] : Xn.notification__medium,
                    ...
                    us = r().memo(function ({
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                { className: p()(es.base, n), ref: g },
                                u.map(({ id: u, items: a, title: n, groupClassNames: s }) =>
                                    r().createElement(
                                        'div',
                                        {
                                            key: u,
                                            className: p()(es.group, es[`group__${i}`], null == s ? void 0 : s.group),
                                        },
                                        n &&
                                            r().createElement(
                                                'div',
                                                { className: p()(es.title, null == s ? void 0 : s.title) },
                                                n,
                                            ),
                    ...
                    ts = R.strings.clan_supply.sidebar.tabs.tooltip,
                    as = ({ children: e, id: u }) => {
                        const t = De[u];
                        return r().createElement(ue, { header: `${ts.header.$dyn(t)}`, body: `${ts.body.$dyn(t)}` }, e);
                    },
                    rs = { icon: 'Tabs_icon_02' },
                    ns = (0, I.Pi)(({ pageView: e, className: u }) => {
                        const t = ve(),
                            n = t.model,
                            s = t.controls,
                    ...
                    ds = (0, I.Pi)(() => {
                        ...
                        return (
                            ...
                            r().createElement(
                                'div',
                                { className: ss },
                                r().createElement('div', { className: os }, r().createElement(jn, { pageView: n })),
                                r().createElement(
                                    fe,
                                    { options: Cs },
                                    r().createElement(ns, { pageView: n, className: is }),
                                ),
                                r().createElement(
                                    'div',
                                    { className: ls },
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [687], () => __webpack_require__(223));
