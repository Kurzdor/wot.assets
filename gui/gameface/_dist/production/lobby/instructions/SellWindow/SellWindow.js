(() => {
    var __webpack_modules__ = {
            768: (e, u, t) => {
                ...
                var n = {};
                t.r(n),
                    t.d(n, { mouse: () => m, off: () => E, on: () => l, onResize: () => c, onScaleUpdated: () => _ });
                var i = {};
                t.r(i),
                    t.d(i, {
                        events: () => n,
            ...
            364: (e, u, t) => {
                'use strict';
                t.d(u, { Sw: () => r.Z, B3: () => c, Z5: () => s, B0: () => a, SU: () => g, ry: () => D });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            634: (e, u, t) => {
                ...
                I.defaultProps = { type: M.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const O = I,
