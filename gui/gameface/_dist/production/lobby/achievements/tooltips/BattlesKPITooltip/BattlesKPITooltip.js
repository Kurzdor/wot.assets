    ...
    var u,
        A = {
            6977: (u, A, F) => {
                var E = {};
                F.r(E),
                    F.d(E, { mouse: () => T, off: () => O, on: () => P, onResize: () => y, onScaleUpdated: () => _ });
                var e = {};
                F.r(e),
                    F.d(e, {
                        events: () => E,
                ...
                var D = {};
                F.r(D), F.d(D, { getBgUrl: () => L, getTextureUrl: () => k });
                var B = {};
                F.r(B),
                    F.d(B, {
                        addModelObserver: () => J,
                ...
                const _u = ((u, A) => {
                    ...
                    Ou = _u[1],
                    Su = 'App_base_99',
                    Ru = 'App_bottomBlock_5e',
                    Tu = 'App_topBlock_67',
                    zu = 'App_divider_31',
                    ju = 'App_titleBLock_f7',
                    Mu = 'App_amount_18',
                    ku = 'App_description_3c',
                    Lu = 'App_stats_7e',
                    Nu = R.strings.achievements_page.tooltips.KPI.battles,
                    Vu = (0, gu.Pi)(() => {
                            ...
                            t().createElement(
                                ...
                                t().createElement(
                                    ...
                                    t().createElement(
                                        ...
                                        t().createElement(w, {
                                            text: Nu.title.top(),
                                            binding: { count: t().createElement('div', { className: Mu }, A) },
                                        }),
                                    ),
                                    t().createElement('div', { className: ku }, Nu.description.top.base()),
                                    t().createElement(w, {
                                        classMix: Lu,
                                        text: Nu.description.top.stats(),
                                ...
                                t().createElement(
                                    'div',
                                    { className: Ru },
                                    t().createElement('div', { className: zu }),
                                    t().createElement(
                                        'div',
                                        { className: ju },
                                        t().createElement(w, {
                                            text: Nu.title.bottom(),
                                            binding: { percent: t().createElement('div', { className: Mu }, D) },
                                        }),
                                    ),
                                    t().createElement('div', { className: ku }, Nu.description.bottom()),
                                ),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement(Pu, null, t().createElement(Vu, null)),
