(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => o, off: () => D, on: () => n, onResize: () => F, onScaleUpdated: () => r });
                var E = t(2472),
                    A = t(1176);
            ...
            9916: (u, e, t) => {
                ...
                function l(u, e, t, E, A, F, r) {
                    ...
                    n.done ? e(D) : Promise.resolve(D).then(E, A);
                }
            ...
            9453: (u, e, t) => {
                ...
                const x = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    M = (u, e, t = T.left) => u.split(e).reduce(t === T.left ? O : P, []),
                    L = (() => {
                        const u = new RegExp(
                    ...
                    N = (u, e = T.left) => {
                        ...
                        return ((u, e = T.left) => {
                            ...
                            const E =
                                ...
                                A = x(u);
                            return M(A, /( )/, e).forEach((u) => (t = t.concat(M(u, E, T.left)))), t;
                        })(u, e);
                    },
                ...
                const q = ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE()),
                    ...
                    H = (0, E.memo)(({ text: u, binding: e, classMix: t }) => {
                        ...
                        return A().createElement(I, { text: D, classMix: t, binding: r });
                    }),
                ...
                const Eu = {
                    ...
                    ru = ({ className: u, currentSubLevelType: e, list: t }) => {
                        const E = [
                                ...
                                null == E
                                    ...
                                    : E.map((u) =>
                                          A().createElement(
                                              ...
                                              A().createElement(
                                                  'div',
                                                  { className: D()(Eu.tableCell, Eu.tableCell__header) },
                                                  u.title,
                                              ),
                                          ),
                                      ),
                            ...
                            null == F
                                ...
                                : F.map((u, t) => {
                                      ...
                                      return A().createElement(
                                          ...
                                          A().createElement(
                                              'div',
                                              { className: D()(Eu.row, E && Eu.row__active) },
                                              E && A().createElement('div', { className: Eu.rowBackground }),
                                              A().createElement(
                                                  'div',
                                                  { className: D()(Eu.tableCell, Eu.tableCell__row) },
                                                  A().createElement(
                                                      'div',
                        ...
                        return A().createElement(
                            ...
                            A().createElement(
                                ...
                                A().createElement(
                                    'div',
                                    { className: ou },
                                    A().createElement(ru, { currentSubLevelType: i, list: n }),
                                ),
                            ),
                        );
                    });
