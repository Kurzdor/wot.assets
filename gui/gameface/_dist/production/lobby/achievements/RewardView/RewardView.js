    ...
    var __webpack_modules__ = {
            ...
            9551: (e, u, t) => {
                ...
                const xe = ((e, u) => {
                        ...
                        ({ observableModel: e }) => {
                            const u = {
                                    ...
                                    animationState: me.LO.box(ve.Initial),
                                },
                                t = (0, be.Om)(() =>
                                    pe(u.rewards.get(), (e) =>
                                        ((e) => {
                        ...
                        const p = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, a.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (je(t, m, { isMouseEvent: !0, on: !0, arguments: ze(n) }, b),
                                    h && h(),
                ...
                const pu = R.images.gui.maps.icons.advanced_achievements,
                    bu = {
                        [Bu.S100x100]: Cu.s54x68,
                        [Bu.S128x128]: Cu.s68x82,
                        [Bu.S180x180]: Cu.s100x118,
                        [Bu.S280x280]: Cu.s156x182,
                        [Bu.S360x360]: Cu.s200x236,
                        [Bu.S420x420]: Cu.s250x278,
                    },
                    vu = ({
                        keyName: e,
                        backgroundName: u,
                        ...
                        return n().createElement(
                            ...
                            n().createElement('div', {
                                ...
                                style: { backgroundImage: `url(${pu.icons.category.$dyn(`${e}_${a}_${bu[i]}`)})` },
                            }),
                        );
                    },
                    fu = {
                    ...
                    Uu = (0, Y.Pi)(({ index: e, className: u }) => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(Ou, {
                                ...
                                backgroundName: _,
                                type: E,
                                size: i < b.ExtraLarge ? nu.S100x100 : nu.S128x128,
                                isTrophy: m,
                                stage: g,
                                iconPosition: A,
                                iconSizeMap: F,
                ...
                const zu = ({ children: e, tooltipArgs: u, className: t }) => {
                        ...
                        const r = u.contentId;
                        return r ? n().createElement(Ye, qu({}, u, { contentId: r }), a) : n().createElement(Wu, u, a);
                    },
                    ju = {
                        base: 'Reward_base_ea',
                ...
                const Et = { duration: 500, easing: Te.easeOutBack },
                    ...
                    Ft = ({
                        ...
                        return n().createElement(
                            ...
                            l &&
                                n().createElement(
                                    ye.animated.div,
                                    { className: it.backplateBox, style: b },
                                    n().createElement(
                                        'div',
                                        {
                    ...
                    Dt = (e) =>
                        e
                            ? {
                                  [b.ExtraSmall]: _t.Small,
                                  [b.Small]: _t.Small,
                                  [b.Medium]: _t.Medium,
                                  [b.Large]: _t.Medium,
                                  [b.ExtraLarge]: _t.Large,
                              }
                            : {
                                  [b.ExtraSmall]: _t.ExtraSmall,
                                  [b.Small]: _t.ExtraSmall,
                                  [b.Medium]: _t.Small,
                                  [b.Large]: _t.Small,
                                  [b.ExtraLarge]: _t.Medium,
                              },
                ...
                const pt = (0, Y.Pi)(({ index: e, delay: u, className: t }) => {
                    ...
                    kt = (0, Y.Pi)(({ className: e }) => {
                        ...
                        return n().createElement(
                            'div',
                            { className: B()(wt.base, u.animationState.get() > ve.Initial && wt.base__shown, e) },
                            ((e, u) => {
                                const t = [];
                    ...
                    $t = (0, Y.Pi)(({ className: e }) => {
                        ...
                        return (
                            (0, a.useEffect)(() => {
                                i === ve.RewardsShown && (c.start(Ut), E.start(Ut));
                            }, [c, E, i]),
                            n().createElement(
                                'div',
                                { className: B()(Pt, e) },
                                ...
                                n().createElement(kt, { className: Mt }),
                    ...
                    Vt = (0, Y.Pi)(() => {
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: B()(Wt, u.animationState.get() > ve.Initial && qt) },
                                    n().createElement(G, {
                                ...
                                n().createElement('div', { className: zt }, n().createElement($t, { className: Yt })),
                            )
                        );
                    });
                engine.whenReady.then(() => {
