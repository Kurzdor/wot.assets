(() => {
    ...
    var __webpack_modules__ = {
            ...
            916: (u, e, t) => {
                t.d(e, { Sw: () => a.Z, B3: () => i, Z5: () => s.Z5, B0: () => o, ry: () => _ });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            188: (u, e, t) => {
                            ...
                            (() => {
                                if (n.days > 30)
                                    return o().createElement(V, {
                                        ...
                                        binding: { fullDate: N(u, B.FullDate) },
                                    });
                                if (n.days)
                                    return o().createElement(V, {
                ...
                const ru = [
                        ...
                        K.BattleBoosterGift,
                        K.OptionalDevice,
                        K.FragmentAntimatter,
                        K.CosmicLootbox,
                    ],
                    au = [K.Gold, K.Credits, K.Crystal, K.FreeXp],
                    su = [K.BattlePassPoints],
                    ou = [K.PremiumPlus, K.Premium],
                ...
                const Cu = 'normal',
                                    ...
                                    A = (t, n, r) => {
                                        ...
                                        const o = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = du(r.keys()); !(u = t()).done; ) s(u.value, e);
                                                    },
                                                    unsubscribe: s,
                                                };
                                            })(n),
                    ...
                    Ru = R.strings.battle_matters.entryPointTooltip.header,
                    Pu = (0, d.Pi)(() => {
                        const u = hu().model,
                        ...
                        return o().createElement(
                            ...
                            o().createElement('div', { className: yu.title }, Ru.title()),
                            e === Cu &&
                                o().createElement(
                                    'div',
                                    { className: yu.progress },
                                    o().createElement(V, { text: Ru.progress(), binding: { done: t, total: n } }),
                                ),
                        );
                    }),
                    Su = [
                ...
                const qu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return o().createElement($u, e, n);
                        const r = e.contentId;
                        return r ? o().createElement(xu, zu({}, e, { contentId: r }), n) : o().createElement(Mu, e, n);
                    },
                    Wu = {
                        base: 'Reward_base_ea',
                ...
                const Ku = o().memo(
                                          ...
                                          u
                                              ...
                                              .map((u, t) =>
                                                  o().createElement(
                                                      'div',
                                                      { key: t, className: D },
                                                      o().createElement(ju, Qu({ size: e }, u)),
                                                  ),
                                              ),
                                          o().createElement(
                                              'div',
                    ...
                    te = (0, d.Pi)(() => {
                        ...
                        return o().createElement(
                            ...
                            o().createElement(Ku, { rewardItemClassMix: ue, size: J.Small, data: u, count: e }),
                        );
                    }),
                    ne = {
                ...
                const Ee = ({ size: u = oe.Default }) => {
                        const e = r()(se.background, se[`background__${u}`]);
                ...
                const me = 'ProgressBarDeltaSimple_base_6c',
                    ...
                    ye = (0, s.memo)(
                        ({
                            ...
                            const b = (0, s.useMemo)(() => Object.assign({ width: '100%' }, Te(u), fe(F)), [F, u]),
                                v = (0, s.useMemo)(() => Object.assign({ width: '0%' }, Te(u), fe(F)), [F, u]),
                                h = (0, s.useMemo)(() => Object.assign({ width: '0%' }, we(F, n), Te(u)), [n, F, u]),
                                f = (0, s.useMemo)(
                                    () => Object.assign({ width: `${Math.abs(i - n)}%` }, we(F, n), Te(u)),
                                    [n, F, i, u],
                                );
                            if (B) return null;
                            const w = r()(be, A, F && 0 === i && ve);
                            return o().createElement(
                                'div',
                                { style: _ ? h : f, className: w },
                                o().createElement(
                                    'div',
                    ...
                    Re = (0, s.memo)(
                        ({
                            ...
                            const A = u < t,
                                ...
                                B = (0, s.useMemo)(() => ({ width: `${t}%`, transitionProperty: 'none' }), [t]),
                                _ = (0, s.useMemo)(
                ...
                const Oe = (0, s.memo)((u) => {
                        ...
                        switch (n.animationSettings.type) {
                            case ie.Simple:
                                return o().createElement(pe, Se({}, n, { onEndAnimation: E, isComplete: a }));
                            case ie.Growing:
                                return o().createElement(Re, Se({}, n, { onEndAnimation: E, isComplete: a }));
                            default:
                                return null;
                        }
                    }),
                ...
                const Ne = (0, s.memo)((u) => {
                    ...
                    return (
                        (n.current.from = a),
                        o().createElement(Oe, xe({}, t, { onEndAnimation: r, key: `${a}-${t.to}`, from: a }))
                    );
                });
                function Ie() {
                    return (
                ...
                const Me = (0, s.memo)(
                        ({
                            ...
                            return a.withStack
                                ...
                                : o().createElement(Oe, Ie({ key: `${r}-${e}` }, l));
                        },
                    ),
                    Le = (u) => ({
                        ...
                        return o().createElement(
                            ...
                            u.computes.hasProgress() &&
                                o().createElement(
                                    ...
                                    o().createElement(qe, { size: oe.Small, value: t, maxValue: n }),
                                ),
                        );
                    }),
                    Je = 'Token_base_de',
                                ...
                                return o().createElement(
                                    ...
                                    a &&
                                        o().createElement(
                                            ...
                                            null,
                                            o().createElement('div', { className: fu }),
                                            o().createElement(X, { endDate: r, className: Tu }),
                                        ),
                                );
                            default:
                ...
                engine.whenReady.then(() => {
                    D().render(
                        o().createElement(vu, null, o().createElement(F, null, o().createElement(st, null))),
