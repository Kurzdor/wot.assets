    ...
    var __webpack_modules__ = {
            ...
            296: (u, e, t) => {
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (Ou(t, F, { isMouseEvent: !0, on: !0, arguments: Lu(a) }, b),
                                    C && C(),
                ...
                const Xu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        if (e.header || e.body) return a().createElement(Gu, e, r);
                        const n = e.contentId,
                            i = e.args,
                            s = null == i ? void 0 : i.contentId;
                        return n || s
                            ? a().createElement(yu, Wu({}, e, { contentId: n || s }), r)
                    ...
                    ju = ({
                        ...
                        return a().createElement(
                            'div',
                            { className: p()($u.base, $u[`base__${r}`], E), style: o },
                            a().createElement(
                                Xu,
                                { tooltipArgs: A, className: $u.tooltipWrapper },
                                a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement(
                                        'div',
                                        { className: p()($u.image, null == l ? void 0 : l.image) },
                                        c &&
                                            a().createElement('div', {
                                                className: p()($u.highlight, null == l ? void 0 : l.highlight),
                                                style: {
                                        ...
                                        e &&
                                            a().createElement('div', {
                                                className: p()($u.icon, null == l ? void 0 : l.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        F &&
                                            a().createElement('div', {
                                                className: p()($u.overlay, null == l ? void 0 : l.overlay),
                                                style: {
                            ...
                            t &&
                                a().createElement(
                                    ...
                                    { tooltipArgs: _ },
                                    a().createElement('div', {
                                        className: p()($u.timer, null == l ? void 0 : l.periodicIcon),
                                    }),
                                ),
                        );
                    },
                    qu = ({ index: u, delay: e = 0, children: t }) => {
                    ...
                    Yu = 'MainReward_reward_3e',
                    zu = 'MainReward_info_1c',
                    Vu = 'MainReward_label_47';
                function Ku() {
                    return (
                        (Ku =
                            Object.assign ||
                ...
                const Qu = ({ reward: u, index: e }) => {
                    ...
                    return a().createElement(
                        ...
                        a().createElement(
                            ju,
                            Ku({}, u, { image: u.image(t), size: t, className: Yu, classNames: { info: zu } }),
                        ),
                        a().createElement('div', { className: Vu }, u.label),
                    );
                };
                let Zu;
                !(function (u) {
                        ...
                        return re.includes(t)
                            ...
                            : ((u, e = Zu.left) => {
                                  ...
                                  const r =
                                      ...
                                      a = u.replace(/&nbsp;/g, ' ');
                                  return ee(a, /( )/, e).forEach((u) => (t = t.concat(ee(u, r, Zu.left)))), t;
                              })(u, e);
                    },
                    ne = 'RewardList_base_03',
                    ie = 'RewardList_reward_ef';
                function se() {
                    return (
                        (se =
                            Object.assign ||
                ...
                const oe = ({ data: u, maxRewards: e = 0, showDelay: t = 0 }) => {
                        ...
                        return a().createElement(
                            ...
                            s.map((u, e) =>
                                a().createElement(
                                    ...
                                    a().createElement(ju, se({}, u, { image: u.image(n), size: n, className: ie })),
                                ),
                            ),
                            i &&
                                a().createElement(
                        ...
                        return a().createElement(
                            ...
                            n &&
                                a().createElement(
                                    'div',
                                    { className: E },
                                    a().createElement(oe, { data: t, maxRewards: 10, showDelay: s }),
                                ),
                        );
                    }),
                    le = {
                ...
                const ce = ({
                    ...
                    const m = (0, r.useRef)(null),
                        ...
                        k = p()(le.state, le.state__default);
                    return (
                        (0, r.useEffect)(
                            () => (
                ...
                ce.defaultProps = { type: Ae.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const Fe = (0, r.memo)(ce);
                var De = t(9887),
                    me = t.n(De);
                const de = ['xl', 'lg', 'md', 'sm', 'xs'],
                    Be = (u) => u.includes('_') && ((u) => de.includes(u))(u.split('_').at(-1)),
                    Ce = [w.ExtraLarge, w.Large, w.Medium, w.Small, w.ExtraSmall],
                    ge = (u, e) =>
                ...
                const we = {
                        ...
                        const U = (0, r.useMemo)(() => {
                                const u = { mt: o, mr: l, mb: _, ml: F },
                                    e = ((u) =>
                                        fe.reduce((e, t) => {
                                            const r = u[t];
                                            return r && 'number' != typeof r ? e.concat(we[!0 === r ? 'MD' : r][t]) : e;
                                        }, []))(u),
                                    r = ((u) =>
                                        fe.reduce((e, t) => {
                                            const r = u[t];
                    ...
                    Te = ({ binding: u, text: e = '', classMix: t, alignment: n = Zu.left }) =>
                        null === e
                ...
                const Ne = Object.keys(Le()),
                            ...
                            Pe(
                                {
                                    ...
                                    mb: !0 === c ? Ge[t || 'paragraph-P16'].mb : c,
                                    ml: !0 === D ? Ge[t || 'paragraph-P16'].ml : D,
                                },
                                B,
                            ),
                            void 0 !== d ? a().createElement(Te, Pe({}, d, { text: e })) : e,
                        );
                    }),
                    $e = 'Footer_base_b8',
                    ...
                    ze = (0, Y.Pi)(() => {
                        ...
                        return a().createElement(
                            'div',
                            { className: $e },
                            !r && a().createElement(Xe, { className: je, text: Ye.description() }),
                            a().createElement(
                                'div',
                                { className: qe },
                                a().createElement(
                                    Fe,
                                    { type: Ae.primary, size: _e.medium, onClick: t.close },
                                    a().createElement(Xe, { text: Ye.buttonText() }),
                                ),
                            ),
                        );
                    }),
                    ...
                    ut = () =>
                        a().createElement(
                            'div',
                            { className: Ve },
                            a().createElement(Xe, { className: Ke, text: Je.featureName() }),
                            a().createElement(Xe, { className: Qe, text: Je.title() }),
                            a().createElement(Xe, { className: Ze, text: Je.subTitle() }),
                        ),
                    et = 'App_base_a3',
                    tt = 'App_vignette_b2',
                    rt = 'App_header_97',
                    ...
                    st = (0, Y.Pi)(() => {
                        ...
                        return (
                            ...
                            a().createElement(
                                ...
                                a().createElement('div', { className: at }, a().createElement(Ee, null)),
                                a().createElement(W, {
