    ...
    var u,
        e = {
            4189: (u, e, t) => {
                var A = {};
                t.r(A),
                    t.d(A, { mouse: () => c, off: () => s, on: () => i, onResize: () => B, onScaleUpdated: () => C });
                var F = {};
                t.r(F),
                    t.d(F, {
                        events: () => A,
                ...
                const nu = eu().forwardRef(function (u, e) {
                    let t = u.children,
                        A = u.className,
                        F = u.theme,
                    ...
                    return (
                        ...
                        eu().createElement(
                            'div',
                            Eu({}, n, {
                                className: D()(Au.base, Au[`base__theme-${E}`], A),
                                ref: function (u) {
                                    (a.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            eu().createElement('div', { className: Au.decorator }, t),
                        )
                    );
                });
                var ru = t(493),
                ...
                const Cu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    lu = (u, e, t = ou.left) => u.split(e).reduce(t === ou.left ? iu : su, []),
                    cu = (() => {
                        const u = new RegExp(
                    ...
                    mu = (u, e = ou.left) => {
                        ...
                        return ((u, e = ou.left) => {
                            ...
                            const A =
                                ...
                                F = Cu(u);
                            return lu(F, /( )/, e).forEach((u) => (t = t.concat(lu(u, A, ou.left)))), t;
                        })(u, e);
                    };
                var gu = t(3403),
                    fu = t(7030);
                ...
                const wu = (0, uu.forwardRef)(function (u, e) {
                        let t = u.src,
                            A = u.className,
                            F = u.autoplay,
                            E = void 0 !== F && F,
                        ...
                        return (
                            ...
                            eu().createElement(
                                'video',
                                bu({ src: t, className: A, style: n, loop: D, ref: s, onClick: B }, C),
                            )
                        );
                    }),
                    yu = (0, uu.memo)(wu);
                ...
                const Tu = 'DogTag_base_2b',
                    Su = 'DogTag_engraving_eb',
                    ku = 'DogTag_background_7f',
                    Ou = R.strings.settings.LANGUAGE_CODE(),
                    Ru = ['de', 'es', 'fr', 'hu', 'it', 'pl', 'pt_br', 'ru', 'tr', 'uk', 'zh_cn', 'cs'];
                let Pu;
                !(function (u) {
                    (u.Small = 'small'), (u.Big = 'big');
                })(Pu || (Pu = {}));
                const Mu = ({ background: u, engraving: e, size: t = Pu.Big, grade: A = 0, className: F }) => {
                        const E = Ru.includes(Ou) ? `_${Ou}` : '';
                ...
                const Wu = ({ engraving: u, count: e, size: t }) => {
                    const A = R.strings.dogtags.component.engraving.coupled.$num(u).counter();
                    return eu().createElement(
                        'div',
                        { className: D()(Lu.base, Lu[`base__${t}`]) },
                        eu().createElement('div', { className: Lu.text }, A),
                        eu().createElement('div', { className: Lu.count }, e),
                    );
                };
                let $u, Iu;
                !(function (u) {
                ...
                const Hu = { duration: 500, easing: zu.easeOutBack },
                    qu = {
                        [Iu.ExtraSmall]: ju.ExtraSmall,
                        [Iu.Small]: ju.Small,
                        [Iu.Medium]: ju.Medium,
                        [Iu.Large]: ju.Large,
                    },
                    Gu = { [Iu.ExtraSmall]: 'small', [Iu.Small]: 'big', [Iu.Medium]: 'big', [Iu.Large]: 's500x300' },
                    Ku = {
                    ...
                    Vu = ({
                        ...
                        const d = (0, fu.useSpring)(() => ({ from: { opacity: 0 }, config: Hu }), [A]),
                            m = d[0],
                            f = d[1],
                            v = (0, fu.useSpring)(() => ({
                        ...
                        const b = () => {
                            C.current && (C.current.goToAndPlay(5), xu(R.sounds.ach_dog_tag_idle()));
                        };
                        return eu().createElement(
                            fu.animated.div,
                            { className: D()(Nu.base, Nu[`base__${a}`], o), style: m },
                            r &&
                                eu().createElement(
                                    fu.animated.div,
                                    { className: Nu.backplateBox, style: p },
                                    eu().createElement(
                                        'div',
                                        {
                                            className: Nu.backplate,
                                            style: {
                                                backgroundImage: `url(R.images.gui.maps.icons.dogtags.${Gu[a]}.bottom_plates.bottom_plate_${u})`,
                                            },
                                        },
                                        eu().createElement(Wu, { engraving: e, count: t, size: qu[a] }),
                                    ),
                                ),
                            eu().createElement('div', { className: Nu.shadow }),
                            A !== $u.Static &&
                                g.isHigh() &&
                                Boolean(c) &&
                                eu().createElement(
                                    'div',
                                    { className: Nu.videoBox },
                                    eu().createElement(yu, {
                                        ref: C,
                                        className: Nu.video,
                                        onEnded: b,
                    ...
                    Uu = ({ binding: u, text: e = '', classMix: t, alignment: A = ou.left, formatWithBrackets: F }) => {
                        if (null === e) return console.error("FormatText was supplied with 'null'"), null;
                        const E = F && u ? Bu(e, u) : e;
                        return eu().createElement(
                            uu.Fragment,
                            null,
                            E.split('\n').map((e, F) =>
                    ...
                    Ju = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Xu = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    ue = (0, uu.memo)(({ text: u, binding: e, classMix: t }) => {
                                ...
                                (n = n.replace(t, `%(${E})`)),
                                    (F[E] = Yu[u]
                                        ? eu().createElement(
                                              'span',
                                              { className: Yu[u] },
                                              eu().createElement(Uu, { text: o, binding: e }),
                                          )
                                        : eu().createElement(
                                              'span',
                                              { style: A(u) },
                        ...
                        return eu().createElement(Uu, { text: n, classMix: t, binding: F });
                    });
                var ee = t(9174);
                function te(u, e) {
                ...
                const Ee = ((u, e) => {
                                    ...
                                    D = (t, A, F) => {
                                        ...
                                        const n = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = te(F.keys()); !(u = t()).done; ) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(A),
                                            ...
                                            C = { mode: t, model: B, externalModel: D, cleanup: o };
                                        return {
                                            model: B,
                    ...
                    ce = 'App_lock_c9',
                    de = 'App_condition_6e',
                    me = 'App_condition__locked_07',
                    ge = R.strings.dogtags,
                    fe = (0, gu.Pi)(() => {
                        const u = re().model,
                            e = u.root.get(),
                            t = e.stage,
                        ...
                        return eu().createElement(
                            'div',
                            { className: De },
                            eu().createElement('div', { className: ae }, r.$dyn('title')),
                            eu().createElement(
                                'div',
                                { className: oe },
                            ...
                            eu().createElement(
                                'div',
                                { className: Ce },
                                ((B = n.id), ge.component.background.coupled.$num(B)).description(),
                            ),
                            eu().createElement('div', { className: ie }),
                            eu().createElement(
                                'div',
                                { className: se },
                                E.isLocked
                                    ? eu().createElement(
                                          ...
                                          eu().createElement(ue, {
                                              classMix: D()(de, me),
                                              text: ge.catalogAnimatedDogTagTooltip.locked(),
                                    ...
                                    : eu().createElement(
                                          eu().Fragment,
                                          null,
                                          eu().createElement('div', { className: le }),
                                          eu().createElement(
                                              'div',
                                              { className: de },
                                              ((a = ge.catalogAnimatedDogTagTooltip.unlocked()),
                ...
                engine.whenReady.then(() => {
                    Du().render(
                        eu().createElement(ne, null, eu().createElement(nu, null, eu().createElement(fe, null))),
