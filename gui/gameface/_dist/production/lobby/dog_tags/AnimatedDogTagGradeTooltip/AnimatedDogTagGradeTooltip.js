    ...
    var u,
        A = {
            9971: (u, A, F) => {
                ...
                const iu = Cu().forwardRef(function (u, A) {
                    ...
                    return (
                        ...
                        Cu().createElement(
                            ...
                            Cu().createElement('div', { className: tu.decorator }, F),
                        )
                    );
                });
                var au = F(493),
                ...
                var xu = F(3403);
                const _u = 'DogTag_base_2b',
                    Pu = 'DogTag_engraving_eb',
                    Tu = 'DogTag_background_7f',
                    Ru = R.strings.settings.LANGUAGE_CODE(),
                    Su = ['de', 'es', 'fr', 'hu', 'it', 'pl', 'pt_br', 'ru', 'tr', 'uk', 'zh_cn', 'cs'];
                let Ou;
                !(function (u) {
                    (u.Small = 'small'), (u.Big = 'big');
                })(Ou || (Ou = {}));
                const zu = ({ background: u, engraving: A, size: F = Ou.Big, grade: E = 0, className: e }) => {
                    const D = Su.includes(Ru) ? `_${Ru}` : '';
                    return Cu().createElement(
                        'div',
                        { className: n()(_u, e) },
                ...
                const Gu = ((u, A) => {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            n = Du.view.addModelObserver(C, A, !0);
                    ...
                    Zu = (0, xu.Pi)(() => {
                        ...
                        return Cu().createElement(
                            'div',
                            { className: qu },
                            Cu().createElement('div', { className: Hu }, D.$dyn('title')),
                            Cu().createElement(
                                'div',
                                { className: Uu },
                                R.strings.dogtags.animatedCustomization.subtitle(),
                            ),
                            Cu().createElement(zu, { background: F, engraving: A, className: Wu }),
                            Cu().createElement(yu, {
                ...
                engine.whenReady.then(() => {
                    su().render(
                        Cu().createElement(Nu, null, Cu().createElement(iu, null, Cu().createElement(Zu, null))),
