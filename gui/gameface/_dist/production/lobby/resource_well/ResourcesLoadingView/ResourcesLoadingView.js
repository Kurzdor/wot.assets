(() => {
    var __webpack_modules__ = {
            ...
            9916: (e, u, t) => {
                'use strict';
                t.d(u, { Sw: () => a.Z, B3: () => o, Z5: () => s.Z5, B0: () => i, ry: () => F, Sy: () => C });
                class r {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            4858: (e, u, t) => {
                ...
                const Fe = Ee({
                    ...
                    Re = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Se, onDrag: r = ye }) => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(ve) || 0 !== e.button || ((0, V.G)('play'), g(_e.Next));
                                },
                                onMouseUp: h,
                                ref: i,
                                onMouseEnter: b,
                            ...
                            s().createElement(
                                ...
                                s().createElement('div', { ref: d, className: B()(be, u.thumb) }),
                                s().createElement('div', { className: B()(fe, u.rail) }),
                            ),
                            s().createElement('div', {
                                className: B()(he, u.rightButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(ve) || 0 !== e.button || ((0, V.G)('play'), g(_e.Prev));
                                },
                                onMouseUp: h,
                                ref: l,
                                onMouseEnter: b,
                ...
                const Ie = 'VerticalBar_base_f3',
                    ...
                    qe = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = $e, onDrag: r = ze }) => {
                        const n = (0, a.useRef)(null),
                            i = (0, a.useRef)(null),
                            l = (0, a.useRef)(null),
                            c = (0, a.useRef)(null),
                ...
                const pu = 'ResourceStepper_base_b7',
                    ...
                    Bu = ({ value: e, index: u, amount: t, currentValue: r }) => {
                        ...
                        return s().createElement(
                            ...
                            s().createElement(
                                'div',
                                { className: B()(gu.count, 0 === L && gu.count__zero) },
                            ...
                            s().createElement(
                                ...
                                s().createElement(
                                    'div',
                                    { className: B()(gu.imageWrapper, S && gu.imageWrapper__disabled), onClick: I },
                                    s().createElement('div', {
                    ...
                    Ou = ({ resourcesTabs: e }) => {
                        const u = (0, a.useState)(0),
                            ...
                            _ = B()(Tu, e[t].value.resources.length <= 5 && ku);
                        return s().createElement(
                            'div',
                            { className: Lu },
                            s().createElement(
                ...
                const Bt = (0, a.memo)(
                    ...
                    kt = 'ActiveState_currentPercent__zero_d0',
                    Pt = 'ActiveState_deltaPercent_56',
                    ...
                    qt = ({ isSmall: e, loadResources: u, onClose: t }) => {
                        const r = (0, j.tT)('model.vehicleCounter', j.DA.Shallow).isVehicleCountAvailable,
                            ...
                            C = Boolean(d);
                        (0, a.useEffect)(() => {
                            o + d === Ut && o !== Ut && (0, V.G)('resources_well_progress_click_oneshot');
                        }, [o, d, C]),
                            (0, a.useEffect)(() => {
                                o && void 0 !== l && o > l && p(jt);
                            }, [l, o, F]),
                ...
                engine.whenReady.then(() => {
                    H().render(
                        s().createElement(Je, null, s().createElement(P, null, s().createElement(Jt, null))),
