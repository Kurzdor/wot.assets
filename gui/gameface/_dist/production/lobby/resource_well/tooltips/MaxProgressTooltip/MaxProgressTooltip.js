    ...
    var __webpack_modules__ = {
            ...
            4179: (u, e, A) => {
                ...
                const h = E.instance,
                    g = {
                        ...
                        sendMoveEvent: (u) => p(B.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: v,
                        sendClosePopOverEvent: () => p(B.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, A = 0) => {
                            p(B.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: A, args: e });
                        },
            ...
            6893: (u, e, A) => {
                ...
                const d = (u, e, A) => {
                    ...
                    v = (u, e, A = l.left) => u.split(e).reduce(A === l.left ? d : p, []),
                    m = (() => {
                        const u = new RegExp(
                        ...
                        return w.includes(A)
                            ...
                            : ((u, e = l.left) => {
                                  ...
                                  const F =
                                      ...
                                      E = u.replace(/&nbsp;/g, ' ');
                                  return v(E, /( )/, e).forEach((u) => (A = A.concat(v(u, F, l.left)))), A;
                              })(u, e);
                    },
                    g = 'FormatText_base_d0',
                    f = ({ binding: u, text: e = '', classMix: A, alignment: D = l.left }) =>
                        null === e
                ...
                const S = (u = 'model', e = N.Deep) => {
                            ...
                            T(() => {
                                if (
                                    ...
                                    const A = (u) => {
                                        ...
                                        F = M(u);
                                    i.current = k.addCallback(F, A, n, e === N.Deep);
                                }
                            }),
                            (0, F.useEffect)(() => {
                                if (e !== N.None)
                                    return () => {
                                        k.removeCallback(i.current, n);
                                    };
                            }, [n, e]),
                            C
                        );
                    ...
                    I = () => {
                        const u = S('model', N.None),
                            e = u.currentValue,
                            A = u.maxValue,
                            F = u.resourceType,
                            D = B()(L.progress, L[`progress__${F}`]);
                        return E().createElement(
                            ...
                            E().createElement(
                                ...
                                E().createElement(f, {
                                    ...
                                    binding: {
                                        maxAmount: E().createElement(
                                            'span',
                                            { className: L.descriptionText__max },
                                            E().createElement(_, { value: A }),
                                        ),
                                    },
                                    text: U.header(),
                                }),
                                E().createElement('div', { className: L.description }, U.body()),
                                E().createElement(
                                    'div',
                                    { className: L.separatorTopWrapper },
                                    E().createElement('div', { className: L.separator }),
                                ),
                                E().createElement(
                                    'div',
                                    ...
                                    E().createElement(f, {
                                        classMix: D,
                                        binding: {
                                            icon: E().createElement('span', {
                                                className: L.icon,
                                                style:
                                                    ((t = F),
                                                    {
                                                        backgroundImage: `url(${R.images.gui.maps.icons.blueprints.fragment.special.$dyn(t) || R.images.gui.maps.icons.resourceWell.resourcesLoading.icons.$dyn(t)})`,
                                                    }),
                                            }),
                                            amount: E().createElement(_, { value: e }),
                                            maxAmount: E().createElement(
                                                'span',
                                                { className: L.maxValue },
                                                E().createElement(_, { value: A }),
                                            ),
                                        },
                                        text: U.amount(),
                    ...
                    V = () => E().createElement(s, null, E().createElement(I, null));
