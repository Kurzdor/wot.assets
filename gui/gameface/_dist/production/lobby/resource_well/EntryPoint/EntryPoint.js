(() => {
    ...
    var __webpack_modules__ = {
            ...
            2657: (u, e, t) => {
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onClick: ((u) => (e) => {
                                              !1 === B && k(), null == s || s(e), null == u || u(e);
                                          })(e.props.onClick),
                                          onMouseDown: ((u) => (e) => {
                                              !1 === B && k(), null == i || i(e), null == u || u(e);
                                          })(e.props.onMouseDown),
                                      },
                                      h,
                                  ),
                ...
                const M = ({ size: u = S.Default }) => {
                        const e = s()(P.background, P[`background__${u}`]);
                ...
                const su = (0, n.memo)(
                    ...
                    Du = (0, n.memo)(
                        ({
                            ...
                            return a().createElement(
                                'div',
                                { className: s()(P.base, P[`base__${t}`]), style: Eu(e) },
                    ...
                    gu = ({ value: u, deltaFrom: e, className: t, hasAnimation: n }) =>
                        a().createElement(
                            'div',
                            { className: s()(cu, t) },
                            a().createElement(Du, { size: S.Small, value: u, deltaFrom: e }),
                            a().createElement(
                                'div',
                                { className: Bu },
                                n
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                'div',
                                {
                                    className: bu.base,
                                    onClick: () => {
                                        l !== O.Paused && l !== O.NotStarted && (f('play'), e());
                                    },
                                    onMouseEnter: C,
                                },
                                a().createElement(vu, {
