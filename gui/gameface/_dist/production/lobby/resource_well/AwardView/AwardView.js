(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => F, off: () => A, on: () => E, onResize: () => r, onScaleUpdated: () => i });
                var a = t(2472),
                    n = t(1176);
            ...
            3649: (u, e, t) => {
                ...
                const E = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    F = (u, e, t = n.left) => u.split(e).reduce(t === n.left ? A : s, []),
                    o = (() => {
                        const u = new RegExp(
                    ...
                    D = (u, e = n.left) => {
                        ...
                        return ((u, e = n.left) => {
                            ...
                            const a =
                                ...
                                r = E(u);
                            return F(r, /( )/, e).forEach((u) => (t = t.concat(F(u, a, n.left)))), t;
                        })(u, e);
                    },
            ...
            2054: (u, e, t) => {
                ...
                const d = (u) => {
                    ...
                    _ = ({ children: u }) => {
                        ...
                        d(() => {
                            i.O.client.events.on('clientResized', F), i.O.client.events.on('self.onScaleUpdated', o);
                        }),
                            (0, a.useEffect)(
                                () => () => {
                ...
                const T = {
                    ...
                    y = (u) => {
                        ...
                        const r = b(),
                            ...
                            E = r.mediaHeight,
                            A = r.mediaSize;
                        return n().createElement('div', L({ className: h()(t, T[i], S[E], M[A]) }, a), e);
                    },
                    k = ['children'];
                const O = (u) => {
                    let e = u.children,
                ...
                const z = (u, e) => u.split('.').reduce((u, e) => u && u[e], e),
                    ...
                    X = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: n, modelPath: K(n, u || ''), resId: a };
                            })(),
                            t = e.modelPrefix,
                            a = u.split('.');
                        if (a.length > 0) {
                ...
                function tu(u = uu.n.NONE, e = eu, t = !1, n = !1) {
                    (0, a.useEffect)(() => {
                        if (u !== uu.n.NONE)
                            return (
                ...
                engine.whenReady.then(() => {
                    N().render(
                        n().createElement(O, null, n().createElement(pu, null)),
                        ...
                        const b = (0, E.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            L = (0, E.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (o(t, _, { isMouseEvent: !0, on: !0, arguments: F(a) }, x),
                                    v && v(),
            ...
            984: (u, e, t) => {
                ...
                const o = ({
                    ...
                    const h = (0, i.useRef)(null),
                        ...
                        N = (0, i.useCallback)(
                            (u) => {
                                F || (null !== D && (0, r.G)(D), C && C(u), t && S(), b(!0));
                            },
                            [F, D, C, S, t],
                        ),
                        I = (0, i.useCallback)(
                            ...
                            E().createElement(
                                ...
                                e
                                    ? E().createElement(s, {
                                          ...
                                          binding: {
                                              vehicleInfo: E().createElement(F.e, { vehicleInfo: u, theme: F.b.Award }),
                                          },
                                      })
                                    : E().createElement(F.e, { vehicleInfo: u, theme: F.b.Award }),
                            ),
                        );
            },
        },
