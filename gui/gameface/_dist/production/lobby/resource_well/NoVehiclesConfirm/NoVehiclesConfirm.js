    ...
    var __webpack_modules__ = {
                    ...
                    o = (u, e = a.left) => {
                        ...
                        return ((u, e = a.left) => {
                            ...
                            const E =
                                ...
                                n = r(u);
                            return F(n, /( )/, e).forEach((u) => (t = t.concat(F(u, E, a.left)))), t;
                        })(u, e);
                    },
                ...
                const n = (u) => u && 'ArrayItem' === u.__proto__.constructor.name,
                    ...
                    F = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: n, modelPath: i(n, u || ''), resId: a };
                            })(),
                            t = e.modelPrefix,
                            r = u.split('.');
                        if (r.length > 0) {
                            ...
                            return (
                                r.reduce((e, E) => {
                                    const r = (0, a.M)(i(t, `${e}.${E}`), window);
                                    return n(r) ? (u.push(r.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
            ...
            3387: (u, e, t) => {
                ...
                const _ = ({ children: u }) => {
                    ...
                    const o = (0, E.useMemo)(() => Object.assign({}, n), [n]);
                ...
                const b = () => {
                        ...
                        return { mediaSize: a, mediaWidth: n, mediaHeight: r, remScreenWidth: e, remScreenHeight: t };
                    },
                ...
                const S = {
                    ...
                    O = (u) => {
                        ...
                        const n = b(),
                            ...
                            i = n.mediaHeight,
                            A = n.mediaSize;
                        return a().createElement('div', L({ className: h()(t, S[r], T[i], M[A]) }, E), e);
                    },
                    y = ['children'];
                const k = (u) => {
                    let e = u.children,
                ...
                class q extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()($.base, $[`base__${r}`], $[`base__${n}`], null == i ? void 0 : i.base),
                            B = h()($.icon, $[`icon__${r}`], $[`icon__${n}`], null == i ? void 0 : i.icon),
                    ...
                    iu = () => {
                        ...
                        return (
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    V,
                                    { type: I.primary, size: U.medium, onClick: e, mixClass: nu },
        ...
        (__webpack_require__.O = (u, e, t, E) => {
            if (!e) {
                ...
                for (A = 0; A < deferred.length; A++) {
                    for (var [e, t, E] = deferred[A], n = !0, r = 0; r < e.length; r++)
                        (!1 & E || a >= E) &&
