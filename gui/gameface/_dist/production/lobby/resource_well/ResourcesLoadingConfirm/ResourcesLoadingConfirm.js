(() => {
    var __webpack_modules__ = {
                ...
                const A = ({
                    ...
                    return E().createElement(
                        ...
                        o.split('\n').map((e, A) =>
                            E().createElement(
                                'div',
                                { className: n()(s.Z.base, t), key: `${e}-${A}` },
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => o, off: () => s, on: () => E, onResize: () => a, onScaleUpdated: () => i });
                var r = t(2472),
                    n = t(1176);
                        ...
                        (0, a.Z)(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    r = (0, E.U0)(u);
                                d.current = A.addCallback(r, t, l, e === o.Deep);
                            }
                        }),
                        (0, s.useEffect)(() => {
                            if (e !== o.None)
                                return () => {
                                    A.removeCallback(d.current, l);
                                };
                        }, [l, e]),
                        C
                    );
            ...
            3649: (u, e, t) => {
                ...
                const i = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    A = (u, e, t = n.left) => u.split(e).reduce(t === n.left ? E : s, []),
                    o = (() => {
                        const u = new RegExp(
                    ...
                    D = (u, e = n.left) => {
                        ...
                        return ((u, e = n.left) => {
                            ...
                            const r =
                                ...
                                a = i(u);
                            return A(a, /( )/, e).forEach((u) => (t = t.concat(A(u, r, n.left)))), t;
                        })(u, e);
                    },
            ...
            1355: (u, e, t) => {
                ...
                const o = i.O.client.getSize('rem'),
                    F = o.width,
                    D = o.height,
                    l = Object.assign({ width: F, height: D }, A(F, D, E)),
                ...
                class q extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            l = h()($.base, $[`base__${i}`], $[`base__${a}`], null == E ? void 0 : E.base),
                            c = h()($.icon, $[`icon__${i}`], $[`icon__${a}`], null == E ? void 0 : E.icon),
                            B = h()($.glow, null == E ? void 0 : E.glow),
                            C = h()($.caption, $[`caption__${i}`], null == E ? void 0 : E.caption),
                            _ = h()($.goto, null == E ? void 0 : E.goto);
                ...
                const Z = R.strings.resource_well.confirm,
                    Y = ({ operationType: u, mixClass: e }) =>
                        n().createElement(
                            'div',
                            { className: e },
                            u === P.Contribute ? Z.resourcesContribute.title() : Z.resourcesReturn.title(),
                        );
                var X = t(280);
                t(3649);
                        ...
                        return n().createElement(
                            ...
                            u === P.Contribute
                                ? n().createElement(
                                      ...
                                      n().createElement(
                                          Eu,
                                          { type: nu.main, size: au.medium, onClick: e, mixClass: Au },
                                          ou.resourcesContribute.buttonConfirm.title(),
                                      ),
                                      n().createElement(
                                          Eu,
                                          { type: nu.primary, size: au.medium, onClick: t, mixClass: Au },
                                ...
                                : n().createElement(
                                      ...
                                      n().createElement(
                                          Eu,
                                          { type: nu.primary, size: au.medium, onClick: e, mixClass: Au },
                                          ou.resourcesReturn.buttonConfirm.title(),
                                      ),
                                      n().createElement(
                                          Eu,
                                          { type: nu.secondary, size: au.medium, onClick: t, mixClass: Au },
                                          ou.buttonCancel.title(),
                                      ),
                                  ),
                        );
                ...
                const lu = 'App_base_7d',
                    ...
                    bu = () => {
                        ...
                        var c;
                        (c = D), G(W.n.ESCAPE, c);
                        const B = h()(lu, A && pu, o && gu);
                        return n().createElement(
                            'div',
                            { className: B },
                            n().createElement('div', { className: cu }),
                            A && n().createElement('div', { className: Bu }, n().createElement(K.M, null)),
                            n().createElement(
                                'div',
                                { className: Cu },
                                n().createElement(q, {
            ...
            1693: (u, e, t) => {
                ...
                const A = {
                    ...
                    o = ({ resource: { count: u, subType: e, type: t } }) => {
                        const r = i()(A.counter, 'currency' !== t && A.counter__noCurrency, A[`counter__${e}`]);
                        return n().createElement(
                            'div',
                            { className: A.base },
                            n().createElement('div', { className: i()(A.resourceIcon, A[`resourceIcon__${e}`]) }),
                            n().createElement(
                                'div',
                                { className: r },
                                n().createElement(
