    ...
    var u,
        A = {
            8570: (u, A, F) => {
                var E = {};
                F.r(E),
                    F.d(E, { mouse: () => T, off: () => S, on: () => P, onResize: () => y, onScaleUpdated: () => _ });
                var D = {};
                F.r(D),
                    F.d(D, {
                        events: () => E,
                ...
                const l = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    b = ({ binding: u, text: A = '', classMix: F, alignment: E = s.left, formatWithBrackets: D }) => {
                    ...
                    ju = (0, gu.Pi)(() => {
                        ...
                        return t().createElement(
                            ...
                            t().createElement(
                                'div',
                                { className: Ou },
                                t().createElement('div', { className: Ru }, A),
                                t().createElement(b, {
                                    classMix: Tu,
                                    text: R.strings.tank_setup.tooltip.deconstructConfirm.deconstructFromInventory(),
                                    binding: { amount: t().createElement('div', { className: zu }, F) },
                                }),
                            ),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement(Pu, null, t().createElement(ju, null)),
