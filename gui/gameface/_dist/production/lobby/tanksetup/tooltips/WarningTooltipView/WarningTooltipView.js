        ...
        A = {
            1033: (u, A, F) => {
                ...
                const su = t().forwardRef(function (u, A) {
                    ...
                    return (
                        ...
                        t().createElement(
                            'div',
                            au({}, B, {
                                className: a()(ou.base, ou[`base__theme-${D}`], E),
                                ref: function (u) {
                ...
                const vu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    gu = (u, A, F = lu.left) => u.split(A).reduce(F === lu.left ? fu : mu, []),
                    pu = (() => {
                        const u = new RegExp(
                    ...
                    xu = 'Content_base_7d',
                    Pu = 'Content_header_8e',
                    Su = 'Content_header__critical_93',
                    _u = 'Content_description_66',
                    Ru = R.strings.tooltips.moduleFits,
                    Tu = t().memo(({ reason: u, isCritical: A }) => {
                        const F = (0, C.useMemo)(() => {
                            const A = Ru.$dyn(u);
                        ...
                        return t().createElement(
                            'div',
                            { className: xu },
                            F.header && t().createElement('div', { className: a()(Pu, A && Su) }, F.header),
                            F.body &&
                                t().createElement('div', { className: _u }, t().createElement(yu, { text: F.body })),
                        );
                    });
                function Ou() {}
                function zu() {
                ...
                const Vu = ((u, A) => {
                    ...
                    })(({ observableModel: u }) => u.primitives({ reason: 'reason', isCritical: 'isCritical' }), Ou),
                    $u = Vu[0],
                    Gu = Vu[1],
                    Iu = (0, o.Pi)(() => {
                        const u = Gu().model;
                        return t().createElement(
                            su,
                            null,
                            t().createElement(Tu, { reason: u.reason.get(), isCritical: u.isCritical.get() }),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement($u, null, t().createElement(Iu, null)),
