    ...
    var u,
        A = {
            1410: (u, A, F) => {
                ...
                const nu = t().forwardRef(function (u, A) {
                    let F = u.children,
                        E = u.className,
                        e = u.theme,
                    ...
                    return (
                        ...
                        t().createElement(
                            'div',
                            tu({}, B, {
                                className: a()(Bu.base, Bu[`base__theme-${D}`], E),
                                ref: function (u) {
                ...
                const au = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    lu = (u, A, F = ou.left) => u.split(A).reduce(F === ou.left ? su : cu, []),
                    du = (() => {
                        const u = new RegExp(
                    ...
                    fu = (u, A = ou.left) => {
                        ...
                        return ((u, A = ou.left) => {
                            ...
                            const E =
                                ...
                                e = au(u);
                            return lu(e, /( )/, A).forEach((u) => (F = F.concat(lu(u, E, ou.left)))), F;
                        })(u, A);
                    },
                    mu = 'FormatText_base_d0',
                    gu = ({ binding: u, text: A = '', classMix: F, alignment: E = ou.left, formatWithBrackets: e }) => {
                        if (null === A) return console.error("FormatText was supplied with 'null'"), null;
                        const D = e && u ? iu(A, u) : A;
                        return t().createElement(
                            ...
                            D.split('\n').map((A, e) =>
                                t().createElement(
                                    ...
                                    ((u, A, F) =>
                                        u.split(/%\((.*?)\)(?:[sd])?/g).map((u) => (F && u in F ? F[u] : fu(u, A))))(
                                        A,
                                        E,
                                        u,
                    ...
                    pu = 'Content_base_7d',
                    bu = 'Content_header_8e',
                    wu = 'Content_header__critical_93',
                    hu = 'Content_description_66',
                    yu = R.strings.tooltips.moduleFits,
                    xu = t().memo(({ reason: u, isCritical: A }) => {
                        const F = (0, C.useMemo)(() => {
                            const A = yu.$dyn(u);
                        ...
                        return t().createElement(
                            'div',
                            { className: pu },
                            F.header && t().createElement('div', { className: a()(bu, A && wu) }, F.header),
                            F.body &&
                                t().createElement('div', { className: hu }, t().createElement(gu, { text: F.body })),
                        );
                    });
                function _u() {}
                function Pu() {
                ...
                const zu = ((u, A) => {
                    ...
                    })(({ observableModel: u }) => u.primitives({ reason: 'reason', isCritical: 'isCritical' }), _u),
                    ju = zu[0],
                    Mu = zu[1],
                    ku = (0, o.Pi)(() => {
                        const u = Mu().model;
                        return t().createElement(
                            nu,
                            null,
                            t().createElement(xu, { reason: u.reason.get(), isCritical: u.isCritical.get() }),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        t().createElement(ju, null, t().createElement(ku, null)),
