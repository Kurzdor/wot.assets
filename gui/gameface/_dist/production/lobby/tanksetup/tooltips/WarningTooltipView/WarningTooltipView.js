    ...
    var u,
        A = {
            1033: (u, A, F) => {
                ...
                const Cu = Object.keys(O).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === O[A]), u), {}),
                    nu = {
                        set: (u, A) => {
                ...
                const lu = n().forwardRef(function (u, A) {
                    ...
                    return (
                        ...
                        n().createElement(
                            'div',
                            su({}, B, {
                                className: a()(iu.base, iu[`base__theme-${D}`], E),
                                ref: function (u) {
                ...
                const fu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    pu = (u, A, F = du.left) => u.split(A).reduce(F === du.left ? mu : gu, []),
                    hu = (() => {
                        const u = new RegExp(
                    ...
                    Ru = 'Content_description_66',
                    Tu = R.strings.tooltips.moduleFits,
                    Ou = n().memo(({ reason: u, isCritical: A }) => {
                        const F = (0, C.useMemo)(() => {
                            const A = Tu.$dyn(u);
                        ...
                        return n().createElement(
                            ...
                            F.body &&
                                n().createElement('div', { className: Ru }, n().createElement(xu, { text: F.body })),
                        );
                    });
                function zu() {}
                function Mu() {
                ...
                const $u = ((u, A) => {
                                                ...
                                                return {
                                                    subscribe: (F, D) => {
                                                        const C = 'string' == typeof D ? `${E}.${D}` : E,
                                                            n = ru.view.addModelObserver(C, A, !0);
                                                    ...
                                                    dispose: function () {
                                                        for (var u, F = ku(e.keys()); !(u = F()).done; ) D(u.value, A);
                                                    },
                                                    unsubscribe: D,
                                                };
                                            })(E),
                    ...
                    })(({ observableModel: u }) => u.primitives({ reason: 'reason', isCritical: 'isCritical' }), zu),
                    Gu = $u[0],
                    Iu = $u[1],
                    Nu = (0, o.Pi)(() => {
                        const u = Iu().model;
                        return n().createElement(
                            lu,
                            null,
                            n().createElement(Ou, { reason: u.reason.get(), isCritical: u.isCritical.get() }),
                        );
                    });
                engine.whenReady.then(() => {
                    r().render(
                        n().createElement(Gu, null, n().createElement(Nu, null)),
