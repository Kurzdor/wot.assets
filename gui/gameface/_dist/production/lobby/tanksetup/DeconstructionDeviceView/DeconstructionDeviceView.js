(() => {
    var __webpack_modules__ = {
            ...
            2841: (e, u, t) => {
                ...
                class G extends o().PureComponent {
                    ...
                    render() {
                        const e = this.props,
                            ...
                            d = f()(V.base, V[`base__${a}`], V[`base__${r}`], null == i ? void 0 : i.base),
                            A = f()(V.icon, V[`icon__${a}`], V[`icon__${r}`], null == i ? void 0 : i.icon),
                            F = f()(V.glow, null == i ? void 0 : i.glow),
                            m = f()(V.caption, V[`caption__${a}`], null == i ? void 0 : i.caption),
                            D = f()(V.goto, null == i ? void 0 : i.goto);
                        return o().createElement(
                            ...
                            'info' !== a && o().createElement('div', { className: V.shine }),
                ...
                function K(e = U.n.NONE, u = j, t = !1, n = !1) {
                    (0, a.useEffect)(() => {
                        if (e !== U.n.NONE)
                            return (
                ...
                const fe = {
                    ...
                    We = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = Re, onDrag: n = Pe }) => {
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement('div', { ref: E, className: f()(Me, u.thumb) }),
                    ...
                    Ve = ({
                        ...
                        return o().createElement(
                            ...
                            o().createElement(We, { getStepByRailClick: l, api: u, onDrag: c, classNames: E }),
                        );
                    },
                ...
                const qe = be({
                    ...
                    nu = (0, a.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = eu, onDrag: n = Qe }) => {
                        const r = (0, a.useRef)(null),
                            ...
                            D = De(() => {
                                ...
                                return (
                                    ...
                                    (u.style.display = 'flex'),
                                    r.current &&
                                        (1 === o ? r.current.classList.add(Ue) : r.current.classList.remove(Ue)),
                                    o
                                );
                            }),
                            C = De(() => {
                        ...
                        const v = (e) => {
                            e.target.classList.contains(Ze) || I('highlight');
                        };
                        return o().createElement(
                            'div',
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Ze) || 0 !== e.button || (I('play'), h(ve.Next));
                                },
                                ref: i,
                                onMouseEnter: v,
                            }),
                            o().createElement(
                                ...
                                o().createElement('div', { ref: E, className: f()(Xe, u.thumb) }),
                                o().createElement('div', { className: f()(Ye, u.rail) }),
                            ),
                            o().createElement('div', {
                                className: f()(je, u.bottomButton),
                                onMouseDown: (e) => {
                                    e.target.classList.contains(Ze) || 0 !== e.button || (I('play'), h(ve.Prev));
                                },
                                onMouseUp: p,
                                ref: s,
                                onMouseEnter: v,
                ...
                const fu = (e) => e.replace(/&nbsp;/g, ' '),
                    ...
                    yu = (e, u, t = hu.left) => e.split(u).reduce(t === hu.left ? bu : wu, []),
                    xu = (() => {
                        const e = new RegExp(
                    ...
                    Tu = (e, u = hu.left) => {
                        ...
                        return ((e, u = hu.left) => {
                            ...
                            const n =
                                ...
                                r = fu(e);
                            return yu(r, /( )/, u).forEach((e) => (t = t.concat(yu(e, n, hu.left)))), t;
                        })(e, u);
                    },
                    ku = (e, u) => e.split(',').includes(u),
                    Mu = {
                ...
                const Ou = ({
                    ...
                    vehicleLvl: r,
                    tags: a = '',
                    size: i = Lu.extraSmall,
                    type: s = Nu.colored,
                    className: l,
                    classNames: c,
                    isShortName: E = !1,
                }) => {
                    const _ = `${((d = n), d.replace(/-/g, '_'))}${e ? '_elite' : ''}`;
                    var d;
                    const A = R.images.gui.maps.icons.vehicleTypes.big.$dyn(_);
                    return o().createElement(
                        'div',
                        { className: f()(Mu.base, Mu[`base__size${vu(i)}`], Mu[`base__type${vu(s)}`], l) },
                        o().createElement('div', { className: f()(Mu.level, null == c ? void 0 : c.level) }, Bu(r)),
                        o().createElement('div', {
                            className: f()(
                                Mu.type,
                                e && Mu[`type__elite${vu(i)}`],
                                Mu[`type__${i}`],
                                null == c ? void 0 : c.typeIcon,
                            ),
                            style: { backgroundImage: `url(${A})` },
                        }),
                        ku(a, 'premiumIGR') && o().createElement('div', { className: Mu.premiumIGR }),
                        o().createElement('div', { className: f()(Mu.name, null == c ? void 0 : c.name) }, E ? t : u),
                    );
                };
                var Ru = t(5282);
                const Pu = {
                ...
                const Wu = ({ type: e = Hu.Plus, isEnabled: u = !0, onClick: t }) =>
                    o().createElement('div', {
                        className: f()(Pu.base, Pu[`base__${e}`], !u && Pu.base__disabled),
                        onClick: (e) => {
                ...
                var Iu = t(8401),
                    Vu = t(3934);
                const zu = 'Availability_base_51',
                    qu = () => o().createElement('div', { className: zu }),
                    Gu = {
                        ...
                        ({ itemsInStorage: e, price: u, isMounted: t, possibleZeroCount: n, show: r = !0 }) => {
                            ...
                            return (
                                (a = t
                                    ...
                                    : e || (n && 0 === e)
                                      ? o().createElement(Vu.K, { itemsInStorage: e })
                                      : u && o().createElement(Iu.t, u)),
                                o().createElement(
                                    'div',
                                    {
                                        className: f()(
                                            Gu.base,
                                            Gu['base__' + (r ? 'shown' : 'hidden')],
                                            (t || e || (n && 0 === e)) && Gu.base__visually,
                                        ),
                                    },
                                    a,
                                )
                ...
                const ju = { calcValue: 0, isPositive: !0, valueKey: 'default' },
                    Ku = ({ values: e, localeName: u }) => {
                    ...
                    Yu = 'Bonus_text_d9',
                    Zu = 'Unit_base_18',
                    Qu = 'Unit_base__special_90',
                    Ju = 'Unit_glow_03',
                    et = R.strings.tank_setup.kpi.bonus.valueTypes,
                    ut = R.strings.tank_setup.kpi.bonus.valueTypes.default(),
                    tt = (0, X.Pi)(({ slotIndex: e, bonusIndex: u, groupType: t }) => {
                        const n = ce().model,
                        ...
                        return o().createElement(
                            'div',
                            { className: f()(Zu, c && Qu) },
                            o().createElement('span', null, o().createElement('span', { className: Ju }), _ + F),
                        );
                    }),
                    nt = ({ slotIndex: e, bonusIndex: u, groupType: t }) => {
                        const n = ce().model,
                        ...
                        return i && a
                            ? o().createElement(
                                  'span',
                                  { className: Xu },
                                  o().createElement(tt, { slotIndex: e, bonusIndex: u, groupType: t }),
                                  ' ',
                                  a &&
                                      i &&
                                      o().createElement(
                    ...
                    at = 'Bonuses_bonus_9b',
                    ot = 'Bonuses_text_91',
                    it = 'Bonuses_effect_5f',
                    st = 'Bonuses_icon_b6',
                    lt = (0, X.Pi)(({ index: e, groupType: u }) => {
                        const t = ce().model,
                        ...
                        return o().createElement(
                            ...
                            ((e, u) => {
                                ...
                                o().createElement(
                                    'div',
                                    { key: e, className: at },
                                    o().createElement(nt, { slotIndex: e, bonusIndex: t, groupType: u }),
                                ),
                            ),
                        );
                    }),
                    ct = 'EquipmentSlot_base_16',
                    Et = 'EquipmentSlot_base__selected_88',
                    _t = 'EquipmentSlot_container_89',
                    dt = 'EquipmentSlot_glowContainer_69',
                    At = 'EquipmentSlot_outerGlow_e8',
                    Ft = 'EquipmentSlot_selectedGlow_62',
                    mt = 'EquipmentSlot_image_c0',
                    Dt = 'EquipmentSlot_types_fa',
                    Ct = 'EquipmentSlot_overlay_4e',
                    Bt = 'EquipmentSlot_name_6b',
                    gt = 'EquipmentSlot_details_51',
                    ht = 'EquipmentSlot_options_ba',
                    pt = 'EquipmentSlot_vehicleName_bb',
                    vt = 'EquipmentSlot_price_ed',
                    ft = 'EquipmentSlot_countText_a8',
                    bt = 'EquipmentSlot_select_34',
                    wt = 'EquipmentSlot_glow_43',
                    yt = (0, X.Pi)(({ index: e, groupType: u, className: t }) => {
                        const n = ce(),
                            r = n.model,
                            a = n.controls,
                        ...
                        return o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(
                                        ...
                                        o().createElement(Ru.n, {
                                            mediaSize: $u.Medium,
                                            linesCount: 3,
                                            blocks: (0, Ru.D)(systemLocale.toUpperCase(l)),
                                        }),
                                    ),
                                    o().createElement(
                                        'div',
                                        { className: gt },
                                        o().createElement(lt, { index: e, groupType: u }),
                                    ),
                                    d > 0 &&
                                        o().createElement(
                                            'div',
                                            { className: ht },
                                            o().createElement(Uu, { itemsInStorage: d, show: !0 }),
                                        ),
                                    Boolean(D) && o().createElement('div', { className: pt }, o().createElement(Ou, F)),
                                    o().createElement(
                                        'div',
                                        { className: vt },
                            ...
                            o().createElement('span', { className: ft }, A),
                            o().createElement(
                                'div',
                                { className: bt },
                                o().createElement(Wu, {
                    ...
                    xt = 'EquipmentGroup_base_b9',
                    St = 'EquipmentGroup_slotsContainer_da',
                    Tt = 'EquipmentGroup_slot_db',
                    kt = (0, X.Pi)(({ groupType: e }) => {
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                ((t = u),
                                (n = (u, t) =>
                                    o().createElement(yt, { index: t, groupType: e, className: Tt, key: t })),
                                Array.isArray(t)
                                    ? t.map(n)
                    ...
                    Mt = 'FormatText_base_d0',
                    Lt = ({ binding: e, text: u = '', classMix: t, alignment: n = hu.left, formatWithBrackets: r }) => {
                        if (null === u) return console.error("FormatText was supplied with 'null'"), null;
                        const i = r && e ? pu(u, e) : u;
                        return o().createElement(
                            a.Fragment,
                            null,
                            i.split('\n').map((u, r) =>
                    ...
                    Ht = (0, a.memo)(({ text: e, binding: u, classMix: t }) => {
                                ...
                                (s = s.replace(t, `%(${i})`)),
                                    (r[i] = Nt[e]
                                        ? o().createElement(
                                              'span',
                                              { className: Nt[e] },
                                              o().createElement(Lt, { text: E, binding: u }),
                                          )
                                        : o().createElement(
                                              'span',
                                              { style: n(e) },
                        ...
                        return o().createElement(Lt, { text: s, classMix: t, binding: r });
                    }),
                    Wt = 'EquipmentHeader_base_ab',
                    It = 'EquipmentHeader_base__hidden_d6',
                    Vt = 'EquipmentHeader_lineBlock_cd',
                    zt = 'EquipmentHeader_label_3d',
                    qt = 'EquipmentHeader_vehicleNameLabel_db',
                    Gt = 'EquipmentHeader_vehicleInfo_95',
                    Ut = R.strings.tank_setup.deconstructionDeviceView,
                    $t = (0, X.Pi)(({ text: e, value: u, isHidden: t, showVehicleInfo: n }) => {
                        const r = ce().model;
                        return o().createElement(
                            'div',
                            { className: f()(Wt, t && It) },
                            o().createElement(
                                ...
                                o().createElement(
                                    'div',
                                    { className: zt },
                                    o().createElement(Ht, { text: e, binding: { value: u } }),
                                ),
                                n &&
                                    o().createElement(
                                        o().Fragment,
                                        null,
                                        o().createElement('div', { className: qt }, Ut.header.activeVehicle()),
                                        o().createElement(
                                            'div',
                                            { className: Gt },
                                            o().createElement(Ou, r.currentVehicleInfo.get()),
                                        ),
                                    ),
                            ),
                        );
                    }),
                    jt = 'CurrencyBlock_base_46',
                    Kt = 'CurrencyBlock_currency_1c',
                    Xt = o().memo(function ({ text: e, value: u, currencyType: t, labelClassName: n }) {
                        return o().createElement(
                            'div',
                            { className: jt },
                    ...
                    Yt = 'Content_base_8f',
                    Zt = 'Content_headerContainer_7b',
                    Qt = 'Content_topHeader_28',
                    Jt = 'Content_header_db',
                    en = 'Content_currencyBlock_09',
                    un = 'Content_currency_b4',
                    tn = 'Content_scrollArea_eb',
                    nn = 'Content_bar_a4',
                    rn = 'Content_gap_3b',
                    an = R.strings.tank_setup.deconstructionDeviceView,
                    on = (0, X.Pi)(() => {
                        const e = ce().model,
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(
                                        'div',
                                        { className: Qt },
                                        o().createElement($t, { text: an.header.inStorage(), value: u, isHidden: l }),
                                    ),
                                    o().createElement(
                                        'div',
                                        { className: Qt },
                                        o().createElement($t, {
                                            text: an.header.onVehicles(),
                                            value: t,
                                            showVehicleInfo: !0,
                                            isHidden: !l,
                                        }),
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(
                                        ...
                                        { api: n, barClassNames: { base: nn } },
                                        u > 0 &&
                                            o().createElement(
                                                'div',
                                                { ref: r },
                                                o().createElement(kt, { groupType: ie.IN_STORAGE }),
                                            ),
                                        t > 0 &&
                                            o().createElement(
                                                o().Fragment,
                                                ...
                                                o().createElement(kt, { groupType: ie.ON_VEHICLES }),
                                            ),
                                    ),
                                ),
                            )
                        ...
                        const m = (0, a.useRef)(null),
                            ...
                            O = f()(
                                ...
                                cn[`base__${n}`],
                                {
                                    ...
                                    [cn[`base__${u}`]]: u,
                                    [cn.base__focus]: C,
                                    [cn.base__highlightActive]: h,
                                    [cn.base__firstHover]: b,
                                },
                                i,
                            ),
                            P = f()(cn.state, cn.state__default);
                        return (
                            (0, a.useEffect)(
                                () => (
                            ...
                            o().createElement(
                                ...
                                n !== sn.ghost &&
                                    o().createElement(
                                        o().Fragment,
                                        null,
                                        o().createElement('div', { className: cn.back }),
                                        o().createElement('span', { className: cn.texture }),
                                    ),
                                o().createElement(
                                    'span',
                                    { className: P },
                                    o().createElement('span', { className: cn.stateDisabled }),
                                    o().createElement('span', { className: cn.stateHighlightHover }),
                                    o().createElement('span', { className: cn.stateHighlightActive }),
                                ),
                                o().createElement(
                                    'span',
                ...
                En.defaultProps = { type: sn.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const _n = (0, a.memo)(En),
                    dn = {
                    ...
                    An = /(?:%\(|{)\w*(?:_[Oo]pen|Start)(?:\)s|})?(.*?)(?:%\(|{)\w*(?:_[Cc]lose|End)(?:\)s|})?/g,
                    Fn = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    mn = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                                ...
                                (s = s.replace(t, `%(${i})`)),
                                    (r[i] = dn[e]
                                        ? o().createElement(
                                              'span',
                                              { className: dn[e] },
                                              o().createElement(Lt, { text: c, binding: u }),
                                          )
                                        : o().createElement(
                                              'span',
                                              { style: n(e) },
                    ...
                    Cn = 'FooterIconValue_base_d4',
                    Bn = 'FooterIconValue_label_33',
                    gn = 'FooterIconValue_value_fa',
                    hn = 'FooterIconValue_icon_0f',
                    pn = o().memo(function ({ label: e, value: u, iconSource: t, className: n }) {
                        return o().createElement(
                            'div',
                            { className: f()(Cn, n) },
                            o().createElement('div', { className: Bn }, e),
                            o().createElement('div', { className: gn }, u),
                            o().createElement('div', { className: hn, style: { backgroundImage: `url(${t})` } }),
                        );
                    }),
                ...
                const bn = R.views.common.tooltip_window.simple_tooltip_content,
                    wn = (e) => {
                        let u = e.children,
                            t = e.body,
                            n = e.header,
                            ...
                            fn(
                                {
                                    contentId:
                                        ...
                                        E ? bn.SimpleTooltipHtmlContent('resId') : bn.SimpleTooltipContent('resId')),
                    ...
                    yn = 'Footer_base_7b',
                    xn = 'Footer_leftBlock_eb',
                    Sn = 'Footer_rightBlock_4c',
                    Tn = 'Footer_currencyBlock_44',
                    kn = 'Footer_price_14',
                    Mn = 'Footer_notEnoughMoney_1d',
                    Ln = 'Footer_btnHangar_26',
                    Nn = 'Footer_button_0f',
                    On = R.strings.tank_setup.deconstructionDeviceView,
                    Rn = (0, X.Pi)(() => {
                        const e = ce(),
                            u = e.model,
                            t = e.controls,
                            ...
                            i = u.computes.hasEnoughMoney()
                                ? On.tooltip.deconstruct.enoughMoney()
                                : On.tooltip.deconstruct.notEnoughMoney();
                        return o().createElement(
                            'div',
                            { className: yn },
                            o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(
                                        ...
                                        o().createElement(
                                            _n,
                                            { size: ln.medium, type: sn.primary, disabled: a, onClick: t.confirm },
                                            On.btn.deconstruct(),
                                        ),
                                    ),
                                ),
                    ...
                    Pn = 'Header_base_85',
                    Hn = 'Header_titleBlock_ca',
                    Wn = 'Header_base__notEnoughMoney_fb',
                    In = 'Header_title_5a',
                    Vn = 'Header_subTitle_b8',
                    zn = 'Header_equipCoinIcon_09',
                    qn = R.strings.tank_setup.deconstructionDeviceView,
                    Gn = () => {
                        const e = ce().model,
                            u = e.computes.hasEnoughMoney(),
                            t = u ? 'enoughMoney' : 'notEnoughMoney',
                            n = { equipment: e.root.get().deviceForUpgradeName },
                            r = (0, a.useMemo)(() => ({ icon: o().createElement('div', { className: zn }) }), []);
                        return o().createElement(
                            'div',
                            { className: f()(Pn, !u && Wn) },
                            o().createElement(
                                'div',
                                { className: Hn },
                                o().createElement(Dn, { text: qn.title.$dyn(`${t}`), binding: n, classMix: In }),
                            ),
                            o().createElement(Dn, { text: qn.subTitle.$dyn(`${t}`), binding: r, classMix: Vn }),
                        );
                    },
                    Un = (0, X.Pi)(() => {
                        const e = ce().controls;
                ...
                engine.whenReady.then(() => {
                    s().render(
                        o().createElement(W, null, o().createElement(le, null, o().createElement(Un, null))),
                ...
                const E = 'ShortenedText_base_fe',
                    ...
                    d = (e) =>
                        e
                            .split(' ')
                            .filter((e) => Boolean(e))
                            .map((e, u) => l().createElement('span', { key: u }, `${e} `)),
                    A = ({ blocks: e, linesCount: u = 2, mediaSize: t }) => {
                        ...
                        (0, s.useEffect)(() => {
                            ...
                            (0, s.useEffect)(() => {
                                if (m.height && !B.current.shortened) {
                                    const u = (0, c.M)(C, m.height);
                                    if (-1 !== u) {
                                        const t = e.slice(0, u);
                                        t.push(l().createElement('span', { key: u }, '...')),
                                            A(t),
