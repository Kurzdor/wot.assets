(() => {
    var __webpack_modules__ = {
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => l, off: () => o, on: () => a, onResize: () => i, onScaleUpdated: () => s });
                var n = t(2472),
                    r = t(1176);
            ...
            9916: (u, e, t) => {
                ...
                const g = r.instance,
                    v = {
                        ...
                        sendMoveEvent: (u) => B(a.MOVE, { isMouseEvent: !0, on: u }),
                        sendCloseEvent: C,
                        sendClosePopOverEvent: () => B(a.POP_OVER, { on: !1 }),
                        sendShowContextMenuEvent: (u, e, t = 0) => {
                            B(a.CONTEXT_MENU, { isMouseEvent: !0, contentID: u, on: !0, decoratorID: t, args: e });
                        },
            ...
            2449: (u, e, t) => {
                ...
                class p extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            A = d()(m.base, m[`base__${s}`], m[`base__${i}`], null == a ? void 0 : a.base),
                            D = d()(m.icon, m[`icon__${s}`], m[`icon__${i}`], null == a ? void 0 : a.icon),
                            F = d()(m.glow, null == a ? void 0 : a.glow),
                            p = d()(m.caption, m[`caption__${s}`], null == a ? void 0 : a.caption),
                ...
                const P = (u) => {
                    ...
                    const r = (0, n.useContext)(S),
                        ...
                        p = { extraLarge: d, large: F, medium: m, small: B, extraSmall: C };
                ...
                const O = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    L = (u, e, t = T.left) => u.split(e).reduce(t === T.left ? M : I, []),
                    U = (() => {
                        const u = new RegExp(
                ...
                const du = (u) => {
                    ...
                    hu = (0, n.memo)(
                        ({
                            ...
                            r().createElement(
                                'span',
                                { className: d()(pu.base, pu[`base__${t}`], l) },
                                r().createElement(
                                    'span',
                                    {
                                        className: d()(
                                ...
                                r().createElement('span', {
                                    className: d()(pu.icon, pu[`icon__${n}-${t}`], null == _ ? void 0 : _.icon),
                                }),
                                u &&
                                    r().createElement(
                                        'span',
                    ...
                    vu = ({ binding: u, text: e = '', classMix: t, alignment: i = T.left, formatWithBrackets: s }) => {
                    ...
                    Su = ({
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: d()(wu, null == l ? void 0 : l.currency) },
                    ...
                    Ou = (0, A.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(Su, {
                                ...
                                showAlertMessage: !0,
                                className: xu,
                                classNames: { currency: Pu, alert: Tu },
                            }),
                        );
                    }),
                    Ru = [
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (Iu(t, D, { isMouseEvent: !0, on: !0, arguments: Mu(r) }, v),
                                    C && C(),
                ...
                const ju = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const i = e.contentId;
                        return i ? r().createElement(Lu, zu({}, e, { contentId: i }), n) : r().createElement(Gu, e, n);
                    },
                    Yu =
                        (eu.Items,
                        eu.Equipment,
                    ...
                    Ku = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: d()($u.base, $u[`base__${n}`], c), style: o },
                            r().createElement(
                                ju,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: d()($u.image, null == l ? void 0 : l.image) },
                                        A &&
                                            r().createElement('div', {
                                                className: d()($u.highlight, null == l ? void 0 : l.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: d()($u.icon, null == l ? void 0 : l.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        D &&
                                            r().createElement('div', {
                                                className: d()($u.overlay, null == l ? void 0 : l.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: E },
                                    r().createElement('div', {
                                        className: d()($u.timer, null == l ? void 0 : l.periodicIcon),
                                    }),
                                ),
                        );
                    },
                    ...
                    Qu = (0, A.Pi)(() => {
                        ...
                        return r().createElement('div', { className: Zu }, r().createElement(Ku, u));
                    });
                let Ju, ue;
                !(function (u) {
                    (u.main = 'main'),
                ...
                const ee = {
                    ...
                    te = ({
                        ...
                        const B = (0, n.useRef)(null),
                            ...
                            L = d()(ee.state, ee.state__default);
                        return (
                            (0, n.useEffect)(
                                () => (
                    ...
                    ie = ({ content: u, classMix: e }) => {
                        ...
                        return (
                            ...
                            r().createElement(
                                Xu,
                                { isEnabled: s, body: u },
                                r().createElement('div', { ref: t, className: d()(re, e) }, u),
                            )
                        );
                    },
                    ...
                    ce = ({ onDeconstructDevice: u, onCloseDialog: e, buttons: t, classNames: n, className: i }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                {
                                    onClick: u,
                                    mixClass: d()(ae, null == n ? void 0 : n.button),
                                    size: s.size,
                                    type: s.type,
                                },
                                r().createElement(ie, {
                                    classMix: d()(oe, null == n ? void 0 : n.buttonText),
                                    content: s.text,
                                }),
                            ),
                            r().createElement(
                ...
                class de extends r().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = d()(De.currencyIcon, n && De[`currencyIcon__${n}-${t}`]),
                            l = d()(De.currency, n && De[`currency__${n}`], n && De[`currency__${n}-${t}`]);
                        return r().createElement(
                            'div',
                            {
                                className: i,
                ...
                const Fe = {
                    ...
                    Be = (0, A.Pi)(({ price: u, buttons: e, onDeconstructDevice: t, onCloseDialog: i }) => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: Fe.priceBlock },
                                r().createElement(
                                    'div',
                                    { className: Fe.stepper },
                                    r().createElement(de, {
                                        value: 1,
                                        minimum: 1,
                                        maximum: _,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(Su, {
                                        ...
                                        type: l,
                                        size: Y.big,
                                        classNames: { currency: Fe.currency, alert: Fe.alert },
                                    }),
                                ),
                            ),
                    ...
                    fe = ({ title: u, deviceName: e, className: t, classNames: n }) =>
                        r().createElement(
                            ...
                            r().createElement(vu, {
                                text: u,
                                classMix: d()(ve, null == n ? void 0 : n.text),
                                binding: {
                                    name: r().createElement(
                                        'span',
                                        { className: d()(be, null == n ? void 0 : n.deviceName) },
                                        e,
                                    ),
                                },
                            }),
                    ...
                    Se = (0, A.Pi)(() => {
                        ...
                        return r().createElement(fe, {
                            deviceName: i,
                            title: s,
                            classNames: { text: ye, deviceName: ye },
                        });
                    }),
