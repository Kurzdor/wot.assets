(() => {
    ...
    var u,
        A = {
            ...
            1039: (u, A, F) => {
                F(5067), F(6536), F(6179), F(3495), F(1043), F(5262);
            },
            6010: (u, A, F) => {
                var e = F(6179),
                    E = F(7382),
            ...
            5067: (u, A, F) => {
                ...
                var D = {};
                F.r(D), F.d(D, { getBgUrl: () => c, getTextureUrl: () => g });
                var B = {};
                function t(u) {
                    return (A) => (
                        engine.on(u, A),
                ...
                const Z = Object.keys(h).reduce((u, A) => ((u[A] = () => viewEnv.getShowingStatus() === h[A]), u), {}),
                    Y = {
                        set: (u, A) => {
