(() => {
    ...
    var __webpack_modules__ = {
            ...
            5067: (u, e, t) => {
                ...
                var E = {};
                t.r(E),
                    t.d(E, { mouse: () => B, off: () => s, on: () => D, onResize: () => a, onScaleUpdated: () => o });
                var n = {};
                t.r(n),
                    t.d(n, {
                        events: () => E,
                ...
                var A = {};
                t.r(A), t.d(A, { getBgUrl: () => m, getTextureUrl: () => d });
                var F = {};
                function r(u) {
                    return (e) => (
                        engine.on(u, e),
                    ...
                    a = ({
                        ...
                        const r = ((u) => {
                                const e = i(u),
                                    ...
                                    E = e.isPositive,
                                    n = e.valueKey;
                                return `${E ? '+' : ''}${A.Z5.getRealFormat(t, A.Gr.WO_ZERO_DIGITS)}${R.strings.tank_setup.kpi.bonus.valueTypes.$dyn(n) || '%'}`;
                            })(e),
                            a = ((u, e = !1) =>
                                e || i(u).isPositive
                        ...
                        return n().createElement(
                            'span',
                            { className: t.base },
                            u && n().createElement('span', { className: t.unit }, r),
                            u && E && ' ',
                            n().createElement('span', { className: t.text }, a),
                        );
                    };
            },
            3137: (u, e, t) => {
            ...
            5987: (u, e, t) => {
                ...
                const o = (u = 1) => {
                    ...
                    l = (u) => {
                        ...
                        if (E.length > 0) {
                            ...
                            return (
                                E.reduce((e, E) => {
                                    const n = D(B(t, `${e}.${E}`), window);
                                    return c(n) ? (u.push(n.id), `${e}.${E}.value`) : (u.push(E), `${e}.${E}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                        ...
                        s(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    E = l(u);
                                v.current = _.addCallback(E, t, r, e === d.Deep);
                            }
                        }),
                        (0, E.useEffect)(() => {
                            if (e !== d.None)
                ...
                const P = 'Header_base_22',
                    ...
                    L = ({ modificationName: u, level: e }) => {
                        const t = (0, E.useMemo)(
                            () => ({ level: n().createElement('div', { className: N }, x(e)) }),
                            [e],
                        );
                        return n().createElement(
                            'div',
                            { className: P },
                            n().createElement('div', { className: T }, u),
                            n().createElement(O.z, {
                                classMix: M,
                ...
                const V = 'Modification_base_8d',
                    ...
                    W = 'Modification_checkmark_ed',
                    G = 'Modification_bottomHighlight_6a',
                    ...
                    j = ({ isReceived: u, isSelected: e, model: t }) => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(
                                'div',
                                { className: U },
                                n().createElement('div', { className: $, style: F }),
                                u &&
                                    n().createElement(
                                        'div',
                                        { className: z },
                ...
                const X = 'ModifiersBlock_base_88',
                    ...
                    nu = ({ modifiers: u }) => {
                        const e = (0, E.useCallback)((u) => ({ unit: I()(eu, u && tu), text: Eu }), []);
                        return n().createElement(
                            'div',
                            { className: X },
                    ...
                    Fu = (0, E.memo)(({ stepState: u, level: e }) => {
                        const t = I()(
                            ...
                            A = (0, E.useMemo)(
                                () => ({ level: n().createElement('span', { className: Au.level }, x(e)) }),
                                [e],
                            ),
                        ...
                        return n().createElement(
                            ...
                            { className: t },
                            n().createElement(f.Z, null),
                            u !== p.Received && n().createElement('div', { className: Au.title }, F.$dyn('title')),
                            n().createElement(
                                'div',
                    ...
                    ou = () =>
                        n().createElement(
                            'div',
                            { className: ru },
                            n().createElement('div', { className: iu }, n().createElement(f.Z, null)),
                            n().createElement(
                                'div',
                                { className: au },
                ...
                const lu = () => {
                    const u = m('model', d.None),
                        ...
                        c = o === p.Received ? Cu.Demount : Cu.Mount,
                        B = o !== p.Received && !D ? Bu.moneyShortage.$dyn(c) : Bu.$dyn(c);
                    return n().createElement(
                        'div',
                        { className: Du },
                        n().createElement(L, { modificationName: e, level: t }),
                        n().createElement(Z, { model: a }),
                        n().createElement(nu, { modifiers: E }),
                        r &&
                            n().createElement(
                                'div',
                                { className: su },
                                n().createElement(w.R, { price: A, description: B, moneyShortage: F }),
                            ),
                        r && o !== p.AvailablePurchase && n().createElement(Fu, { stepState: o, level: t }),
                        s &&
                            n().createElement(
                                'div',
                                { className: cu },
                                n().createElement(f.Z, null),
                                n().createElement(b.f, null),
                            ),
                        i && o !== p.Received && n().createElement(ou, null),
                    );
                };
                function _u() {
                ...
                const pu = n().forwardRef(function (u, e) {
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement('div', { className: du.decorator }, t),
                            )
                        );
                    }),
                    gu = () => n().createElement(pu, null, n().createElement(lu, null)),
                    bu = document.createElement('div');
                (window.onload = () => document.body.appendChild(bu)), F().render(n().createElement(gu, null), bu);
            },
            7024: (u, e, t) => {
                t.d(e, { f: () => a });
                var E = t(6179),
                        ...
                        ({
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    ...
                                    i && A > 0 && '+',
                                    n().createElement(a, { value: A, format: E === D.V2.gold ? 'gold' : 'integral' }),
                                ),
                                n().createElement('span', {
                                    className: r()(o.icon, o[`icon__${E}-${t}`], null == C ? void 0 : C.icon),
                                }),
                                u &&
                                    n().createElement(
                                        'span',
                ...
                const d = 'PriceBlock_base_54',
                    ...
                    b = ({ price: u, moneyShortage: e, description: t }) => {
                        ...
                        return n().createElement(
                            ...
                            n().createElement(A.z, { text: t, binding: r, classMix: v }),
                        );
                    };
            },
            8899: (u, e, t) => {
