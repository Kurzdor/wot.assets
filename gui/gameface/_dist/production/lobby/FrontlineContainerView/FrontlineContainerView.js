    ...
    var __webpack_modules__ = {
            ...
            3977: (e, t, u) => {
                ...
                const h = {
                    ...
                    N = (0, i.memo)(
                        ({ api: e, classNames: t = {}, getStepByRailClick: u = x, onDrag: n = k, onClick: a = k }) => {
                            const r = (0, i.useRef)(null),
                                ...
                                b = () => {
                                    ...
                                    const r = e.animationScroll.scrollPosition.get(),
                                        i = Math.min(1, n / a),
                                        o = (0, E.u)(0, 1, r / (a - n)),
                                        d = (t.offsetWidth - T(t, i)) * o;
                                    (u.style.transform = `translateX(${0 | d}px)`),
                                        ((e) => {
                                            if (s.current && l.current && c.current && m.current) {
                                                if (0 === e)
                                                    return (
                                                        s.current.classList.add(S), void l.current.classList.remove(S)
                                                    );
                                                if (
                                                    ((t = c.current),
                                                    (u = m.current),
                                                    ...
                                                    return (
                                                        s.current.classList.remove(S), void l.current.classList.add(S)
                                                    );
                                                var t, u;
                                                s.current.classList.remove(S), l.current.classList.remove(S);
                                            }
                                        })(d);
                                },
                                R = A(() => {
                                    (() => {
                                        ...
                                        (t.style.width = `${T(u, s)}px`),
                                            ...
                                            r.current &&
                                                (1 === s ? r.current.classList.add(w) : r.current.classList.remove(w));
                                    })(),
                                        b();
                                });
                            (0, i.useEffect)(() => (0, _.v)(R)),
                                (0, i.useEffect)(
                                    () =>
                                        (0, _.v)(() => {
                                            const t = () => {
                                ...
                                (0, i.useEffect)(() => {
                                    ...
                                    const t = g.O.client.events.mouse.move(([t, u]) => {
                                            ...
                                            const l = t.clientX - v.offset - i.getBoundingClientRect().x,
                            ...
                            return o().createElement(
                                'div',
                                {
                                    className: d()('HorizontalBar_base_49', t.base),
                                    ref: r,
                                ...
                                o().createElement(
                                        ...
                                        onMouseDown: (t) => {
                                            ...
                                            n &&
                                                ...
                                                t.target === n
                                                    ? C({
                                                          pending: !0,
                                                          offset: t.screenX - n.getBoundingClientRect().x,
                                                      })
                                                    : ((t) => {
                                                          const n = m.current,
                                    ...
                                    o().createElement('div', {
                                        ref: m,
                                        className: d()('HorizontalBar_thumb_fd', t.thumb),
                                    }),
                    ...
                    L = ({
                        ...
                        return o().createElement(
                            ...
                            o().createElement(N, { getStepByRailClick: l, api: t, onDrag: c, classNames: m }),
                        );
                    },
                        ...
                        Fe
                            ...
                            : (function (e) {
                                  ...
                                  for (let u = fe.length - 1; u >= 0; u--)
                                      for (; e >= fe[u]; ) (t += Ae[u]), (e -= fe[u]);
                                  return t;
                              })(e);
                var ve = u(3618);
                const Be = (0, i.memo)(({ withDivider: e = !0, className: t, children: u }) =>
                        o().createElement(
                            'div',
                            ...
                            o().createElement(
                                ...
                                ((e) => [
                                    ...
                                    o().createElement(
                                        ...
                                        u
                                            ? o().createElement(ve.w, { text: t, binding: u })
                                    ...
                                    e.map(({ header: e, text: t, image: u }, n) =>
                                        o().createElement(
                                            ...
                                            o().createElement(
                                                ...
                                                e.binding
                                                    ? o().createElement(ve.w, {
                                                          text: e.value,
                                                          binding: e.binding,
                                                          classMix: ce,
                                                      })
                                                    : o().createElement('div', { className: ce }, e.value),
                                                o().createElement(ve.w, { text: t.value, binding: t.binding }),
                                            ),
                                        ),
                                    ),
                                ),
                                ...
                                o().createElement(
                                    ...
                                    $e.map((e, t) =>
                                        o().createElement(
                                            ...
                                            o().createElement(ve.w, { text: e.text }),
                                            e.list &&
                                                e.list.map((e, t) =>
                                                    o().createElement(
                                                        'div',
                        ...
                        o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    qe.map((e, t) => o().createElement(ve.w, { key: t, text: e, classMix: Ye })),
                                ),
            ...
            4389: (e, t, u) => {
                ...
                const L = (0, n.memo)((e) => {
                        ...
                        switch (r.animationSettings.type) {
                            ...
                            case g.Growing:
                                return a().createElement(T, P({}, r, { onEndAnimation: l, isComplete: i }));
                            default:
                                return null;
                        }
                    }),
