    ...
    var __webpack_modules__ = {
            ...
            912: (u, e, t) => {
                ...
                const Du = (u, e, t) => {
                    ...
                    Bu = (u, e, t = nu.left) => u.split(e).reduce(t === nu.left ? Du : ou, []),
                    su = (() => {
                        const u = new RegExp(
                        ...
                        return lu.includes(t)
                            ...
                            : ((u, e = nu.left) => {
                                  ...
                                  const E =
                                      ...
                                      A = u.replace(/&nbsp;/g, ' ');
                                  return Bu(A, /( )/, e).forEach((u) => (t = t.concat(Bu(u, E, nu.left)))), t;
                              })(u, e);
                    },
                    du = 'FormatText_base_d0',
                    cu = ({ binding: u, text: e = '', classMix: t, alignment: r = nu.left }) =>
                        null === e
                            ...
                            : A().createElement(
                                  ...
                                  e.split('\n').map((e, F) =>
                                      A().createElement(
                                          'div',
                                          { className: h()(du, t), key: `${e}-${F}` },
                                          ((u, e, t) =>
                                              u
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((u) => (t && u in t ? t[u] : Cu(u, e))))(e, r, u).map((u, e) =>
                    ...
                    _u = ({ state: u }) => {
                        switch (u) {
                            case N.PrimeTimeToday:
                                return A().createElement(cu, { text: mu.info.battlesToday() });
                            case N.PrimeTimeTomorrow:
                                return A().createElement(cu, { text: mu.info.battlesTomorrow() });
                            case N.Ended:
                                return A().createElement(cu, { text: mu.info.battlesEnd() });
                            default:
                                return (
                ...
                const vu = (u, e, t) => {
                    ...
                    fu = ({ state: u, startTimestamp: e, endTimestamp: t }) => {
                        switch (u) {
                            ...
                            case N.PrimeTimeNotChosen:
                                return A().createElement(cu, { text: Tu.chooseTime() });
                            case N.PrimeTimeNow:
                            case N.PrimeTimeToday:
                            case N.PrimeTimeTomorrow:
                                return A().createElement(cu, {
                    ...
                    xu = {
                        highlighted: [N.NotStarted, N.PrimeTimeNow, N.PrimeTimeNotChosen, N.Started],
                        withInfo: [N.Ended, N.PrimeTimeToday, N.PrimeTimeTomorrow],
                        withoutDate: [N.Ended, N.DataError],
                        disabled: [N.Ended, N.PrimeTimeToday, N.PrimeTimeTomorrow],
                    },
                    bu = (0, U.Pi)(() => {
                        const u = q(),
                            e = u.controls,
                        ...
                        return A().createElement(
                            'div',
                            {
                                className: h()(Z, xu.disabled.includes(E) && Q, r && J),
                                onClick: () => {
                                    I(R.sounds.yes()), e.open();
                                },
                                onMouseEnter: () => {
                                    W.playHighlight();
                                },
                            ...
                            xu.disabled.includes(E) && A().createElement('div', { className: tu }),
                            A().createElement('div', { className: uu }),
                            xu.highlighted.includes(E) && A().createElement('div', { className: eu }),
                            A().createElement(
                                'div',
                                { className: Eu },
                                A().createElement('div', { className: Au }, pu.title()),
                                xu.withInfo.includes(E) &&
                                    A().createElement('div', { className: ru }, A().createElement(_u, { state: E })),
                ...
                engine.whenReady.then(() => {
                    k().render(
                        A().createElement(Y, null, A().createElement(H, null, A().createElement(bu, null))),
