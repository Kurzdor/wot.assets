    ...
    var __webpack_modules__ = {
            ...
            1039: (u, e, t) => {
                ...
                const o = (0, r.memo)(({ children: u }) => {
                    ...
                    const s = (0, r.useMemo)(() => Object.assign({}, o), [o]);
                                                ...
                                                return {
                                                    subscribe: (t, n) => {
                                                        const F = 'string' == typeof n ? `${r}.${n}` : r,
                                                            i = l.O.view.addModelObserver(F, e, !0);
            ...
            6598: (u, e, t) => {
                                      ...
                                      Object.assign(
                                          {
                                              ...
                                              onClick: ((u) => (e) => {
                                                  !1 === l && S(), null == i || i(e), null == u || u(e);
                                              })(e.props.onClick),
                                              onMouseDown: ((u) => (e) => {
                                                  !1 === l && S(), null == F || F(e), null == u || u(e);
                                              })(e.props.onMouseDown),
                                          },
                                          p,
                                      ),
                ...
                let p, f, x;
                !(function (u) {
                    (u[(u.ExtraSmall = b.j.extraSmall.width)] = 'ExtraSmall'),
                        (u[(u.Small = b.j.small.width)] = 'Small'),
                        (u[(u.Medium = b.j.medium.width)] = 'Medium'),
                        (u[(u.Large = b.j.large.width)] = 'Large'),
                        (u[(u.ExtraLarge = b.j.extraLarge.width)] = 'ExtraLarge');
                })(p || (p = {})),
                    (function (u) {
                        (u[(u.ExtraSmall = b.j.extraSmall.width)] = 'ExtraSmall'),
                            (u[(u.Small = b.j.small.width)] = 'Small'),
                    ...
                    (function (u) {
                        (u[(u.ExtraSmall = b.j.extraSmall.height)] = 'ExtraSmall'),
                            (u[(u.Small = b.j.small.height)] = 'Small'),
                            (u[(u.Medium = b.j.medium.height)] = 'Medium'),
                            (u[(u.Large = b.j.large.height)] = 'Large'),
                            (u[(u.ExtraLarge = b.j.extraLarge.height)] = 'ExtraLarge');
                    })(x || (x = {}));
                let y;
                !(function (u) {
                ...
                const S = (u, e, t) => {
                    ...
                    L = (u, e, t = y.left) => u.split(e).reduce(t === y.left ? S : O, []),
                    T = (() => {
                        const u = new RegExp(
                    ...
                    M = ['zh_cn', 'zh_sg', 'zh_tw'],
                    P = ({ binding: u, text: e = '', classMix: t, alignment: r = y.left }) =>
                        null === e
                    ...
                    j = ({ count: u, maxCount: e, hasInfinite: t, isEnabled: r }) => {
                        ...
                        const o = String(I.$dyn(i)),
                            ...
                            l = D ? 24 : 20,
                            s = 0.6 * l + 'rem',
                            B = A().createElement('div', { style: { width: s } }, I.mult()),
                            C = A().createElement('div', { className: N }),
                            c = E()(k, D && H, !r && W);
                        return A().createElement(
                            'div',
                            { className: c, style: { fontSize: `${l}rem` } },
                            A().createElement(P, { text: o, binding: { count: a, mult: B, infin: C } }),
                        );
                    },
                    U = {
