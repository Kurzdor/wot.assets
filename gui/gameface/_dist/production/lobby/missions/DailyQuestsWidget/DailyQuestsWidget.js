(() => {
    ...
    var __webpack_modules__ = {
                            ...
                            (0, c.Z)(() => {
                                if (
                                    ...
                                    const t = (u) => {
                                        ...
                                        n = (0, _.U0)(u);
                                    C.current = d.addCallback(n, t, o, e === F.Deep);
                                }
                            }),
                            (0, n.useEffect)(() => {
                                if (e !== F.None)
            ...
            4274: (u, e, t) => {
                ...
                const M = ({ size: u = w.Default }) =>
                        i().createElement('div', { className: E()(v.background, v[`background__${u}`]) }),
                    S = {
                ...
                const Z = (0, r.memo)((u) => {
                        ...
                        switch (n.animationSettings.type) {
                            case f.Simple:
                                return i().createElement(U, Y({}, n, { onEndAnimation: l, isComplete: o }));
                            case f.Growing:
                                return i().createElement(W, Y({}, n, { onEndAnimation: l, isComplete: o }));
                            default:
                                return null;
                        }
                    }),
                ...
                const tu = (0, r.memo)(
                        ({
                            ...
                            return r.withStack
                                ? i().createElement(uu, E)
                                : i().createElement(Z, eu({ key: `${a}-${e}` }, E));
                        },
                    ),
                    nu = (u) => ({
                    ...
                    su = (0, r.memo)(
                        ({
                            ...
                            return i().createElement(
                                'div',
                                { className: E()(v.base, v[`base__${t}`]), style: nu(e) },
                                !o && i().createElement(M, { size: t }),
                                i().createElement(tu, {
                                    size: t,
                                    lineRef: c,
                                    disabled: a,
                ...
                const _u = ({ countdown: u, noIcon: e }) =>
                    i().createElement(
                        'div',
                        { className: lu },
                        !e && i().createElement('div', { className: Eu }),
                        i().createElement(
                            'div',
                            { className: cu },
                ...
                const bu = Bu,
                    ...
                    Hu = 'QuestCard_progressCounter_current_af',
                ...
                const ue = class extends bu {
                        ...
                        renderCard() {
                            ...
                            return i().createElement(
                                'div',
                                {
                                    className: E()(ku, hu, { [Iu]: h, [Ru]: r }, { [gu]: d, [vu]: m }),
                                    style: M,
                                    onClick: s,
                                    onMouseEnter: l,
                                    ref: c,
                                ...
                                i().createElement(
                                    'div',
                                    { className: Nu },
                                    i().createElement('div', { className: E()(Lu, wu, { [fu]: d }) }),
                                ),
                                i().createElement(
                                    'div',
                                    { className: E()(xu, { [Mu]: F }) },
                                    i().createElement('div', { className: E()(Qu, Su, { [yu]: F }) }),
                                ),
                                ...
                                i().createElement(
                                    ...
                                    { className: zu },
                                    i().createElement('div', {
                                        className: E()(Vu, { [$u]: h }, { [Ou]: a && h, [Tu]: F }),
                                        style: h ? void 0 : D(b),
                                    }),
                                ),
                                i().createElement(
                                    ...
                                    f &&
                                        i().createElement(
                                            ...
                                            i().createElement(
                                                'div',
                                                { className: E()(Gu, { [Yu]: h }) },
                                                i().createElement('span', { className: Hu }, p),
                                ...
                                !h &&
                                    ...
                                    i().createElement(
                                        'div',
                                        { className: Xu },
                                        i().createElement(_u, { countdown: o }),
                                    ),
                            );
                            var S, y;
                        }
                    ...
                    renderCard() {
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                ...
                                { className: B.border },
                                i().createElement('div', {
                                    className: E()(B.border_bg, B.border_bg__appearStart, {
                            ...
                            i().createElement(
                                'div',
                                { className: E()(B.complete, { [B.complete__blink]: d }) },
                                i().createElement('div', {
                                    className: E()(B.complete_bg, B.complete_bg__completeStart, {
                                        [B.complete_bg__completeEnd]: d,
                                    }),
                                }),
                            ),
                            i().createElement('div', { className: B.icon, style: D(m) }),
                            C &&
                                i().createElement('div', {
                                    className: E()(B.check, { [B.check__completeStart]: n, [B.check__completeEnd]: d }),
                                }),
                            !C && r && i().createElement(_u, { countdown: r, noIcon: !0 }),
                        );
                    }
                }
                const re = ae,
                ...
                const se = 'Widget_base_f1',
                    ...
                    ce = ({
                        ...
                        const l = u.slice(0, 3),
                            ...
                            O = (0, r.useCallback)(() => {
                                (0, oe.G)(R.sounds.play()), t();
                            }, [t]);
                        (0, r.useEffect)(() => {
                            e &&
                                (b > 0
                                    ? B
                                        ? (0, oe.G)(R.sounds.dq_widget_bonus_reveal())
                                        : (0, oe.G)(R.sounds.dq_widget_quest_complete())
                                    : D && D.completed
                                      ? (0, oe.G)(R.sounds.dq_widget_bonus_complete())
                                      : (0, oe.G)(R.sounds.dq_widget_slide_in()));
                        }, [e, b, B, D]),
                            (0, r.useEffect)(() => {
                                e && !B && w(F.List);
                            }, [e, B]);
                        ...
                        return i().createElement(
                            'div',
                            { className: E()(se, { [le]: v === F.Bonus && T === A.Normal }) },
                            v === F.List &&
                                i().createElement(g, {
                                    innerRef: f,
                                    quests: l,
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [45], () => __webpack_require__(4274));
