(() => {
    ...
    var __webpack_modules__ = {
                ...
                const c = (e) => (e ? { left: 0 } : { right: 0 }),
                    ...
                    F = (0, o.memo)(
                        ({
                            ...
                            const R = (0, o.useMemo)(() => Object.assign({ width: '100%' }, A(e), c(C)), [C, e]),
                                S = (0, o.useMemo)(() => Object.assign({ width: '0%' }, A(e), c(C)), [C, e]),
                            ...
                            return a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { style: f ? S : R, className: E.Z.glow },
                    ...
                    ({
                        ...
                        return C
                            ...
                            : s().createElement(
                                  ...
                                  s().createElement(
                                      'div',
                                      { style: p ? b : v, className: i.Z.delta },
            ...
            4179: (e, u, t) => {
                t.d(u, { Sw: () => r.Z, B3: () => l, Z5: () => o, B0: () => i, SU: () => b, ry: () => B });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            9840: (e, u, t) => {
                        ...
                        const b = (0, s.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, s.useCallback)(() => {
                                (b.current.isVisible && b.current.timeoutId) ||
                                    (P(t, F, { isMouseEvent: !0, on: !0, arguments: f(n) }, v),
                                    C && C(),
                                  ...
                                  Object.assign(
                                      {
                                          ...
                                          onMouseLeave: ((e) => (u) => {
                                              y(), null == o || o(u), null == e || e(u);
                                          })(u.props.onMouseLeave),
                                          onClick: ((e) => (u) => {
                                              !1 === d && y(), null == i || i(u), null == e || e(u);
                                          })(u.props.onClick),
                                          onMouseDown: ((e) => (u) => {
                ...
                const L = ({ children: e, tooltipArgs: u, className: t }) => {
                    ...
                    return s || a
                        ? r().createElement(y, x({}, u, { contentId: s || a }), n)
                ...
                const G = [
                    ...
                    $ = [B.Gold, B.Credits, B.Crystal, B.FreeXp],
                    z = [B.BattlePassPoints],
                    q = [B.PremiumPlus, B.Premium],
                    ...
                    Z = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: l()(H.base, H[`base__${n}`], E), style: i },
                            r().createElement(
                                L,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: l()(H.image, null == c ? void 0 : c.image) },
                                        F &&
                                            r().createElement('div', {
                                                className: l()(H.highlight, null == c ? void 0 : c.highlight),
                                                style: {
                                        ...
                                        u &&
                                            r().createElement('div', {
                                                className: l()(H.icon, null == c ? void 0 : c.rewardIcon),
                                                style: { backgroundImage: `url(${u})` },
                                            }),
                                        _ &&
                                            r().createElement('div', {
                                                className: l()(H.overlay, null == c ? void 0 : c.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: A },
                                    r().createElement('div', {
                                        className: l()(H.timer, null == c ? void 0 : c.periodicIcon),
                                    }),
                                ),
                        );
                    },
                ...
                const ee = r().memo(
                    ...
                    ue = 'DailyQuestsTooltipContent_base_65',
                    te = 'DailyQuestsTooltipContent_rewards_wrapper_72',
                    ne = 'DailyQuestsTooltipContent_info_82',
                    se = 'DailyQuestsTooltipContent_icon_86',
                    re = 'DailyQuestsTooltipContent_status_e0',
                    oe = 'DailyQuestsTooltipContent_statusIcon_4d',
                    ae = 'DailyQuestsTooltipContent_status_completed_8d',
                    ie = 'DailyQuestsTooltipContent_separator_00',
                    le = 'DailyQuestsTooltipContent_conditions_operator_ac',
                    Ee = { color: '#fff', fontSize: '20rem' },
                    ce = { marginLeft: '10rem', marginRight: '10rem' },
                    de = ({ model: e }) => {
                        ...
                        return r().createElement(
                            'div',
                            { className: E },
                            r().createElement('div', { className: se, style: F }),
                            r().createElement(
                                'div',
                                { className: ne },
                                r().createElement(m.L, {
                                    conditions: u,
                                    columns: !0,
                                    progressBarStyles: ce,
                                    textStyles: Ee,
                                    progressInfoStyles: Ee,
                                    missionId: o,
                                    swapProgress: !0,
                                    reverse: !0,
                                }),
                            ...
                            r().createElement('div', { className: te }, r().createElement(ee, { data: A })),
                            r().createElement('div', { className: ie }),
                            r().createElement('div', { className: c }, r().createElement('div', { className: oe }), d),
                        );
                    };
                class Ae extends r().Component {
                    ...
                    render() {
                        return r().createElement(
                            'div',
                            null,
                            r().createElement(F, null, r().createElement(de, { model: this.state.model })),
                        );
                    }
                }
                n.O.view.extraSize.set(0, 0),
                    engine.whenReady.then(() => {
                        a().render(r().createElement(Ae, null), document.getElementById('root'));
                    });
            },
            3847: (e, u, t) => {
                t.d(u, { L: () => I });
                            ...
                            _ = t
                                ? o().createElement(
                                      ...
                                      o().createElement(
                                          ...
                                          o().createElement('div', { className: b }, c),
                                      ),
                                  )
                                : o().createElement(
                                      o().Fragment,
                ...
                const I = ({
                    ...
                    const w = s()(a, b, { [i]: n === k.$.BIG, [c]: n === k.$.HUGE, [d]: r, [F]: l });
                    return o().createElement(
                        'div',
                        { className: w },
                        o().createElement(O, {
