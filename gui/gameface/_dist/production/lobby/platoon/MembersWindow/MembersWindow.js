    ...
    var __webpack_modules__ = {
            380: (e) => {
                ...
                (F.prototype.bind = function (e, u) {
                    ...
                    Object.defineProperties(F.prototype, _);
                var D = function () {
                    this.eventElements = [];
                };
                function b(e) {
                ...
                var B = function (e, u, t, n, o, r) {
                    ...
                    !(function (e, u, t, n, o, r) {
                        ...
                        u &&
                            !o &&
                            (E.dispatchEvent(h('ps-scroll-' + s)),
                            u < 0
                                ? E.dispatchEvent(h('ps-scroll-' + c))
                                : u > 0 && E.dispatchEvent(h('ps-scroll-' + d)),
                            n &&
                                (function (e, u) {
                                    m(e, u), A(e, u);
                                })(e, s));
                        e.reach[s] && (u || r) && E.dispatchEvent(h('ps-' + s + '-reach-' + e.reach[s]));
                    })(e, t, i, n, o, r);
                };
                var v = function (e, u, n, o) {
                    ...
                    if (r) {
                        if (
                            ...
                            r.scrollLeft < n ? (r.scrollLeft = n) : r.scrollLeft > l && (r.scrollLeft = l);
                        }
                        ...
                        r.contains(e.scrollbarXRail) ||
                            (a(r, s.rail('x')).forEach(function (e) {
                                return i(e);
                            }),
                            r.appendChild(e.scrollbarXRail)),
                            r.contains(e.scrollbarYRail) ||
                                (a(r, s.rail('y')).forEach(function (e) {
                                    return i(e);
                                }),
                            ...
                            e.scrollbarXActive
                                ? (r.classList.add(c.active('x')), B(e, 'left', E - e.lastScrollLeft, !0, u))
                                : (r.classList.remove(c.active('x')),
                                  (e.scrollbarXWidth = 0),
                                  (e.scrollbarXLeft = 0),
                                  (r.scrollLeft = 0)),
                            e.scrollbarYActive
                                ? (r.classList.add(c.active('y')), B(e, 'top', r.scrollTop - e.lastScrollTop, !0, u))
                    ...
                    k = function (e) {
                        ...
                        _
                            ? ((E = F ? 'scrollX' : 'scrollLeft'),
                              (A = F ? 'innerWidth' : 'width'),
                              (m = 'scrollWidth'))
                            : ((E = F ? 'scrollY' : 'scrollTop'),
                              (A = F ? 'innerHeight' : 'height'),
                              (m = 'scrollHeight'));
                        var b = u[E],
                            C = (function (e) {
                                var u,
                                ...
                                } else u = (n[a] - n.getBoundingClientRect()[o]) | 0;
                                return ['left', 'top'].includes(l) ? r : u - r;
                            })({
                                isWindow: F,
                                scrollableDomEle: u,
                                elementLengthProp: A,
                        ...
                        var p = function e(n) {
                            if (!s || !s()) {
                                var l = n - d,
                                    ...
                                    })({ easingPreset: a, cubicBezierPoints: i, runTime: l, duration: r });
                                if (!isNaN(m)) {
                                    var A = Math.round(m * C),
                                        p = D ? A + b : C - A;
                                    if (
                                        (c.breakBounds &&
                                            (p < c.startBound
                                ...
                                r = function () {
                                    if (1 === n.buttons) {
                                        if (
                                            ...
                                            S({ axis: u, cursorPositionOnRail: i, direction: a, i: e }) &&
                                                clearTimeout(o),
                                                v(e, !1, t);
                                        }
                                        n.stopPropagation();
                ...
                function M(e, u, t) {
                    var n = t[0],
                        ...
                        C = null;
                    function p(t) {
                        (F[s] = b(_ + C * (t[r] - D))), m(e, d), v(e, !1, u), t.stopPropagation(), t.preventDefault();
                    }
                    function h() {
                        A(e, d), e[E].classList.remove(c.clicking), e.event.unbind(e.ownerDocument, 'mousemove', p);
                    }
                ...
                var L = 1e3,
                    R = {
                                    ...
                                    !(function (e, t, o) {
                                        ...
                                        for (var r = e; r && r !== n; ) {
                                            ...
                                            if (
                                                ...
                                                if (
                                                    a > 0 &&
                                                    !((0 === r.scrollTop && o > 0) || (r.scrollTop === a && o < 0))
                                                )
                                                    return !0;
                                                var l = r.scrollWidth - r.clientWidth;
                                                if (
                                                    l > 0 &&
                                                    !((0 === r.scrollLeft && t < 0) || (r.scrollLeft === l && t > 0))
                                                )
                                                    return !0;
                                            }
                                            r = r.parentNode;
                        ...
                        touch: function (e, t) {
                            ...
                            function l(u, o) {
                                (n.scrollTop -= o), (n.scrollLeft -= u), v(e, !1, t);
                            }
                            function c(e) {
                        ...
                        'drag-move': function (e, u) {
                            ...
                            function F(o) {
                                if (e.scrollbarXActive) {
                                    var l = n - o.screenX;
                                    (t.scrollLeft += l), (n = o.screenX);
                                    var s = new Date().getTime();
                                    if (((r = (l / (s - i)) * 1e3), (i = s), e.onScroll(), u > 0)) {
                            ...
                            function D(n) {
                                ...
                                if (t.scrollLeft < u) s(u - t.scrollLeft, L, d);
                                else if (t.scrollLeft > o) s(o - t.scrollLeft, L, d);
                                else {
                                    new Date().getTime() - i < 100 && s(r / 4, L, d, !0);
                                }
                                A(e, 'x'),
                    ...
                    return (
                            ...
                            (r = ['bottom', 'top'].includes(u) ? this.element.scrollTop : this.element.scrollLeft),
                        {
                            ...
                            onRefUpdateCallback: function (e) {
                                v(o, !0, o.settings.overScrollWidth, !1), t && t(e);
                            },
            ...
            67: (e, u, t) => {
                ...
                var r = {};
                t.r(r), t.d(r, { getBgUrl: () => _, getTextureUrl: () => F });
                var i = {};
                function a(e) {
                    return (u) => (
                        engine.on(e, u),
            ...
            251: (e, u, t) => {
                let n;
                t.d(u, { B0: () => n, B3: () => o, Gr: () => r, kH: () => a, lf: () => i }),
                    (function (e) {
            ...
            72: (e, u, t) => {
                ...
                function a(e, u, t, n, o, r, i) {
                    ...
                    a.done ? u(l) : Promise.resolve(l).then(n, o);
                }
                const l = (e) => ({ __Type: 'GFBoundingBox', x: e.x, y: e.y, width: e.width, height: e.height }),
                    ...
                    E = (e) => d(r.B0.MOVE, { isMouseEvent: !0, on: e }),
                    m = () => d(r.B0.CLOSE),
                    A = () => d(r.B0.POP_OVER, { on: !1 }),
                    F = (e, u, t = 0) => {
                        d(r.B0.CONTEXT_MENU, { isMouseEvent: !0, contentID: e, on: !0, decoratorID: t, args: u });
                    },
                    _ = (e, u, t, n, i = R.invalid('resId'), a) => {
                        const s = o.O.view.getViewGlobalPosition(),
                            ...
                            F = c.height,
                            _ = {
                                x: o.O.view.pxToRem(E) + s.x,
                                y: o.O.view.pxToRem(m) + s.y,
                                width: o.O.view.pxToRem(A),
            ...
            602: (e, u, t) => {
                ...
                const c = a().createContext(null),
                    d = (e) => {
                        ...
                        return a().createElement(c.Provider, { value: t }, u);
                    };
                function E(e) {
                ...
                const D = ({
                    ...
                    const p = (0, i.useRef)(null),
                        ...
                        S = y[1],
                        T = (0, i.useCallback)(() => {
                            r || (p.current && (p.current.focus(), v(!0)));
                        }, [r]),
                        M = (0, i.useCallback)(
                            (e) => {
                        ...
                        H = o()(
                            ...
                            A[`base__${n}`],
                            {
                                ...
                                [A.base__firstHover]: k,
                            },
                            l,
                        ),
                        W = o()(A.state, A.state__default);
                    return (
                        (0, i.useEffect)(
                            () => (
                ...
                D.defaultProps = { type: F.primary, isFocused: !1, soundHover: 'highlight', soundClick: 'play' };
                const b = (0, i.memo)(D),
                    C = {
                        base: 'Button_base_8d',
                ...
                const h = ({ onClick: e, type: u }) => {
                        const t = (0, i.useCallback)(() => {
                            ...
                            r = o()(C.base, C[`base__${u}`]);
                        return a().createElement('div', { className: r, onClick: e, onMouseEnter: t, onMouseDown: n });
                    },
                    B = (e = 1) => {
                ...
                const w = (e, u, t = {}, n = 0) => {
                    ...
                    y = (e) => {
                        ...
                        const v = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            y = (0, i.useMemo)(() => b || B().resId, [b]),
                            k = (0, i.useCallback)(() => {
                                (v.current.isVisible && v.current.timeoutId) ||
                                    (w(t, A, { isMouseEvent: !0, on: !0, arguments: g(n) }, y),
                                    C && C(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (e) => {
                                                  (e.clientX === window.innerWidth &&
                                                      ...
                                                      ((v.current.timeoutId = window.setTimeout(k, c ? 100 : 400)),
                                                      o && o(e),
                                                      M && M(e));
                                              }),
                                          onMouseLeave: ((e) => (u) => {
                ...
                const T = R.views.common.tooltip_window.simple_tooltip_content,
                    M = (e) => {
                        ...
                        const c = (0, i.useMemo)(() => {
                            const e = Object.assign({}, l, { body: t, header: n, note: o, alert: r });
                    ...
                    P = 'Title_base_44',
                    N = ({ title: e, infoTooltipHeader: u, infoTooltipBody: t }) =>
                        a().createElement(
                            'div',
                            { className: P },
                            e,
                            u && t && a().createElement(x, { tooltipHeader: u, tooltipBody: t }),
                        ),
                    O = 'Header_base_ff',
                    I = 'Header_base__grabbing_dc',
                    H = 'Header_icon_6e',
                    W = 'Header_icon__reload_c2',
                    Y = 'Header_reloadButton_19',
                    X = ({
                        title: e,
                        showMinimizeBtn: u,
                        onMinimize: t,
                        ...
                        const d = (0, i.useState)(!1),
                            ...
                            F = (0, i.useCallback)((e) => {
                                const u = () => {
                                    r.O.view.sendEvent.move(!1), A(!1), document.removeEventListener('mouseup', u);
                                };
                                0 === e.button &&
                                    (r.O.view.sendEvent.move(!0), A(!0), document.addEventListener('mouseup', u));
                            }, []);
                        return a().createElement(
                            'div',
                            { className: o()(O, E && I), onMouseDown: F },
                            a().createElement(N, { title: e, infoTooltipBody: c, infoTooltipHeader: s }),
                            l &&
                                a().createElement(
                                    b,
                                    {
                                        mixClass: Y,
                                        onClick: (e) => {
                                            m.playClick(), null == l || l(e);
                                        },
                                    },
                                    a().createElement('div', { className: o()(H, W) }),
                                ),
                            u &&
                                a().createElement(h, {
                                    type: p.Minimize,
                                    onClick: (e) => {
                                        m.playClick(), t ? t(e) : r.O.view.sendEvent.minimize();
                                    },
                                }),
                            a().createElement(h, {
                                type: p.Close,
                                onClick: (e) => {
                                    m.playClick(), n ? n(e) : r.O.view.sendEvent.close();
                                },
                            }),
                        );
                    },
                    ...
                    U = 'WindowDecorator_frame__focused_af',
                    j = 'WindowDecorator_container_1d',
                    V = 'WindowDecorator_contentDecorations_be',
                                ...
                                v = () => {
                                    B.run(() => {
                                        const e = D.current,
                                            u = b.current;
                                        if (!e || !u) return;
                                        const t = r.O.view.pxToRem(e.offsetWidth),
                                            n = r.O.view.pxToRem(e.offsetHeight);
                                        (u.style.width = `${t}rem`), (u.style.height = `${n}rem`);
                                        const o = t + 10 + 26,
                                            i = 28 + n + 5 + 26;
                                        r.O.view.setInputPaddingsRem(13), r.O.view.resize(o, i, 'rem');
                                    });
                                };
                            var f;
                            return (
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        'div',
                                        { className: o()(z, A), style: { '--outer-shadow-width': '13rem' }, ref: _ },
                                        a().createElement('div', { className: o()($, p && U) }),
                                        a().createElement(X, {
                                            title: e,
                                            infoTooltipHeader: E,
                                            infoTooltipBody: m,
                                        ...
                                        a().createElement(
                                            ...
                                            a().createElement('div', { className: K, ref: D }, F),
                                        ),
                                    ),
                                )
                            );
                ...
                const ee = (e, u) => e.split('.').reduce((e, u) => e && e[u], u),
                    ue = (e) => {
                    ...
                    re = (e) => {
                        const u = ((e) => {
                                ...
                                return { modelPrefix: o, modelPath: ne(o, e || ''), resId: n };
                            })(),
                            t = u.modelPrefix,
                            n = e.split('.');
                        if (n.length > 0) {
                            ...
                            return (
                                n.reduce((u, n) => {
                                    const o = ee(ne(t, `${u}.${n}`), window);
                                    return te(o) ? (e.push(o.id), `${u}.${n}.value`) : (e.push(n), `${u}.${n}`);
                                }),
                                e.reduce((e, u) => e + '.' + u)
                            );
                        }
                            ...
                            ue(() => {
                                if (
                                    ...
                                    const t = (e) => {
                                        ...
                                        o = re(e);
                                    E.current = ie.addCallback(o, t, a, u === ae.Deep);
                                }
                            }),
                            (0, i.useEffect)(() => {
                                if (u !== ae.None)
                                    return () => {
                                        ie.removeCallback(E.current, a);
                                    };
                            }, [a, u]),
                            c
                        );
                    ...
                    Ce = (0, i.memo)(({ id: e, fallback: u, onLoadCallback: t, mixClass: n }) => {
                        const r = (0, i.useState)(''),
                            ...
                            F = (0, i.useCallback)(
                                (e) => {
                                    e.includes(d) &&
                                        (A(!0), engine.off(De, F), window.subViews.removeChildChangedCallback(d));
                                },
                                [d],
                            ),
                            _ = (0, i.useCallback)((e) => {
                ...
                var pe = t(493),
                    he = t.n(pe);
                const Be = (e) => ({ backgroundImage: `url('${e}')` }),
                    ve = 'BonusInfoIcon_bonusInfoIcon_3d',
                    fe = () => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement('div', { className: ve, style: e }),
                        );
                    };
                function ge() {
                    return (
                        ...
                        ({
                            ...
                            return a().createElement(
                                ...
                                a().createElement(
                                    ...
                                    a().createElement(
                                        b,
                                        ge({ type: F.primary, size: _.small, onClick: s, disabled: !u }, o),
                                        n || e,
                                    ),
                                ),
                            );
                ...
                const Le = ({ position: e }) => {
                        const u = R.images.gui.maps.icons.platoon.common.separator.$dyn(e),
                            t = [Me.right, Me.left].includes(e),
                            n = o()(ye, t ? Se : ke);
                        return a().createElement(
                            'div',
                            { className: n },
                            a().createElement('div', { className: Te, style: Be(u) }),
                        );
                    },
                    Re = 'ToggleButton_base_b9',
                    xe = 'ToggleButton_content_85',
                    Pe = 'ToggleButton_overlay_0a',
                    Ne = 'ToggleButton_base__active_68',
                ...
                const We = (e) => {
                    ...
                    Ye = ((0, i.memo)(We), { contentId: R.views.lobby.platoon.AlertTooltip('resId'), isEnabled: !0 }),
                    Xe = (e, u, t, n = !0) =>
                        e && n
                            ? Ye
                            : ((e, u, t) => ({
                    ...
                    ze = 'CommanderControls_left_98',
                    $e = 'CommanderControls_tiersLimit_2c',
                    Ue = 'CommanderControls_findPlayers_c1';
                function je() {
                    return (
                        (je =
                            Object.assign ||
                ...
                const Ve = () => {
                        const e = le().shouldShowFindPlayersButton,
                            u = le('model.btnInviteFriends'),
                            t = le('model.btnFindPlayers'),
                            n = (0, i.useCallback)(() => {
                                t.onClick(), E(t.soundClickName);
                            }, [t]),
                            o = (0, i.useMemo)(() => ({ type: F.secondary }), []),
                            r = (0, i.useMemo)(
                                () => Xe(!t.isEnabled, t.caption, t.description, t.hasTooltip),
                        ...
                        return a().createElement(
                                    ...
                                    a().createElement(
                                        ...
                                        a().createElement(
                                            ...
                                            a().createElement(
                                                b,
                                                {
                                                    type: t.isLight ? F.primary : F.secondary,
                                                    size: _.small,
                            ...
                            a().createElement(we, je({}, u, { cButtonProps: o })),
                        );
                    },
                    Ke = 'Footer_base_d0',
                    qe = 'Footer_message_3d',
                    Ge = 'Footer_message__alert_64',
                    Qe = () => {
                        const e = le('model.btnSwitchReady'),
                            u = e.onClick,
                            t = e.caption,
                            n = e.description,
                            r = e.tooltipHeader,
                            ...
                            m = o()(qe, !E && Ge),
                            A = (0, i.useCallback)(() => u(), [u]),
                            D = l ? F.primaryRed : F.primary;
                        return a().createElement(
                            'div',
                            { className: Ke },
                            a().createElement('div', { className: m }, d),
                            a().createElement(
                                M,
                                { header: r, body: n },
                                a().createElement(b, { onClick: A, size: _.small, type: D, disabled: !s }, t),
                            ),
                        );
                    },
                    Ze = 'Bonus_base_96',
                    Je = 'Bonus_currencyImage_16',
                    eu = 'Bonus_caption_7e',
                    uu = ({ currency: e, amount: u }) => {
                        const t = R.images.gui.maps.icons.platoon.members_window.currencies.$dyn(e),
                            n = (0, i.useMemo)(() => Be(t), [t]);
                        return a().createElement(
                            'div',
                            { className: Ze },
                            a().createElement('div', { className: Je, style: n }),
                            a().createElement('span', { className: eu }, `+${u}%`),
                        );
                    },
                    tu = 'Bonuses_base_6f',
                    nu = () => {
                        const e = le('model.header.bonuses');
                        return 0 === e.length
                            ? null
                            : a().createElement(
                                  'div',
                ...
                const iu = (e, u, t) => {
                    ...
                    lu = (e, u, t = ru.left) => e.split(u).reduce(t === ru.left ? iu : au, []),
                    su = (() => {
                        const e = new RegExp(
                        ...
                        return cu.includes(t)
                            ...
                            : ((e, u = ru.left) => {
                                  ...
                                  const n =
                                      ...
                                      o = e.replace(/&nbsp;/g, ' ');
                                  return lu(o, /( )/, u).forEach((e) => (t = t.concat(lu(e, n, ru.left)))), t;
                              })(e, u);
                    };
                let Eu;
                !(function (e) {
                ...
                const mu = ou,
                    ...
                    Fu = ({ binding: e, text: u = '', classMix: t, alignment: n = ru.left }) =>
                        null === u
                            ...
                            : a().createElement(
                                  ...
                                  u.split('\n').map((u, r) =>
                                      a().createElement(
                                          'div',
                                          { className: o()(Au, t), key: `${u}-${r}` },
                                          ((e, u, t) =>
                                              e
                                                  .split(/%\((.*?)\)(?:[sd])?/g)
                                                  .map((e) => (t && e in t ? t[e] : du(e, u))))(u, n, e).map((e, u) =>
                                              a().createElement(i.Fragment, { key: `${u}-${e}` }, e),
                                          ),
                                      ),
                                  ),
                              ),
                    _u = 'NoBonus_textContainer_ef',
                    Du = 'NoBonus_textMix_ff',
                    bu = 'NoBonus_icon_69',
                    Cu = () => {
                        const e = le('model.header.noBonusPlaceholder'),
                            u = e.text,
                            t = e.icon,
                            n = t && Be(t);
                        return i.createElement(
                            ...
                            u &&
                                i.createElement(
                                    'div',
                                    { className: _u },
                                    i.createElement(Fu, { text: u, classMix: Du, alignment: ru.right }),
                                ),
                            n && i.createElement('div', { style: n, className: bu }),
                        );
                    },
                    pu = (e, u) => {
                ...
                const gu = ({ children: e, tooltipArgs: u, className: t }) => {
                        ...
                        return o || i
                            ? a().createElement(y, fu({}, u, { contentId: o || i }), n)
                    ...
                    Tu = ({ content: e, classMix: u }) => {
                        ...
                        return (
                            ...
                            a().createElement(
                                M,
                                { isEnabled: r, body: e },
                                a().createElement('div', { ref: t, className: o()(Su, u) }, e),
                            )
                        );
                    },
                    Mu = {
                ...
                const Ru = (0, i.memo)(
                        ({
                            ...
                            const F = (0, i.useState)(Lu.Out),
                                ...
                                w = (0, i.useCallback)((e) => c && c(e), [c]),
                                y = (0, i.useCallback)(() => D(Lu.Out), []);
                            (0, i.useEffect)(() => {
                                B || p(!1);
                            }, [u, B]),
                                (0, i.useEffect)(() => {
                            ...
                            return a().createElement(
                                ...
                                !C && u === yu.Alert && a().createElement('div', { className: Mu.alert }),
                                a().createElement(
                                    'div',
                                    { className: o()(Mu.label, Mu[`label__${t}`], !l && Mu.label__placeholder) },
                                    A || a().createElement(Tu, { content: l || r }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: o()(Mu.button, Mu[`button__${t}`]) },
                                    a().createElement('div', { className: o()(Mu.arrow, Mu[`arrow__${t}`]) }),
                                    _ === Lu.Over && a().createElement('div', { className: Mu.gradient }),
                                    h && a().createElement('div', { className: Mu.disabled }),
                                ),
                            );
                        },
                    ),
                    ...
                    Pu = (e) => {
                        const u = (0, i.useState)(xu(e ? e.current : null)),
                            t = u[0],
                            n = u[1];
                        return (
                            (0, i.useEffect)(() => {
                ...
                var Nu = t(380),
                    Ou = t.n(Nu);
                const Iu = 'ScrollArea_base_47',
                    Hu = 'ScrollArea_base__scrollIndent_1d',
                    Wu = 'ScrollArea_base__verticalScrollbarMargin_50',
                    Yu = 'ScrollArea_base__multiple_44',
                    Xu = 'ScrollArea_base__hidden_ec',
                    zu = a().forwardRef((e, u) => {
                        const t = e.offsetLeft,
                            ...
                            R = (0, i.useCallback)(() => w, [w]),
                            x = (0, i.useCallback)(() => {
                                w && w.update();
                            }, [w]),
                            P = (0, i.useCallback)(
                                (e, u, t) => {
                                    w && (w.setScrollLeft(e, u, t), h && h(e, w.contentWidth - w.containerWidth));
                                },
                                [w, h],
                            ),
                            N = (0, i.useCallback)(
                                (e) => {
                                    w && (w.setScrollLeftImmediately(e), h && h(e, w.contentWidth - w.containerWidth));
                                },
                                [w, h],
                            ),
                            O = (0, i.useCallback)(
                            ...
                            z = (0, i.useCallback)(
                                (e) => {
                                    'function' == typeof u ? u(e) : null !== u && (u.current = e), T(e);
                                },
                                [u],
                            ),
                            $ = (0, i.useCallback)(() => {
                        ...
                        (0, i.useEffect)(() => {
                            if (w && S)
                                return (
                                    ...
                                    S.addEventListener('ps-scroll-x', H),
                                    S.addEventListener('ps-scroll-y', W),
                                    ...
                                    () => {
                                        window.removeEventListener('resize', $),
                                            ...
                                            S &&
                                                (S.removeEventListener('ps-scroll-x', H),
                                                S.removeEventListener('ps-scroll-y', W),
                                                S.removeEventListener('over-scroll-beginning', Y),
                                                S.removeEventListener('over-scroll-ending', X));
                                    }
                                );
                        }, [U, H, Y, X, $, S, w, W]);
                        const j = (0, i.useRef)(S || null);
                        j.current = S || null;
                        const V = Pu(j);
                        (0, i.useEffect)(
                            () => (
                                !w && S && V && y(new (Ou())(S, Object.assign({}, s))),
                                () => {
                            ...
                            (0, i.useEffect)(() => {
                                b &&
                                    ((b.setScrollLeft = P),
                                    (b.setScrollTop = O),
                                    (b.setScrollLeftImmediately = N),
                                    (b.setScrollTopImmediately = I),
                                    (b.updateScrollArea = x),
                                    (b.getScrollbar = R));
                            }, [b, P, N, O, I, x, R]);
                        const K = o()(Iu, { [Hu]: F, [Xu]: !v, [Wu]: _, [Yu]: D }, p);
                        return a().createElement('div', { className: K, ref: z }, C);
                    }),
                    $u = [
                        'children',
                        'isEnabled',
                        ...
                        const m = (0, i.useState)(!1),
                            ...
                            B = (0, i.useCallback)(() => {
                                ...
                                if (e && t && u) {
                                    ...
                                    t.setScrollTop(n, void 0, c ? p : void 0);
                                }
                            }, [p, c]);
                        (0, i.useEffect)(() => {
                            if (n && null !== o) return wu(B);
                        }, [l, B, o, n]);
                        const v = !(!b.current || !b.current.scrollbar) && b.current.scrollbar.scrollbarYActive,
                            f = {
                            ...
                            g = (0, i.cloneElement)(u, f);
                        return a().createElement(
                            'div',
                            { className: d, ref: D },
                            a().createElement(zu, Uu({ ref: b, key: l, scrollAreaContainer: _.current }, E), g),
                        );
                    },
                    Vu = {
                ...
                const qu = (0, i.memo)((e) => {
                        ...
                        const s = l.id,
                            ...
                            C = o()(Vu.base, u && Vu[`base__${u}`], c && Vu.base__selected, d && Vu.base__disabled, t);
                        return a().createElement(
                            'div',
                            { className: C, onMouseEnter: D, onMouseDown: b, onClick: _ },
                            r ? r(l) : m,
                        );
                    }),
                    Gu = { base__withScroll: 'DropDownItems_base__withScroll_19' };
                function Qu() {
                    return (
                        (Qu =
                            Object.assign ||
                ...
                const Zu = ({
                        ...
                        a().createElement(
                            'div',
                            { className: o()(Gu.base, m && Gu.base__withScroll) },
                            u.map((u) => {
                                const o = `${l}_${u.id}`;
                                return a().createElement(
                                    'div',
                                    ...
                                    a().createElement(
                                        qu,
                                        Qu({ size: e, soundHover: s, soundClick: c, classMix: d, itemRenderer: E }, u, {
                                            onClick: i,
                    ...
                    ut = ({
                        ...
                        return a().createElement(
                            'div',
                            { id: C, className: o()(Ju.base, Ju[`base__${u}`], s) },
                            a().createElement(
                                ju,
                                { selectedItemId: _, isEnabled: l, scrollSettings: et, classMix: Ju.scrollMix },
                                a().createElement(Zu, {
                                    parentId: e,
                                    items: t,
                                    size: u,
                    ...
                    nt = (0, i.memo)(
                        ({
                            ...
                            const M = (0, i.useRef)(null),
                                L = (0, i.useRef)(null),
                                R = (0, i.useRef)({ open: !1, listAbove: !1 }),
                                x = (0, i.useState)(!1),
                                P = x[0],
                                N = x[1],
                                O = (0, i.useState)(!1),
                                I = O[0],
                                H = O[1],
                                W = (0, i.useState)(window.innerHeight),
                                Y = W[0],
                                X = W[1],
                                z = pu(n, s),
                                $ = r !== yu.Disabled,
                            ...
                            const q = (0, i.useCallback)(() => {
                                R.current.open && ((R.current.open = !1), N(!1), C && C());
                            }, [C]);
                            J(j ? Q.n.ESCAPE : Q.n.NONE, q, j);
                            const G = (0, i.useCallback)(() => {
                                h && h(), U && (N(!1), (R.current.open = !1), C && C());
                            }, [h, C, U]);
                            (0, i.useEffect)(() => {
                                const e = M.current;
                                if (e && j)
                            ...
                            const Z = (0, i.useCallback)(() => {
                                ...
                                const e = u && u.current,
                                    t = e ? e.getBoundingClientRect().bottom : Y,
                                    n =
                            ...
                            (0, i.useEffect)(() => wu(Z), [Z, l, t.length]);
                            const ee = (0, i.useCallback)(
                                    (e) => {
                                        const u = z.findIndex((u) => u === e) > -1;
                                        let t = [];
                                        (t = s ? (u ? z.filter((u) => u !== e) : [e, ...z]) : u ? [] : [e]), D && D(t);
                                    },
                                    [s, D, z],
                                ),
                                ue = (0, i.useCallback)(() => {
                                ...
                                oe = (0, i.useCallback)((e) => B && B(e), [B]),
                                re = (0, i.useCallback)((e) => g && g(e), [g]),
                                ie = (0, i.useCallback)((e) => f && f(e), [f]),
                                ae = (0, i.useCallback)((e) => w && w(e), [w]),
                                le = (0, i.useMemo)(
                                    () =>
                                        t
                                ...
                                se = (0, i.useMemo)(() => t.filter((e) => z.includes(e.id)), [t, z]),
                                ce = m ? m(se) : void 0;
                            return a().createElement(
                                'div',
                                {
                                    id: e,
                                    ref: M,
                                    className: o()(tt.base, tt[`base__${l}`], E && E.base),
                                    onMouseEnter: oe,
                                    onMouseUp: re,
                                    onMouseDown: ie,
                                    onMouseLeave: ae,
                                ...
                                a().createElement(
                                    'div',
                                    { className: o()(tt.control, j && tt.control__down) },
                                    a().createElement(
                                        gu,
                                        { tooltipArgs: _ },
                                        a().createElement(Ru, {
                                ...
                                a().createElement(
                                    'div',
                                    {
                                        ...
                                        className: o()(
                                            ...
                                            I ? tt.list__above : tt.list__under,
                                        ),
                                    },
                                    a().createElement(ut, {
                                        parentId: e,
                ...
                const it = (e) => {
                        ...
                        const c = (0, i.useState)(pu(n, r)),
                            d = c[0],
                            E = c[1],
                            m = (0, i.useCallback)(
                                (e) => {
                                    E(e), l && l(u.filter((u) => e.includes(u.id)));
                                },
                                [u, l],
                            );
                        return a().createElement(nt, rt({ onChanges: m, items: u, selected: d, multiple: r }, s));
                    },
                    at = ['modelPath', 'pure'];
                function lt() {
                    return (
                ...
                const st = (0, i.memo)((e) => {
                        ...
                        const o = le(u),
                            ...
                            A = (0, i.useCallback)(
                                (e) => {
                                    r({ selectedIds: e ? e.join(', ') : '' });
                                },
                                [r],
                            );
                        return t
                            ? a().createElement(nt, lt({ items: d, selected: E, multiple: l, onChanges: A }, n))
                            : a().createElement(it, lt({ items: d, selected: E, multiple: l, onChanges: m }, n));
                    }),
                    ct = 'DropDown_memberCountDropdown_67',
                    dt = 'DropDown_memberCountDescription_8a',
                    Et = 'DropDown_memberCountDropdownItem_f5',
                    mt = (e) => {
                        var u;
                    ...
                    At = () => {
                        const e = le('model.header.memberCountDropdown'),
                            u = e.isDisabled,
                            t = e.tooltipText,
                            n = { body: t };
                        return a().createElement(
                            ...
                            a().createElement(st, {
                                ...
                                classMix: { base: ct, item: Et },
                                size: ku.Small,
                                itemRenderer: mt,
                                variant: u ? yu.Disabled : yu.Basic,
                    ...
                    Ft = 'Header_base_26',
                    _t = 'Header_base__wide_be',
                    Dt = 'Header_buttonContainer_84',
                    bt = 'Header_leavePlatoonButton_e4',
                    Ct = 'Header_dropdowns_f3',
                    pt = 'Header_muteButtonContainer_7e',
                    ht = 'Header_muteIcon_54';
                function Bt() {
                    return (
                        (Bt =
                            Object.assign ||
                ...
                const vt = () => {
                    const e = le().prebattleType,
                        u = le('model.header.btnLeavePlatoon'),
                        t = le('model.header.btnMuteAll'),
                        n = le('model.header'),
                        r = n.backgroundImage,
                        l = n.showNoBonusPlaceholder,
                        s = n.showInfoIcon,
                        c = e === G.Comp7,
                        d = (0, i.useCallback)(() => {
                    ...
                    return a().createElement(
                        'div',
                        { className: o()(Ft, c && _t), style: Be(r) },
                        a().createElement(
                            'div',
                            { className: Dt },
                            a().createElement(
                                we,
                                Bt({}, u, { onClick: d, cButtonProps: { type: F.secondary }, className: o()(c && bt) }),
                            ),
                            c && a().createElement('div', { className: Ct }, a().createElement(At, null)),
                        ),
                        t.isVisible &&
                            a().createElement(
                                M,
                        ...
                        l ? a().createElement(Cu, null) : a().createElement(nu, null),
                ...
                const kt = (e) => {
                        ...
                        return a().createElement(
                            gt,
                            yt({}, t, { contentID: R.views.common.BackportContextMenu('resId') }),
                            u,
                        );
                    },
                    St = 'SlotLabel_formattedText_e8',
                    Tt = ({ slotLabelElements: e }) => {
                        ...
                        return a().createElement(
                            ...
                            e.map(({ value: e }, t) =>
                                a().createElement(
                                    ...
                                    a().createElement(Fu, { text: e.content, classMix: St }),
                                ),
                            ),
                        );
                    },
                ...
                const Rt = ({ text: e, type: u, slotLabelElements: t }) => {
                    const n = o()(Mt.base, u === Lt.disabled && Mt.base__disabled),
                        r = o()(Mt.image, Mt[`image__${u}`]);
                    return a().createElement(
                        'div',
                        { className: n },
                        a().createElement(
                            'div',
                            { className: Mt.central },
                        ...
                        a().createElement(
                            'div',
                            { className: Mt.footer },
                            t.length > 0 && a().createElement(Tt, { slotLabelElements: t }),
                        ),
                    );
                };
                let xt, Pt;
                ...
                const Nt = 'WTRInfo_wtr_5e',
                    Ot = 'WTRInfo_wtrIcon_a9',
                    It = 'WTRInfo_wtrValue_80',
                    Ht = ({ rating: e }) =>
                        a().createElement(
                            'div',
                            { className: Nt },
                            a().createElement('div', { className: Ot }),
                            a().createElement('span', { className: It }, e),
                        ),
                    Wt = (e) => e.replace('-', '_'),
                    Yt = (e, u) =>
                        String(
                    ...
                    Xt = (e, u) => String(R.images.gui.maps.icons.vehicle.c_420x307.$dyn(Wt(u).toLowerCase())),
                    zt = (e, u) =>
                        String(R.images.gui.maps.icons.battleRoyale.vehicles.c_210x153.$dyn(Wt(u).toLowerCase())),
                    $t = 'MutedIcon_base_d2',
                    Ut = () => {
                ...
                const Vt = {
                    ...
                    Kt = { [jt.default]: 'c_24x24', [jt.x48]: 'c_48x48', [jt.x80]: 'c_80x80', [jt.x220]: 'c_220x220' },
                    qt = ({ badgeID: e, size: u = jt.default, className: t }) => {
                        const n = R.images.gui.maps.icons.library.badges.$dyn(Kt[u]);
                        return a().createElement('div', {
                            className: o()(Vt.base, Vt[`base__${u}`], t),
                    ...
                    Qt = (0, i.memo)(({ tooltipHeaderName: e }) => {
                        const u = (0, i.useMemo)(() => {
                                return (
                        ...
                        return a().createElement(
                            M,
                            { header: u, body: t },
                            a().createElement('div', { className: Gt.anonymizedIcon }),
                        );
                    });
                function Zt() {
                    return (
                ...
                const Jt = { [jt.default]: 'c_64x24', [jt.x48]: 'c_68x28' },
                    en = { [jt.default]: 'c_48x48', [jt.x48]: 'c_48x48' },
                    un = ({
                        userName: e,
                        clanAbbrev: u = '',
                        igrType: t = 0,
                        ...
                        const F = R.images.gui.maps.icons.library.badges.strips.$dyn(Jt[E]),
                            _ = (0, i.useMemo)(
                                () => ({ backgroundImage: `url(${F.$dyn(`strip_${r.badgeID}`)})` }),
                                [r, F],
                            ),
                            D = R.images.gui.maps.icons.library.badges.$dyn(en[E]),
                            b = (0, i.useMemo)(
                                () => ({ backgroundImage: `url(${D.$dyn(`badge_${r.badgeID}`)})` }),
                                [r, D],
                            ),
                            C = u ? `[${u}]` : '',
                            p = o()(Gt.base, Gt[`base__${E}`], l && Gt.base__inverted),
                            h = o()(Gt.userName, m),
                            B = o()(Gt.clanTag, A),
                            v = e !== d,
                            f = s ? `${d}${C}` : d,
                            g = Boolean(n.badgeID) && a().createElement(qt, Zt({ size: E }, n, { key: 'badge' })),
                            w = Date.now(),
                            y = [
                                g,
                                [
                                    a().createElement(
                                        ...
                                        a().createElement(Tu, { content: e, key: w }),
                                    ),
                                    !s && Boolean(C) && a().createElement('div', { className: B, key: 'clanTag' }, C),
                                ],
                                0 !== t && a().createElement('div', { className: Gt.igrIcon, key: 'igrType' }),
                                Boolean(r.badgeID) &&
                                    a().createElement(
                                        'div',
                                        { className: Gt.suffixBadgeWrapper, key: 'suffixBadge' },
                                        a().createElement('div', { className: Gt.suffixBadgeStripe, style: _ }),
                                        a().createElement('div', { className: Gt.suffixBadge, style: b }),
                                    ),
                                c && v && a().createElement(Qt, { tooltipHeaderName: f, key: 'anonymizer' }),
                            ];
                        return a().createElement('div', { className: p }, l ? y.reverse() : y);
                    },
                    tn = 'PlayerName_userName_c9',
                    nn = { badgeID: '' },
                    on = ({ name: e, badgeID: u, clanTag: t, color: n }) => {
                        const o = (0, i.useMemo)(() => ({ badgeID: u || '' }), [u]),
                            r = (0, i.useMemo)(() => ({ color: n }), [n]);
                        return a().createElement(
                            'div',
                            { style: r },
                            a().createElement(un, {
                                ...
                                suffixBadge: nn,
                                clanAbbrev: t,
                                userNameClassName: tn,
                            }),
                        );
                    },
                    rn = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                    an = [1, 4, 5, 9, 10, 40, 50, 90, 100, 400, 500, 900, 1e3];
                function ln(e) {
                    let u = '';
                    for (let t = an.length - 1; t >= 0; t--) for (; e >= an[t]; ) (u += rn[t]), (e -= an[t]);
                    return u;
                }
                ['ko', 'no'].includes(R.strings.settings.LANGUAGE_CODE());
                const sn = 'VehicleDescription_base_1b',
                    cn = 'VehicleDescription_vehicleType_a1',
                    dn = 'VehicleDescription_vehicleType__elite_71',
                    En = ({ type: e, isPremium: u, name: t, tier: n, className: r, prebattleType: i }) =>
                        a().createElement(
                            'div',
                            { className: o()(sn, r) },
                            i !== xt.BattleRoyal && ln(n),
                            a().createElement('div', { className: o()(cn, u && dn), style: Be(Yt(e, u)) }),
                            t,
                        ),
                    mn = (0, i.memo)(({ src: e, className: u, autoPlay: t = !1, loop: n = !1 }) => {
                        const o = (0, i.useRef)(null);
                        return (
                            (0, i.useEffect)(() => {
                                engine.on('clientMinimized', (e) => {
                                    o.current && (e ? o.current.pause() : o.current.play());
                                });
                            }, []),
                            a().createElement('video', { ref: o, className: u, src: e, autoPlay: t, loop: n })
                        );
                    });
                mn.displayName = 'Video';
                const An = 'VoiceAnimation_talkingAnimation_c4',
                    Fn = 'VoiceAnimation_talkingAnimation__visible_18',
                    _n = ({ visible: e }) => {
                        const u = o()(An, e && Fn);
                    ...
                    Dn = ({ estimatedTime: e }) =>
                        a().createElement(
                            a().Fragment,
                            null,
                            a().createElement('div', null, R.strings.platoon.members.card.searching()),
                            a().createElement('span', null, '(', e, ')'),
                        ),
                    bn = (e, u, t, n) => {
                        let o = R.images.gui.maps.icons.platoon.members_window.tall_slot.cards;
                        if (n && n !== xt.Squad) {
                            const e = o.$dyn(n.toString());
                            e && (o = e);
                        }
                        let r = null;
                        return (
                            (r = e
                                ...
                                : u
                                  ? t
                                      ...
                                      : o.$dyn('ready')
                                  : t
                                    ? o.$dyn('not_ready_player')
                                    : o.$dyn('not_ready')),
                            r || bn(e, u, t)
                        );
                    },
                    Cn = 'Player_base_7d',
                    pn = 'Player_topping_6c',
                    hn = 'Player_toppingBack_cd',
                    Bn = 'Player_topping__isPlayer_03',
                    vn = 'Player_topping__isCommander_b9',
                    fn = 'Player_toppingPremiumIcon_20',
                    gn = 'Player_toppingPlayerIcon_0b',
                    wn = 'Player_mutedContainer_69',
                    yn = 'Player_name_11',
                    kn = 'Player_footer_1a',
                    Sn = 'Player_readiness_f9',
                    Tn = 'Player_readiness__isReady_c9',
                    Mn = 'Player_vehicleImage_42',
                    Ln = 'Player_flagImage_4e';
                function Rn() {
                    return (
                        (Rn =
                            Object.assign ||
                ...
                const xn = ({ player: e, isInBattle: u, infoText: t, prebattleType: n }) => {
                        const r = o()(Sn, e.isReady && !u && Tn),
                            l = n === xt.BattleRoyal ? zt : Xt,
                            s = e.isReady ? l(e.vehicle.nation, e.vehicle.techName) : '',
                            c = e.isReady
                                ? String(
                                ...
                                : '',
                            d = (0, i.useMemo)(
                                () => bn(u, e.isReady, e.isCurrentUser, n),
                                [u, e.isReady, e.isCurrentUser, n],
                            ),
                            E = o()(pn, e.isCommander ? vn : Bn);
                        return a().createElement(
                            'div',
                            { className: Cn, style: Be(d) },
                            a().createElement(
                                'div',
                                { className: E },
                                a().createElement('div', { className: hn }),
                                e.isPrem && a().createElement('div', { className: fn }),
                                a().createElement(_n, { visible: e.voice.isSpeaking }),
                            ...
                            !u &&
                                ...
                                a().createElement(
                                    a().Fragment,
                                    null,
                                    a().createElement('div', { className: Ln, style: Be(c) }),
                                    a().createElement('div', { className: Mn, style: Be(s) }),
                                ),
                            e.isIgnored &&
                                a().createElement('div', {
                                    className: Ln,
                            ...
                            a().createElement(
                                'div',
                                { className: wn },
                                e.voice.isMutedByUser && a().createElement(Ut, null),
                            ),
                            a().createElement('div', { className: yn }, a().createElement(on, e.commonData)),
                            '' !== e.commonData.rating && a().createElement(Ht, { rating: e.commonData.rating }),
                            a().createElement(
                                'div',
                                { className: kn },
                                e.isReady && !u ? a().createElement(En, Rn({}, e.vehicle, { prebattleType: n })) : t,
                            ),
                            a().createElement('div', { className: r }),
                        );
                    },
                    Pn = (e) => {
                                ...
                                e.isEmpty
                                    ? ((e) =>
                                          e.isDisabled
                                              ...
                                              : e.isSearching
                                                ? {
                                                      text: a().createElement(Dn, { estimatedTime: e.estimatedTime }),
                                                      type: Lt.spinner,
                                                      slotLabelElements: e.slotLabelElements,
                                                  }
                                                : {
                        ...
                        return (0, i.useMemo)(() => (e) => void 0 !== e.isInBattle, [])(u)
                            ? a().createElement(xn, u)
                            : a().createElement(Rt, u);
                    };
                ...
                let On;
                (Nn.defaultProps = { format: 'integral' }),
                    (function (e) {
                        (e[(e.First = 6)] = 'First'),
                            (e[(e.Second = 5)] = 'Second'),
                            (e[(e.Third = 4)] = 'Third'),
                ...
                const In = [On.First, On.Second, On.Third, On.Fourth],
                    Hn = (e) => In.includes(e);
                let Wn, Yn;
                !(function (e) {
                    (e[(e.A = 1)] = 'A'),
                ...
                const Xn = R.strings.comp7.division,
                    zn = { [Wn.A]: 'A', [Wn.B]: 'B', [Wn.C]: 'C', [Wn.D]: 'D', [Wn.E]: 'E' },
                    $n = (e) => Xn.$dyn(zn[e]),
                    Un = {
                        [On.First]: 'first',
                        [On.Second]: 'second',
                ...
                const qn = ({ rank: e, size: u, division: t, className: n }) => {
                        const r = (0, i.useMemo)(() => {
                            const n = R.images.gui.maps.icons.comp7.ranks.$num(u),
                                o = Hn(e) && void 0 !== t ? `_${$n(t)}` : '';
                            return { backgroundImage: `url(${n.$dyn(`${jn(e)}${o}`)})`, '--imageSize': `${u}rem` };
                        }, [e, u, t]);
                        return a().createElement('div', { className: o()(Vn, n), style: r });
                    },
                    Gn = 'Comp7Content_base_f9',
                    Qn = 'Comp7Content_icon_0f',
                    Zn = 'Comp7Content_base__general_aa',
                    Jn = R.strings.comp7.scoreTooltip,
                    eo = ({ slot: e }) => {
                        const u = e.rankData,
                            t = u.rank,
                            n = u.division,
                        ...
                        return a().createElement(
                            a().Fragment,
                            null,
                            a().createElement(on, e.player.commonData),
                            a().createElement(
                                M,
                                { header: Jn.header(), body: Jn.body() },
                                a().createElement(
                                    'div',
                                    { className: o()(Gn, Hn(t) && Zn) },
                                    a().createElement(
                                        'div',
                                        { className: Qn },
                                        a().createElement(qn, { rank: t, division: n, size: Kn.x22 }),
                                    ),
                                    a().createElement(Nn, { value: r }),
                                ),
                            ),
                        );
                    },
                    uo = R.images.gui.maps.icons.platoon.members_window.wide_slot,
                    to = uo.cards,
                    no = R.strings.platoon.members.card,
                    oo = 'Vehicle_base_9f',
                    ro = 'Vehicle_vehicle_15',
                    io = 'Vehicle_description_4f';
                function ao() {
                    return (
                        (ao =
                            Object.assign ||
                ...
                const lo = ({ vehicle: e }) => {
                        const u =
                            ((t = e.nation),
                            (n = e.techName),
                            String(R.images.gui.maps.icons.vehicle.$dyn(`${t}_${Wt(n)}`)));
                        var t, n;
                        return a().createElement(
                            'div',
                            { className: oo },
                            a().createElement(En, ao({}, e, { className: io })),
                            a().createElement('div', { className: ro, style: Be(u) }),
                        );
                    },
                    so = {
                    ...
                    co = (e) => {
                        const u = e.player,
                            ...
                            r = (0, i.useMemo)(
                                () =>
                                    ((e) =>
                                        e.isSearching
                                            ? `${no.searching()} (${e.estimatedTime})`
                                            : e.isDisabled
                                              ? no.disabledVertical()
                                              : e.isEmpty
                                                ? no.empty()
                                                : e.prebattleType === xt.Comp7
                                                  ? a().createElement(eo, { slot: e })
                                                  : a().createElement(on, e.player.commonData))(e),
                                [e],
                            ),
                            l = (0, i.useMemo)(() => ({ slotId: e.slotId }), [e.slotId]),
                            s = !u.isReady || e.isInBattle ? e.infoText : a().createElement(lo, { vehicle: u.vehicle }),
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: so.mutedContainer },
                                    u.voice.isMutedByUser && a().createElement(Ut, null),
                                ),
                                a().createElement(
                                    'div',
                                    { className: o()(so.memberType, e.isDisabled && so.isDisabled) },
                                    a().createElement(_n, { visible: u.voice.isSpeaking }),
                                    a().createElement('div', {
                                        style: Be(n),
                                        className: o()(so.icon, e.isSearching && so.spinner),
                                    }),
                                ),
                                a().createElement(
                                    'div',
                                    { className: o()(so.mainContent, e.isEmpty && so.mainContent__isEmpty) },
                                    r,
                                ),
                                !e.isEmpty && a().createElement('div', { className: so.detailsContainer }, s),
                                u.isReady &&
                                    !e.isInBattle &&
                                    a().createElement('div', {
                                        className: o()(so.readiness, u.isReady && so.readiness__isReady),
                                    }),
                            ),
                        );
                    },
                    Eo = 'SlotContainer_base__short_e7';
                function mo() {
                    return (
                        (mo =
                            Object.assign ||
                ...
                const Ao = ({ slot: e, isHorizontal: u, isShort: t }) => {
                        const n = u ? Pn : co,
                            r = e.player.commonData.name,
                            l = (0, i.useMemo)(() => ({ userName: r }), [r]),
                            s = a().createElement(
                                'div',
                                { className: o()(t && Eo) },
                                a().createElement(n, mo({ key: e.slotId }, e)),
                            );
                        return e.player.isCurrentUser || e.isEmpty
                            ? s
                            : a().createElement(kt, { args: l, key: e.slotId }, s);
                    },
                    Fo = 'Slots_base_7e',
                    _o = 'Slots_base__isHorizontal_aa',
                    Do = 'Slots_base__isHorizontal__short_ba',
                    bo = () => {
                        const e = le(),
                            u = e.isHorizontal,
                            t = e.isShort,
                    ...
                    Co = 'MembersWindow_base_9b',
                    po = 'MembersWindow_base__isHorizontal_ce',
                    ho = 'MembersWindow_base__isHorizontal__short_0c',
                    Bo = 'MembersWindow_base__isVertical_44',
                    vo = 'MembersWindow_base__isExtendedVertical_f6',
                    fo = 'MembersWindow_chatContainer_41',
                    go = 'MembersWindow_commanderControls_cf',
                    wo = 'MembersWindow_commanderControls__center_6d',
                    yo = 'MembersWindow_platoon_60',
                    ko = 'MembersWindow_slots_21',
                    So = () => {
                        const e = le(),
                            u = e.canMinimize,
                            t = e.prebattleType,
                            ...
                            A = e.windowTooltipBody,
                            F = e.rawTitle,
                            _ = e.shouldShowFindPlayersButton,
                            D = t === G.Comp7,
                            b = (0, i.useCallback)(() => {
                                r.O.view.setEventHandled(), c();
                            }, [c]),
                        ...
                        return (
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'div',
                                    { className: D ? o()(Co, vo) : o()(Co, l ? [po, s && ho] : Bo) },
                                    a().createElement(
                                        'div',
                                        { className: yo },
                                        a().createElement(vt, null),
                                        a().createElement(Le, { position: Me.top }),
                                        a().createElement('div', { className: ko }, a().createElement(bo, null)),
                                        a().createElement(
                                            'div',
                                            { className: o()(go, !_ && wo) },
                                            n && a().createElement(Ve, null),
                                        ),
                                        a().createElement(Le, { position: Me.bottom }),
                                        a().createElement(Qe, null),
                                    ),
                                    a().createElement(Le, { position: Me.left }),
                                    a().createElement(Ce, {
                ...
                engine.whenReady.then(() => {
                    he().render(a().createElement(So, null), document.getElementById('root')),
        ...
        (() => {
            ...
            var u = (u, t) => {
                    ...
                    for (u && u(t); l < r.length; l++)
                        (o = r[l]), __webpack_require__.o(e, o) && e[o] && e[o][0](), (e[o] = 0);
                    return __webpack_require__.O(s);
                },
                t = (self.webpackChunkgameface = self.webpackChunkgameface || []);
            t.forEach(u.bind(null, 0)), (t.push = u.bind(null, t.push.bind(t)));
        })();
    var __webpack_exports__ = __webpack_require__.O(void 0, [720], () => __webpack_require__(602));
