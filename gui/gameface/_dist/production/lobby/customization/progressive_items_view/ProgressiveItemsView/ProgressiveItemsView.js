(() => {
    ...
    var __webpack_modules__ = {
            ...
            910: (u, e, t) => {
                    ...
                    tu = (0, o.memo)(
                        ({
                            ...
                            const s = (0, o.useRef)(null),
                                ...
                                _ = () => {
                                    ...
                                    const a = u.animationScroll.scrollPosition.get(),
                                        o = Math.min(1, n / r),
                                        i = k(0, 1, a / (r - n)),
                                        s = (e.offsetWidth - eu(e, o)) * i;
                                    (t.style.transform = `translateX(${0 | s}px)`),
                                        ((u) => {
                                            if (l.current && c.current && E.current && A.current) {
                                                if (0 === u)
                                                    return (
                                                        l.current.classList.add(Z), void c.current.classList.remove(Z)
                                                    );
                                                if (
                                                    ((e = E.current),
                                                    (t = A.current),
                                                    ...
                                                    return (
                                                        l.current.classList.remove(Z), void c.current.classList.add(Z)
                                                    );
                                                var e, t;
                                                l.current.classList.remove(Z), c.current.classList.remove(Z);
                                            }
                                        })(s);
                                },
                                C = T(() => {
                                    (() => {
                                        ...
                                        (e.style.width = `${eu(t, a)}px`),
                                            ...
                                            s.current &&
                                                (1 === a ? s.current.classList.add(U) : s.current.classList.remove(U));
                                    })(),
                                        _();
                                });
                            (0, o.useEffect)(() => S(C)),
                            ...
                            return i().createElement(
                                'div',
                                { className: y()($, e.base), ref: s, onWheel: u.handleMouseWheel },
                                i().createElement('div', {
                                    className: y()(G, e.leftButton),
                                    onMouseDown: (u) => {
                                        u.target.classList.contains(Z) || 0 !== u.button || (N('play'), f(H.Next));
                                    },
                                    onMouseUp: p,
                                    ref: l,
                                    onMouseEnter: h,
                                ...
                                i().createElement(
                                    ...
                                    i().createElement('div', { ref: A, className: y()(K, e.thumb) }),
                                    i().createElement('div', { className: y()(X, e.rail) }),
                                ),
                                i().createElement('div', {
                                    className: y()(q, e.rightButton),
                                    onMouseDown: (u) => {
                                        u.target.classList.contains(Z) || 0 !== u.button || (N('play'), f(H.Prev));
                                    },
                                    onMouseUp: p,
                                    ref: c,
                                    onMouseEnter: h,
                ...
                const ju = Vu;
                const $u = 'ProgressionHeader_base_d3',
                    ...
                    Yu = ({ title: u, className: e }) => {
                        const t = (0, o.useContext)(_),
                            n = y()($u, (t.large || t.extraLarge) && Uu, e);
                        return i().createElement(
                            'div',
                            { className: n },
                ...
                const Fe = (u) => {
                    ...
                    ke = 'Item_image_f0',
                    xe = 'Item_image__small_9c',
                    Te = 'Item_image__large_38',
                    Pe = 'Item_image__locked_0f',
                ...
                const xt = (0, o.memo)(
                        ({
                            ...
                            return a.withStack
                                ...
                                : i().createElement(wt, kt({ key: `${r}-${e}` }, c));
                        },
                    ),
                    Tt = (u) => ({
                        ...
                        ({
                            ...
                            const m = ((u, e, t) =>
                                (0, o.useMemo)(() => {
                                    ...
                                    return { value: n, deltaFrom: Pt(n, e, t) };
                                }, [t, e, u]))(s, u, l);
                            return i().createElement(
                                'div',
                                { className: y()(Je.base, Je[`base__${t}`]), style: Tt(e) },
                ...
                const Xt = (function (u, e, t) {
                        ...
                        ({
                            ...
                            const E = (0, o.useContext)(_),
                                ...
                                C = y()($e, A && Ue, F && Ge);
                            let g;
                            g = r.hideProgressBarAndString ? y()(Ie, A && ze, F && He) : y()(We, A && Ve, F && je);
                            const f = (0, o.useCallback)(() => {
                            ...
                            return i().createElement(
                                ...
                                i().createElement(
                                    ...
                                    t && i().createElement(jt, Kt({}, r, { className: g })),
                ...
                const _n = {
                    ...
                    xn = 'FormatText_base_d0',
                    Tn = ({ binding: u, text: e = '', classMix: t, alignment: n = Xu.left, formatWithBrackets: r }) => {
