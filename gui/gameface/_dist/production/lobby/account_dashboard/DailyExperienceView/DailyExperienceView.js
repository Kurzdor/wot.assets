(() => {
    var __webpack_modules__ = {
            ...
            67: (u, e, t) => {
                ...
                var a = {};
                t.r(a),
                    t.d(a, { mouse: () => c, off: () => l, on: () => s, onResize: () => o, onScaleUpdated: () => F });
                var r = {};
                t.r(r),
                    t.d(r, {
                        events: () => a,
            ...
            266: (u, e, t) => {
                ...
                const L = {
                    ...
                    k = (u) => {
                        ...
                        const n = x(),
                            ...
                            E = n.mediaHeight,
                            A = n.mediaSize;
                        return r().createElement('div', y({ className: h()(t, L[i], T[E], S[A]) }, a), e);
                    },
                    M = ['children'];
                const O = (u) => {
                    let e = u.children,
                ...
                const Z = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    J = (u, e, t = K.left) => u.split(e).reduce(t === K.left ? X : Q, []),
                    uu = (() => {
                        const u = new RegExp(
                    ...
                    tu = (u, e = K.left) => {
                        ...
                        return ((u, e = K.left) => {
                            ...
                            const a =
                                ...
                                r = Z(u);
                            return J(r, /( )/, e).forEach((u) => (t = t.concat(J(u, a, K.left)))), t;
                        })(u, e);
                    },
                    ...
                    Eu = /(?<=(?:%\(|{))(.*?)(?=(?:_[Oo]pen|Start))/,
                    Au = /(?<=(?:_[Oo]pen|Start)(?:\)s?|}))(.*?)(?=(?:%\(|{))/,
                    ou = (0, a.memo)(({ text: u, binding: e, classMix: t }) => {
                        ...
                        return r().createElement(ru, { text: A, classMix: t, binding: i });
                    });
                function Fu() {
                    return !1;
                }
                    ...
                    const C = (0, a.useRef)(null),
                        ...
                        W = h()(
                            ...
                            _u[`base__${n}`],
                            {
                                ...
                                [_u.base__firstHover]: w,
                            },
                            E,
                        ),
                        P = h()(_u.state, _u.state__default);
                    return (
                        (0, a.useEffect)(
                            () => (
                ...
                const pu = (0, a.memo)(gu),
                    ...
                    Lu = 'StateWidget_icon__wotPlus_0c',
                    Tu = 'StateWidget_icon__wotPremium_f4',
                ...
                const Hu = {
                    ...
                    Nu = (0, V.Pi)(({ type: u }) => {
                        const e = du(),
                            ...
                            A = a.onWotPlusDetailsButtonClick,
                            o = t.root.get(),
                            F = o.isWotPremium,
                            s = o.isWotPlus,
                            l = o.wotPremiumMaxApplications,
                            D = o.wotPlusMaxApplications,
                            ...
                            _ = { [Ru.WotPremium]: F ? E : n, [Ru.WotPlus]: s ? A : i },
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: h()(yu, u === Ru.WotPremium && Tu, u === Ru.WotPlus && Lu) },
                                    r().createElement('div', {
                                        className: h()(Su, {
                    ...
                    qu = 'DailyExperienceApp_multiplier_left__wotPlus_12',
                    Ku = 'DailyExperienceApp_multiplier_right_d0',
                    ...
                    ae = (0, V.Pi)(() => {
                        const u = du(),
                            ...
                            i = a.leftBonusCount,
                            E = a.totalBonusCount,
                            A = a.wotPremiumMaxApplications,
                            o = a.wotPlusMaxApplications;
                        var F;
                        return (
                            (F = t),
                            z(j.n.ESCAPE, F),
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            'div',
                                            { className: ju },
                                            r().createElement('div', { className: h()(zu, n ? qu : Vu) }),
                                            r().createElement(
                                                'div',
                                                { className: Ku },
                                                r().createElement(ou, {
                                                ...
                                                r().createElement(
                                                    'div',
                                                    { className: ue },
                                                    A > 0 && r().createElement(Nu, { type: Ru.WotPremium }),
                                                    o > 0 && n && r().createElement('div', { className: te }),
                                                    o > 0 && n && r().createElement(Nu, { type: Ru.WotPlus }),
                                                ),
                                            ),
                                        ),
                                    ),
