(() => {
    ...
    var __webpack_modules__ = {
            527: (u, e, t) => {
                t.r(e),
                    t.d(e, { mouse: () => F, off: () => i, on: () => o, onResize: () => E, onScaleUpdated: () => A });
                var n = t(472),
                    r = t(176);
            ...
            192: (u, e, t) => {
                ...
                const D = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    l = (u, e, t = F.left) => u.split(e).reduce(t === F.left ? B : c, []),
                    C = (() => {
                        const u = new RegExp(
                    ...
                    d = (u, e = F.left) => {
                        ...
                        return ((u, e = F.left) => {
                            ...
                            const n =
                                ...
                                r = D(u);
                            return l(r, /( )/, e).forEach((u) => (t = t.concat(l(u, n, F.left)))), t;
                        })(u, e);
                    },
                    m = 'FormatText_base_d0',
                    p = ({ binding: u, text: e = '', classMix: t, alignment: E = F.left, formatWithBrackets: A }) => {
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (S(t, c, { isMouseEvent: !0, on: !0, arguments: y(r) }, w),
                                    m && m(),
                ...
                const U = R.views.common.tooltip_window.simple_tooltip_content,
                    G = (u) => {
                        ...
                        const F = (0, n.useMemo)(() => {
                            const u = Object.assign({}, i, { body: t, header: E, note: A, alert: o });
                ...
                const V = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const E = e.contentId;
                    return E ? r().createElement(k, q({}, e, { contentId: E }), n) : r().createElement(L, e, n);
                };
                ...
                const j = [
                    ...
                    J = ({
                        ...
                        const c = ((u, e) => {
                            ...
                            C = ((u, e) => {
                                ...
                                switch (e) {
                                    ...
                                    case b.CURRENCY:
                                    case b.NUMBER:
                                        return r().createElement(Y, { format: 'integral', value: Number(u) });
                                    case b.PREMIUM_PLUS: {
                                        const e = Number(u);
                        ...
                        return r().createElement(
                            'div',
                            { className: i()(Z.base, Z[`base__${n}`], F), style: s },
                            r().createElement(
                                V,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: i()(Z.image, null == a ? void 0 : a.image) },
                                        c &&
                                            r().createElement('div', {
                                                className: i()(Z.highlight, null == a ? void 0 : a.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: i()(Z.icon, null == a ? void 0 : a.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        l &&
                                            r().createElement('div', {
                                                className: i()(Z.overlay, null == a ? void 0 : a.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: B },
                                    r().createElement('div', {
                                        className: i()(Z.timer, null == a ? void 0 : a.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const Eu = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            ru({}, s, {
                                className: i()(tu.base, tu[`base__theme-${o}`], E),
                                ref: function (u) {
                                    (a.current = u), 'function' == typeof e ? e(u) : e && (e.current = u);
                                },
                            }),
                            r().createElement('div', { className: tu.decorator }, t),
                        )
                    );
                });
                let Au, ou;
                        ...
                        return [
                            function ({ mode: E = 'real', options: A, children: o, mocks: i }) {
                                const s = (0, n.useRef)([]),
                                    F = (t, n, r) => {
                                        ...
                                        const A = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = _u(r.keys()); !(u = t()).done; ) E(u.value, e);
                                                    },
                                                    unsubscribe: E,
                                                };
                                            })(n),
                                    ...
                                    B = D[0],
                                    c = D[1],
                                    l = (0, n.useState)(() => F(E, A, i)),
                                    C = l[0],
                                    _ = l[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        a.current ? _(F(B, A, i)) : (a.current = !0);
                                    }, [i, B, A]),
                                    (0, n.useEffect)(() => {
                                        c(E);
                                    }, [E]),
                    ...
                    Nu = (0, Bu.Pi)(() => {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                'div',
                                { className: wu },
                                r().createElement('div', { className: bu }, Iu.title()),
                                r().createElement('div', { className: fu }, Iu.description()),
                                r().createElement(
                                    'div',
                                    { className: Tu },
                                        ...
                                        r().createElement(
                                            ...
                                            u.name === ou.SELECTABLE_VEHICLE_DISCOUNT && u.vehicleLvl
                                                ? r().createElement(
                                                      'div',
                                                      { className: Ou },
                                                      r().createElement('div', { className: yu }, Du(u.vehicleLvl)),
                                                      r().createElement('div', { className: Su }),
                                                  )
                                                : r().createElement(J, ku({}, u, { size: w.S48x48 })),
                                            r().createElement(
                                                'div',
                                                { className: Pu },
                                                u.name === ou.SELECTABLE_VEHICLE_DISCOUNT && u.vehicleLvl
                ...
                engine.whenReady.then(() => {
                    A().render(
                        r().createElement(vu, null, r().createElement(Nu, null)),
