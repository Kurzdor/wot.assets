    ...
    var __webpack_modules__ = {
            ...
            192: (u, e, t) => {
                ...
                const i = (u, e, t) => {
                    ...
                    D = (u, e, t = s.left) => u.split(e).reduce(t === s.left ? i : a, []),
                    B = (() => {
                        const u = new RegExp(
                        ...
                        return c.includes(t)
                            ...
                            : ((u, e = s.left) => {
                                  ...
                                  const n =
                                      ...
                                      r = u.replace(/&nbsp;/g, ' ');
                                  return D(r, /( )/, e).forEach((u) => (t = t.concat(D(u, n, s.left)))), t;
                              })(u, e);
                    },
                    C = 'FormatText_base_d0',
                    _ = ({ binding: u, text: e = '', classMix: t, alignment: E = s.left }) =>
                        null === e
                        ...
                        const g = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            w = (0, n.useCallback)(() => {
                                (g.current.isVisible && g.current.timeoutId) ||
                                    (P(t, c, { isMouseEvent: !0, on: !0, arguments: T(r) }, b),
                                    m && m(),
                                          ...
                                          onMouseEnter:
                                              ...
                                              (u) => {
                                                  (u.clientX === window.innerWidth &&
                                                      ...
                                                      ((g.current.timeoutId = window.setTimeout(w, i ? 100 : 400)),
                                                      E && E(u),
                                                      S && S(u));
                                              }),
                                          onMouseLeave: ((u) => (e) => {
                ...
                const I = R.views.common.tooltip_window.simple_tooltip_content,
                    L = (u) => {
                        ...
                        const i = (0, n.useMemo)(() => {
                            const u = Object.assign({}, F, { body: t, header: E, note: A, alert: o });
                ...
                const q = [
                    ...
                    H = (u, e = p.Small) => {
                        ...
                        switch (t) {
                            ...
                            case 'dossier_badge':
                                return `R.images.gui.maps.icons.quests.bonuses.badges.${F}.${E}`;
                            case 'dossier_achievement':
                                return `R.images.gui.maps.icons.achievement.${F}.${E}`;
                            case 'xp':
                            case 'xpFactor':
                            ...
                            case 'collectionItem':
                                return `R.images.gui.maps.icons.collectionItems.${F}.${E}`;
                            default:
                    ...
                    X = ({
                        ...
                        return r().createElement(
                            'div',
                            { className: F()(W.base, W[`base__${n}`], i), style: s },
                            r().createElement(
                                U,
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: F()(W.image, null == a ? void 0 : a.image) },
                                        c &&
                                            r().createElement('div', {
                                                className: F()(W.highlight, null == a ? void 0 : a.highlight),
                                                style: {
                                        ...
                                        e &&
                                            r().createElement('div', {
                                                className: F()(W.icon, null == a ? void 0 : a.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        l &&
                                            r().createElement('div', {
                                                className: F()(W.overlay, null == a ? void 0 : a.overlay),
                                                style: {
                            ...
                            t &&
                                r().createElement(
                                    ...
                                    { tooltipArgs: B },
                                    r().createElement('div', {
                                        className: F()(W.timer, null == a ? void 0 : a.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                const eu = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            uu({}, s, {
                                className: F()(Z.base, Z[`base__theme-${o}`], E),
                                ref: function (u) {
                ...
                const Cu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: E = 'real', options: A, children: o, mocks: F }) {
                                const s = (0, n.useRef)([]),
                                    i = (t, n, r) => {
                                        var E;
                                        const A = (function ({
                                                ...
                                                return {
                                                    subscribe: (t, E) => {
                                                        const o = 'string' == typeof E ? `${n}.${E}` : n,
                                                            F = K.O.view.addModelObserver(o, e, !0);
                                            ...
                                            D = { mode: t, model: a, externalModel: o, cleanup: i };
                                        return {
                                            model: a,
                                    ...
                                    B = D[0],
                                    c = D[1],
                                    l = (0, n.useState)(() => i(E, A, F)),
                                    C = l[0],
                                    _ = l[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        a.current ? _(i(B, A, F)) : (a.current = !0);
                                    }, [F, B, A]),
                                    (0, n.useEffect)(() => {
                                        c(E);
                                    }, [E]),
                    ...
                    })(({ observableModel: u }) => ({ rewards: u.array('rewards') }), iu),
                    _u = Cu[0],
                    du = Cu[1],
                    mu = 'App_base_7e',
                    pu = 'App_title_bd',
                                        ...
                                        r().createElement(
                                            ...
                                            u.name === nu.SELECTABLE_VEHICLE_DISCOUNT && u.vehicleLvl
                                                ? r().createElement(
                                                      'div',
                                                      { className: fu },
                                                      r().createElement('div', { className: Tu }, Fu(u.vehicleLvl)),
        ...
        (__webpack_require__.O = (u, e, t, n) => {
            if (!e) {
                ...
                for (F = 0; F < deferred.length; F++) {
                    for (var [e, t, n] = deferred[F], E = !0, A = 0; A < e.length; A++)
                        (!1 & n || r >= n) &&
