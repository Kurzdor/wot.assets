    ...
    var e,
        t = {
            ...
            4219: (e, t, r) => {
                ...
                var n = {};
                r.r(n),
                    r.d(n, { mouse: () => w, off: () => f, on: () => h, onResize: () => d, onScaleUpdated: () => g });
                var a = {};
                r.r(a),
                    r.d(a, {
                        events: () => n,
                ...
                const le = re.client.getSize('rem'),
                    ...
                    de = (e) => {
                        ...
                        if (r.extraLarge || r.large || r.medium || r.small || r.extraSmall) {
                            ...
                            if (r.extraLargeWidth && m) return u(t, r, _);
                            if (r.largeWidth && d) return u(t, r, _);
                        ...
                        return (
                            (0, o.useEffect)(() => {
                                ...
                                switch (w) {
                                    ...
                                    case 'stop':
                                        return (function () {
                                            const e = 0 === m && x ? { path: x, x: 0, y: 0 } : n(m),
                                                t = new Image();
                                            t.src = e.path;
                                            const a = () => r(ke(e, t));
                                            return (
                ...
                const je = (e) => {
                    ...
                    return s().createElement(
                        ...
                        s().createElement(
                            'div',
                            { className: fe()(ze.value, m && ze.value__text) },
                            d ? l : c,
                    ...
                    it = ((e, t) => {
                        ...
                        return [
                            function ({ mode: e = 'real', options: n, children: a, mocks: i }) {
                                ...
                                return (
                                    (0, o.useEffect)(() => {
                                        c.current ? v(u(d, n, i)) : (c.current = !0);
                                    }, [i, d, n]),
                                    (0, o.useEffect)(() => {
                                        g(e);
                                    }, [e]),
