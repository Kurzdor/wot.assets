(() => {
    var __webpack_modules__ = {
                ...
                const i = ['children'],
                    s = (e) => {
                        ...
                        const s = (0, n.useContext)(a.Y),
                            ...
                            h = { extraLarge: D, large: B, medium: C, small: f, extraSmall: p };
                        if (t.extraLarge || t.large || t.medium || t.small || t.extraSmall) {
                            ...
                            if (t.mediumWidth && F) return (0, r.H)(u, t, h);
                            if (t.smallWidth && g) return (0, r.H)(u, t, h);
                            if (t.extraSmallWidth && _) return (0, r.H)(u, t, h);
                            if (
                                !(
                                    t.extraLargeWidth ||
                                    t.largeWidth ||
            ...
            5067: (e, u, t) => {
                ...
                const U = Object.keys(C).reduce((e, u) => ((e[u] = () => viewEnv.getShowingStatus() === C[u]), e), {}),
                    V = {
                        set: (e, u) => {
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(
                                        'div',
                                        {
                                            className: r()(
                                                l.Z.truncated,
                                                !p.isTruncateFinished && m && l.Z.truncated__hide,
                                            ),
                                            style: S,
                                        },
                                        p.isTruncateFinished && m ? p.elementList : v,
                                    ),
                                ),
                            )
                        );
            ...
            3977: (e, u, t) => {
                ...
                var r = {};
                t.r(r), t.d(r, { Area: () => Y, Bar: () => G, Default: () => Z, useVerticalScrollApi: () => I });
                var a = t(9916),
                    i = t(4029),
                    s = t(6179),
                    o = t.n(s),
                ...
                const h = {
                        ...
                        return (o = {}) => {
                            ...
                            return (
                                ...
                                (0, s.useMemo)(
                                    ...
                                    [B.scrollPosition, b, w, m.off, m.on, y, S, p, c.step.clampedArrowStepTimeout],
                                )
                            );
                        };
                    },
                    ...
                    L = (0, s.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = y, onDrag: n = k }) => {
                        ...
                        (0, s.useEffect)(() => (0, A.v)(b)),
                            ...
                            (0, s.useEffect)(() => {
                                ...
                                const u = F.O.client.events.mouse.move(([u, t]) => {
                                        ...
                                        const E = u.clientX - C.offset - s.getBoundingClientRect().x,
                        ...
                        const M = (e) => {
                            e.target.classList.contains(S) || (0, B.G)('highlight');
                        };
                        return o().createElement(
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(S) || 0 !== e.button || ((0, B.G)('play'), L(p.Next));
                                },
                                onMouseUp: N,
                                ref: a,
                                onMouseEnter: M,
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(S) || 0 !== e.button || ((0, B.G)('play'), L(p.Prev));
                                },
                                onMouseUp: N,
                                ref: i,
                                onMouseEnter: M,
                ...
                const I = v({
                    ...
                    G = (0, s.memo)(({ api: e, classNames: u = {}, getStepByRailClick: t = j, onDrag: n = W }) => {
                        const r = (0, s.useRef)(null),
                            a = (0, s.useRef)(null),
                            i = (0, s.useRef)(null),
                            l = (0, s.useRef)(null),
                        ...
                        const S = D((u) => e.applyStepTo(u), E, [e]),
                            x = S[0],
                            y = S[1];
                        (0, s.useEffect)(
                            () => (
                        ...
                        return o().createElement(
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(H) || 0 !== e.button || ((0, B.G)('play'), x(p.Next));
                                },
                                ref: a,
                                onMouseEnter: R,
                            }),
                            ...
                            o().createElement('div', {
                                ...
                                onMouseDown: (e) => {
                                    e.target.classList.contains(H) || 0 !== e.button || ((0, B.G)('play'), x(p.Prev));
                                },
                                onMouseUp: y,
                                ref: i,
                                onMouseEnter: R,
                ...
                const oe = 'default_sectionTitleLong_f5',
                    ...
                    _e = ['I', 'IV', 'V', 'IX', 'X', 'XL', 'L', 'XC', 'C', 'CD', 'D', 'CM', 'M'],
                        ...
                        Be
                            ...
                            : (function (e) {
                                  ...
                                  for (let t = De.length - 1; t >= 0; t--)
                                      for (; e >= De[t]; ) (u += _e[t]), (e -= De[t]);
                                  return u;
                              })(e);
                var fe = t(3618);
                const pe = (0, s.memo)(({ withDivider: e = !0, className: u, children: t }) =>
                        o().createElement(
                            'div',
                            ...
                            o().createElement(
                                ...
                                ((e) => [
                                    ...
                                    o().createElement(
                                        ...
                                        t
                                            ? o().createElement(fe.w, { text: u, binding: t })
                    ...
                    be = (0, s.memo)(({ withNinthLevel: e, withBattlePass: u, withRandomReserves: t, duration: n }) =>
                        o().createElement(
                            pe,
                                    ...
                                    e.map(({ header: e, text: u, image: t }, n) =>
                                        o().createElement(
                                            ...
                                            o().createElement(
                                                ...
                                                o().createElement(fe.w, { text: u.value, binding: u.binding }),
                                            ),
                                        ),
                                    ),
                                ),
                ...
                const Se = 'ProgressionSection_caption_98',
                    xe = 'ProgressionSection_captionDescription_e4',
                    ye = 'ProgressionSection_captionImgContainer_a1',
                    Re = 'ProgressionSection_tableColumn_78',
                    ke = 'ProgressionSection_tableCell_60',
                    Te = 'ProgressionSection_tableCell__header_a9',
                    Le = [
                        null,
                                ...
                                o().createElement(
                                    ...
                                    Le.map((e, u) =>
                                        o().createElement(
                                            ...
                                            {
                                                key: u,
                                                className: d()(ke, e ? 'ProgressionSection_tableCell__right_98' : Te),
                                            },
                                            e,
                                        ),
                                    ),
                                ),
                                we.UI(u, ({ rankName: e, rankPoints: u }, t) =>
                                    o().createElement(
                                        'div',
                                        { key: t, className: Re },
                                        o().createElement(
                                        ...
                                        u.map(({ value: e }, u) => {
                                            return o().createElement(
                                                ...
                                                {
                                                    key: u,
                                                    className: d()(ke, 'ProgressionSection_tableCell__centered_6d'),
                                                },
                                                0 === u
                                                    ? ((e) => {
                    ...
                    Oe = (0, J.Pi)(() => {
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                we.UI(e.getSkillsCategories(), ({ type: e, skills: u }, t) =>
                                    o().createElement(
                                        'div',
                ...
                const He = [
                    ...
                    je = 'ScenariosSection_progressionTableCell_71',
                    Ue = (0, s.forwardRef)((e, u) =>
                        o().createElement(
                            'div',
                            { ref: u },
                            o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(
                                        ...
                                        He.map(({ label: e, icon: u, cells: t }, n) =>
                                            o().createElement(
                                                'div',
                    ...
                    Ze = (0, s.memo)(({ startTimestamp: e, endTimestamp: u }) => {
                        ...
                        o().createElement(
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    qe.map((e, u) => o().createElement(fe.w, { key: u, text: e, classMix: Ye })),
                                ),
                                o().createElement('div', { className: 'WinStrategySection_img_9f' }),
                            ),
                        ),
                    Xe = (0, J.Pi)(({ isFullScreen: e = !1 }) => {
                        ...
                        return (
                            ...
                            o().createElement(
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(Ze, { startTimestamp: E, endTimestamp: m }),
                                ),
                                e &&
                                    o().createElement(K.A, {
                                        classNames: {
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(Ne, { withBattlePass: c }),
                ...
                const Qe = () => {
                    const e = ae().controls;
                    return (0, Je.I9)(e.close), o().createElement(Xe, { isFullScreen: !0 });
                };
                R.views.frontline.lobby.InfoView('resId'),
                    engine.whenReady.then(() => {
                        c().render(
                            o().createElement(i.z, null, o().createElement(re, null, o().createElement(Qe, null))),
