(() => {
    ...
    var __webpack_modules__ = {
            67: (u, e, t) => {
                ...
                var n = {};
                t.r(n),
                    t.d(n, { mouse: () => l, off: () => c, on: () => F, onResize: () => s, onScaleUpdated: () => A });
                var o = {};
                t.r(o),
                    t.d(o, {
                        events: () => n,
                ...
                var r = {};
                t.r(r), t.d(r, { getBgUrl: () => m, getTextureUrl: () => d });
                var a = {};
                function E(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const W = Object.keys(v).reduce((u, e) => ((u[e] = () => viewEnv.getShowingStatus() === v[e]), u), {}),
                    K = {
                        set: (u, e) => {
            ...
            916: (u, e, t) => {
                t.d(e, { Sw: () => r.Z, B3: () => i, Z5: () => a.Z5, B0: () => E, ry: () => B });
                class n {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                ...
                function _(u, e, t, n, o, r, a) {
                    ...
                    E.done ? e(i) : Promise.resolve(i).then(n, o);
                }
            ...
            358: (u, e, t) => {
                ...
                const A = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    D = (u, e, t = i.left) => u.split(e).reduce(t === i.left ? F : c, []),
                    l = (() => {
                        const u = new RegExp(
                    ...
                    C = (u, e = i.left) => {
                        ...
                        return ((u, e = i.left) => {
                            ...
                            const n =
                                ...
                                o = A(u);
                            return D(o, /( )/, e).forEach((u) => (t = t.concat(D(u, n, i.left)))), t;
                        })(u, e);
                    };
                var B = t(916),
                    d = t(613);
                ...
                const v = (u = 1) => {
                    ...
                    f = (u) => {
                        const e = ((u) => {
                                ...
                                return { modelPrefix: o, modelPath: g(o, u || ''), resId: n };
                            })(),
                            t = e.modelPrefix,
                            n = u.split('.');
                        if (n.length > 0) {
                        ...
                        b(() => {
                            if (
                                ...
                                const t = (u) => {
                                    ...
                                    n = f(u);
                                c.current = y.addCallback(n, t, E, e === k.Deep);
                            }
                        }),
                        (0, n.useEffect)(() => {
                            if (e !== k.None)
                    ...
                    const C = (0, n.useRef)(null),
                        ...
                        H = L()(
                            ...
                            S[`base__${r}`],
                            {
                                ...
                                [S[`base__${e}`]]: e,
                                [S.base__focus]: d,
                                [S.base__highlightActive]: p,
                                [S.base__firstHover]: g,
                            },
                            E,
                        ),
                        V = L()(S.state, S.state__default);
                    return (
                        (0, n.useEffect)(
                            () => (
                ...
                const Y = (u) => {
                    let e = u.id,
                        ...
                        c = u.type,
                        D = void 0 === c ? j.primary : c,
                        l = u.soundHover,
                        _ = void 0 === l ? 'highlight' : l,
                        C = u.soundClick,
                        B = void 0 === C ? 'play' : C,
                        d = u.onMouseEnter,
                        m = u.onMouseLeave,
                    ...
                    const O = (0, n.useState)(!1),
                        ...
                        Q = o().createElement(
                            ...
                            o().createElement(
                                'div',
                                { className: L()($.labelContent, 's-labelContent'), style: y },
                                f || k,
                            ),
                        );
                    return o().createElement(
                        ...
                        K(
                            {
                                id: e,
                                className: L()($.base, $[`base__${F}`], $[`base__${D}`], {
                                    [$.base__checked]: r,
                                    [$.base__disabled]: E,
                                    [$.base__mouseDown]: M,
                                    [$.base__alert]: s,
                ...
                const eu = (0, n.memo)(
                    ...
                    nu = ({ binding: u, text: e = '', classMix: t, alignment: r = i.left, formatWithBrackets: a }) => {
                ...
                class Eu extends o().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = L()(ou.base, ou[`base__${a}`], ou[`base__${r}`], null == E ? void 0 : E.base),
                            l = L()(ou.icon, ou[`icon__${a}`], ou[`icon__${r}`], null == E ? void 0 : E.icon),
                            _ = L()(ou.glow, null == E ? void 0 : E.glow),
                            C = L()(ou.caption, ou[`caption__${a}`], null == E ? void 0 : E.caption),
                            B = L()(ou.goto, null == E ? void 0 : E.goto);
                        return o().createElement(
                            'div',
                            au(
                                {
                            ...
                            o().createElement('div', { className: l }, o().createElement('div', { className: _ })),
                ...
                const cu = (u, e, t = {}, n = 0) => {
                    ...
                    Du = (u) => {
                        ...
                        const h = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            g = (0, n.useMemo)(() => d || v().resId, [d]),
                            w = (0, n.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (cu(t, l, { isMouseEvent: !0, on: !0, arguments: Fu(o) }, g),
                                    m && m(),
                ...
                const du = 'CurrencyBalance_base_e7',
                    ...
                    Mu = 'App_title_e7',
                    Nu = 'App_cannotMountContainer_36',
                        ...
                        return o().createElement(
                            ...
                            o().createElement(
                                ...
                                l &&
                                    o().createElement('img', {
                                        className: Ou,
                                        src: R.images.gui.maps.shop.modules.c_180x135.$dyn(l),
                                    }),
                                o().createElement(
                                    'div',
                                    { className: Mu },
                                ...
                                o().createElement(
                                    ...
                                    o().createElement(
                                        U,
                                        { type: I.primary, size: H.medium, onClick: g, mixClass: ju },
