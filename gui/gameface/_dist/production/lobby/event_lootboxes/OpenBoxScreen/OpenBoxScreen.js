    ...
    var __webpack_modules__ = {
            ...
            661: (u, e, t) => {
                ...
                const L = {
                    ...
                    O = (u) => {
                        ...
                        const r = S(),
                            ...
                            o = r.mediaHeight,
                            s = r.mediaSize;
                        return a().createElement('div', y({ className: p()(t, L[i], P[o], k[s]) }, n), e);
                    },
                    I = ['children'],
                    M = (u) => {
                        let e = u.children,
                ...
                const Lu = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    Ou = (u, e, t = Tu.left) => u.split(e).reduce(t === Tu.left ? Pu : ku, []),
                    Iu = (() => {
                        const u = new RegExp(
                    ...
                    Hu = ({ dayLimit: u, onClick: e, useExternalShop: t }) => {
                        const r = (0, n.useMemo)(
                                () => ({
                            ...
                            i = (0, n.useCallback)(() => {
                                (0, Z.G)('ev_cosmic_lootbox_play'), e();
                            }, [e]),
                            o = (0, n.useCallback)(() => {
                                (0, Z.G)('ev_cosmic_lootbox_highlight');
                            }, []);
                        return a().createElement(
                            Su,
                            r,
                ...
                const zu = (u) => {
                    ...
                    ju = ({
                        ...
                        (0, n.useEffect)(
                            () =>
                                Q(() => {
                                    _(!1), (0, Z.G)('ev_cosmic_lootbox_icon');
                                }, A),
                            [A],
                        ),
                            (0, n.useEffect)(
                        ...
                        const x = i || Object.keys(Gu).includes(E);
                        return a().createElement(
                            'div',
                            { className: f },
                            a().createElement(
                ...
                const ae = ({
                    ...
                    const _ = (0, n.useRef)(null),
                        ...
                        k = (0, n.useCallback)(
                            (u) => {
                                i || (null !== E && (0, Z.G)(E), c && c(u), t && x(), v(!0));
                            },
                            [i, E, c, x, t],
                        ),
                        O = (0, n.useCallback)(
                ...
                const re = (0, n.memo)(ae),
                    ...
                    _e = ({
                        ...
                        return a().createElement(
                            ...
                            _ && a().createElement(Hu, { dayLimit: c, onClick: l, useExternalShop: m }),
                        );
                    },
                    Be = () => {
                        const u = j(),
                        ...
                        return a().createElement(
                            ...
                            s && a().createElement(q.E, { isActive: e, onClick: h }),
                        );
                    };
            ...
            865: (u, e, t) => {
                ...
                const B = ({ mixClass: u, soundClick: e = 'play', soundHover: t, onCloseCallback: i }) => {
                    const s = (0, n.useCallback)(() => {
                        i && i(), (0, r.Sy)();
                    }, [i]);
                    var E;
                    (E = s), _(d.n.ESCAPE, E);
                    const l = o()('CloseBtn_base_0e', u);
                    return a().createElement(
                        'div',
                        { className: l },
                        a().createElement(c, {
