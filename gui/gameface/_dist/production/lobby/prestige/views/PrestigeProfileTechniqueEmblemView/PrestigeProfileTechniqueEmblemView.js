(() => {
    ...
    var __webpack_modules__ = {
                        ...
                        const k = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            L = (0, i.useCallback)(() => {
                                (k.current.isVisible && k.current.timeoutId) ||
                                    (l(n, g, { isMouseEvent: !0, on: !0, arguments: s(o) }, x),
                                    O && O(),
            ...
            67: (e, t, n) => {
                ...
                const H = Object.keys(p).reduce((e, t) => ((e[t] = () => viewEnv.getShowingStatus() === p[t]), e), {}),
                    Y = {
                        set: (e, t) => {
                ...
                const d = {
                    ...
                    m = ({ label: e, type: t, size: n }) => {
                        ...
                        return l().createElement(
                            'div',
                            { className: o()(u.base, u[`base__${n}`]) },
                            e
                                .split('')
                                .map((e, t) =>
                                    l().createElement('div', {
                                        key: t,
                                        className: o()(u.letter, u[`letter__s${e}`]),
                    ...
                    w = ({ emblem: e, size: t, showLevel: n = !0, isTooltipEnabled: r = !1 }) => {
                        const s = ((e, t) => {
                            if (e.type === a.C.UNDEFINED) return;
                            const n = t === c.U.MediumExtended ? c.U.Large : t,
                                r = R.images.gui.maps.icons.prestige.emblem.$dyn(d[n]);
                            return e.type === a.C.MAXIMUM ? r.$dyn(a.C.MAXIMUM) : r.$dyn(e.type).$dyn(`c_${e.grade}`);
                        })(e, t);
                        if (!s) return null;
                        const _ = n && e.type !== a.C.MAXIMUM;
                        return l().createElement(
                            i.i,
                            { header: b.title(), body: b.body(), isEnabled: r },
                            l().createElement(
                                'div',
                                { className: o()(v.base, v[`base__${t}`]) },
                                l().createElement('div', {
                                    className: v.icon,
                                    style: { backgroundImage: `url(${s})` },
                                }),
                                _ && l().createElement(m, { label: e.level.toString(), type: e.type, size: t }),
                            ),
                        );
                    };
            },
