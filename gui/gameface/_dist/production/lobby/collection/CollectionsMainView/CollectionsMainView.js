                ...
                const T = {
                    ...
                    O = (e) => {
                        ...
                        const r = y(),
                            ...
                            a = r.mediaHeight,
                            s = r.mediaSize;
                        return i().createElement('div', x({ className: p()(t, T[o], M[a], P[s]) }, n), u);
                    },
                    N = ['children'];
                const k = (e) => {
                    let u = e.children,
                    ...
                    ge = ({
                        ...
                        return (l = {}) => {
                            ...
                            return (0, o.useMemo)(
                                ...
                                [D.scrollPosition, g, h, m.off, m.on, v, p, C, E.step.clampedArrowStepTimeout],
                            );
                        };
                    },
                    he = ge({
                        ...
                        return i().createElement(
                            ...
                            i().createElement(
                                ...
                                i().createElement(
                                    'div',
                                    {
                                        className: p()(ku.book, ku[`book__${x}`]),
                                        onMouseOver: () => {
                                            v ||
                                                (O = setTimeout(() => {
