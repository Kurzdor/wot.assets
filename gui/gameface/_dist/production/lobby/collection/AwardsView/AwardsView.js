(() => {
    var __webpack_modules__ = {
            ...
            527: (e, t, u) => {
                'use strict';
                u.r(t),
                    u.d(t, { mouse: () => h, off: () => n, on: () => s, onResize: () => r, onScaleUpdated: () => o });
                var i = u(472),
                    a = u(176);
                const r = (0, i.E)('clientResized'),
                    o = (0, i.E)('self.onScaleUpdated'),
                    s = (e, t) => engine.on(e, t),
                    n = (e, t) => engine.off(e, t),
            ...
            916: (e, t, u) => {
                'use strict';
                u.d(t, { B3: () => n, Z5: () => o.Z5, B0: () => s, ry: () => p, Sy: () => f });
                class i {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
                ...
                const D = a.instance,
                    C = {
                        ...
                        sendShowContextMenuEvent: (e, t, u = 0) => {
                            _(s.CONTEXT_MENU, { isMouseEvent: !0, contentID: e, on: !0, decoratorID: u, args: t });
                        },
            ...
            935: (e, t, u) => {
                ...
                const L = {
                    ...
                    P = (e) => {
                        ...
                        const r = S(),
                            ...
                            s = r.mediaHeight,
                            n = r.mediaSize;
                        return a().createElement('div', x({ className: F()(u, L[o], T[s], O[n]) }, i), t);
                    },
                    y = ['children'];
                const U = (e) => {
                    let t = e.children,
                    ...
                    return [
                        function ({ mode: r = 'real', options: s, children: n, mocks: l }) {
                            ...
                            return (
                                ...
                                a().createElement(u.Provider, { value: p }, n)
                            );
                        },
                        () => (0, i.useContext)(u),
                    ];
                    ...
                    Me = we()(
                            ...
                            const t = Object.assign({}, e.primitives(['currentCollection']), e.primitives(['page']), {
                                ...
                                u = (0, Re.Om)(
                                    () => {
                                        ...
                                        return Ue[Te(e)] || Ue.defaultConfig;
                                    },
                                    { equals: Ae },
                                ),
                                i = (0, Re.Om)(
                        ...
                        ({ model: e, externalModel: t, cleanup: u }) => {
                            ...
                            const s = (0, pe.aD)(() => r(e.computes.getPageNumber() + 1)),
                                n = (0, pe.aD)(() => r(e.computes.getPageNumber() - 1)),
                    ...
                    const A = (0, i.useRef)(null),
                        ...
                        I = F()(
                            ...
                            We[`base__${r}`],
                            {
                                ...
                                [We[`base__${t}`]]: t,
                                [We.base__focus]: _,
                                [We.base__highlightActive]: D,
                                [We.base__firstHover]: v,
                            },
                            s,
                        ),
                        M = F()(We.state, We.state__default);
                    return (
                        (0, i.useEffect)(
                            () => (
                    ...
                    Xe = (0, X.Pi)(() => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                {
                                    type: $e.primary,
                                    size: i >= C.Medium ? qe.medium : qe.small,
                                    mixClass: Ve,
                                    onClick: t.onOpenCollection,
                                    disabled: r,
                                },
                                kt.footer.buttonText(),
                            ),
                        );
                    }),
                    Ke = 'Header_base_f2',
                    Qe = 'Header_overhead_71',
                    Ze = 'Header_title_d5',
                    Je = (0, X.Pi)(() => {
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement(
                                    'span',
                                    null,
                                    ye(R.strings, `collection_${e}.collection.awardsView.header.name`),
                                ),
                                a().createElement('span', null, ye(R.strings, `collection_${e}.collection.season`)),
                            ),
                            a().createElement('div', { className: Ze }, kt.header.subtitle()),
                        );
                    }),
                    et = 33,
                    tt = 0,
                ...
                const st = (0, i.memo)(function (e) {
                        ...
                        return (
                            ...
                            a().createElement('canvas', ot({}, w, { width: t, height: u, ref: D }))
                        );
                    }),
                    nt = (e, t) => {
                        let u = e;
                        ...
                        const D = (0, i.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            B = (0, i.useCallback)(() => {
                                (D.current.isVisible && D.current.timeoutId) ||
                                    (ct(u, m, { isMouseEvent: !0, on: !0, arguments: gt(a) }, C),
                                    f && f(),
                ...
                const Ct = ({ children: e, tooltipArgs: t, className: u }) => {
                        ...
                        if (t.header || t.body) return a().createElement(wt, t, i);
                        const r = t.contentId;
                        return r ? a().createElement(mt, Dt({}, t, { contentId: r }), i) : a().createElement(pt, t, i);
                    },
                    Bt = {
                        base: 'Reward_base_ea',
                    ...
                    vt = ({
                        ...
                        return a().createElement(
                            'div',
                            { className: F()(Bt.base, Bt[`base__${i}`], l), style: n },
                            a().createElement(
                                Ct,
                ...
                const xt = (0, X.Pi)(() => {
                        ...
                        return a().createElement(
                            'div',
                            { className: F()(St.base, 1 === e.length && St.base__wide) },
                            e.map((e, t) =>
                                a().createElement(
                                    'div',
                                    { className: St.rewardWrapper, key: t },
                                    a().createElement(
                                        vt,
                                        bt({}, e, {
                                            size: u,
                                            image: e.getImage(u),
                                            classNames: {
                                                info: F()(e.valueType !== ue.MULTI ? St.infoLabel : St.infoCount),
                                            },
                                        }),
                                    ),
                                    e.valueType !== ue.CURRENCY &&
                                        a().createElement(
                                            'div',
                                            { className: F()(St.label, St[`label__${e.name}`]) },
                                            e.label,
                                        ),
                                ),
                            ),
                    ...
                    Rt = 'MainRewards_base_06',
                    Lt = 'MainRewards_ribbonWrapper_50',
                    Tt = 'MainRewards_ribbon_19',
                    Ot = 'MainRewards_raysWrapper_f7',
                    Pt = 'MainRewards_rays_ea',
                    yt = 'MainRewards_sunShineCanvas_e9',
                    Ut = {
                        width: 400,
                        height: 400,
                        frameCount: 50,
                ...
                const Mt = (0, X.Pi)(() => {
                        ...
                        return a().createElement(
                            'div',
                            { className: Rt },
                            a().createElement('div', { className: Ot }, a().createElement('div', { className: Pt })),
                            1 === e &&
                                a().createElement(st, {
                                    width: Ut.width,
                                    height: Ut.height,
                                    frameCount: Ut.frameCount,
                                    getImageSource: at(Ut),
                                    frameTime: 50,
                                    className: yt,
                                }),
                            a().createElement('div', { className: Lt }, a().createElement('div', { className: Tt })),
                            a().createElement(xt, null),
                        );
                    }),
                    kt = R.strings.collections,
                    Nt = (0, X.Pi)(() => {
                        const e = He().model,
                        ...
                        return (
                            ...
                            a().createElement(
                                'div',
                                { className: F()(Ge.base, Ge[`base__${Q(r, o)}`]) },
                                a().createElement('div', {
                ...
                engine.whenReady.then(() => {
                    M().render(
                        a().createElement(
                            Ne,
                            null,
                            a().createElement(U, { className: k }, a().createElement(Nt, null)),
                        ),
