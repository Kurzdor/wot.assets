(() => {
    var __webpack_modules__ = {
            ...
            916: (u, e, t) => {
                'use strict';
                t.d(e, { B3: () => E, Z5: () => i.Z5, B0: () => o, ry: () => m, Sy: () => g });
                class r {
                    constructor() {
                        (this.entries = []),
                            (this._listenMouse = !1),
            ...
            14: (u, e, t) => {
                ...
                const l = i.O.client.getSize('rem'),
                    ...
                    d = (u) => {
                        ...
                        const n = (0, r.useContext)(F),
                            ...
                            f = { extraLarge: m, large: C, medium: g, small: h, extraSmall: p };
                ...
                const S = {
                    ...
                    M = (u) => {
                        ...
                        const a = b(),
                            ...
                            o = a.mediaHeight,
                            s = a.mediaSize;
                        return n().createElement('div', x({ className: C()(t, S[i], T[o], y[s]) }, r), e);
                    },
                    O = ['children'],
                    L = (u) => {
                        let e = u.children,
                ...
                const U = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    W = (u, e, t = N.left) => u.split(e).reduce(t === N.left ? H : G, []),
                    j = (() => {
                        const u = new RegExp(
                    ...
                    $ = ['zh_cn', 'zh_sg', 'zh_tw'],
                    X = ({ binding: u, text: e = '', classMix: t, alignment: a = N.left, formatWithBrackets: i }) => {
                ...
                const eu = [
                        ...
                        V.BattleBoosterGift,
                        V.OptionalDevice,
                        V.FragmentAntimatter,
                        V.CosmicLootbox,
                    ],
                    tu = [V.Gold, V.Credits, V.Crystal, V.FreeXp],
                    ru = [V.BattlePassPoints],
                        ...
                        const p = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            v = (0, r.useCallback)(() => {
                                (p.current.isVisible && p.current.timeoutId) ||
                                    (_u(t, F, { isMouseEvent: !0, on: !0, arguments: cu(n) }, f),
                                    C && C(),
                ...
                const fu = ({ children: u, tooltipArgs: e, className: t }) => {
                        ...
                        const a = e.contentId;
                        return a ? n().createElement(Fu, pu({}, e, { contentId: a }), r) : n().createElement(Bu, e, r);
                    },
                    vu = {
                        base: 'Reward_base_ea',
                    ...
                    bu = ({
                        ...
                        return n().createElement(
                            'div',
                            { className: C()(vu.base, vu[`base__${r}`], E), style: s },
                            n().createElement(
                                fu,
                                ...
                                n().createElement(
                                    ...
                                    n().createElement(
                                        'div',
                                        { className: C()(vu.image, null == l ? void 0 : l.image) },
                                        _ &&
                                            n().createElement('div', {
                                                className: C()(vu.highlight, null == l ? void 0 : l.highlight),
                                                style: {
                                        ...
                                        e &&
                                            n().createElement('div', {
                                                className: C()(vu.icon, null == l ? void 0 : l.rewardIcon),
                                                style: { backgroundImage: `url(${e})` },
                                            }),
                                        F &&
                                            n().createElement('div', {
                                                className: C()(vu.overlay, null == l ? void 0 : l.overlay),
                                                style: {
                            ...
                            t &&
                                n().createElement(
                                    ...
                                    { tooltipArgs: c },
                                    n().createElement('div', {
                                        className: C()(vu.timer, null == l ? void 0 : l.periodicIcon),
                                    }),
                                ),
                        );
                    };
                ...
                class Ru extends n().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            _ = C()(xu.base, xu[`base__${i}`], xu[`base__${a}`], null == o ? void 0 : o.base),
                            F = C()(xu.icon, xu[`icon__${i}`], xu[`icon__${a}`], null == o ? void 0 : o.icon),
                            D = C()(xu.glow, null == o ? void 0 : o.glow),
                            d = C()(xu.caption, xu[`caption__${i}`], null == o ? void 0 : o.caption),
                            B = C()(xu.goto, null == o ? void 0 : o.goto);
                        return n().createElement(
                            'div',
                            Tu(
                                {
                            ...
                            'info' !== i && n().createElement('div', { className: xu.shine }),
                ...
                function Ou(u = yu.n.NONE, e = Mu, t = !1, n = !1) {
                    (0, r.useEffect)(() => {
                        if (u !== yu.n.NONE)
                            return (
                ...
                const Gu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: u = 'real', options: a, children: o, mocks: s }) {
                                                ...
                                                observableModel: {
                                                    array: (e, t) => {
                                                        const r = null != t ? t : s(e),
                                                            n = Iu.observable.box(r, { equals: ku });
                                                        return (
                                                            'real' === u &&
                                                                o.subscribe(
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        A.current ? B(l(_, a, s)) : (A.current = !0);
                                    }, [s, _, a]),
                                    (0, r.useEffect)(() => {
                                        F(u);
                                    }, [u]),
                    ...
                    Wu = Gu[0],
                    ju = Gu[1],
                    $u = 'RewardsViewApp_title_decoration_0a',
                    Xu = {
                ...
                const Yu = ['xl', 'lg', 'md', 'sm', 'xs'],
                    zu = (u) => u.includes('_') && ((u) => Yu.includes(u))(u.split('_').at(-1)),
                    Ku = [p.ExtraLarge, p.Large, p.Medium, p.Small, p.ExtraSmall],
                    Qu = (u, e) =>
                        Object.keys(u).reduce((t, r) => {
                            ...
                            return (
                                void 0 === a ||
                                    ((u, e) => Yu.some((t) => void 0 !== e[`${u}_${t}`]))(n, u) ||
                                    (t[n] = a),
                                t
                            );
                        }, {}),
                ...
                const ee = {
                    ...
                    ne = ((u, e = Qu) => {
                        ...
                        return n().memo((e) =>
                            Object.keys(e).some((u) => zu(String(u)) && void 0 !== e[u])
                                ? n().createElement(t, e)
                                : n().createElement(u, e),
                        );
                    })((u) => {
                        let e = u.className,
                            ...
                            L = u.shrink,
                            P = u.flex,
                            k = void 0 === P ? (O || L ? `${O ? 1 : 0} ${L ? 1 : 0} auto` : void 0) : P,
                            I = u.style,
                            N = u.children,
                            U = (function (u, e) {
                                if (null == u) return {};
                        ...
                        const H = (0, r.useMemo)(() => {
                            ...
                            }, [t, a, s, l, c, F, I, k, T, m, M, w, S]),
                            G = H.computedStyle,
                            W = H.computedClassNames;
                        return n().createElement('div', ue({ className: C()(Zu.base, ...W, e), style: G }, U), N);
                    }),
                    ae = ['className', 'textVariant', 'color', 'onClick', 'children', 'disabled'];
                function ie() {
                    return (
                        (ie =
                            Object.assign ||
                ...
                const oe = { main: Xu.base__main, done: Xu.base__done, disabled: Xu.base__disabled },
                    se = (u) => {
                        let e = u.className,
                            t = u.textVariant,
                            r = u.color,
                        ...
                        return n().createElement(
                            ne,
                            ie({ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }, E, {
                                className: C()(Xu.base, oe[s ? 'disabled' : a], t && Xu[t], e),
                                onClick: i,
                            }),
                            o,
                        );
                    },
                    Ee = 'Announcer_text_9d',
                    le = ['className', 'active'];
                function Ae() {
                    return (
                        (Ae =
                ...
                const ce = (u) => {
                    ...
                    return n().createElement(
                        'div',
                        Ae({}, r, { className: C()('ListenIcon_base_4e', t && 'ListenIcon_base__active_66', e) }),
                    ...
                    De = (0, Pu.observer)((u) => {
                                    ...
                                    (0, r.useEffect)(() => {
                                        ...
                                        const n = u,
                                            i = n.includes(' ')
                                                ...
                                                : (function (u, e) {
                                                      const t = [];
                                                      for (let e = 0, r = u.length; e < r; e += 3)
                                        ...
                                        return (
                                            (function u() {
                                                const E = Date.now() - s,
                                                    l = Math.min(1, E / e),
                                                    A = Math.min(Math.ceil(i.length * l), i.length),
                                                    c = i.slice(0, A).join(o);
                                                l < 1
                                                    ? (c !== r && ((r = c), a(c)), (t = requestAnimationFrame(u)))
                                                    : a(n);
                                            })(),
                        ...
                        return (
                            ...
                            n().createElement(
                                ...
                                n().createElement(
                                    'div',
                                    { className: C()('Announcer_base_17', o && 'Announcer_base__visible_1b') },
                                    ...
                                    n().createElement(
                                        ...
                                        n().createElement(
                                            ...
                                            n().createElement(ce, { active: !0 }),
                                        ),
                                    ),
                                    n().createElement(
                                        'div',
                                        { className: 'Announcer_text_container_4a', ref: A },
                                        n().createElement('div', { className: Ee }, o),
                                        n().createElement(
                                            'div',
                                            {
                                                ref: l,
                ...
                const Be = (0, Pu.observer)(() => {
                    const u = ju(),
                        e = u.model,
                        t = u.controls,
                        a = e.announcer.get(),
                        i = e.computes.getRewards(),
                        o = e.primitives.heroAsset.get();
                    (0, r.useEffect)(
                        () =>
                            ((u) => {
                                let e,
                                ...
                                return (
                                    (t = requestAnimationFrame(() => {
                                        t = requestAnimationFrame(() => {
                                            (t = null), (e = void wu('gui_reward_screen_general'));
                                        });
                                    })),
                                    () => {
                    ...
                    return (
                        ...
                        n().createElement(
                            ...
                            n().createElement(De, {
                                className: 'RewardsViewApp_announcer_29',
                                text: a.text,
                                time: a.time,
                            }),
                            n().createElement(Ru, {
                                classNames: { base: 'RewardsViewApp_close_55' },
                                caption: R.strings.cosmicEvent.rewardsView.close(),
                                onClick: () => t.onCloseButtonClick(),
                                side: 'right',
                                type: 'close',
                            }),
                            n().createElement(
                                'div',
                                { className: 'RewardsViewApp_header_7b' },
                                n().createElement(
                                    'div',
                                    { className: 'RewardsViewApp_title_1b' },
                                    e.primitives.title.get(),
                                    n().createElement('div', {
                                        className: C()($u, 'RewardsViewApp_title_decoration__left_ee'),
                                    }),
                                    n().createElement('div', {
                                        className: C()($u, 'RewardsViewApp_title_decoration__right_6a'),
                                    }),
                                ),
                                n().createElement(
                                    'div',
                                    { className: 'RewardsViewApp_subtitle_a5' },
                                    n().createElement(X, {
                                        text: e.primitives.subtitle.get(),
                                        binding: { stepNumber: e.primitives.progressionStage.get() },
                                    }),
                                ),
                            ),
                            o && n().createElement('div', { className: 'RewardsViewApp_mainRewards_spacer_ff' }),
                            o && n().createElement('img', { src: o, className: 'RewardsViewApp_hero_66' }),
                            n().createElement(
                                'div',
                                {
                                    className: C()(
                                        'RewardsViewApp_mainRewards_60',
                                        o && 'RewardsViewApp_mainRewards__hero_5d',
                                    ),
                                },
                                i.map((u, e) => {
                                    const t =
                                    ...
                                    return n().createElement(
                                        'div',
                                        { key: e, className: 'RewardsViewApp_reward_74' },
                                        n().createElement(
                                            bu,
                                            de({}, u, {
                                                image: ou(u, A),
                                        ...
                                        n().createElement(
                                            'div',
                                            { className: 'RewardsViewApp_reward_title_d2' },
                                            n().createElement(
                                                'div',
                                                { className: 'RewardsViewApp_reward_title_label_28' },
                                                u.label,
                                            ),
                                            n().createElement(
                                                'div',
                                                { className: 'RewardsViewApp_reward_title_value_29' },
                                                lu(u.value, t),
                                            ),
                                        ),
                                    );
                            ...
                            n().createElement(
                                'div',
                                { className: 'RewardsViewApp_button_container_ef' },
                                n().createElement(
                                    se,
                                    {
                                        className: 'RewardsViewApp_button_9c',
                                        onClick: () => {
                                            wu('yes1'), t.onCloseButtonClick();
                                        },
                                        onMouseEnter: () => wu('highlight'),
                                    },
                ...
                engine.whenReady.then(() => {
                    k().render(
                        n().createElement(L, null, n().createElement(Wu, null, n().createElement(Be, null))),
