(() => {
    var __webpack_modules__ = {
            ...
            527: (u, e, t) => {
                'use strict';
                t.r(e),
                    t.d(e, { mouse: () => F, off: () => A, on: () => E, onResize: () => n, onScaleUpdated: () => i });
                var r = t(472),
                    a = t(176);
            ...
            622: (u, e, t) => {
                ...
                const S = {
                    ...
                    y = (u) => {
                        ...
                        const n = x(),
                            ...
                            E = n.mediaHeight,
                            A = n.mediaSize;
                        return a().createElement('div', L({ className: h()(t, S[i], M[E], T[A]) }, r), e);
                    },
                    O = ['children'];
                const H = (u) => {
                    let e = u.children,
                        ...
                        let e = u.className,
                            ...
                            x =
                                void 0 === f
                                    ...
                                    : f,
                            w = u.alignItems,
                            L = void 0 === w ? (d ? 'flex-start' : g && 'center') || (p && 'flex-end') || void 0 : w,
                            S = u.alignSelf,
                            M = u.wrap,
                            T = u.flexWrap,
                ...
                const tu = ({
                    ...
                    const c = (0, r.useRef)(null),
                        ...
                        x = v[1],
                        w = (0, r.useCallback)(() => {
                            i || (c.current && (c.current.focus(), d(!0)));
                        }, [i]),
                        L = (0, r.useCallback)(
                            (u) => {
                ...
                const _u = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    mu = (u, e, t = lu.left) => u.split(e).reduce(t === lu.left ? Bu : cu, []),
                    Cu = (() => {
                        const u = new RegExp(
                            ...
                            wu(
                                {
                                    ...
                                    mr: !0 === s ? yu[t || 'paragraph-P16'].mr : s,
                                    mb: !0 === D ? yu[t || 'paragraph-P16'].mb : D,
                                    ml: !0 === B ? yu[t || 'paragraph-P16'].ml : B,
                                },
                                C,
                            ),
                ...
                class Wu extends a().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            D = h()(ku.base, ku[`base__${i}`], ku[`base__${n}`], null == E ? void 0 : E.base),
                            _ = h()(ku.icon, ku[`icon__${i}`], ku[`icon__${n}`], null == E ? void 0 : E.icon),
                            B = h()(ku.glow, null == E ? void 0 : E.glow),
                            c = h()(ku.caption, ku[`caption__${i}`], null == E ? void 0 : E.caption),
                            m = h()(ku.goto, null == E ? void 0 : E.goto);
                        return a().createElement(
                            'div',
                            Nu(
                                {
                            ...
                            'info' !== i && a().createElement('div', { className: ku.shine }),
                ...
                const qu = ((u, e) => {
                        ...
                        return [
                            function ({ mode: n = 'real', options: E, children: A, mocks: o }) {
                                ...
                                return (
                                    (0, r.useEffect)(() => {
                                        l.current ? C(s(_, E, o)) : (l.current = !0);
                                    }, [o, _, E]),
                                    (0, r.useEffect)(() => {
                                        B(n);
                                    }, [n]),
                    ...
                    ie = (0, ju.Pi)(() => {
                        const u = Zu(),
                            ...
                            F = A.battleBonusEarnings,
                            s = A.additionalWoTPlusEnabled,
                                            ...
                                            o &&
                                                a().createElement(
                                                    ...
                                                    a().createElement(Hu, {
                                                        ...
                                                        format: {
                                                            binding: {
                                                                earnings: a().createElement('span', null, F, '%'),
                                                            },
                                                        },
