(() => {
    ...
    var __webpack_modules__ = {
            ...
            5011: (u, e, t) => {
                ...
                const nu = { [tu.NBSP]: uu.NoBreakSymbol, [tu.ZWNBSP]: uu.NoBreakSymbol, [tu.NEW_LINE]: uu.LineBreak },
                    ...
                    Eu = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? ou[n]
                                ? a().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: r()(lu, ou[n]) },
                                      u,
                                  )
                                : a().createElement(
                                      'span',
                    ...
                    Au = {
                        [uu.Word]: Eu,
                        [uu.NoBreakSymbol]: Eu,
                        [uu.Binding]: ({ elementList: u, textBlock: e, key: t }) =>
                            a().createElement(
                                'span',
                        ...
                        [uu.LineBreak]: ({ key: u }) =>
                            a().createElement('span', { key: u, 'data-block-type': uu.LineBreak, className: au }),
                        [uu.NewLine]: ({ elementList: u, key: e }) =>
                            a().createElement('span', { key: e, 'data-block-type': uu.NewLine, className: su }, u),
                        [uu.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            a().createElement(
                                'span',
                                { key: e, 'data-block-type': uu.NoBreakWrapper, className: iu },
                                u,
                            ),
                    },
                    Fu = (u, e, t) => {
                    ...
                    _u = (u, e = '') => {
                        ...
                        return (
                            Du(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: uu.Word, colorTag: e, childList: Bu(u) });
                                },
                                (u) => {
                                    const n = u[0],
                                        r = nu[n.charAt(0)];
                            ...
                            Du(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof o || 'number' == typeof o
                                        ? n.push(..._u(String(o), t))
                                        : n.push({ blockType: uu.Binding, colorTag: t, childList: [o] });
                                },
                            ),
                            n
                        );
                    ...
                    pu = (u, e) => {
                        ...
                        if (u.blockType === uu.NoBreakWrapper) u.childList.push(n), t.push(u);
                        else {
                            const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
                            u.childList.length > 0 && t.push(u),
                                t.push({ blockType: uu.NoBreakWrapper, colorTag: '', childList: [e, n] });
                        }
                    ...
                    fu = a().memo(
                        ({
                            ...
                            const F = (0, i.useRef)(null),
                                ...
                                h = (0, i.useMemo)(() => ({ justifyContent: c, alignContent: E }), [E, c]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                a().createElement(
                                    'div',
                                    { className: r()(H, e, Z, s && $), style: h },
                                    a().createElement('div', { className: J, ref: F }, C),
                                    a().createElement(
                                        Y,
                                        { tooltipArgs: p },
                                        a().createElement(
                                            'div',
                                            { className: r()(X, !B.isTruncateFinished && s && Q), style: h },
                ...
                const Tu = a().memo(function ({ iconName: u, size: e = yu.c24x24, className: t }) {
                        var n;
                        return a().createElement('div', {
                            style: {
                                backgroundImage: `url(${null == (n = R.images.gui.maps.icons.tankmen.skills.$dyn(e)) ? void 0 : n.$dyn(u)})`,
                            },
                            className: r()(ku.base, ku[`base__${e}`], t),
                        });
                    }),
                    Ou = {
                ...
                const Lu = { [xu.Big]: yu.c22x22, [xu.Small]: yu.c14x14 };
                var Pu;
                !(function (u) {
                    (u.Grey = 'grey'), (u.LightYellow = 'lightYellow'), (u.Yellow = 'yellow'), (u.Red = 'red');
                })(Pu || (Pu = {}));
                const Su = (u, e, t) =>
                        u === O.Possible || u === O.New
                            ? Pu.LightYellow
                            : u === O.Irrelevant
                              ? Pu.Grey
                              : -1 === e
                                ...
                                : e < 1
                                  ...
                                  : u === O.Learning
                                    ? Pu.Yellow
                                    : Pu.Grey,
                    Ru = a().memo(function ({ icon: u, type: e, size: t, efficiency: n = 1, hasInstruction: o = !1 }) {
                        const i = (!o && -1 === n) || e === O.Irrelevant;
                        return a().createElement(
                            'div',
                            { className: r()(Ou.base, Ou[`base__${t}`]) },
                            a().createElement('div', {
                                className: r()(Ou.background, Ou[`background__${Su(e, n, o)}`]),
                            }),
                            u &&
                                a().createElement(
                                    'div',
                                    ...
                                    a().createElement(Tu, {
                                        iconName: u,
                                        size: Lu[t],
                                        className: r()(i && Ou.disabledIcon),
                                    }),
                                    i && a().createElement('div', { className: Ou.disabled }),
                                ),
                        );
                    }),
                    Nu = 'FreePerk_base_51',
                    Mu = 'FreePerk_icon_ff',
                    Iu = 'FreePerk_perkLevel_ba',
                    Wu = 'FreePerk_perkLevel__available_3b',
                    ju = 'FreePerk_perkLevel__inProgress_5b',
                    Vu = 'FreePerk_multiple_ee',
                    zu = 'FreePerk_partly_12',
                    Uu = ({ count: u, text: e, perkLevel: t = Hu }) => {
                        if (0 === u) return null;
                        const n = t < Hu;
                        return a().createElement(
                            'div',
                            ...
                            a().createElement(
                                'div',
                                { className: Mu },
                                a().createElement(Ru, { icon: 'new_skill', size: xu.Big, type: O.New }),
                            ),
                            u > 1 &&
                                a().createElement(fu, {
                                    classMix: Vu,
                            ...
                            a().createElement('div', { className: r()(Iu, n ? ju : Wu) }, e),
                            0 !== t &&
                                n &&
                                a().createElement('div', { className: zu }, R.strings.tooltips.perkAvailable.partly()),
                        );
                    },
                    Gu = 'PerkAvailableTooltipApp_base_8b',
                    qu = 'PerkAvailableTooltipApp_header_ca',
                    Yu = 'PerkAvailableTooltipApp_divider_9e',
                    Ku = 'PerkAvailableTooltipApp_perks_2b',
                    Hu = 100,
                    Zu = () => {
                        const u = T().model,
                        ...
                        return a().createElement(
                            ...
                            a().createElement(
                                ...
                                a().createElement('div', { className: qu }, R.strings.tooltips.perkAvailable.header()),
                            ),
                            a().createElement(
                                'div',
                                { className: Ku },
                                ...
                                r && a().createElement(Uu, { count: n ? t : t - 1, text: _(Hu) }),
                                o && a().createElement(Uu, { count: 1, text: _(e), perkLevel: e }),
                            ),
                        );
                    };
                engine.whenReady.then(() => {
                    d().render(
                        a().createElement(A, null, a().createElement(y, null, a().createElement(Zu, null))),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(5011));
