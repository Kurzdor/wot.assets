(() => {
    ...
    var __webpack_modules__ = {
            ...
            3032: (u, e, t) => {
                ...
                const C = 'Divided_base_06',
                    m = 'Divided_divider_64',
                    p = (0, n.memo)(({ children: u, classNames: e }) =>
                        r().createElement(
                            'div',
                            { className: C },
                            u,
                            r().createElement('div', { className: s()(m, null == e ? void 0 : e.divider) }),
                        ),
                    ),
                    v = 'default_asterisk_d6',
                    h = 'default_zeroPerk_bb',
                    f = 'HeaderSection_base_f2',
                    b = 'HeaderSection_image_2d',
                    g = 'HeaderSection_textContainer_7d',
                    w = 'HeaderSection_title_b8',
                    y = 'HeaderSection_subtitle_a6',
                    k = (0, n.memo)(({ title: u, icon: e, skillType: t, withAsterisk: n = !1 }) =>
                        r().createElement(
                            p,
                            null,
                            r().createElement(
                                ...
                                { className: f },
                                e &&
                                    r().createElement('div', { className: b, style: { backgroundImage: `url(${e})` } }),
                                r().createElement(
                                    'div',
                                    { className: g },
                                    ...
                                    r().createElement(
                                        ...
                                        t === B.Situational && n && r().createElement('div', { className: v }),
                                    ),
                                ),
                            ),
                        ),
                    ),
                    T = 'TooltipAdvancedFooter_base_d6',
                    O = 'TooltipAdvancedFooter_altBtn_e0',
                    x = r().memo(function ({ classMix: u }) {
                ...
                const G = ((u, e) => {
                                    ...
                                    E = (t, n, r) => {
                                        ...
                                        const i = (function ({
                                                ...
                                                return {
                                                    ...
                                                    dispose: function () {
                                                        for (var u, t = I(r.keys()); !(u = t()).done; ) o(u.value, e);
                                                    },
                                                    unsubscribe: o,
                                                };
                                            })(n),
                        ...
                        const e = Object.assign(
                            ...
                            t = (0, U.Om)(() => j(e.boosters.get(), N), { equals: P }),
                            n = (0, U.Om)(() => -1 === e.efficiency.get() && e.boosterType.get() === _.None, {
                                equals: P,
                            }),
                            r = (0, U.Om)(() => e.efficiency.get() < 1, { equals: P });
                        return Object.assign({}, e, { computes: { boosters: t, isDisabled: n, isLowEfficiency: r } });
                    }, L),
                    z = G[0],
                    q = G[1];
                t(1281);
                ...
                const K = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    $ = r().memo(function ({ skillType: u, skills: e, isLowEfficiency: t }) {
                        const o = (0, n.useMemo)(
                            () =>
                                u === B.Common
                                    ? t
                                        ? R.strings.tooltips.perks.fullGroupSkillWithLowEfficiencyTitle()
                                        : R.strings.tooltips.perks.fullGroupSkillTitle()
                                    : t
                                      ? R.strings.tooltips.perks.fullSkillWithLowEfficiencyTitle()
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: Z.skillsList },
                                    j(e, ({ value: u, text: e, impact: t }, n) =>
                                        r().createElement(
                                            'div',
                                            { key: n, className: Z.skill },
                                            r().createElement(
                                                'div',
                                                { className: s()(Z.skillValue, Z[`skillValue__${t}`]) },
                                                K(u),
                                            ),
                                            r().createElement('div', { className: Z.skillText }, e),
                                        ),
                                    ),
                                ),
                            ),
                        ...
                        const h = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            b = (0, n.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (uu(t, d, { isMouseEvent: !0, on: !0, arguments: J(r) }, f),
                                    m && m(),
                ...
                const cu = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    const o = e.contentId;
                    return o ? r().createElement(eu, lu({}, e, { contentId: o }), n) : r().createElement(ru, e, n);
                };
                var Eu = t(8045);
                const Au = 'ExtendedText_base_71',
                    Fu = 'ExtendedText_base__zeroPadding_25',
                    du = 'ExtendedText_base__isTruncationAvailable_5b',
                    Du = 'ExtendedText_truncated_97',
                    Bu = 'ExtendedText_truncated__hide_31',
                    _u = 'ExtendedText_unTruncated_b8';
                let Cu, mu, pu;
                !(function (u) {
                    (u[(u.Word = 0)] = 'Word'),
                ...
                const vu = { [pu.NBSP]: Cu.NoBreakSymbol, [pu.ZWNBSP]: Cu.NoBreakSymbol, [pu.NEW_LINE]: Cu.LineBreak },
                    ...
                    Tu = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? fu[n]
                                ? r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: s()(yu, fu[n]) },
                                      u,
                                  )
                                : r().createElement(
                                      'span',
                    ...
                    Ou = {
                        ...
                        [Cu.LineBreak]: ({ key: u }) =>
                            r().createElement('span', { key: u, 'data-block-type': Cu.LineBreak, className: gu }),
                        [Cu.NewLine]: ({ elementList: u, key: e }) =>
                            r().createElement('span', { key: e, 'data-block-type': Cu.NewLine, className: wu }, u),
                        [Cu.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            r().createElement(
                                'span',
                                { key: e, 'data-block-type': Cu.NoBreakWrapper, className: bu },
                                u,
                            ),
                    },
                    xu = (u, e, t) => {
                            ...
                            Lu(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof o || 'number' == typeof o
                                        ? n.push(...Mu(String(o), t))
                                        : n.push({ blockType: Cu.Binding, colorTag: t, childList: [o] });
                                },
                            ),
                            n
                        );
                    ...
                    ju = (u, e) => !u || u.offsetTop + u.offsetHeight > e,
                        ...
                        for (let l = t; l >= 0; l--) {
                            ...
                            }
                            {
                                const u = t.children,
                                    c = e[l],
                                    A = c.props.children,
                                    F = zu(u, A, u.length - 1, n, o, i),
                                    d = F[0],
                                    D = F[1];
                                if (!(d < 0)) {
                                    const u = A.slice(0, d);
                                    (s = r().cloneElement(c, c.props, u, D)), (a = l);
                                    break;
                                }
                                o -= E.length;
                            }
                        ...
                        const l = o.children,
                            c = ((u, e) => {
                                ...
                                for (; n - t >= 0; ) {
                                    ...
                                    ju(u[r], e) ? (n = r - 1) : (t = r + 1);
                                }
                                return t - 1;
                            })(l, i);
                        if (c < 0) return [r, !1];
                        const E = zu(l, r, c, a, n.length, n),
                            A = E[0],
                            F = E[1];
                    ...
                    Hu = r().memo(
                        ({
                            ...
                            const F = (0, n.useRef)(null),
                                ...
                                v = (0, n.useMemo)(() => ({ justifyContent: c, alignContent: E }), [E, c]);
                            return (
                                ((u, e, t = !0) => {
                                ...
                                r().createElement(
                                    'div',
                                    { className: s()(Au, e, Fu, a && du), style: v },
                                    r().createElement('div', { className: _u, ref: F }, C),
                                    r().createElement(
                                        cu,
                                        { tooltipArgs: m },
                                        r().createElement(
                                            'div',
                                            { className: s()(Du, !B.isTruncateFinished && a && Bu), style: v },
                    ...
                    Ku = ({ description: u, kwargs: e, className: t }) => {
                        const o = (0, n.useMemo)(() => {
                            const u = e ? JSON.parse(e) : {},
                                t = {};
                            for (const e in u) {
                                var n, o;
                                t[e] = r().createElement(
                                    'div',
                                    { className: fu[`${null == (n = u[e]) ? void 0 : n.color}`] },
                                    null == (o = u[e]) ? void 0 : o.value,
                                );
                            }
                            return t;
                        }, [e]);
                        return r().createElement(Hu, { classMix: t, text: u, binding: o });
                    },
                    Yu = 'EfficiencyInfo_base_94',
                    Zu = 'EfficiencyInfo_container_d7',
                    $u = 'EfficiencyInfo_icon_dc',
                    Xu = 'EfficiencyInfo_percent_97',
                    Qu = ({ efficiencyValue: u }) =>
                        r().createElement(
                            'div',
                            { className: Yu },
                            -1 === u
                                ? r().createElement(
                                      ...
                                      r().createElement('div', null, R.strings.tooltips.perks.efficiency.untrained()),
                                  )
                                : r().createElement(
                                      'div',
                                      null,
                                      r().createElement(Hu, {
                                          ...
                                          binding: {
                                              value: r().createElement(
                                                  'div',
                                                  { className: Xu },
                                                  Y(X.Z5.getNumberFormat(100 * u, X.B3.INTEGRAL)),
                                              ),
                                          },
                                      }),
                                  ),
                    ...
                    Ju = 'TypeInfo_base_9e',
                    ue = 'TypeInfo_asterisk_97',
                    ee = 'TypeInfo_conditionalText_93',
                    te = 'TypeInfo_commonIcon_48',
                    ne = 'TypeInfo_commonText_53',
                    re = ({ skillType: u, isCommonExtraAvailable: e }) => {
                        switch (!0) {
                            case B.Situational === u:
                                return r().createElement(
                                    'div',
                                    { className: Ju },
                                    r().createElement('div', { className: s()(v, ue) }),
                                    r().createElement(
                                        'div',
                                        { className: ee },
                    ...
                    oe = 'ExtraInfo_base_55',
                    ie = 'ExtraInfo_zeroPerkBlock_01',
                    ae = 'ExtraInfo_zeroPerkIcon_63',
                    se = ({ skillType: u, isCommonExtraAvailable: e, isZeroPerk: t }) =>
                        u === B.Situational || (u === B.Common && e) || t
                            ? r().createElement(
                                  p,
                                  null,
                                  r().createElement(
                                      'div',
                                      { className: oe },
                                      r().createElement(re, { skillType: u, isCommonExtraAvailable: e }),
                                      t &&
                                          r().createElement(
                                              'div',
                                              { className: ie },
                                              r().createElement('div', { className: s()(h, ae) }),
                                              R.strings.tooltips.perks.zeroPerkInfo(),
                                          ),
                                  ),
                              )
                            : null,
                    le = 'InstructionInfo_base_9e',
                    ce = 'InstructionInfo_icon_28',
                    Ee = 'InstructionInfo_text_dc',
                    Ae = ({ boosterType: u }) => {
                        if (u !== _.None) {
                            const e = u === _.Extra,
                                t = e
                    ...
                    Fe = 'MainContentSection_description_ac',
                    de = 'MainContentSection_irrelevant_99',
                    De = (0, D.Pi)(() => {
                        const u = q().model,
                            e = u.level.get(),
                            t = u.skillType.get(),
                            n = u.isIrrelevant.get(),
                            o = u.computes.isLowEfficiency(),
                            i = u.boosterType.get();
                        return r().createElement(
                            r().Fragment,
                            null,
                            r().createElement(
                                ...
                                null,
                                r().createElement(Ku, {
                                    description: u.description.get(),
                                    kwargs: u.descriptionKwargs.get(),
                                    className: Fe,
                                }),
                            ),
                            ((e > 0 && e < 100) || (0 === e && o)) &&
                            ...
                            n &&
                                r().createElement(
                                    p,
                                    null,
                                    r().createElement('div', { className: de }, R.strings.tooltips.perks.irrelevant()),
                                ),
                            i === _.None &&
                                o &&
                                !n &&
                                r().createElement(
                                    p,
                                    null,
                                    r().createElement(Qu, { efficiencyValue: u.efficiency.get() }),
                                ),
                            r().createElement(Ae, { boosterType: i }),
                            u.isAdvancedTooltipEnable.get() && r().createElement(x, null),
                        );
                    }),
                    Be = 'ErrorBackground_base_33',
                    _e = () => r().createElement('div', { className: Be }),
                    Ce = 'CrewPerksApp_base_b3',
                    me = (0, D.Pi)(function () {
                        const u = q().model;
                        return r().createElement(
                            d,
                            ...
                            r().createElement(
                                'div',
                                { className: Ce },
                                u.computes.isDisabled() && !u.isIrrelevant.get() && r().createElement(_e, null),
                                r().createElement(k, {
                                    title: u.title.get(),
                                    icon: u.icon.get(),
                ...
                engine.whenReady.then(() => {
                    i().render(
                        r().createElement(z, null, r().createElement(me, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(3032));
