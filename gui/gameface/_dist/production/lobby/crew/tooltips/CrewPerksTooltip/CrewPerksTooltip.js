(() => {
    ...
    var __webpack_modules__ = {
            ...
            3019: (u, e, t) => {
                ...
                const d = r().forwardRef(function (u, e) {
                    ...
                    return (
                        ...
                        r().createElement(
                            'div',
                            F({}, d, {
                                className: s()(c.base, c[`base__theme-${a}`], o),
                                ref: function (u) {
                ...
                const _ = 'Divided_base_06',
                    C = 'Divided_divider_64',
                    m = (0, n.memo)(({ children: u, classNames: e }) =>
                        r().createElement(
                            'div',
                            { className: _ },
                            u,
                            r().createElement('div', { className: s()(C, null == e ? void 0 : e.divider) }),
                        ),
                    ),
                    p = 'default_asterisk_d6',
                    v = 'default_zeroPerk_bb',
                    h = 'HeaderSection_base_f2',
                    b = 'HeaderSection_image_2d',
                    f = 'HeaderSection_textContainer_7d',
                    w = 'HeaderSection_title_b8',
                    g = 'HeaderSection_subtitle_a6',
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        t === B.Situational && n && r().createElement('div', { className: p }),
                                    ),
                                ),
                            ),
                        ),
                        ...
                        const h = (0, n.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            f = (0, n.useCallback)(() => {
                                (h.current.isVisible && h.current.timeoutId) ||
                                    (x(t, d, { isMouseEvent: !0, on: !0, arguments: O(r) }, b),
                                    m && m(),
                ...
                const j = ({ children: u, tooltipArgs: e, className: t }) => {
                    ...
                    return o || a
                        ? r().createElement(S, W({}, e, { contentId: o || a }), n)
                        : r().createElement(L, e, n);
                };
                var H = t(8045);
                const q = 'ExtendedText_base_71',
                    z = 'ExtendedText_base__zeroPadding_25',
                    K = 'ExtendedText_base__isTruncationAvailable_5b',
                    G = 'ExtendedText_truncated_97',
                    Y = 'ExtendedText_truncated__hide_31',
                    Z = 'ExtendedText_unTruncated_b8';
                let $;
                !(function (u) {
                ...
                const eu = { [uu.NBSP]: Q.NoBreakSymbol, [uu.ZWNBSP]: Q.NoBreakSymbol, [uu.NEW_LINE]: Q.LineBreak },
                    ...
                    au = ({ elementList: u, textBlock: e, key: t }) => {
                        ...
                        return n
                            ? tu[n]
                                ? r().createElement(
                                      'span',
                                      { key: t, 'data-block-type': e.blockType, className: tu[n] },
                                      u,
                                  )
                                : r().createElement('span', { key: t, 'data-block-type': e.blockType, style: iu(n) }, u)
                    ...
                    su = {
                        ...
                        [Q.LineBreak]: ({ key: u }) =>
                            r().createElement('span', { key: u, 'data-block-type': Q.LineBreak, className: ru }),
                        [Q.NewLine]: ({ elementList: u, key: e }) =>
                            r().createElement('span', { key: e, 'data-block-type': Q.NewLine, className: ou }, u),
                        [Q.NoBreakWrapper]: ({ elementList: u, key: e }) =>
                            r().createElement(
                                'span',
                                { key: e, 'data-block-type': Q.NoBreakWrapper, className: nu },
                                u,
                            ),
                    },
                    lu = (u, e, t) => {
                    ...
                    Fu = (u, e = '') => {
                        ...
                        return (
                            cu(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (u) => {
                                    t.push({ blockType: Q.Word, colorTag: e, childList: Au(u) });
                                },
                                (u) => {
                                    const n = u[0],
                                        r = eu[n.charAt(0)];
                            ...
                            cu(
                                ...
                                (u) => {
                                    ...
                                    'string' == typeof o || 'number' == typeof o
                                        ? n.push(...Fu(String(o), t))
                                        : n.push({ blockType: Q.Binding, colorTag: t, childList: [o] });
                                },
                            ),
                            n
                        );
                    ...
                    Du = (u, e) => {
                        ...
                        if (u.blockType === Q.NoBreakWrapper) u.childList.push(n), t.push(u);
                        else {
                            const e = Object.assign({}, u, { childList: u.childList.splice(-1) });
                            u.childList.length > 0 && t.push(u),
                                t.push({ blockType: Q.NoBreakWrapper, colorTag: '', childList: [e, n] });
                        }
                    ...
                    hu = r().memo(
                        ({
                            ...
                            return (
                                ...
                                r().createElement(
                                    'div',
                                    { className: s()(q, e, z, a && K), style: v },
                                    r().createElement('div', { className: Z, ref: F }, C),
                                    r().createElement(
                                        j,
                                        { tooltipArgs: m },
                                        r().createElement(
                                            'div',
                                            { className: s()(G, !B.isTruncateFinished && a && Y), style: v },
                    ...
                    bu = 'TooltipAdvancedFooter_base_d6',
                    fu = 'TooltipAdvancedFooter_altBtn_e0',
                    wu = r().memo(function ({ classMix: u }) {
                        return r().createElement(
                            'div',
                            { className: s()(bu, u) },
                ...
                const Lu = ((u, e) => {
                                ...
                                const E = (0, n.useRef)([]),
                                    c = (t, n, r) => {
                                        ...
                                        const i = (function ({
                                            ...
                                            F = { mode: t, model: A, externalModel: a, cleanup: c };
                                        return {
                                            model: A,
                                    ...
                                    d = F[0],
                                    D = F[1],
                                    B = (0, n.useState)(() => c(o, i, s)),
                                    _ = B[0],
                                    C = B[1];
                                return (
                                    (0, n.useEffect)(() => {
                                        A.current ? C(c(d, i, s)) : (A.current = !0);
                                    }, [s, d, i]),
                                    (0, n.useEffect)(() => {
                                        D(o);
                                    }, [o]),
                        ...
                        const e = Object.assign(
                            ...
                            t = (0, Nu.Om)(() => Pu(e.boosters.get(), ku), { equals: yu });
                    ...
                    Uu = r().memo(function ({ skillType: u, skills: e }) {
                        const t =
                            u === B.Common
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    'div',
                                    { className: Iu.skillsList },
                                    Pu(e, ({ value: u, text: e, impact: t }, n) =>
                                        r().createElement(
                                            'div',
                                            { key: n, className: Iu.skill },
                                            r().createElement(
                                                'div',
                                                { className: s()(Iu.skillValue, Iu[`skillValue__${t}`]) },
                                                X(u),
                                            ),
                                            r().createElement('div', { className: Iu.skillText }, e),
                                        ),
                                    ),
                                ),
                            ),
                    ...
                    Vu = 'TypeInfo_base_9e',
                    Wu = 'TypeInfo_asterisk_97',
                    ju = 'TypeInfo_conditionalText_93',
                    Hu = 'TypeInfo_commonIcon_48',
                    qu = 'TypeInfo_commonText_53',
                    zu = ({ skillType: u, isCommonExtraAvailable: e }) => {
                        switch (!0) {
                            case B.Situational === u:
                                return r().createElement(
                                    'div',
                                    { className: Vu },
                                    r().createElement('div', { className: s()(p, Wu) }),
                                    r().createElement(
                                        'div',
                                        { className: ju },
                    ...
                    Ku = 'ExtraInfo_base_55',
                    Gu = 'ExtraInfo_zeroPerkBlock_01',
                    Yu = 'ExtraInfo_zeroPerkIcon_63',
                    Zu = ({ skillType: u, isCommonExtraAvailable: e, isZeroPerk: t }) =>
                        u === B.Situational || (u === B.Common && e) || t
                            ? r().createElement(
                                  ...
                                  r().createElement(
                                      'div',
                                      { className: Ku },
                                      r().createElement(zu, { skillType: u, isCommonExtraAvailable: e }),
                                      t &&
                                          r().createElement(
                                              'div',
                                              { className: Gu },
                                              r().createElement('div', { className: s()(v, Yu) }),
                                              R.strings.tooltips.perks.zeroPerkInfo(),
                                          ),
                                  ),
                              )
                            : null,
                    $u = 'MainContentSection_description_ac',
                    Xu = 'MainContentSection_irrelevant_99',
                    Qu = (0, D.Pi)(() => {
                        const u = Ru().model,
                            e = u.level.get(),
                            t = u.skillType.get();
                        return r().createElement(
                            ...
                            r().createElement(
                                m,
                                null,
                                r().createElement(hu, { classMix: $u, text: u.description.get() }),
                            ),
                            e > 0 && e < 100 && r().createElement(Uu, { skillType: t, skills: u.computes.boosters() }),
                            r().createElement(Zu, {
                                skillType: t,
                            ...
                            u.isIrrelevant.get() &&
                                r().createElement(
                                    m,
                                    null,
                                    r().createElement('div', { className: Xu }, R.strings.tooltips.perks.irrelevant()),
                                ),
                            u.isAdvancedTooltipEnable.get() && r().createElement(wu, null),
                        );
                    }),
                    Ju = 'CrewPerksApp_base_b3',
                    ue = (0, D.Pi)(function () {
                        const u = Ru().model;
                        return r().createElement(
                            d,
                ...
                engine.whenReady.then(() => {
                    i().render(
                        r().createElement(Mu, null, r().createElement(ue, null)),
    ...
    var __webpack_exports__ = __webpack_require__.O(void 0, [56], () => __webpack_require__(3019));
