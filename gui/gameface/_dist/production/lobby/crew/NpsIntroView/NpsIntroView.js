    ...
    var __webpack_modules__ = {
            ...
            2224: (u, e, t) => {
                ...
                const V = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    K = (u, e, t = j.left) => u.split(e).reduce(t === j.left ? z : X, []),
                    Q = (() => {
                        const u = new RegExp(
                ...
                const Ju = ({ format: u, value: e }) => {
                    ...
                    ee = [ju.Gold, ju.Credits, ju.Crystal, ju.FreeXp],
                    te = [ju.BattlePassPoints, ju.EquipCoin],
                    ne = [ju.PremiumPlus, ju.Premium],
                    re = (u) =>
                        ue.includes(u)
                            ? zu.MULTI
                            : ee.includes(u)
                ...
                const Re = 'AnimatedReward_base_48',
                    ...
                    ke = 'AdditionalRewards_reward__big_7f',
                    Me = 'AdditionalRewards_rewardsList_33',
                    Ie = ({ reawards: u, title: e, className: t }) => {
                        const a = (0, n.useState)(!1),
                            ...
                            A = (e) => ({
                                ...
                                config: { duration: 200 },
                                onStart: () => {
                                    e + 1 === u.length && s(!0), i || be.hY.sound('bp_reward');
                                },
                            });
                        return r().createElement(
                            'div',
                    ...
                    qe = { [w.ExtraLarge]: Vu.S600x450, [w.Large]: Vu.S600x450 },
                    je = { [w.ExtraLarge]: Vu.S400x300, [w.Large]: Vu.S400x300, [w.Medium]: Vu.S296x222 },
                    Ye = ({ rewards: u, className: e, withAnimations: t = !0, withScaledSingleReward: n = !0 }) => {
                        const a = f().mediaSize,
                            i = ((u, e, t) => (u > 1 || !t ? je[e] || Vu.S232x174 : qe[e] || Vu.S400x300))(
                                u.length,
                                a,
                                n,
                            );
                            ...
                            fe(u, (u, e) =>
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: Ge },
                                        r().createElement('div', { className: We }, V(u.label)),
                                    ),
                                ),
                            ),
                        );
                ...
                engine.whenReady.then(() => {
                    I().render(
                        r().createElement(bu, null, r().createElement(k, null, r().createElement(Ft, null))),
