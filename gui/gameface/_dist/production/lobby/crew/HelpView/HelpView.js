                ...
                const y = {
                    ...
                    C = (e) => {
                        ...
                        const a = O(),
                            ...
                            s = a.mediaHeight,
                            l = a.mediaSize;
                        return i().createElement('div', T({ className: b()(n, y[o], H[s], P[l]) }, r), t);
                    },
                    A = ['children'];
                const I = (e) => {
                    let t = e.children,
                        ...
                        const x = (0, r.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            S = (0, r.useCallback)(() => {
                                (x.current.isVisible && x.current.timeoutId) ||
                                    (G(n, h, { isMouseEvent: !0, on: !0, arguments: V(i) }, L),
                                    p && p(),
                        ...
                        i().createElement(
                            ...
                            i().createElement(
                                ...
                                Le(t, (e, t) =>
                                    i().createElement(
                                        'div',
                                        { key: t, className: b()(Te.contentItem, Te[`contentItem__${e.size}`]) },
                                        i().createElement('div', {
                                            className: b()(Te.contentImage, Te[`contentImage__${e.size}`]),
