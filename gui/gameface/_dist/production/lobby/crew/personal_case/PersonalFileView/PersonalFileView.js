    ...
    var __webpack_modules__ = {
            ...
            6010: (e, t, u) => {
                ...
                const s = (e) => {
                    ...
                    const s = (0, n.useContext)(a.Y),
                        ...
                        B = { extraLarge: f, large: h, medium: p, small: b, extraSmall: v };
                        ...
                        const p = (0, d.useRef)(null),
                            ...
                            x = () => {
                                ...
                                (u.style.transform = `translateX(${0 | o}px)`),
                                    ((e) => {
                                        if (b.current && v.current && B.current && C.current) {
                                            if (0 === e)
                                                return b.current.classList.add(g), void v.current.classList.remove(g);
                                            if (
                                                ((t = B.current),
                                                (u = C.current),
                                                e - (t.offsetWidth - u.offsetWidth) >= -0.5)
                                            )
                                                return b.current.classList.remove(g), void v.current.classList.add(g);
                                            var t, u;
                                            b.current.classList.remove(g), v.current.classList.remove(g);
                                        }
                                    })(o);
                            },
                            N = (0, l.z)(() => {
                        ...
                        (0, d.useEffect)(() => (0, i.v)(N)),
                            ...
                            (0, d.useEffect)(() => {
                                ...
                                const t = s.O.client.events.mouse.move(([t, u]) => {
                                        ...
                                        const o = t.clientX - w.offset - s.getBoundingClientRect().x,
                                            c = (o / s.offsetWidth) * (null != (r = e.getContainerSize()) ? r : 0);
                ...
                const c = ({
                    ...
                    return i().createElement(
                        ...
                        i().createElement(
                            ...
                            i().createElement(l.Area, { className: m, api: A, classNames: d }, e),
                        ),
            ...
            6225: (e, t, u) => {
                ...
                const g = 'disable',
                    ...
                    b = (0, d.memo)(({ api: e, classNames: t = {}, getStepByRailClick: u = f, onDrag: n = A }) => {
                                ...
                                const t = s.O.client.events.mouse.up(() => {
                                    ...
                                    u = s.O.client.events.mouse.move(([t]) => {
                                        h(e, (u) => {
                                            ...
                                            if (!r || !a || !i) return;
                                            const s = t.screenY - y.offset - r.getBoundingClientRect().y,
                ...
                const c = ({
                    ...
                    return i().createElement(
                        ...
                        i().createElement(
                            ...
                            i().createElement(l.Area, { className: d, classNames: m, api: A }, e),
                        ),
                        i().createElement(s.$Q, { getStepByRailClick: _, api: t, onDrag: E, classNames: g }),
                    );
                };
                        ...
                        return (n = {}) => {
                            const F = n.settings,
                                ...
                                B = (0, d.useSpring)(() => ({
                                    ...
                                    onChange: (e) => {
                                        const t = h.current;
                                        t && (u(t, e), b.trigger('change', e), g && v());
                                    },
                                ...
                                S = (0, c.useCallback)(
                                    (e) => {
                                        0 !== e.deltaY && y(m(e)),
                                            h.current && b.trigger('mouseWheel', e, C.scrollPosition, t(h.current));
                                    },
                                    [C.scrollPosition, y, b],
                                ),
                                x = (0, i.M)(
                                    () =>
                                        (0, r.v)(() => {
                            ...
                            return (0, c.useMemo)(
                                ...
                                [C.scrollPosition, w, y, b.off, b.on, N, S, D, f.step.clampedArrowStepTimeout],
                            );
                        };
                    };
            },
            ...
            3415: (e, t, u) => {
                ...
                const o = ({ children: e, tooltipArgs: t, className: u }) => {
                    ...
                    const o = t.contentId;
                    return o ? r().createElement(s.u, l({}, t, { contentId: o }), n) : r().createElement(a.t, t, n);
                };
            },
            6373: (e, t, u) => {
                u.d(t, { i: () => o });
                        ...
                        const k = (0, a.useRef)({ timeoutId: 0, isVisible: !1, prevTarget: null, hideTimerId: null }),
                            ...
                            y = (0, a.useCallback)(() => {
                                (k.current.isVisible && k.current.timeoutId) ||
                                    (l(u, f, { isMouseEvent: !0, on: !0, arguments: s(r) }, w),
                                    B && B(),
                ...
                const l = () => (e, t) => {
                    ...
                    return [
                        function ({ mode: l = 'real', options: o, children: c, mocks: d }) {
                            ...
                            return (
                                (0, a.useEffect)(() => {
                                    E.current ? p(_(A, o, d)) : (E.current = !0);
                                }, [d, A, o]),
                                (0, a.useEffect)(() => {
                                    F(l);
                                }, [l]),
            ...
            527: (e, t, u) => {
                u.r(t),
                    u.d(t, { mouse: () => c, off: () => l, on: () => s, onResize: () => a, onScaleUpdated: () => i });
                var n = u(2472),
                    r = u(1176);
                ...
                const _ = l().memo(
                    ({
                        ...
                        const h = (0, s.useRef)(null),
                            ...
                            w = (0, s.useMemo)(() => ({ justifyContent: A, alignContent: F }), [F, A]);
                        return (
                            (0, i.y)(h, k, E),
                            l().createElement(
                                'div',
                    ...
                    c = (e, t = '') => {
                        ...
                        return (
                            (0, a.Z)(
                                ...
                                /(\n+|[\xa0\ufeff]+)/g,
                                (e) => {
                                    u.push({ blockType: i.kH.Word, colorTag: t, childList: o(e) });
                                },
                                (e) => {
                                    const n = e[0],
                                        r = i.aF[n.charAt(0)];
                    ...
                    o = (e, t, u, n, i, s) => {
                        ...
                        for (let m = u; m >= 0; m--) {
                            ...
                            if (!(u.childElementCount > 1)) {
                                ...
                                const _ = E.slice(0, E.length - o) + s,
                                    g = t[m];
                ...
                const c = (e) => ({ color: `#${e}` }),
                    ...
                    m = {
                        ...
                        [s.kH.NewLine]: ({ elementList: e, key: t }) =>
                            i().createElement(
                                'span',
                                { key: t, 'data-block-type': s.kH.NewLine, className: o.Z.newLine },
                                e,
                            ),
                        [s.kH.NoBreakWrapper]: ({ elementList: e, key: t }) =>
                            i().createElement(
                                'span',
                                { key: t, 'data-block-type': s.kH.NoBreakWrapper, className: o.Z.noBreakWrapper },
                                e,
                            ),
                    };
            },
            ...
            7077: (e, t, u) => {
                ...
                const c = ({ name: e, size: t = o.c100x60, classMix: u, isSkin: n = !1 }) => {
                    ...
                    return s().createElement('div', { style: c, className: r()(l.Z.base, l.Z[`base__${t}`], u) });
                };
            },
            8018: (e, t, u) => {
                u.d(t, { Gc: () => i, H$: () => s, Y4: () => l });
            ...
            9023: (e, t, u) => {
                ...
                const E = (0, l.q)()(
                        ({ observableModel: e }) => {
                            const t = Object.assign(
                                ...
                                i = (0, _.Om)(() => u(t.commonSkills.get()), { equals: o.jv }),
                                l = (0, _.Om)(() => t.isTankmanInVehicle.get() && t.isTTCVisible.get(), !0),
                                d = (0, _.Om)(() => t.skillsEfficiency.get() === s.sU, !0);
                ...
                const w = r().memo(function (e) {
                    ...
                    O = (0, i.Pi)(function ({ className: e, style: t }) {
                        const u = A(),
                            n = u.controls,
                            i = u.model,
                            s = (0, a.GS)().mediaSize,
                ...
                const j = r().memo(function ({ role: e, size: t = Z.c30x30, className: u }) {
                    ...
                    U = (0, i.Pi)(function ({ role: e, isFemale: t, className: u }) {
                        const n = ((e, t) =>
                            e
                ...
                const le = (e, t, u, n) =>
                        ...
                        return r().createElement(
                            'div',
                            {
                                className: h()(
                                    ...
                                    ie[`base__${a}`],
                                    u && ie.base__hover,
                                    ie[`base__${le(a, i, e, s)}`],
                                ),
                            },
                            r().createElement(ae.y, { iconName: t, size: ae.F.c52x52, className: ie.skillIcon }),
                    ...
                    de = r().memo(function ({
                        ...
                        const s = (0, n.useMemo)(() => ({ height: i + '%' }), [i]),
                            l = u !== Ee.Disabled,
                            o = t === _e.InProgress,
                        ...
                        return r().createElement(
                            ...
                            o && r().createElement('div', { className: ce.progressBar, style: s }),
                ...
                const ge = r().memo(function ({
                        ...
                        const A = (0, n.useState)(!1),
                            ...
                            y = (0, n.useMemo)(() => ({ skillName: e, tooltipId: X.HZ }), [e]);
                        return r().createElement(
                            K.t,
                            { targetId: Ke, args: y, ignoreMouseClick: !0 },
                            r().createElement(
                                'div',
                                {
                                    ...
                                    onClick: v ? w : void 0,
                                    className: h()(me.base, me[`base__${s}`], v && me.base__clickable, _),
                                },
                                r().createElement(de, {
                                    skillState: m,
                                    isHovered: F,
                ...
                const fe = (0, i.Pi)(function (e) {
                        ...
                        const c = (0, n.useRef)(!1),
                            ...
                            })(_.selectAvailableSkillsCount.get(), _.computes.isUntrained(), t, s, l),
                            b = Y(
                                () => {
                    ...
                    pe = 'SkillsRow_skill_df',
                    be = 'SkillsRow_emptySkill_b5';
                function ve() {
                    return (
                        (ve =
                            Object.assign ||
                        ...
                        r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        Be,
                                        Ie({}, e, { isIrrelevant: u, className: Te, isLockedByZeroPerks: s }),
                                    ),
                                ),
                            ),
                        ),
            ...
            299: (e, t, u) => {
                    ...
                    f = r().memo(function ({ name: e, className: t, isSkin: u = !1 }) {
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                s && r().createElement('div', { className: A }),
                            ),
                        );
                    });
                var h = u(5716),
                ...
                const C = (0, b.q)()(
                        ({ observableModel: e }) => {
                            const t = Object.assign(
                                ...
                                u = (0, v.Om)(() => t.skillsEfficiency.get() < p.yb),
                                n = (0, v.Om)(() => t.skillsEfficiency.get() === p.sU),
                                r = (0, v.Om)(() => {
                ...
                const L = 'RetrainAndEfficiency_base_71',
                    ...
                    ue = (0, s.Pi)(function ({ className: e }) {
                        const t = k(),
                            u = t.model,
                            n = t.controls,
                            a = (0, S.GS)().mediaSize,
                            s = u.currentVehicle.get(),
                        ...
                        return r().createElement(
                            ...
                            r().createElement(
                                ...
                                r().createElement(l.w, {
                                    ...
                                    binding: {
                                        vehicle: r().createElement('div', { className: i()(U, s.isPremium && $) }, c),
                                    },
                                }),
                            ),
                            r().createElement(Z, {
                ...
                const re = 'Name_base_2d',
                    ...
                    le = (0, s.Pi)(function ({ className: e }) {
                        const t = k(),
                            u = t.model,
                            a = t.controls,
                            s = (0, n.useCallback)(() => {
                            ...
                            r().createElement(
                                ...
                                u.hasUniqueSound.get() &&
                                    r().createElement(
                                        ...
                                        r().createElement(
                                            w.u5,
                                            { size: w.qE.extraSmall, type: w.L$.ghost, mixClass: ie, onClick: s },
                ...
                const Ze = (0, s.Pi)(function ({ className: e }) {
                        const t = k(),
                            u = t.model,
                            a = t.controls,
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        'div',
                                        { className: Oe },
                                        r().createElement('div', { className: Ie }, (0, he.HG)(s.tier)),
                                        r().createElement('div', { style: h(s.isPremium), className: Pe }),
                                        r().createElement('div', { className: Re }, s.name),
                                    ),
                            ...
                            r().createElement(
                                ...
                                r().createElement(
                                    ...
                                    r().createElement(
                                        ...
                                        { className: Oe },
                                        r().createElement(l.w, {
                                            alignContent: be.v2.Center,
                                            justifyContent: be.v2.Center,
                                            classMix: We,
                    ...
                    et = (0, s.Pi)(function ({ className: e }) {
                        const t = k().model,
                            u = t.description.get(),
                            n = Boolean(u);
                        return r().createElement(
