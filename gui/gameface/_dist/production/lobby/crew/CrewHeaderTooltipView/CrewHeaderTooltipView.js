            ...
            5: (u, e, A) => {
                ...
                const y = (u = 1) => {
                    ...
                    N = (u) =>
                        ((u, e) =>
                            u.split('.').reduce((u, A) => {
                                const t = x(`${u}.${A}`, window);
                                return P(t) ? e(u, A, t) : `${u}.${A}`;
                            }))(u, (u, e) => `${u}.${e}.value`),
                    M = (u) => {
                        const e = ((u) => {
                                const e = y(),
                        ...
                        if (t.length > 0) {
                            ...
                            return (
                                t.reduce((e, t) => {
                                    const E = x(S(A, `${e}.${t}`), window);
                                    return P(E) ? (u.push(E.id), `${e}.${t}.value`) : (u.push(t), `${e}.${t}`);
                                }),
                                u.reduce((u, e) => u + '.' + e)
                            );
                        }
                ...
                const W = 'CrewHeaderTooltipApp_base_e2',
                    ...
                    K = 'CrewHeaderTooltipApp_heading_6d',
                    G = 'CrewHeaderTooltipApp_bonus_c5',
                    ...
                    cu = ({ IdleCrewBonus: u = U.Disabled, bonusXpPerFiveMinutes: e, vehicleName: A }) =>
                        n().createElement(
                            ...
                            n().createElement('div', { className: K }, ou.heading),
                            n().createElement(
                                'div',
                                { className: G },
