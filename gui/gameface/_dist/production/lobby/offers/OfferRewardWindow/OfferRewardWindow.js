(() => {
    ...
    var __webpack_modules__ = {
            768: (u, e, t) => {
                ...
                var r = {};
                t.r(r), t.d(r, { getBgUrl: () => w, getTextureUrl: () => g });
                var i = {};
                function a(u) {
                    return (e) => (
                        engine.on(u, e),
                ...
                const p = {
                    ...
                    h = { play: Object.assign({}, v, { sound: D }), setRTPC: d };
                function g(u, e, t = 1) {
            ...
            920: (u, e, t) => {
                ...
                class I extends o().PureComponent {
                    ...
                    render() {
                        const u = this.props,
                            ...
                            c = S()(M.base, M[`base__${i}`], M[`base__${r}`], null == a ? void 0 : a.base),
                ...
                const tu = [
                    ...
                    nu = [$.Gold, $.Credits, $.Crystal, $.FreeXp],
                    ou = [$.BattlePassPoints, $.EquipCoin],
                    ru = [$.PremiumPlus, $.Premium],
                    iu = [K.Small, K.Big],
                    au = {
                        base: 'Reward_base_ea',
                    ...
                    su = ({
                        ...
                        return o().createElement(
                            'div',
                            { className: S()(au.base, au[`base__${n}`], E), style: s },
                            o().createElement(
                                W,
                                { tooltipArgs: _, className: au.tooltipWrapper },
                                o().createElement(
                                    o().Fragment,
                                    null,
                                    o().createElement(
                                ...
                                const a = n[2]
                                    ...
                                    .map(
                                        (u, e, r) => (
                                            ...
                                            o().createElement(
                                                'span',
                                                { key: `sub${t}-${i}-${e}`, className: _u[n[1]] },
                                                u,
                                            )
                                        ),
                                    );
                ...
                function Ru() {
                    i().render(o().createElement(fu, null), Tu);
                }
                (window.onload = () => {
