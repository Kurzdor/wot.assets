        ...
        F = {
            901: (u, F, A) => {
                ...
                const N = (u) => u.replace(/&nbsp;/g, ' '),
                    ...
                    L = (u, F, A = y.left) => u.split(F).reduce(A === y.left ? k : P, []),
                    O = (() => {
                        const u = new RegExp(
                    ...
                    T = (u, F = y.left) => {
                        ...
                        return ((u, F = y.left) => {
                            ...
                            const E =
                                ...
                                D = N(u);
                            return L(D, /( )/, F).forEach((u) => (A = A.concat(L(u, E, y.left)))), A;
                        })(u, F);
                    },
                    S = 'ContentFooter_base_66',
                    ...
                    uu = ({ data: u, nextBackgroundPath: F, onContentChanged: A, className: B }) => {
                        ...
                        const m = a((F = !1) => {
                            u && (l(F), (f.current = !u.backgroundPath), A(), (g.current = !0));
                        });
                        if (
                            ((0, E.useEffect)(() => {
                                if (!u) return;
                        ...
                        return D().createElement(
                            ...
                            D().createElement('div', {
                                className: t()(X.vignette, f.current && X.vignette__invisible),
                            }),
                        ...
                        (0, E.useEffect)(() => {
                            ...
                            (0, E.useEffect)(() => {
                                ...
                                if (!F || (!u && F.backgroundPath)) e(F);
                                    ...
                                    if (!f.current) return g(o.In), i(F.backgroundPath), r(u, F.transitionTime);
                                    (f.current = !1), u();
                                }
                            }, [F]);
                        const _ = a(() => {
